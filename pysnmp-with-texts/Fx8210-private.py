...
Produced by pysmi-1.3.3 at Sun Mar 10 11:02:03 2024
...
Table of managers to which traps must be sent. Up to 10 entries in table. Some
(up to 5) entries in table are copied from the permanent trap table at reset
time. The other entries are learned from SNMP requests coming to the target
station.
""")
...
If the entry is fixed, it can not be deleted because of aging, which means it
was copied from the permanent trap table.
""")
...
A time stamp of the last time the Manager sent SNMP request to the target agent
( in 50 msec units ).
""")
...
if mibBuilder.loadTexts:
    eventTrap.setDescription("""\
Octet string used to send events to NMS. String description: 1'st octet :
severity code (ASCII decimal) 2'nd octet : space 3'rd - 5'th octet : diu number
(ASCII decimal) 6'th octet : space 7'th - 12'th octet : message code (ASCII
decimal) e.g: BR0345 13'th octet : space 14'th and up : extra message string
(ASCII)
""")
...
if mibBuilder.loadTexts:
    fxmSystemIpAddr.setDescription("""\
...
if mibBuilder.loadTexts:
    fxmSystemIPNetMask.setDescription("""\
IP Network Mask
""")
...
if mibBuilder.loadTexts:
    fxmSystemIPDefGway.setDescription("""\
...
if mibBuilder.loadTexts:
    fxmSystemBroadcastOpt.setDescription("""\
...
if mibBuilder.loadTexts:
    fxmSystemBootServer.setDescription("""\
...
if mibBuilder.loadTexts:
    fxmSystemBootGenName.setDescription("""\
...
if mibBuilder.loadTexts:
    fxmSystemBootMode.setDescription("""\
Method for booting
""")
...
if mibBuilder.loadTexts:
    fxmSystemSelfTestLevel.setDescription("""\
...
if mibBuilder.loadTexts:
    fxmSystemReset.setDescription("""\
Resetting the target station. When reading the instance of this object the
...
if mibBuilder.loadTexts:
    pfxmSystemIpAddr.setDescription("""\
IP address of the agent
""")
...
if mibBuilder.loadTexts:
    pfxmSystemIPNetMask.setDescription("""\
IP Network Mask
""")
...
if mibBuilder.loadTexts:
    pfxmSystemIPDefGway.setDescription("""\
Default Gateway Address
""")
...
if mibBuilder.loadTexts:
    pfxmSystemBroadcastOpt.setDescription("""\
Default Broadcast option: all zeros or all ones
""")
...
if mibBuilder.loadTexts:
    pfxmSystemBootServer.setDescription("""\
IP address to which a TFTP for boot is sent.
""")
...
if mibBuilder.loadTexts:
    pfxmSystemBootGenName.setDescription("""\
Path and file name that is sent as a TFTP request
""")
...
if mibBuilder.loadTexts:
    pfxmSystemBootMode.setDescription("""\
Method for booting
""")
...
if mibBuilder.loadTexts:
    pfxmSystemSelfTestLevel.setDescription("""\
Type of self test to be executed upon cold-reset
""")
...
if mibBuilder.loadTexts:
    pfxmSystemCommunity1.setDescription("""\
...
if mibBuilder.loadTexts:
    pfxmSystemCommunity2.setDescription("""\
...
if mibBuilder.loadTexts:
    pfxmSystemCommunity3.setDescription("""\
...
if mibBuilder.loadTexts:
    pfxmSystemCommunity4.setDescription("""\
...
if mibBuilder.loadTexts:
    pfxmSystemCommunity5.setDescription("""\
...
if mibBuilder.loadTexts:
    pfxmSystemCommunity6.setDescription("""\
...
if mibBuilder.loadTexts:
    pfxmSystemCommunity7.setDescription("""\
...
if mibBuilder.loadTexts:
    pfxmSystemCommunity8.setDescription("""\
...
if mibBuilder.loadTexts:
    sendGenericEvent.setDescription("""\
This trap message is generated by any software module in the FINEX software.
