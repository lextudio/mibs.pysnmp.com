...
xcmCommsConfigTC.setLastUpdated("1110120000Z")
if mibBuilder.loadTexts:
    xcmCommsConfigTC.setOrganization("""\
Xerox Corporation - XCMI Working Group
""")
xcmCommsConfigTC.setContactInfo("""\
...
Contents Encoding ------ -------- -------- 1-12 MAC-address ASCII hexadecimal
(uppercase) [IEEE 802.x] ('0'-'9', 'A'-'F') 13-14 XCMI-reserved ASCII decimal
zeros [XCMI future] ('0' - 0x30) 15-16 NetBIOS-port binary network-byte order
...
'xcmSnmpIPHostnameDomain'. Octets Contents Encoding ------ -------- -------- 1
Host Name Length unsigned char 0-255 2-n FQDN n+1, n+2 UDP Port
"""
...
commsConfigGroup -- 2**0 2 : commsOptionGroup -- 2**1 4 : commsDirRecordGroup
-- 2**2 8 : commsDirAttributeGroup -- 2**3 16 : commsDirStringGroup -- 2**4 32
: commsProtocolGroup -- 2**5 Usage: Conforming management agents SHALL
accurately report their support for XCMI Comms Config MIB object groups.
"""
