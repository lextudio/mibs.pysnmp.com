...
Produced by pysmi-1.3.3 at Sun Mar 10 12:05:45 2024
...
Ingress rate in Mbit/s. The granularity of FE port is between 1 and 100. For GE
...
if mibBuilder.loadTexts:
    brLimitType.setDescription("""\
0: Broadcast Only, 1: Broadcast and multicast, 2: Broadcast and unknown
unicast, 3: Broadcast, multicast and unknown unicast.
""")
...
if mibBuilder.loadTexts:
    securedClientService.setDescription("""\
