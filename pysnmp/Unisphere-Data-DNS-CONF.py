# SNMP MIB module (Unisphere-Data-DNS-CONF) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Unisphere-Data-DNS-CONF
...
(usdDnsEnableGroup,
 ...
 usdDnsServerListGroup) = mibBuilder.importSymbols(
...
usdDnsAgent = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 9)
)
usdDnsAgent.setRevisions(
        ("2001-03-27 23:00",)
)
...
usdDnsAgentV1 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 9, 1)
)
if mibBuilder.loadTexts:
    usdDnsAgentV1.setProductRelease("""\
