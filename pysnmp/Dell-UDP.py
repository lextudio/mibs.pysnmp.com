# SNMP MIB module (Dell-UDP) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Dell-UDP
# Produced by pysmi-1.5.4 at Mon Oct 14 21:35:11 2024
...
rsUdpRelayEntry.setIndexNames(
    (0, "Dell-UDP", "rsUdpRelayDstPort"),
    (0, "Dell-UDP", "rsUdpRelaySrcIpInf"),
    (0, "Dell-UDP", "rsUdpRelayDstIpAddr"),
)
if mibBuilder.loadTexts:
...
rlUdpSessionEntry = _RlUdpSessionEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 42, 3, 1)
)
rlUdpSessionEntry.setIndexNames(
    (0, "Dell-UDP", "rlUdpSessionLocalAddrType"),
    (0, "Dell-UDP", "rlUdpSessionLocalAddr"),
    (0, "Dell-UDP", "rlUdpSessionLocalPort"),
    (0, "Dell-UDP", "rlUdpSessionAppInst"),
)
if mibBuilder.loadTexts:
