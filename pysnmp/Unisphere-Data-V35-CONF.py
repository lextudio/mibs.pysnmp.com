# SNMP MIB module (Unisphere-Data-V35-CONF) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Unisphere-Data-V35-CONF
...
(usdV35Group,) = mibBuilder.importSymbols(
...
usdV35Agent = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 54)
)
usdV35Agent.setRevisions(
        ("2002-01-25 21:43",)
)
...
usdV35AgentV1 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 54, 1)
)
if mibBuilder.loadTexts:
    usdV35AgentV1.setProductRelease("""\
