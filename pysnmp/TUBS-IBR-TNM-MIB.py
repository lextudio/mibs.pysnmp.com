# SNMP MIB module (TUBS-IBR-TNM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/TUBS-IBR-TNM-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 23:07:57 2024
...
tnmPeerEntry.setIndexNames(
    (0, "TUBS-IBR-TNM-MIB", "tnmPeerTAddress"),
)
if mibBuilder.loadTexts:
...
tnmEvalEntry.setIndexNames(
    (0, "TUBS-IBR-TNM-MIB", "tnmEvalIndex"),
)
if mibBuilder.loadTexts:
    tnmEvalEntry.setStatus("current")


class _TnmEvalIndex_Type(Integer32):
    """Custom type tnmEvalIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_TnmEvalIndex_Type.__name__ = "Integer32"
