# SNMP MIB module (TERAWAVE-ilmi-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/TERAWAVE-ilmi-MIB
...
_AtmfPortTableEntry_Object = MibTableRow
atmfPortTableEntry = _AtmfPortTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 353, 2, 1, 1, 1)
)
atmfPortTableEntry.setIndexNames(
    (0, "TERAWAVE-ilmi-MIB", "atmfPortIndex"),
)
if mibBuilder.loadTexts:
    atmfPortTableEntry.setStatus("mandatory")
...
_AtmfPortAddress_Type = OctetString
...
if mibBuilder.loadTexts:
    atmfPortAddress.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    atmfPortTransmissionType.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    atmfPortMediaType.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    atmfPortOperStatus.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    atmfPortSpecific.setStatus("mandatory")
_AtmfPortMyIfName_Type = OctetString
...
_AtmfMyOsiNmNsapAddress_Type = OctetString
...
_AtmfMySystemIdentifier_Type = OctetString
...
_AtmfAtmLayerTableEntry_Object = MibTableRow
atmfAtmLayerTableEntry = _AtmfAtmLayerTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 353, 2, 2, 1, 1)
)
atmfAtmLayerTableEntry.setIndexNames(
    (0, "TERAWAVE-ilmi-MIB", "atmfAtmLayerIndex"),
)
if mibBuilder.loadTexts:
    atmfAtmLayerTableEntry.setStatus("mandatory")
...
_AtmfAtmStatsTableEntry_Object = MibTableRow
atmfAtmStatsTableEntry = _AtmfAtmStatsTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 353, 2, 3, 1, 1)
)
atmfAtmStatsTableEntry.setIndexNames(
    (0, "TERAWAVE-ilmi-MIB", "atmfAtmStatsIndex"),
)
if mibBuilder.loadTexts:
    atmfAtmStatsTableEntry.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    atmfAtmStatsDroppedReceivedCells.setStatus("mandatory")
...
_AtmfVpcTableEntry_Object = MibTableRow
atmfVpcTableEntry = _AtmfVpcTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 353, 2, 4, 1, 1)
)
atmfVpcTableEntry.setIndexNames(
    (0, "TERAWAVE-ilmi-MIB", "atmfVpcPortIndex"),
    (0, "TERAWAVE-ilmi-MIB", "atmfVpcVpi"),
)
if mibBuilder.loadTexts:
    atmfVpcTableEntry.setStatus("mandatory")
_AtmfVpcPortIndex_Type = Integer32
...
if mibBuilder.loadTexts:
    atmfVpcQoSCategory.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    atmfVpcTransmitQoSClass.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    atmfVpcReceiveQoSClass.setStatus("mandatory")


class _AtmfVpcBestEffortIndicator_Type(Integer32):
    """Custom type atmfVpcBestEffortIndicator based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AtmfVpcBestEffortIndicator_Type.__name__ = "Integer32"
...
class _AtmfVpcServiceCategory_Type(Integer32):
    """Custom type atmfVpcServiceCategory based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AtmfVpcServiceCategory_Type.__name__ = "Integer32"
...
_AtmfVccTableEntry_Object = MibTableRow
atmfVccTableEntry = _AtmfVccTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 353, 2, 5, 1, 1)
)
atmfVccTableEntry.setIndexNames(
    (0, "TERAWAVE-ilmi-MIB", "atmfVccPortIndex"),
    (0, "TERAWAVE-ilmi-MIB", "atmfVccVpi"),
    (0, "TERAWAVE-ilmi-MIB", "atmfVccVci"),
)
if mibBuilder.loadTexts:
    atmfVccTableEntry.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    atmfVccQoSCategory.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    atmfVccTransmitQoSClass.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    atmfVccReceiveQoSClass.setStatus("mandatory")


class _AtmfVccBestEffortIndicator_Type(Integer32):
    """Custom type atmfVccBestEffortIndicator based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AtmfVccBestEffortIndicator_Type.__name__ = "Integer32"
...
class _AtmfVccTransmitFrameDiscard_Type(Integer32):
    """Custom type atmfVccTransmitFrameDiscard based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AtmfVccTransmitFrameDiscard_Type.__name__ = "Integer32"
...
class _AtmfVccReceiveFrameDiscard_Type(Integer32):
    """Custom type atmfVccReceiveFrameDiscard based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AtmfVccReceiveFrameDiscard_Type.__name__ = "Integer32"
...
class _AtmfVccServiceCategory_Type(Integer32):
    """Custom type atmfVccServiceCategory based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AtmfVccServiceCategory_Type.__name__ = "Integer32"
...
_AtmfAddressTableEntry_Object = MibTableRow
atmfAddressTableEntry = _AtmfAddressTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 353, 2, 6, 1, 1)
)
atmfAddressTableEntry.setIndexNames(
    (0, "TERAWAVE-ilmi-MIB", "atmfAddressPort"),
    (0, "TERAWAVE-ilmi-MIB", "atmfAddressAtmAddress"),
)
if mibBuilder.loadTexts:
    atmfAddressTableEntry.setStatus("mandatory")
...
_AtmfAddressAtmAddress_Type = OctetString
...
atmfAddressStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
atmfAddressOrgScope.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
_AtmfNetPrefixTableEntry_Object = MibTableRow
atmfNetPrefixTableEntry = _AtmfNetPrefixTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 353, 2, 7, 1, 1)
)
atmfNetPrefixTableEntry.setIndexNames(
    (0, "TERAWAVE-ilmi-MIB", "atmfNetPrefixPort"),
    (0, "TERAWAVE-ilmi-MIB", "atmfNetPrefixPrefix"),
)
if mibBuilder.loadTexts:
    atmfNetPrefixTableEntry.setStatus("mandatory")
...
_AtmfNetPrefixPrefix_Type = OctetString
...
atmfNetPrefixStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
_AtmfVpcAbrTableEntry_Object = MibTableRow
atmfVpcAbrTableEntry = _AtmfVpcAbrTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 353, 2, 9, 1, 1)
)
atmfVpcAbrTableEntry.setIndexNames(
    (0, "TERAWAVE-ilmi-MIB", "atmfVpcAbrPortIndex"),
    (0, "TERAWAVE-ilmi-MIB", "atmfVpcAbrVpi"),
)
if mibBuilder.loadTexts:
    atmfVpcAbrTableEntry.setStatus("mandatory")
...
_AtmfVccAbrTableEntry_Object = MibTableRow
atmfVccAbrTableEntry = _AtmfVccAbrTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 353, 2, 10, 1, 1)
)
atmfVccAbrTableEntry.setIndexNames(
    (0, "TERAWAVE-ilmi-MIB", "atmfVccAbrPortIndex"),
    (0, "TERAWAVE-ilmi-MIB", "atmfVccAbrVpi"),
    (0, "TERAWAVE-ilmi-MIB", "atmfVccAbrVci"),
)
if mibBuilder.loadTexts:
    atmfVccAbrTableEntry.setStatus("mandatory")
...
_AtmfAddressRegistrationAdminTableEntry_Object = MibTableRow
atmfAddressRegistrationAdminTableEntry = _AtmfAddressRegistrationAdminTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 353, 2, 11, 1, 1)
)
atmfAddressRegistrationAdminTableEntry.setIndexNames(
    (0, "TERAWAVE-ilmi-MIB", "atmfAddressRegistrationAdminIndex"),
)
if mibBuilder.loadTexts:
    atmfAddressRegistrationAdminTableEntry.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"atmForum": atmForum,
       ...
       "atmfPortTableEntry": atmfPortTableEntry,
       ...
       "atmfAtmLayerTableEntry": atmfAtmLayerTableEntry,
       ...
       "atmfVpcTableEntry": atmfVpcTableEntry,
       ...
       "atmfVccTableEntry": atmfVccTableEntry,
       ...
       "atmfAddressTableEntry": atmfAddressTableEntry,
       ...
       "atmfNetPrefixTableEntry": atmfNetPrefixTableEntry,
       ...
       "atmfVpcAbrTableEntry": atmfVpcAbrTableEntry,
       ...
       "atmfAddressRegistrationAdminTableEntry": atmfAddressRegistrationAdminTableEntry,
