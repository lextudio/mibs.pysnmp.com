# SNMP MIB module (ChrComPmDs3DS3-Current-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmDs3DS3-Current-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:08 2024
...
_ChrComPmDs3DS3_CurrentTable_Object = MibTable
chrComPmDs3DS3_CurrentTable = _ChrComPmDs3DS3_CurrentTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10)
)
if mibBuilder.loadTexts:
    chrComPmDs3DS3_CurrentTable.setStatus("current")
_ChrComPmDs3DS3_CurrentEntry_Object = MibTableRow
chrComPmDs3DS3_CurrentEntry = _ChrComPmDs3DS3_CurrentEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1)
)
chrComPmDs3DS3_CurrentEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
)
if mibBuilder.loadTexts:
    chrComPmDs3DS3_CurrentEntry.setStatus("current")
...
chrComPmDs3SuspectedInterval = _ChrComPmDs3SuspectedInterval_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 1),
...
chrComPmDs3ElapsedTime = _ChrComPmDs3ElapsedTime_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 2),
...
chrComPmDs3SuppressedIntrvls = _ChrComPmDs3SuppressedIntrvls_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 3),
...
chrComPmDs3LCV = _ChrComPmDs3LCV_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 4),
...
chrComPmDs3LES = _ChrComPmDs3LES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 5),
...
chrComPmDs3LSES = _ChrComPmDs3LSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 6),
...
chrComPmDs3LOSS = _ChrComPmDs3LOSS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 7),
...
chrComPmDs3PCV = _ChrComPmDs3PCV_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 8),
...
chrComPmDs3CCV = _ChrComPmDs3CCV_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 9),
...
chrComPmDs3PES = _ChrComPmDs3PES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 10),
...
chrComPmDs3CES = _ChrComPmDs3CES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 11),
...
chrComPmDs3PSES = _ChrComPmDs3PSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 12),
...
chrComPmDs3CSES = _ChrComPmDs3CSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 13),
...
chrComPmDs3SAS = _ChrComPmDs3SAS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 14),
...
chrComPmDs3AISS = _ChrComPmDs3AISS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 15),
...
chrComPmDs3UASP = _ChrComPmDs3UASP_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 16),
...
chrComPmDs3UASCP = _ChrComPmDs3UASCP_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 17),
...
chrComPmDs3PSC = _ChrComPmDs3PSC_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 18),
...
chrComPmDs3ESPLCP = _ChrComPmDs3ESPLCP_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 19),
...
chrComPmDs3ThresholdProfIndex = _ChrComPmDs3ThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 20),
...
chrComPmDs3ResetPmCountersAction = _ChrComPmDs3ResetPmCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 10, 1, 21),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmDs3DS3-CurrentTable": chrComPmDs3DS3_CurrentTable,
       "chrComPmDs3DS3-CurrentEntry": chrComPmDs3DS3_CurrentEntry,
