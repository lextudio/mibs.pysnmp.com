# SNMP MIB module (XYPLEX-LAT1-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/XYPLEX-LAT1-MIB
...
latPortEntry.setIndexNames(
    (0, "XYPLEX-LAT1-MIB", "latPortIndex"),
)
if mibBuilder.loadTexts:
...
latOfferedServiceEntry.setIndexNames(
    (0, "XYPLEX-LAT1-MIB", "latOfferedServiceName"),
)
if mibBuilder.loadTexts:
...
latVisibleServiceEntry.setIndexNames(
    (0, "XYPLEX-LAT1-MIB", "latVisibleServiceName"),
)
if mibBuilder.loadTexts:
