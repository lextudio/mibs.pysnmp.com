# SNMP MIB module (PANDATEL-GMF-MODEM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/PANDATEL-GMF-MODEM-MIB
...
_Gmf_ObjectIdentity = ObjectIdentity
gmf = _Gmf_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202)
)
_GmfModemTable_Object = MibTable
gmfModemTable = _GmfModemTable_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1)
)
if mibBuilder.loadTexts:
    gmfModemTable.setStatus("mandatory")
_GmfTableEntry_Object = MibTableRow
gmfTableEntry = _GmfTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1)
)
gmfTableEntry.setIndexNames(
    (0, "PANDATEL-GMF-MODEM-MIB", "mdmRack"),
    (0, "PANDATEL-GMF-MODEM-MIB", "mdmModem"),
    (0, "PANDATEL-GMF-MODEM-MIB", "mdmPosition"),
)
if mibBuilder.loadTexts:
    gmfTableEntry.setStatus("mandatory")
_MdmRack_Type = Integer32
_MdmRack_Object = MibTableColumn
mdmRack = _MdmRack_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 1),
    _MdmRack_Type()
)
...
mdmModem = _MdmModem_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 2),
    _MdmModem_Type()
)
...
mdmPosition = _MdmPosition_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 3),
    _MdmPosition_Type()
)
...
mdmModemName = _MdmModemName_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 5),
    _MdmModemName_Type()
)
...
mdmInterfaceEmulationMode = _MdmInterfaceEmulationMode_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 6),
...
mdmModemProperty = _MdmModemProperty_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 7),
...
class _MdmLineEmulationMode_Type(Integer32):
    """Custom type mdmLineEmulationMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_MdmLineEmulationMode_Type.__name__ = "Integer32"
_MdmLineEmulationMode_Object = MibTableColumn
mdmLineEmulationMode = _MdmLineEmulationMode_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 8),
    _MdmLineEmulationMode_Type()
)
mdmLineEmulationMode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    mdmLineEmulationMode.setStatus("mandatory")
...
mdmClockSystem = _MdmClockSystem_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 23),
...
mdmClockSource = _MdmClockSource_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 24),
...
mdmDataRate = _MdmDataRate_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 25),
    _MdmDataRate_Type()
)
...
mdmStartTimeslot = _MdmStartTimeslot_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 26),
...
mdmTimeslotSize = _MdmTimeslotSize_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 27),
...
mdmTimeslot16 = _MdmTimeslot16_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 40),
    _MdmTimeslot16_Type()
)
...
mdmCRC4Generation = _MdmCRC4Generation_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 41),
...
mdmFramingMode = _MdmFramingMode_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 50),
...
class _MdmCodingMode_Type(Integer32):
    """Custom type mdmCodingMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_MdmCodingMode_Type.__name__ = "Integer32"
_MdmCodingMode_Object = MibTableColumn
mdmCodingMode = _MdmCodingMode_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 51),
    _MdmCodingMode_Type()
)
mdmCodingMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    mdmCodingMode.setStatus("mandatory")
...
mdmScrambler = _MdmScrambler_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 63),
    _MdmScrambler_Type()
)
...
mdmRemoteAccessMode = _MdmRemoteAccessMode_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 64),
...
mdmForcedRemoteAccess = _MdmForcedRemoteAccess_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 65),
...
class _MdmTDPhaseLocking_Type(Integer32):
    """Custom type mdmTDPhaseLocking based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_MdmTDPhaseLocking_Type.__name__ = "Integer32"
_MdmTDPhaseLocking_Object = MibTableColumn
mdmTDPhaseLocking = _MdmTDPhaseLocking_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 67),
    _MdmTDPhaseLocking_Type()
)
mdmTDPhaseLocking.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    mdmTDPhaseLocking.setStatus("mandatory")


class _MdmLineBuiltOut_Type(Integer32):
    """Custom type mdmLineBuiltOut based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_MdmLineBuiltOut_Type.__name__ = "Integer32"
_MdmLineBuiltOut_Object = MibTableColumn
mdmLineBuiltOut = _MdmLineBuiltOut_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 68),
    _MdmLineBuiltOut_Type()
)
mdmLineBuiltOut.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    mdmLineBuiltOut.setStatus("mandatory")
...
mdmCRC6Test = _MdmCRC6Test_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 100),
    _MdmCRC6Test_Type()
)
...
mdmCRC6Status = _MdmCRC6Status_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 101),
    _MdmCRC6Status_Type()
)
...
mdmCRC6Error = _MdmCRC6Error_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 202, 1, 1, 102),
    _MdmCRC6Error_Type()
)
mdmCRC6Error.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    mdmCRC6Error.setStatus("mandatory")
_Gmf_modem_ObjectIdentity = ObjectIdentity
gmf_modem = _Gmf_modem_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 10000, 2, 202)
)
...
mibBuilder.exportSymbols(
    ...
    **{"gmf": gmf,
       "gmfModemTable": gmfModemTable,
       "gmfTableEntry": gmfTableEntry,
       "mdmRack": mdmRack,
       "mdmModem": mdmModem,
