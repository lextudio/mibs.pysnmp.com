...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ARISTA-BGP4V2-TC-MIB
...
class AristaBgp4V2IdentifierTC(OctetString, TextualConvention):
    status = "current"
    displayHint = "1d."
...
class AristaBgp4V2AddressFamilyIdentifierTC(Integer32, TextualConvention):
    status = "current"
...
class AristaBgp4V2SubsequentAddressFamilyIdentifierTC(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
