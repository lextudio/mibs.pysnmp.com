# SNMP MIB module (ChrComPmEthETH-Day-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmEthETH-Day-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:14 2024
...
_ChrComPmEthETH_DayTable_Object = MibTable
chrComPmEthETH_DayTable = _ChrComPmEthETH_DayTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11)
)
if mibBuilder.loadTexts:
    chrComPmEthETH_DayTable.setStatus("current")
_ChrComPmEthETH_DayEntry_Object = MibTableRow
chrComPmEthETH_DayEntry = _ChrComPmEthETH_DayEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1)
)
chrComPmEthETH_DayEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmEthETH-Day-MIB", "chrComPmEthDayNumber"),
)
if mibBuilder.loadTexts:
    chrComPmEthETH_DayEntry.setStatus("current")


class _ChrComPmEthDayNumber_Type(Unsigned32):
    """Custom type chrComPmEthDayNumber based on Unsigned32"""
...
_ChrComPmEthDayNumber_Type.__name__ = "Unsigned32"
_ChrComPmEthDayNumber_Object = MibTableColumn
chrComPmEthDayNumber = _ChrComPmEthDayNumber_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 1),
    _ChrComPmEthDayNumber_Type()
)
chrComPmEthDayNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    chrComPmEthDayNumber.setStatus("current")
...
chrComPmEthSuspectedInterval = _ChrComPmEthSuspectedInterval_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 2),
...
chrComPmEthElapsedTime = _ChrComPmEthElapsedTime_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 3),
...
chrComPmEthSuppressedIntrvls = _ChrComPmEthSuppressedIntrvls_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 4),
...
chrComPmEthdot3StatsFCSErrors = _ChrComPmEthdot3StatsFCSErrors_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 5),
...
chrComPmEthdot3StatsLateCollisions = _ChrComPmEthdot3StatsLateCollisions_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 6),
...
chrComPmEthdot3StatsFrameTooLongs = _ChrComPmEthdot3StatsFrameTooLongs_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 7),
...
chrComPmEthdot3StatsInternalMacReceiveErrors = _ChrComPmEthdot3StatsInternalMacReceiveErrors_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 8),
...
chrComPmEthifInOctets = _ChrComPmEthifInOctets_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 9),
...
chrComPmEthifInUcastPkts = _ChrComPmEthifInUcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 10),
...
chrComPmEthifInDiscards = _ChrComPmEthifInDiscards_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 11),
...
chrComPmEthifInErrors = _ChrComPmEthifInErrors_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 12),
...
chrComPmEthifOutOctets = _ChrComPmEthifOutOctets_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 13),
...
chrComPmEthifOutUcastPkts = _ChrComPmEthifOutUcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 14),
...
chrComPmEthifInMulticastPkts = _ChrComPmEthifInMulticastPkts_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 15),
...
chrComPmEthifInBroadcastPkts = _ChrComPmEthifInBroadcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 16),
...
chrComPmEthifOutMulticastPkts = _ChrComPmEthifOutMulticastPkts_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 17),
...
chrComPmEthifOutBroadcastPkts = _ChrComPmEthifOutBroadcastPkts_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 18),
...
chrComPmEthchrFrames64Bytes = _ChrComPmEthchrFrames64Bytes_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 19),
...
chrComPmEthchrFrames65to127Bytes = _ChrComPmEthchrFrames65to127Bytes_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 20),
...
chrComPmEthchrFrames128to256Bytes = _ChrComPmEthchrFrames128to256Bytes_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 21),
...
chrComPmEthchrFrames257to512Bytes = _ChrComPmEthchrFrames257to512Bytes_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 22),
...
chrComPmEthchrFrames513to1024Bytes = _ChrComPmEthchrFrames513to1024Bytes_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 23),
...
chrComPmEthchrFrames1024toMaxBytes = _ChrComPmEthchrFrames1024toMaxBytes_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 24),
...
_ChrComPmEthResetPmCountersAction_Type = TruthValue
_ChrComPmEthResetPmCountersAction_Object = MibTableColumn
chrComPmEthResetPmCountersAction = _ChrComPmEthResetPmCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 5, 11, 1, 25),
    _ChrComPmEthResetPmCountersAction_Type()
)
chrComPmEthResetPmCountersAction.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    chrComPmEthResetPmCountersAction.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmEthETH-DayTable": chrComPmEthETH_DayTable,
       "chrComPmEthETH-DayEntry": chrComPmEthETH_DayEntry,
       "chrComPmEthDayNumber": chrComPmEthDayNumber,
       ...
       "chrComPmEthResetPmCountersAction": chrComPmEthResetPmCountersAction}
)
