# SNMP MIB module (TUBS-PROC-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/TUBS-PROC-MIB
...
procEntry.setIndexNames(
    (0, "TUBS-PROC-MIB", "procID"),
)
if mibBuilder.loadTexts:
    procEntry.setStatus("current")
_ProcID_Type = Integer32
