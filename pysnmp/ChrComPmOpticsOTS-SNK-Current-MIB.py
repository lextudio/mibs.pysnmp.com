# SNMP MIB module (ChrComPmOpticsOTS-SNK-Current-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmOpticsOTS-SNK-Current-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:23 2024
...
_ChrComPmOpticsOTS_SNK_CurrentTable_Object = MibTable
chrComPmOpticsOTS_SNK_CurrentTable = _ChrComPmOpticsOTS_SNK_CurrentTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 1)
)
if mibBuilder.loadTexts:
    chrComPmOpticsOTS_SNK_CurrentTable.setStatus("current")
_ChrComPmOpticsOTS_SNK_CurrentEntry_Object = MibTableRow
chrComPmOpticsOTS_SNK_CurrentEntry = _ChrComPmOpticsOTS_SNK_CurrentEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 1, 1)
)
chrComPmOpticsOTS_SNK_CurrentEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
)
if mibBuilder.loadTexts:
    chrComPmOpticsOTS_SNK_CurrentEntry.setStatus("current")
...
chrComPmOpticsSD = _ChrComPmOpticsSD_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 1, 1, 10),
...
chrComPmOpticsThresholdProfIndex = _ChrComPmOpticsThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 1, 1, 11),
...
chrComPmOpticsResetCountersAction = _ChrComPmOpticsResetCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 1, 1, 12),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmOpticsOTS-SNK-CurrentTable": chrComPmOpticsOTS_SNK_CurrentTable,
       "chrComPmOpticsOTS-SNK-CurrentEntry": chrComPmOpticsOTS_SNK_CurrentEntry,
