...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/RADLAN-ippreflist-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:44:01 2024
...
class RlIpPrefListEntryType(Integer32, TextualConvention):
    status = "current"
...
class RlIpPrefListActionType(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class RlIpPrefListType(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
