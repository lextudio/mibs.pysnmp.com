...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/RFC1289-phivMIB
...
class _PhivDDCMPCircuitSelectTimeouts_Type(PhivCounter):
    """Custom type phivDDCMPCircuitSelectTimeouts based on PhivCounter"""
    subtypeSpec = PhivCounter.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_PhivDDCMPCircuitSelectTimeouts_Type.__name__ = "PhivCounter"
...
_PhivCountersCountSendFailure_Type = PhivCounter
...
class _PhivCountersCountCollDetectFailure_Type(PhivCounter):
    """Custom type phivCountersCountCollDetectFailure based on PhivCounter"""
    subtypeSpec = PhivCounter.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_PhivCountersCountCollDetectFailure_Type.__name__ = "PhivCounter"
...
class _PhivCountersCountReceiveFailure_Type(PhivCounter):
    """Custom type phivCountersCountReceiveFailure based on PhivCounter"""
    subtypeSpec = PhivCounter.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_PhivCountersCountReceiveFailure_Type.__name__ = "PhivCounter"
...
class _PhivCountersCountUnrecFrameDest_Type(PhivCounter):
    """Custom type phivCountersCountUnrecFrameDest based on PhivCounter"""
    subtypeSpec = PhivCounter.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_PhivCountersCountUnrecFrameDest_Type.__name__ = "PhivCounter"
...
class _PhivCountersCountDataOver_Type(PhivCounter):
    """Custom type phivCountersCountDataOver based on PhivCounter"""
    subtypeSpec = PhivCounter.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_PhivCountersCountDataOver_Type.__name__ = "PhivCounter"
...
class _PhivCountersCountSysBuffUnav_Type(PhivCounter):
    """Custom type phivCountersCountSysBuffUnav based on PhivCounter"""
    subtypeSpec = PhivCounter.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_PhivCountersCountSysBuffUnav_Type.__name__ = "PhivCounter"
...
class _PhivCountersCountUsrBuffUnav_Type(PhivCounter):
    """Custom type phivCountersCountUsrBuffUnav based on PhivCounter"""
    subtypeSpec = PhivCounter.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_PhivCountersCountUsrBuffUnav_Type.__name__ = "PhivCounter"
