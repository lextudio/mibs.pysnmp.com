# SNMP MIB module (Unisphere-Data-QoS-Manager-CONF) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Unisphere-Data-QoS-Manager-CONF
# Produced by pysmi-1.5.4 at Mon Oct 14 23:11:28 2024
...
(usdQosCapabilityGroup,
 ...
 usdQosTrafficClassListGroup) = mibBuilder.importSymbols(
...
usdQosManagerAgent = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 50)
)
usdQosManagerAgent.setRevisions(
        ("2001-12-06 16:09",)
)
...
usdQosManagerAgentV1 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 50, 1)
)
if mibBuilder.loadTexts:
    usdQosManagerAgentV1.setProductRelease("""\
...
if mibBuilder.loadTexts:
    usdQosManagerAgentV1.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"usdQosManagerAgent": usdQosManagerAgent,
       "usdQosManagerAgentV1": usdQosManagerAgentV1}
)
