# SNMP MIB module (ChrComPmSonetSNT-PFE-Day-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmSonetSNT-PFE-Day-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:37 2024
...
_ChrComPmSonetSNT_PFE_DayTable_Object = MibTable
chrComPmSonetSNT_PFE_DayTable = _ChrComPmSonetSNT_PFE_DayTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 15)
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_PFE_DayTable.setStatus("current")
_ChrComPmSonetSNT_PFE_DayEntry_Object = MibTableRow
chrComPmSonetSNT_PFE_DayEntry = _ChrComPmSonetSNT_PFE_DayEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 15, 1)
)
chrComPmSonetSNT_PFE_DayEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmSonetSNT-PFE-Day-MIB", "chrComPmSonetDayNumber"),
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_PFE_DayEntry.setStatus("current")
...
chrComPmSonetDayNumber = _ChrComPmSonetDayNumber_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 15, 1, 1),
...
chrComPmSonetSuspectedInterval = _ChrComPmSonetSuspectedInterval_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 15, 1, 2),
...
chrComPmSonetElapsedTime = _ChrComPmSonetElapsedTime_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 15, 1, 3),
...
chrComPmSonetSuppressedIntrvls = _ChrComPmSonetSuppressedIntrvls_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 15, 1, 4),
...
chrComPmSonetES = _ChrComPmSonetES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 15, 1, 5),
...
chrComPmSonetSES = _ChrComPmSonetSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 15, 1, 6),
...
chrComPmSonetCV = _ChrComPmSonetCV_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 15, 1, 7),
...
chrComPmSonetUAS = _ChrComPmSonetUAS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 15, 1, 8),
...
chrComPmSonetThresholdProfIndex = _ChrComPmSonetThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 15, 1, 9),
...
chrComPmSonetResetPmCountersAction = _ChrComPmSonetResetPmCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 15, 1, 10),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmSonetSNT-PFE-DayTable": chrComPmSonetSNT_PFE_DayTable,
       "chrComPmSonetSNT-PFE-DayEntry": chrComPmSonetSNT_PFE_DayEntry,
