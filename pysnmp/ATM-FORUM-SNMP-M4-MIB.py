...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ATM-FORUM-SNMP-M4-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 20:43:55 2024
...
class AtmfM4AlarmLogSeverity(Integer32, TextualConvention):
    status = "current"
...
class AtmfM4AlarmSeverity(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
