# SNMP MIB module (QOS-ACL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/QOS-ACL-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:40:55 2024
...
qosACL = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2)
)
...
aclIfTable = _AclIfTable_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 2)
)
if mibBuilder.loadTexts:
    aclIfTable.setStatus("current")
_AclIfEntry_Object = MibTableRow
aclIfEntry = _AclIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 2, 1)
)
aclIfEntry.setIndexNames(
    (0, "QOS-ACL-MIB", "aclIfIndex"),
    (0, "QOS-ACL-MIB", "aclIfDirection"),
    (0, "QOS-ACL-MIB", "aclIfSequence"),
    (0, "QOS-ACL-MIB", "aclIfAclType"),
    (0, "QOS-ACL-MIB", "aclIfAclId"),
)
if mibBuilder.loadTexts:
...
class _AclRuleIpTosMask_Type(Integer32):
    """Custom type aclRuleIpTosMask based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
aclIpv6RuleSrcL4PortRangeStart = _AclIpv6RuleSrcL4PortRangeStart_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 10),
...
aclIpv6RuleSrcL4PortRangeEnd = _AclIpv6RuleSrcL4PortRangeEnd_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 11),
...
aclIpv6RuleDestL4Port = _AclIpv6RuleDestL4Port_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 12),
...
aclIpv6RuleDestL4PortRangeStart = _AclIpv6RuleDestL4PortRangeStart_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 13),
...
aclIpv6RuleDestL4PortRangeEnd = _AclIpv6RuleDestL4PortRangeEnd_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 14),
...
aclIpv6RuleStatus = _AclIpv6RuleStatus_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 15),
...
aclIpv6RuleFlowLabel = _AclIpv6RuleFlowLabel_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 16),
...
aclIpv6RuleIPDSCP = _AclIpv6RuleIPDSCP_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 17),
...
aclRuleSrcIpv6Prefix = _AclRuleSrcIpv6Prefix_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 18),
...
aclRuleSrcIpv6PrefixLength = _AclRuleSrcIpv6PrefixLength_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 19),
...
aclRuleDstIpv6Prefix = _AclRuleDstIpv6Prefix_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 20),
...
aclRuleDstIpv6PrefixLength = _AclRuleDstIpv6PrefixLength_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 21),
...
aclIpv6RuleTimeRangeName = _AclIpv6RuleTimeRangeName_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 22),
...
aclIpv6RuleTimeRangeStatus = _AclIpv6RuleTimeRangeStatus_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 13, 1, 23),
...
aclVlanTable = _AclVlanTable_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 15)
)
if mibBuilder.loadTexts:
    aclVlanTable.setStatus("current")
_AclVlanEntry_Object = MibTableRow
aclVlanEntry = _AclVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 15, 1)
)
aclVlanEntry.setIndexNames(
    (0, "QOS-ACL-MIB", "aclVlanIndex"),
    (0, "QOS-ACL-MIB", "aclVlanDirection"),
    (0, "QOS-ACL-MIB", "aclVlanSequence"),
    (0, "QOS-ACL-MIB", "aclVlanAclType"),
    (0, "QOS-ACL-MIB", "aclVlanAclId"),
)
if mibBuilder.loadTexts:
...
aclTrapRuleLogEvent = NotificationType(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 10, 1)
)
aclTrapRuleLogEvent.setObjects(
      *(("QOS-ACL-MIB", "aclIfAclType"),
        ("QOS-ACL-MIB", "aclIfAclId"),
        ("QOS-ACL-MIB", "aclTrapRuleIndex"),
        ("QOS-ACL-MIB", "aclTrapRuleAction"),
        ("QOS-ACL-MIB", "aclTrapRuleHitCount"))
)
if mibBuilder.loadTexts:
...
aclTrapRuleTimeRangeEvent = NotificationType(
    (1, 3, 6, 1, 4, 1, 7244, 2, 3, 2, 10, 2)
)
aclTrapRuleTimeRangeEvent.setObjects(
      *(("QOS-ACL-MIB", "aclIfAclType"),
        ("QOS-ACL-MIB", "aclIfAclId"),
        ("QOS-ACL-MIB", "aclTrapRuleIndex"),
        ("QOS-ACL-MIB", "aclTrapRuleTimeRangeName"),
        ("QOS-ACL-MIB", "aclTrapRuleTimeRangeNotification"),
        ("QOS-ACL-MIB", "aclTrapRuleInstallationStatus"))
)
if mibBuilder.loadTexts:
