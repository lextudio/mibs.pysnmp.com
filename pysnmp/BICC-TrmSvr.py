# SNMP MIB module (BICC-TrmSvr) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/BICC-TrmSvr
# Produced by pysmi-1.5.4 at Mon Oct 14 20:47:56 2024
...
vSysEtherType = _VSysEtherType_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 1, 10),
    _VSysEtherType_Type()
)
...
vSysBroadband = _VSysBroadband_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 1, 11),
    _VSysBroadband_Type()
)
...
vSysPasswordLimit = _VSysPasswordLimit_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 1, 12),
...
vSysPrivPassword = _VSysPrivPassword_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 1, 13),
...
vSysMaintenancePassword = _VSysMaintenancePassword_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 1, 14),
...
vPortBreakDuration = _VPortBreakDuration_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 10),
...
vPortXoffMark = _VPortXoffMark_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 11),
    _VPortXoffMark_Type()
)
...
vPortXonMark = _VPortXonMark_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 12),
    _VPortXonMark_Type()
)
...
vPortNumber = _VPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 13),
    _VPortNumber_Type()
)
...
vPortIndex = _VPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 1),
    _VPortIndex_Type()
)
...
vPortType = _VPortType_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 2),
    _VPortType_Type()
)
...
vPortName = _VPortName_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 3),
    _VPortName_Type()
)
...
vPortUserName = _VPortUserName_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 4),
    _VPortUserName_Type()
)
...
vPortState = _VPortState_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 5),
    _VPortState_Type()
)
...
vPortLogout = _VPortLogout_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 6),
    _VPortLogout_Type()
)
...
vPortActiveSessions = _VPortActiveSessions_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 7),
...
vPortCurrSessNumber = _VPortCurrSessNumber_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 8),
...
vPortCurrSessProt = _VPortCurrSessProt_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 9),
...
vPortAccess = _VPortAccess_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 10),
    _VPortAccess_Type()
)
...
vPortVirtualEnable = _VPortVirtualEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 11),
...
vPortVirtualString = _VPortVirtualString_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 12),
...
vPortSessionLimit = _VPortSessionLimit_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 13),
...
vPortProfile = _VPortProfile_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 14),
    _VPortProfile_Type()
)
...
vPortQueueing = _VPortQueueing_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 15),
    _VPortQueueing_Type()
)
...
vPortPasswordEnable = _VPortPasswordEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 16),
...
vPortTacacsEnable = _VPortTacacsEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 17),
...
vPortSecurityEnable = _VPortSecurityEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 18),
...
vPortGroups = _VPortGroups_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 19),
    _VPortGroups_Type()
)
...
vPortBreakMode = _VPortBreakMode_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 20),
...
vPortBackSwitch = _VPortBackSwitch_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 21),
...
vPortForwSwitch = _VPortForwSwitch_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 22),
...
vPortLocalSwitch = _VPortLocalSwitch_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 23),
...
vPortPrefSvc = _VPortPrefSvc_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 24),
    _VPortPrefSvc_Type()
)
...
vPortPrefNode = _VPortPrefNode_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 25),
    _VPortPrefNode_Type()
)
...
vPortPrefPort = _VPortPrefPort_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 26),
    _VPortPrefPort_Type()
)
...
vPortPrefMode = _VPortPrefMode_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 27),
    _VPortPrefMode_Type()
)
...
vPortAutoConnect = _VPortAutoConnect_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 28),
...
vPortPrompt = _VPortPrompt_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 29),
    _VPortPrompt_Type()
)
...
vPortInactiveLogout = _VPortInactiveLogout_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 30),
...
vPortAutoPrompt = _VPortAutoPrompt_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 31),
...
vPortBroadcastEnable = _VPortBroadcastEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 32),
...
vPortInterrupts = _VPortInterrupts_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 33),
...
vPortMessageCodes = _VPortMessageCodes_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 34),
...
vPortVerification = _VPortVerification_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 35),
...
vPortDialup = _VPortDialup_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 36),
    _VPortDialup_Type()
)
...
vPortRemoteModify = _VPortRemoteModify_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 37),
...
vPortAbsoluteLogout = _VPortAbsoluteLogout_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 38),
...
vPortIOflush = _VPortIOflush_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 39),
    _VPortIOflush_Type()
)
...
vPortLogoutMsgEnable = _VPortLogoutMsgEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 40),
...
vPortScreenType = _VPortScreenType_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 41),
...
vPortFlowType = _VPortFlowType_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 42),
    _VPortFlowType_Type()
)
...
vPortInFlowState = _VPortInFlowState_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 43),
...
vPortOutFlowState = _VPortOutFlowState_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 44),
...
vPortCTSstate = _VPortCTSstate_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 45),
    _VPortCTSstate_Type()
)
...
vPortDSRstate = _VPortDSRstate_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 46),
    _VPortDSRstate_Type()
)
...
vPortDCDstate = _VPortDCDstate_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 47),
    _VPortDCDstate_Type()
)
...
vPortDTRstate = _VPortDTRstate_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 48),
    _VPortDTRstate_Type()
)
...
vPortRIstate = _VPortRIstate_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 49),
    _VPortRIstate_Type()
)
...
vPortRTSstate = _VPortRTSstate_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 50),
    _VPortRTSstate_Type()
)
...
vPortSpeed = _VPortSpeed_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 51),
    _VPortSpeed_Type()
)
...
vPortCharSize = _VPortCharSize_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 52),
    _VPortCharSize_Type()
)
...
vPortParityType = _VPortParityType_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 53),
...
vPortAutobaud = _VPortAutobaud_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 54),
    _VPortAutobaud_Type()
)
...
vPortModemControl = _VPortModemControl_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 55),
...
vPortDSRlogout = _VPortDSRlogout_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 56),
...
vPortRing = _VPortRing_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 57),
    _VPortRing_Type()
)
...
vPortDTRwait = _VPortDTRwait_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 58),
    _VPortDTRwait_Type()
)
...
vPortSignalCheckEnable = _VPortSignalCheckEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 59),
...
vPortHandshake = _VPortHandshake_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 60),
...
vPortRcvChars = _VPortRcvChars_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 61),
    _VPortRcvChars_Type()
)
...
vPortTrnChars = _VPortTrnChars_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 62),
    _VPortTrnChars_Type()
)
...
vPortFrameErrs = _VPortFrameErrs_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 63),
...
vPortOverrunErrs = _VPortOverrunErrs_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 64),
...
vPortParityErrs = _VPortParityErrs_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 65),
...
vPortCharsDropped = _VPortCharsDropped_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 2, 14, 1, 66),
...
vSvcName = _VSvcName_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 1),
    _VSvcName_Type()
)
...
vSvcPorts = _VSvcPorts_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 2),
    _VSvcPorts_Type()
)
...
vSvcIdent = _VSvcIdent_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 3),
    _VSvcIdent_Type()
)
...
vSvcRating = _VSvcRating_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 4),
    _VSvcRating_Type()
)
...
vSvcLtEnable = _VSvcLtEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 5),
    _VSvcLtEnable_Type()
)
...
vSvcTelEnable = _VSvcTelEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 6),
    _VSvcTelEnable_Type()
)
...
vSvcLprEnable = _VSvcLprEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 7),
    _VSvcLprEnable_Type()
)
...
vSvcRawEnable = _VSvcRawEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 8),
    _VSvcRawEnable_Type()
)
...
vSvcVirtualEnable = _VSvcVirtualEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 9),
...
vSvcVirtualText = _VSvcVirtualText_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 10),
...
vSvcConnectEnable = _VSvcConnectEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 11),
...
vSvcPassword = _VSvcPassword_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 12),
    _VSvcPassword_Type()
)
...
vSvcQueueEnable = _VSvcQueueEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 13),
...
vSvcIpAddr = _VSvcIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 14),
    _VSvcIpAddr_Type()
)
...
vSvcTcpPort = _VSvcTcpPort_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 15),
    _VSvcTcpPort_Type()
)
...
vSvcProfile = _VSvcProfile_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 16),
    _VSvcProfile_Type()
)
...
vSvcStatus = _VSvcStatus_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 3, 3, 1, 17),
    _VSvcStatus_Type()
)
...
vProfName = _VProfName_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 1),
    _VProfName_Type()
)
...
vProfDomain = _VProfDomain_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 2),
    _VProfDomain_Type()
)
...
vProfConcatenate = _VProfConcatenate_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 3),
...
vProfPermHostOnly = _VProfPermHostOnly_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 4),
...
vProfTcpPort = _VProfTcpPort_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 5),
    _VProfTcpPort_Type()
)
...
vProfTcpTimeout = _VProfTcpTimeout_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 6),
...
vProfTcpKeepalive = _VProfTcpKeepalive_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 7),
...
vProfIpTTL = _VProfIpTTL_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 8),
    _VProfIpTTL_Type()
)
...
vProfIpPrecedence = _VProfIpPrecedence_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 9),
...
vProfTermType = _VProfTermType_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 10),
    _VProfTermType_Type()
)
...
vProfCrToNet = _VProfCrToNet_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 11),
    _VProfCrToNet_Type()
)
...
vProfCrFromTerm = _VProfCrFromTerm_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 12),
...
vProfPadChar = _VProfPadChar_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 13),
    _VProfPadChar_Type()
)
...
vProfPadLength = _VProfPadLength_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 14),
...
vProfEndRecord = _VProfEndRecord_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 15),
...
vProfNop = _VProfNop_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 16),
    _VProfNop_Type()
)
...
vProfDataMark = _VProfDataMark_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 17),
    _VProfDataMark_Type()
)
...
vProfBreak = _VProfBreak_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 18),
    _VProfBreak_Type()
)
...
vProfIntProcess = _VProfIntProcess_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 19),
...
vProfAbortOutput = _VProfAbortOutput_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 20),
...
vProfAttention = _VProfAttention_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 21),
...
vProfEraseChar = _VProfEraseChar_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 22),
...
vProfEraseLine = _VProfEraseLine_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 23),
...
vProfGoAhead = _VProfGoAhead_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 24),
    _VProfGoAhead_Type()
)
...
vProfNullPass = _VProfNullPass_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 25),
    _VProfNullPass_Type()
)
...
vProfLocalEcho = _VProfLocalEcho_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 26),
...
vProfRemoteEcho = _VProfRemoteEcho_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 27),
...
vProfLocalBinary = _VProfLocalBinary_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 28),
...
vProfRemoteBinary = _VProfRemoteBinary_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 29),
...
vProfStatus = _VProfStatus_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 4, 2, 1, 30),
    _VProfStatus_Type()
)
...
vSecIndex = _VSecIndex_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 5, 3, 1, 1),
    _VSecIndex_Type()
)
...
vSecAddress = _VSecAddress_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 5, 3, 1, 2),
    _VSecAddress_Type()
)
...
vSecMask = _VSecMask_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 5, 3, 1, 3),
    _VSecMask_Type()
)
...
vSecGroups = _VSecGroups_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 5, 3, 1, 4),
    _VSecGroups_Type()
)
...
vSecStatus = _VSecStatus_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 5, 3, 1, 5),
    _VSecStatus_Type()
)
...
vHostHostname = _VHostHostname_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 6, 2, 1, 1),
    _VHostHostname_Type()
)
...
vHostAddress = _VHostAddress_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 6, 2, 1, 2),
    _VHostAddress_Type()
)
...
vHostTTL = _VHostTTL_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 6, 2, 1, 3),
    _VHostTTL_Type()
)
...
vHostStatus = _VHostStatus_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 6, 2, 1, 4),
    _VHostStatus_Type()
)
...
vNsAddress = _VNsAddress_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 7, 4, 1, 1),
    _VNsAddress_Type()
)
...
vNsHostname = _VNsHostname_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 7, 4, 1, 2),
    _VNsHostname_Type()
)
...
vNsTTL = _VNsTTL_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 7, 4, 1, 3),
    _VNsTTL_Type()
)
...
vNsStatus = _VNsStatus_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 7, 4, 1, 4),
    _VNsStatus_Type()
)
...
vTacAddress = _VTacAddress_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 8, 2, 1, 1),
    _VTacAddress_Type()
)
...
vTacHostname = _VTacHostname_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 8, 2, 1, 2),
    _VTacHostname_Type()
)
...
vTacStatus = _VTacStatus_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 8, 2, 1, 3),
    _VTacStatus_Type()
)
...
vArpMaxEntries = _VArpMaxEntries_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 10, 1),
...
vArpRetryTimeout = _VArpRetryTimeout_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 10, 2),
...
vArpRetryMax = _VArpRetryMax_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 10, 3),
    _VArpRetryMax_Type()
)
...
vArpConfirmTimer = _VArpConfirmTimer_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 10, 4),
...
vArpIdleTimeout = _VArpIdleTimeout_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 10, 5),
...
vTcpIpPrecedence = _VTcpIpPrecedence_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 11, 1),
...
vTcpSendQSize = _VTcpSendQSize_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 11, 2),
    _VTcpSendQSize_Type()
)
...
vTcpRcvWinSize = _VTcpRcvWinSize_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 11, 3),
...
vTcpSegSize = _VTcpSegSize_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 11, 4),
    _VTcpSegSize_Type()
)
...
vTcpTimerInterval = _VTcpTimerInterval_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 11, 5),
...
vTcpChecksumEnable = _VTcpChecksumEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 11, 6),
...
vTelCourierEnable = _VTelCourierEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 1),
...
vTelCourierText = _VTelCourierText_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 2),
...
vTelSessCurrNumber = _VTelSessCurrNumber_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 3),
...
vTelSessPortIndex = _VTelSessPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 1),
...
vTelSessIndex = _VTelSessIndex_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 2),
    _VTelSessIndex_Type()
)
...
vTelSessOrigin = _VTelSessOrigin_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 3),
...
vTelSessState = _VTelSessState_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 4),
    _VTelSessState_Type()
)
...
vTelSessDisconnect = _VTelSessDisconnect_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 5),
...
vTelSessLocalAddr = _VTelSessLocalAddr_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 6),
...
vTelSessLocalTcpPort = _VTelSessLocalTcpPort_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 7),
...
vTelSessRemAddr = _VTelSessRemAddr_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 8),
...
vTelSessRemTcpPort = _VTelSessRemTcpPort_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 9),
...
vTelSessCrToNet = _VTelSessCrToNet_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 10),
...
vTelSessCrFromTerm = _VTelSessCrFromTerm_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 11),
...
vTelSessPadChar = _VTelSessPadChar_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 12),
...
vTelSessPadLength = _VTelSessPadLength_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 13),
...
vTelSessUserTimeout = _VTelSessUserTimeout_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 14),
...
vTelSessKeepalive = _VTelSessKeepalive_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 15),
...
vTelSessIpTTL = _VTelSessIpTTL_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 16),
    _VTelSessIpTTL_Type()
)
...
vTelSessIpPrecedence = _VTelSessIpPrecedence_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 17),
...
vTelSessEndRecord = _VTelSessEndRecord_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 18),
...
vTelSessNop = _VTelSessNop_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 19),
    _VTelSessNop_Type()
)
...
vTelSessDataMark = _VTelSessDataMark_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 20),
...
vTelSessBreak = _VTelSessBreak_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 21),
    _VTelSessBreak_Type()
)
...
vTelSessIntProcess = _VTelSessIntProcess_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 22),
...
vTelSessAbortOutput = _VTelSessAbortOutput_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 23),
...
vTelSessAttention = _VTelSessAttention_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 24),
...
vTelSessEraseChar = _VTelSessEraseChar_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 25),
...
vTelSessEraseLine = _VTelSessEraseLine_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 26),
...
vTelSessGoAhead = _VTelSessGoAhead_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 27),
...
vTelSessNullPass = _VTelSessNullPass_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 28),
...
vTelSessTermType = _VTelSessTermType_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 29),
...
vTelSessLocalEcho = _VTelSessLocalEcho_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 30),
...
vTelSessRemoteEcho = _VTelSessRemoteEcho_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 31),
...
vTelSessLocalBinary = _VTelSessLocalBinary_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 32),
...
vTelSessRemoteBinary = _VTelSessRemoteBinary_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 12, 4, 1, 33),
...
vRlogSessPortIndex = _VRlogSessPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 13, 2, 1, 1),
...
vRlogSessIndex = _VRlogSessIndex_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 13, 2, 1, 2),
...
vRlogSessOrigin = _VRlogSessOrigin_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 13, 2, 1, 3),
...
vRlogSessState = _VRlogSessState_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 13, 2, 1, 4),
...
vRlogSessDisconnect = _VRlogSessDisconnect_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 13, 2, 1, 5),
...
vRlogSessLocalAddr = _VRlogSessLocalAddr_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 13, 2, 1, 6),
...
vRlogSessLocalTcpPort = _VRlogSessLocalTcpPort_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 13, 2, 1, 7),
...
vRlogSessRemAddr = _VRlogSessRemAddr_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 13, 2, 1, 8),
...
vRlogSessRemTcpPort = _VRlogSessRemTcpPort_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 13, 2, 1, 9),
...
vRlogSessTermType = _VRlogSessTermType_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 13, 2, 1, 10),
...
vLtNodeName = _VLtNodeName_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 1),
    _VLtNodeName_Type()
)
...
vLtNodeID = _VLtNodeID_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 2),
    _VLtNodeID_Type()
)
...
vLtNodeGroups = _VLtNodeGroups_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 3),
    _VLtNodeGroups_Type()
)
...
vLtNumber = _VLtNumber_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 4),
    _VLtNumber_Type()
)
...
vLtMcastEnable = _VLtMcastEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 5),
...
vLtMcastTimer = _VLtMcastTimer_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 6),
    _VLtMcastTimer_Type()
)
...
vLtCktTimer = _VLtCktTimer_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 7),
    _VLtCktTimer_Type()
)
...
vLtKeepaliveTimer = _VLtKeepaliveTimer_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 8),
...
vLtMaxRetran = _VLtMaxRetran_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 9),
    _VLtMaxRetran_Type()
)
...
vLtSlotPerCkt = _VLtSlotPerCkt_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 10),
    _VLtSlotPerCkt_Type()
)
...
vLtMaxNodes = _VLtMaxNodes_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 11),
    _VLtMaxNodes_Type()
)
...
vLtMaxSvcs = _VLtMaxSvcs_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 12),
    _VLtMaxSvcs_Type()
)
...
vLtMaxCkts = _VLtMaxCkts_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 13),
    _VLtMaxCkts_Type()
)
...
vLtSessCurrNumber = _VLtSessCurrNumber_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 14),
...
vLtSessPortIndex = _VLtSessPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 15, 1, 1),
...
vLtSessIndex = _VLtSessIndex_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 15, 1, 2),
    _VLtSessIndex_Type()
)
...
vLtSessOrigin = _VLtSessOrigin_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 15, 1, 3),
    _VLtSessOrigin_Type()
)
...
vLtSessState = _VLtSessState_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 15, 1, 4),
    _VLtSessState_Type()
)
...
vLtSessDisconnect = _VLtSessDisconnect_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 15, 1, 5),
...
vLtSessSvcName = _VLtSessSvcName_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 15, 1, 6),
...
vLtSessNodeName = _VLtSessNodeName_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 15, 1, 7),
...
vLtSessDestName = _VLtSessDestName_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 15, 1, 8),
...
vLtTotalRcvPkts = _VLtTotalRcvPkts_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 16),
...
vLtTotalTrnPkts = _VLtTotalTrnPkts_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 17),
...
vLtTotalRetranPkts = _VLtTotalRetranPkts_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 18),
...
vLtRcvCorruptPkts = _VLtRcvCorruptPkts_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 19),
...
vLtRcvCorruptMcasts = _VLtRcvCorruptMcasts_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 20),
...
vLtRcvDuplicatePkts = _VLtRcvDuplicatePkts_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 21),
...
vLtReqAccepted = _VLtReqAccepted_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 22),
...
vLtReqRejected = _VLtReqRejected_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 23),
...
vLtTotalNodeDiscards = _VLtTotalNodeDiscards_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 14, 24),
...
vQueMaxEntries = _VQueMaxEntries_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 15, 1),
...
vQueCurrNumber = _VQueCurrNumber_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 15, 2),
...
vQueEntryNumber = _VQueEntryNumber_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 15, 3, 1, 1),
...
vQueSvcName = _VQueSvcName_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 15, 3, 1, 2),
    _VQueSvcName_Type()
)
...
vQueNodeName = _VQueNodeName_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 15, 3, 1, 3),
    _VQueNodeName_Type()
)
...
vQuePortName = _VQuePortName_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 15, 3, 1, 4),
    _VQuePortName_Type()
)
...
vQueStatus = _VQueStatus_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 15, 3, 1, 5),
    _VQueStatus_Type()
)
...
vSnmpReadCommunity = _VSnmpReadCommunity_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 16, 1),
...
vSnmpWriteCommunity = _VSnmpWriteCommunity_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 16, 2),
...
vSnmpReadWriteCommunity = _VSnmpReadWriteCommunity_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 16, 3),
...
vSnmpWriteEnable = _VSnmpWriteEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 16, 4),
...
vSnmpTrapDestCurrNumber = _VSnmpTrapDestCurrNumber_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 16, 5),
...
vSnmpTrapDestTable = _VSnmpTrapDestTable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 16, 6)
)
if mibBuilder.loadTexts:
...
vSnmpTrapDestEntry = _VSnmpTrapDestEntry_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 16, 6, 1)
)
vSnmpTrapDestEntry.setIndexNames(
    (0, "BICC-TrmSvr", "vSnmpTrapDestAddr"),
)
if mibBuilder.loadTexts:
...
vSnmpTrapDestAddr = _VSnmpTrapDestAddr_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 16, 6, 1, 1),
...
vSnmpTrapDestCommunity = _VSnmpTrapDestCommunity_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 16, 6, 1, 2),
...
vSnmpTrapDestColdEnable = _VSnmpTrapDestColdEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 16, 6, 1, 3),
...
vSnmpTrapDestAuthEnable = _VSnmpTrapDestAuthEnable_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 16, 6, 1, 4),
...
vSnmpTrapDestStatus = _VSnmpTrapDestStatus_Object(
    (1, 3, 6, 1, 4, 1, 170, 1, 1, 2, 6, 1, 16, 6, 1, 5),
...
mibBuilder.exportSymbols(
    ...
    **{"Character": Character,
       ...
       "vcpServerDevice": vcpServerDevice,
