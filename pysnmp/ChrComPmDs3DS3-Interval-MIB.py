# SNMP MIB module (ChrComPmDs3DS3-Interval-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmDs3DS3-Interval-MIB
...
_ChrComPmDs3DS3_IntervalTable_Object = MibTable
chrComPmDs3DS3_IntervalTable = _ChrComPmDs3DS3_IntervalTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12)
)
if mibBuilder.loadTexts:
    chrComPmDs3DS3_IntervalTable.setStatus("current")
_ChrComPmDs3DS3_IntervalEntry_Object = MibTableRow
chrComPmDs3DS3_IntervalEntry = _ChrComPmDs3DS3_IntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1)
)
chrComPmDs3DS3_IntervalEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmDs3DS3-Interval-MIB", "chrComPmDs3IntervalNumber"),
)
if mibBuilder.loadTexts:
    chrComPmDs3DS3_IntervalEntry.setStatus("current")


class _ChrComPmDs3IntervalNumber_Type(Unsigned32):
    """Custom type chrComPmDs3IntervalNumber based on Unsigned32"""
...
_ChrComPmDs3IntervalNumber_Type.__name__ = "Unsigned32"
_ChrComPmDs3IntervalNumber_Object = MibTableColumn
chrComPmDs3IntervalNumber = _ChrComPmDs3IntervalNumber_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 1),
    _ChrComPmDs3IntervalNumber_Type()
)
chrComPmDs3IntervalNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    chrComPmDs3IntervalNumber.setStatus("current")
...
chrComPmDs3SuspectedInterval = _ChrComPmDs3SuspectedInterval_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 2),
...
chrComPmDs3ElapsedTime = _ChrComPmDs3ElapsedTime_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 3),
...
chrComPmDs3SuppressedIntrvls = _ChrComPmDs3SuppressedIntrvls_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 4),
...
chrComPmDs3LCV = _ChrComPmDs3LCV_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 5),
...
chrComPmDs3LES = _ChrComPmDs3LES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 6),
...
chrComPmDs3LSES = _ChrComPmDs3LSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 7),
...
chrComPmDs3LOSS = _ChrComPmDs3LOSS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 8),
...
chrComPmDs3PCV = _ChrComPmDs3PCV_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 9),
...
chrComPmDs3CCV = _ChrComPmDs3CCV_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 10),
...
chrComPmDs3PES = _ChrComPmDs3PES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 11),
...
chrComPmDs3CES = _ChrComPmDs3CES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 12),
...
chrComPmDs3PSES = _ChrComPmDs3PSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 13),
...
chrComPmDs3CSES = _ChrComPmDs3CSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 14),
...
chrComPmDs3SAS = _ChrComPmDs3SAS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 15),
...
chrComPmDs3AISS = _ChrComPmDs3AISS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 16),
...
chrComPmDs3UASP = _ChrComPmDs3UASP_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 17),
...
chrComPmDs3UASCP = _ChrComPmDs3UASCP_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 18),
...
chrComPmDs3PSC = _ChrComPmDs3PSC_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 19),
...
chrComPmDs3ESPLCP = _ChrComPmDs3ESPLCP_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 12, 1, 20),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmDs3DS3-IntervalTable": chrComPmDs3DS3_IntervalTable,
       "chrComPmDs3DS3-IntervalEntry": chrComPmDs3DS3_IntervalEntry,
       "chrComPmDs3IntervalNumber": chrComPmDs3IntervalNumber,
