# SNMP MIB module (MRV-IN-REACH-DECNET-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/MRV-IN-REACH-DECNET-MIB
...
phivCircuitEntry.setIndexNames(
    (0, "MRV-IN-REACH-DECNET-MIB", "xPhivCircuitIndex"),
)
if mibBuilder.loadTexts:
...
phivCircuitImportEntry.setIndexNames(
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitImportIf"),
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitImportAddr"),
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitImportMask"),
)
if mibBuilder.loadTexts:
...
phivCircuitImportAreaEntry.setIndexNames(
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitImportAreaIf"),
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitImportAreaAddr"),
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitImportAreaMask"),
)
if mibBuilder.loadTexts:
...
phivCircuitExportEntry.setIndexNames(
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitExportIf"),
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitExportAddr"),
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitExportMask"),
)
if mibBuilder.loadTexts:
...
phivCircuitExportAreaEntry.setIndexNames(
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitExportAreaIf"),
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitExportAreaAddr"),
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitExportAreaMask"),
)
if mibBuilder.loadTexts:
...
phivCircuitFilterEntry.setIndexNames(
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitFilterIf"),
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitFilterDstAddr"),
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitFilterDstMask"),
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitFilterSrcAddr"),
    (0, "MRV-IN-REACH-DECNET-MIB", "phivCircuitFilterSrcMask"),
)
if mibBuilder.loadTexts:
...
phivTrafficEntry.setIndexNames(
    (0, "MRV-IN-REACH-DECNET-MIB", "phivTrafficIndex"),
)
if mibBuilder.loadTexts:
