# SNMP MIB module (Dell-SSL) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Dell-SSL
# Produced by pysmi-1.5.4 at Mon Oct 14 21:34:58 2024
...
class RlSslPublicKeyAlgorithm(Integer32, TextualConvention):
    status = "current"
...
rlSslCertificateGenerationEntry.setIndexNames(
    (0, "Dell-SSL", "rlSslCertificateGenerationIndex"),
)
if mibBuilder.loadTexts:
...
rlSslCertificateExportEntry.setIndexNames(
    (0, "Dell-SSL", "rlSslCertificateExportId"),
    (0, "Dell-SSL", "rlSslCertificateExportType"),
    (0, "Dell-SSL", "rlSslCertificateExportFragmentId"),
)
if mibBuilder.loadTexts:
...
rlSslCertificateImportEntry.setIndexNames(
    (0, "Dell-SSL", "rlSslCertificateImportId"),
    (0, "Dell-SSL", "rlSslCertificateImportFormat"),
    (0, "Dell-SSL", "rlSslCertificateImportFragmentId"),
)
if mibBuilder.loadTexts:
...
rlSslImportExportSelfKeyEntry = _RlSslImportExportSelfKeyEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 100, 8, 1)
)
rlSslImportExportSelfKeyEntry.setIndexNames(
    (0, "Dell-SSL", "rlSslImportExportSelfKeyFormat"),
    (0, "Dell-SSL", "rlSslImportExportSelfKeyIndex"),
    (0, "Dell-SSL", "rlSslImportExportSelfKeyFragmentId"),
)
if mibBuilder.loadTexts:
