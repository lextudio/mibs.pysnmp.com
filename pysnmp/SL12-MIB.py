# SNMP MIB module (SL12-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/SL12-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:53:48 2024
...
_Sl12_ObjectIdentity = ObjectIdentity
sl12 = _Sl12_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 41)
)
...
esPointEntry.setIndexNames(
    (0, "SL12-MIB", "esIndexES"),
    (0, "SL12-MIB", "esIndexPC"),
    (0, "SL12-MIB", "esIndexPoint"),
)
if mibBuilder.loadTexts:
...
contact1ActiveTrap.setObjects(
      *(("SL12-MIB", "thisTrapText"),
        ("SL12-MIB", "siteID"),
        ("SL12-MIB", "contact1Name"),
        ("SL12-MIB", "contact1State"))
)
if mibBuilder.loadTexts:
...
contact2ActiveTrap.setObjects(
      *(("SL12-MIB", "thisTrapText"),
        ("SL12-MIB", "siteID"),
        ("SL12-MIB", "contact2Name"),
        ("SL12-MIB", "contact2State"))
)
if mibBuilder.loadTexts:
...
contact3ActiveTrap.setObjects(
      *(("SL12-MIB", "thisTrapText"),
        ("SL12-MIB", "siteID"),
        ("SL12-MIB", "contact3Name"),
        ("SL12-MIB", "contact3State"))
)
if mibBuilder.loadTexts:
...
contact4ActiveTrap.setObjects(
      *(("SL12-MIB", "thisTrapText"),
        ("SL12-MIB", "siteID"),
        ("SL12-MIB", "contact4Name"),
        ("SL12-MIB", "contact4State"))
)
if mibBuilder.loadTexts:
...
contact5ActiveTrap.setObjects(
      *(("SL12-MIB", "thisTrapText"),
        ("SL12-MIB", "siteID"),
        ("SL12-MIB", "contact5Name"),
        ("SL12-MIB", "contact5State"))
)
if mibBuilder.loadTexts:
...
contact6ActiveTrap.setObjects(
      *(("SL12-MIB", "thisTrapText"),
        ("SL12-MIB", "siteID"),
        ("SL12-MIB", "contact6Name"),
        ("SL12-MIB", "contact6State"))
)
if mibBuilder.loadTexts:
...
analog1HighTrap.setObjects(
      *(("SL12-MIB", "thisTrapText"),
        ("SL12-MIB", "siteID"),
        ("SL12-MIB", "analog1Name"),
        ("SL12-MIB", "analog1Value"))
)
if mibBuilder.loadTexts:
...
analog2HighTrap.setObjects(
      *(("SL12-MIB", "thisTrapText"),
        ("SL12-MIB", "siteID"),
        ("SL12-MIB", "analog2Name"),
        ("SL12-MIB", "analog2Value"))
)
if mibBuilder.loadTexts:
...
contactESActiveTrap.setObjects(
      *(("SL12-MIB", "thisTrapText"),
        ("SL12-MIB", "siteID"),
        ("SL12-MIB", "esPointName"),
        ("SL12-MIB", "esPointValueInt"),
        ("SL12-MIB", "esIndexES"),
        ("SL12-MIB", "esIndexPoint"))
)
if mibBuilder.loadTexts:
