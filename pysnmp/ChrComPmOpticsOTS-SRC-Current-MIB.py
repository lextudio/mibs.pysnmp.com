# SNMP MIB module (ChrComPmOpticsOTS-SRC-Current-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmOpticsOTS-SRC-Current-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:26 2024
...
_ChrComPmOpticsOTS_SRC_CurrentTable_Object = MibTable
chrComPmOpticsOTS_SRC_CurrentTable = _ChrComPmOpticsOTS_SRC_CurrentTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 4)
)
if mibBuilder.loadTexts:
    chrComPmOpticsOTS_SRC_CurrentTable.setStatus("current")
_ChrComPmOpticsOTS_SRC_CurrentEntry_Object = MibTableRow
chrComPmOpticsOTS_SRC_CurrentEntry = _ChrComPmOpticsOTS_SRC_CurrentEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 4, 1)
)
chrComPmOpticsOTS_SRC_CurrentEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
)
if mibBuilder.loadTexts:
    chrComPmOpticsOTS_SRC_CurrentEntry.setStatus("current")
...
chrComPmOpticsSD = _ChrComPmOpticsSD_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 4, 1, 10),
...
chrComPmOpticsThresholdProfIndex = _ChrComPmOpticsThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 4, 1, 11),
...
chrComPmOpticsResetCountersAction = _ChrComPmOpticsResetCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 4, 1, 12),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmOpticsOTS-SRC-CurrentTable": chrComPmOpticsOTS_SRC_CurrentTable,
       "chrComPmOpticsOTS-SRC-CurrentEntry": chrComPmOpticsOTS_SRC_CurrentEntry,
