# SNMP MIB module (ChrComPmSonetSNT-L-Day-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmSonetSNT-L-Day-MIB
...
_ChrComPmSonetSNT_L_DayTable_Object = MibTable
chrComPmSonetSNT_L_DayTable = _ChrComPmSonetSNT_L_DayTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 6)
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_L_DayTable.setStatus("current")
_ChrComPmSonetSNT_L_DayEntry_Object = MibTableRow
chrComPmSonetSNT_L_DayEntry = _ChrComPmSonetSNT_L_DayEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 6, 1)
)
chrComPmSonetSNT_L_DayEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmSonetSNT-L-Day-MIB", "chrComPmSonetDayNumber"),
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_L_DayEntry.setStatus("current")
...
chrComPmSonetResetPmCountersAction = _ChrComPmSonetResetPmCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 6, 1, 10),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmSonetSNT-L-DayTable": chrComPmSonetSNT_L_DayTable,
       "chrComPmSonetSNT-L-DayEntry": chrComPmSonetSNT_L_DayEntry,
