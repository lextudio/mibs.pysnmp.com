# SNMP MIB module (ChrComPmSonetSNT-LFE-Current-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmSonetSNT-LFE-Current-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:31 2024
...
_ChrComPmSonetSNT_LFE_CurrentTable_Object = MibTable
chrComPmSonetSNT_LFE_CurrentTable = _ChrComPmSonetSNT_LFE_CurrentTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 7)
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_LFE_CurrentTable.setStatus("current")
_ChrComPmSonetSNT_LFE_CurrentEntry_Object = MibTableRow
chrComPmSonetSNT_LFE_CurrentEntry = _ChrComPmSonetSNT_LFE_CurrentEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 7, 1)
)
chrComPmSonetSNT_LFE_CurrentEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_LFE_CurrentEntry.setStatus("current")
...
chrComPmSonetResetPmCountersAction = _ChrComPmSonetResetPmCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 7, 1, 10),
...
mibBuilder.exportSymbols(
    "ChrComPmSonetSNT-LFE-Current-MIB",
    **{"chrComPmSonetSNT-LFE-CurrentTable": chrComPmSonetSNT_LFE_CurrentTable,
       "chrComPmSonetSNT-LFE-CurrentEntry": chrComPmSonetSNT_LFE_CurrentEntry,
