# SNMP MIB module (DKSF-707-1-X-X-1) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DKSF-707-1-X-X-1
...
npGsmTrap.setObjects(
      *(("DKSF-707-1-X-X-1", "npGsmFailed"),
        ("DKSF-707-1-X-X-1", "npGsmRegistration"),
        ("DKSF-707-1-X-X-1", "npGsmStrength"))
)
if mibBuilder.loadTexts:
    npGsmTrap.setStatus(
        "current"
