# SNMP MIB module (DKSF-202-9-X-X-1) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DKSF-202-9-X-X-1
...
netPing2PWR220SMSv2 = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 25728, 202)
)
...
_NpBatteryTraps_ObjectIdentity = ObjectIdentity
npBatteryTraps = _NpBatteryTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25728, 3900, 2)
)
_NpBatteryTrapPrefix_ObjectIdentity = ObjectIdentity
npBatteryTrapPrefix = _NpBatteryTrapPrefix_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25728, 3900, 2, 0)
)
...
npPwrEntry.setIndexNames(
    (0, "DKSF-202-9-X-X-1", "npPwrChannelN"),
)
if mibBuilder.loadTexts:
...
npThermoEntry.setIndexNames(
    (0, "DKSF-202-9-X-X-1", "npThermoSensorN"),
)
if mibBuilder.loadTexts:
...
npGsmTrap.setObjects(
      *(("DKSF-202-9-X-X-1", "npGsmFailed"),
        ("DKSF-202-9-X-X-1", "npGsmRegistration"),
        ("DKSF-202-9-X-X-1", "npGsmStrength"))
)
if mibBuilder.loadTexts:
    npGsmTrap.setStatus(
        "current"
...
npBatteryTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25728, 3900, 2, 0, 1)
)
npBatteryTrap.setObjects(
      *(("DKSF-202-9-X-X-1", "npBatteryPok"),
        ("DKSF-202-9-X-X-1", "npBatteryLevel"))
)
if mibBuilder.loadTexts:
    npBatteryTrap.setStatus(
        "current"
    )
...
npRelHumTrap.setObjects(
      *(("DKSF-202-9-X-X-1", "npRelHumSensorStatusH"),
        ("DKSF-202-9-X-X-1", "npRelHumSensorValueH"),
        ("DKSF-202-9-X-X-1", "npRelHumSafeRangeHigh"),
        ("DKSF-202-9-X-X-1", "npRelHumSafeRangeLow"),
        ("DKSF-202-9-X-X-1", "npTrapEmailTo"))
)
if mibBuilder.loadTexts:
...
npThermoTrap.setObjects(
      *(("DKSF-202-9-X-X-1", "npThermoTrapSensorN"),
        ("DKSF-202-9-X-X-1", "npThermoTrapValue"),
        ("DKSF-202-9-X-X-1", "npThermoTrapStatus"),
        ("DKSF-202-9-X-X-1", "npThermoTrapLow"),
        ("DKSF-202-9-X-X-1", "npThermoTrapHigh"),
        ("DKSF-202-9-X-X-1", "npThermoTrapMemo"))
)
if mibBuilder.loadTexts:
...
npIoTrap.setObjects(
      *(("DKSF-202-9-X-X-1", "npIoTrapLineN"),
        ("DKSF-202-9-X-X-1", "npIoTrapLevelIn"),
        ("DKSF-202-9-X-X-1", "npIoTrapMemo"))
)
if mibBuilder.loadTexts:
    npIoTrap.setStatus(
        "current"
...
mibBuilder.exportSymbols(
    ...
    **{"lightcom": lightcom,
       ...
       "netPing2PWR220SMSv2": netPing2PWR220SMSv2,
       "npReboot": npReboot,
       ...
       "npBatteryTraps": npBatteryTraps,
       "npBatteryTrapPrefix": npBatteryTrapPrefix,
       "npBatteryTrap": npBatteryTrap,
       "npRelay": npRelay,
