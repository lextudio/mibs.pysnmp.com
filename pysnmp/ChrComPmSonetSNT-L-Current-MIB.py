# SNMP MIB module (ChrComPmSonetSNT-L-Current-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmSonetSNT-L-Current-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:29 2024
...
_ChrComPmSonetSNT_L_CurrentTable_Object = MibTable
chrComPmSonetSNT_L_CurrentTable = _ChrComPmSonetSNT_L_CurrentTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 4)
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_L_CurrentTable.setStatus("current")
_ChrComPmSonetSNT_L_CurrentEntry_Object = MibTableRow
chrComPmSonetSNT_L_CurrentEntry = _ChrComPmSonetSNT_L_CurrentEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 4, 1)
)
chrComPmSonetSNT_L_CurrentEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_L_CurrentEntry.setStatus("current")
...
chrComPmSonetResetPmCountersAction = _ChrComPmSonetResetPmCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 4, 1, 10),
...
mibBuilder.exportSymbols(
    "ChrComPmSonetSNT-L-Current-MIB",
    **{"chrComPmSonetSNT-L-CurrentTable": chrComPmSonetSNT_L_CurrentTable,
       "chrComPmSonetSNT-L-CurrentEntry": chrComPmSonetSNT_L_CurrentEntry,
