# SNMP MIB module (ChrComPmOpticsOMS-SRC-Day-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmOpticsOMS-SRC-Day-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:22 2024
...
_ChrComPmOpticsOMS_SRC_DayTable_Object = MibTable
chrComPmOpticsOMS_SRC_DayTable = _ChrComPmOpticsOMS_SRC_DayTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12)
)
if mibBuilder.loadTexts:
    chrComPmOpticsOMS_SRC_DayTable.setStatus("current")
_ChrComPmOpticsOMS_SRC_DayEntry_Object = MibTableRow
chrComPmOpticsOMS_SRC_DayEntry = _ChrComPmOpticsOMS_SRC_DayEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1)
)
chrComPmOpticsOMS_SRC_DayEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmOpticsOMS-SRC-Day-MIB", "chrComPmOpticsDayNumber"),
)
if mibBuilder.loadTexts:
    chrComPmOpticsOMS_SRC_DayEntry.setStatus("current")
...
chrComPmOpticsDayNumber = _ChrComPmOpticsDayNumber_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 1),
...
chrComPmOpticsSuspectedIntrvl = _ChrComPmOpticsSuspectedIntrvl_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 2),
...
chrComPmOpticsElapsedTime = _ChrComPmOpticsElapsedTime_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 3),
...
chrComPmOpticsSuppressedIntrvls = _ChrComPmOpticsSuppressedIntrvls_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 4),
...
chrComPmOpticsORS = _ChrComPmOpticsORS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 5),
...
chrComPmOpticsSES = _ChrComPmOpticsSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 6),
...
chrComPmOpticsUAS = _ChrComPmOpticsUAS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 7),
...
chrComPmOpticsMean = _ChrComPmOpticsMean_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 8),
...
chrComPmOpticsMax = _ChrComPmOpticsMax_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 9),
...
chrComPmOpticsMin = _ChrComPmOpticsMin_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 10),
...
chrComPmOpticsSD = _ChrComPmOpticsSD_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 11),
...
chrComPmOpticsThresholdProfIndex = _ChrComPmOpticsThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 12),
...
chrComPmOpticsResetCountersAction = _ChrComPmOpticsResetCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 12, 1, 13),
...
mibBuilder.exportSymbols(
    "ChrComPmOpticsOMS-SRC-Day-MIB",
    **{"chrComPmOpticsOMS-SRC-DayTable": chrComPmOpticsOMS_SRC_DayTable,
       "chrComPmOpticsOMS-SRC-DayEntry": chrComPmOpticsOMS_SRC_DayEntry,
