# SNMP MIB module (LJ4650-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/LJ4650-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:18:45 2024
...
_Pml_engine_nvram_shadow_copy_Type = OctetString
_Pml_engine_nvram_shadow_copy_Object = MibScalar
pml_engine_nvram_shadow_copy = _Pml_engine_nvram_shadow_copy_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 5, 9),
    _Pml_engine_nvram_shadow_copy_Type()
)
pml_engine_nvram_shadow_copy.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    pml_engine_nvram_shadow_copy.setStatus("optional")
_Pml_engine_nvram_Type = OctetString
_Pml_engine_nvram_Object = MibScalar
pml_engine_nvram = _Pml_engine_nvram_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 5, 10),
    _Pml_engine_nvram_Type()
)
pml_engine_nvram.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    pml_engine_nvram.setStatus("optional")
...
_Job_info_job_settings_ObjectIdentity = ObjectIdentity
job_info_job_settings = _Job_info_job_settings_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 21)
)
_Job_info_settings_vertical_resolution_Type = Integer32
_Job_info_settings_vertical_resolution_Object = MibScalar
job_info_settings_vertical_resolution = _Job_info_settings_vertical_resolution_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 21, 2),
    _Job_info_settings_vertical_resolution_Type()
)
job_info_settings_vertical_resolution.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    job_info_settings_vertical_resolution.setStatus("optional")
_Job_info_settings_horizontal_resolution_Type = Integer32
_Job_info_settings_horizontal_resolution_Object = MibScalar
job_info_settings_horizontal_resolution = _Job_info_settings_horizontal_resolution_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 21, 3),
    _Job_info_settings_horizontal_resolution_Type()
)
job_info_settings_horizontal_resolution.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    job_info_settings_horizontal_resolution.setStatus("optional")


class _Job_info_settings_orientation_Type(Integer32):
    """Custom type job_info_settings_orientation based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Job_info_settings_orientation_Type.__name__ = "Integer32"
_Job_info_settings_orientation_Object = MibScalar
job_info_settings_orientation = _Job_info_settings_orientation_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 21, 5),
    _Job_info_settings_orientation_Type()
)
job_info_settings_orientation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    job_info_settings_orientation.setStatus("optional")


class _Job_info_settings_economode_Type(Integer32):
    """Custom type job_info_settings_economode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Job_info_settings_economode_Type.__name__ = "Integer32"
_Job_info_settings_economode_Object = MibScalar
job_info_settings_economode = _Job_info_settings_economode_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 21, 11),
    _Job_info_settings_economode_Type()
)
job_info_settings_economode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    job_info_settings_economode.setStatus("optional")
...
class _Job_info_accounting_language_Type(Integer32):
    """Custom type job_info_accounting_language based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Job_info_accounting_language_Type.__name__ = "Integer32"
_Job_info_accounting_language_Object = MibScalar
job_info_accounting_language = _Job_info_accounting_language_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 28, 30),
    _Job_info_accounting_language_Type()
)
job_info_accounting_language.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    job_info_accounting_language.setStatus("optional")
_Job_info_accounting_source_trays_used_Type = OctetString
_Job_info_accounting_source_trays_used_Object = MibScalar
job_info_accounting_source_trays_used = _Job_info_accounting_source_trays_used_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 28, 31),
    _Job_info_accounting_source_trays_used_Type()
)
job_info_accounting_source_trays_used.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    job_info_accounting_source_trays_used.setStatus("optional")
...
class _Media25_name_Type(DisplayString):
    """Custom type media25_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 24),
    )
...
_Media25_name_Type.__name__ = "DisplayString"
...
class _Media25_short_name_Type(DisplayString):
    """Custom type media25_short_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 9),
    )
...
_Media25_short_name_Type.__name__ = "DisplayString"
...
class _Media26_name_Type(DisplayString):
    """Custom type media26_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 24),
    )
...
_Media26_name_Type.__name__ = "DisplayString"
...
class _Media26_short_name_Type(DisplayString):
    """Custom type media26_short_name based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 9),
    )
...
_Media26_short_name_Type.__name__ = "DisplayString"
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "pml-engine-nvram-shadow-copy": pml_engine_nvram_shadow_copy,
       "pml-engine-nvram": pml_engine_nvram,
       "job": job,
       ...
       "job-info-job-settings": job_info_job_settings,
       "job-info-settings-vertical-resolution": job_info_settings_vertical_resolution,
       "job-info-settings-horizontal-resolution": job_info_settings_horizontal_resolution,
       "job-info-settings-orientation": job_info_settings_orientation,
       "job-info-settings-economode": job_info_settings_economode,
       ...
       "job-info-accounting-language": job_info_accounting_language,
       "job-info-accounting-source-trays-used": job_info_accounting_source_trays_used,
       "held-job": held_job,
