# SNMP MIB module (NCR-CORESSTCOMMSLOG-MIB) expressed in pysnmp data model.
#
...
_SstCommsLogTable_Object = MibTable
sstCommsLogTable = _SstCommsLogTable_Object(
    (1, 3, 6, 1, 4, 1, 191, 39, 13, 2, 4, 8)
)
if mibBuilder.loadTexts:
    sstCommsLogTable.setStatus("mandatory")
_SstLogEntry_Object = MibTableRow
sstLogEntry = _SstLogEntry_Object(
    (1, 3, 6, 1, 4, 1, 191, 39, 13, 2, 4, 8, 1)
)
sstLogEntry.setIndexNames(
    (0, "NCR-CORESSTCOMMSLOG-MIB", "sstLogIndex"),
)
if mibBuilder.loadTexts:
...
sstLogIndex = _SstLogIndex_Object(
    (1, 3, 6, 1, 4, 1, 191, 39, 13, 2, 4, 8, 1, 1),
    _SstLogIndex_Type()
)
...
sstLogDeviceName = _SstLogDeviceName_Object(
    (1, 3, 6, 1, 4, 1, 191, 39, 13, 2, 4, 8, 1, 2),
...
sstLogServiceName = _SstLogServiceName_Object(
    (1, 3, 6, 1, 4, 1, 191, 39, 13, 2, 4, 8, 1, 3),
...
sstLogTCode = _SstLogTCode_Object(
    (1, 3, 6, 1, 4, 1, 191, 39, 13, 2, 4, 8, 1, 4),
    _SstLogTCode_Type()
)
...
sstLogSData = _SstLogSData_Object(
    (1, 3, 6, 1, 4, 1, 191, 39, 13, 2, 4, 8, 1, 5),
    _SstLogSData_Type()
)
...
sstLogMData = _SstLogMData_Object(
    (1, 3, 6, 1, 4, 1, 191, 39, 13, 2, 4, 8, 1, 6),
    _SstLogMData_Type()
)
...
sstLogDescription = _SstLogDescription_Object(
    (1, 3, 6, 1, 4, 1, 191, 39, 13, 2, 4, 8, 1, 7),
...
mibBuilder.exportSymbols(
    ...
    **{"ncr": ncr,
       ...
       "sstApplic": sstApplic,
       "sstLogs": sstLogs,
       "sstCommsLogTable": sstCommsLogTable,
