# SNMP MIB module (INTEL-IPROUTER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/INTEL-IPROUTER-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:09:48 2024
...
confIfMCRouteProto = _ConfIfMCRouteProto_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 1, 1, 20),
    _ConfIfMCRouteProto_Type()
)
confIfMCRouteProto.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    confIfMCRouteProto.setStatus("obsolete")
...
confIfDvmrpMetric = _ConfIfDvmrpMetric_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 1, 1, 21),
    _ConfIfDvmrpMetric_Type()
)
confIfDvmrpMetric.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    confIfDvmrpMetric.setStatus("obsolete")


class _ConfIfTtlThreshold_Type(Integer32):
    """Custom type confIfTtlThreshold based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ConfIfTtlThreshold_Type.__name__ = "Integer32"
_ConfIfTtlThreshold_Object = MibTableColumn
confIfTtlThreshold = _ConfIfTtlThreshold_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 1, 1, 22),
    _ConfIfTtlThreshold_Type()
)
confIfTtlThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    confIfTtlThreshold.setStatus("mandatory")


class _ConfIfTunnelName_Type(OctetString):
    """Custom type confIfTunnelName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ConfIfTunnelName_Type.__name__ = "OctetString"
_ConfIfTunnelName_Object = MibTableColumn
confIfTunnelName = _ConfIfTunnelName_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 1, 1, 23),
    _ConfIfTunnelName_Type()
)
confIfTunnelName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    confIfTunnelName.setStatus("mandatory")
_ConfIfLocalIP_Type = IpAddress
_ConfIfLocalIP_Object = MibTableColumn
confIfLocalIP = _ConfIfLocalIP_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 1, 1, 24),
    _ConfIfLocalIP_Type()
)
confIfLocalIP.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    confIfLocalIP.setStatus("mandatory")
_ConfIfRemoteIP_Type = IpAddress
_ConfIfRemoteIP_Object = MibTableColumn
confIfRemoteIP = _ConfIfRemoteIP_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 1, 1, 25),
    _ConfIfRemoteIP_Type()
)
confIfRemoteIP.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    confIfRemoteIP.setStatus("mandatory")


class _ConfIfMgtAccess_Type(Integer32):
    """Custom type confIfMgtAccess based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ConfIfMgtAccess_Type.__name__ = "Integer32"
_ConfIfMgtAccess_Object = MibTableColumn
confIfMgtAccess = _ConfIfMgtAccess_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 1, 1, 26),
    _ConfIfMgtAccess_Type()
)
confIfMgtAccess.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    confIfMgtAccess.setStatus("mandatory")


class _ConfIfRtrDiscovery_Type(Integer32):
    """Custom type confIfRtrDiscovery based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ConfIfRtrDiscovery_Type.__name__ = "Integer32"
_ConfIfRtrDiscovery_Object = MibTableColumn
confIfRtrDiscovery = _ConfIfRtrDiscovery_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 1, 1, 27),
    _ConfIfRtrDiscovery_Type()
)
confIfRtrDiscovery.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    confIfRtrDiscovery.setStatus("mandatory")


class _ConfIfType_Type(Integer32):
    """Custom type confIfType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ConfIfType_Type.__name__ = "Integer32"
_ConfIfType_Object = MibTableColumn
confIfType = _ConfIfType_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 1, 1, 28),
    _ConfIfType_Type()
)
confIfType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    confIfType.setStatus("mandatory")


class _ConfMgtAddress_Type(Integer32):
    """Custom type confMgtAddress based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_ConfMgtAddress_Type.__name__ = "Integer32"
_ConfMgtAddress_Object = MibTableColumn
confMgtAddress = _ConfMgtAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 1, 1, 29),
    _ConfMgtAddress_Type()
)
confMgtAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    confMgtAddress.setStatus("mandatory")
_FilterTable_Object = MibTable
filterTable = _FilterTable_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 2)
)
if mibBuilder.loadTexts:
    filterTable.setStatus("mandatory")
_FilterEntry_Object = MibTableRow
filterEntry = _FilterEntry_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 2, 1)
)
filterEntry.setIndexNames(
    (0, "INTEL-IPROUTER-MIB", "filterIfIndex"),
    (0, "INTEL-IPROUTER-MIB", "filterDirIndex"),
    (0, "INTEL-IPROUTER-MIB", "filterIndex"),
)
if mibBuilder.loadTexts:
...
natTable = _NatTable_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 3)
)
if mibBuilder.loadTexts:
    natTable.setStatus("mandatory")
_NatEntry_Object = MibTableRow
natEntry = _NatEntry_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 3, 1)
)
natEntry.setIndexNames(
    (0, "INTEL-IPROUTER-MIB", "natIfIndex"),
    (0, "INTEL-IPROUTER-MIB", "natIndex"),
)
if mibBuilder.loadTexts:
...
natIntMask = _NatIntMask_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 3, 1, 4),
    _NatIntMask_Type()
)
natIntMask.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    natIntMask.setStatus("mandatory")
_NatIntPort_Type = Integer32
_NatIntPort_Object = MibTableColumn
natIntPort = _NatIntPort_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 3, 1, 5),
    _NatIntPort_Type()
)
natIntPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    natIntPort.setStatus("mandatory")
_NatExtAddr_Type = IpAddress
_NatExtAddr_Object = MibTableColumn
natExtAddr = _NatExtAddr_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 3, 1, 6),
    _NatExtAddr_Type()
)
...
natExtMask = _NatExtMask_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 3, 1, 7),
    _NatExtMask_Type()
)
natExtMask.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    natExtMask.setStatus("mandatory")
_NatExtPort_Type = Integer32
_NatExtPort_Object = MibTableColumn
natExtPort = _NatExtPort_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 3, 1, 8),
    _NatExtPort_Type()
)
natExtPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    natExtPort.setStatus("mandatory")
...
class _TosPrefThreshold_Type(Integer32):
    """Custom type tosPrefThreshold based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_TosPrefThreshold_Type.__name__ = "Integer32"
_TosPrefThreshold_Object = MibScalar
tosPrefThreshold = _TosPrefThreshold_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 1, 5),
    _TosPrefThreshold_Type()
)
tosPrefThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tosPrefThreshold.setStatus("mandatory")
_Stat_ObjectIdentity = ObjectIdentity
stat = _Stat_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 2)
)
_StatIfTable_Object = MibTable
statIfTable = _StatIfTable_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 2, 1)
)
if mibBuilder.loadTexts:
    statIfTable.setStatus("mandatory")
_StatIfEntry_Object = MibTableRow
statIfEntry = _StatIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 21, 2, 1, 1)
)
statIfEntry.setIndexNames(
    (0, "INTEL-IPROUTER-MIB", "statIfIndex"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"iprouter": iprouter,
       ...
       "confIfTtlThreshold": confIfTtlThreshold,
       "confIfTunnelName": confIfTunnelName,
       "confIfLocalIP": confIfLocalIP,
       "confIfRemoteIP": confIfRemoteIP,
       "confIfMgtAccess": confIfMgtAccess,
       "confIfRtrDiscovery": confIfRtrDiscovery,
       "confIfType": confIfType,
       "confMgtAddress": confMgtAddress,
       ...
       "natIntPort": natIntPort,
       "natExtAddr": natExtAddr,
       "natExtMask": natExtMask,
       "natExtPort": natExtPort,
       "natType": natType,
       "natTime": natTime,
       ...
       "tosPrefThreshold": tosPrefThreshold,
       "stat": stat,
