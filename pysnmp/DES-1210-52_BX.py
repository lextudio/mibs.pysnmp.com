# SNMP MIB module (DES-1210-52_BX) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DES-1210-52_BX
# Produced by pysmi-1.5.4 at Mon Oct 14 21:24:36 2024
...
sysPortCtrlEntry.setIndexNames(
    (0, "DES-1210-52_BX", "sysPortCtrlIndex"),
)
if mibBuilder.loadTexts:
...
ipifV6AddressEntry.setIndexNames(
    (0, "DES-1210-52_BX", "ipifV6AddressMainIndex"),
    (0, "DES-1210-52_BX", "ipifV6AddressIpAddr"),
    (0, "DES-1210-52_BX", "ipifV6AddressIpPrefix"),
)
if mibBuilder.loadTexts:
...
dot1qVlanEntry.setIndexNames(
    (0, "DES-1210-52_BX", "dot1qVlanName"),
)
if mibBuilder.loadTexts:
...
dot1qVlanUngisterMCFilterEntry.setIndexNames(
    (0, "DES-1210-52_BX", "dot1qVlanUngisterMCFilterVlanId"),
)
if mibBuilder.loadTexts:
...
laPortChannelEntry.setIndexNames(
    (0, "DES-1210-52_BX", "laPortChannelIfIndex"),
)
if mibBuilder.loadTexts:
...
laPortControlEntry.setIndexNames(
    (0, "DES-1210-52_BX", "laPortControlIndex"),
)
if mibBuilder.loadTexts:
...
staticEntry.setIndexNames(
    (0, "DES-1210-52_BX", "staticVlanID"),
    (0, "DES-1210-52_BX", "staticMac"),
    (0, "DES-1210-52_BX", "staticPort"),
)
if mibBuilder.loadTexts:
...
igsVlanRouterEntry.setIndexNames(
    (0, "DES-1210-52_BX", "igsVlanRouterVlanId"),
)
if mibBuilder.loadTexts:
...
igsVlanFilterEntry.setIndexNames(
    (0, "DES-1210-52_BX", "igsVlanFilterVlanId"),
)
if mibBuilder.loadTexts:
...
igsVlanMulticastGroupEntry.setIndexNames(
    (0, "DES-1210-52_BX", "igsVlanMulticastGroupVlanId"),
    (0, "DES-1210-52_BX", "igsVlanMulticastGroupIpAddress"),
)
if mibBuilder.loadTexts:
...
dot1xAuthConfigPortEntry.setIndexNames(
    (0, "DES-1210-52_BX", "dot1xAuthConfigPortNumber"),
)
if mibBuilder.loadTexts:
...
dot1pPortEntry.setIndexNames(
    (0, "DES-1210-52_BX", "dot1pPortIndex"),
)
if mibBuilder.loadTexts:
...
aclQosIndex = _AclQosIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 12, 6, 1, 1, 1),
    _AclQosIndex_Type()
)
...
aclQosType = _AclQosType_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 12, 6, 1, 1, 2),
    _AclQosType_Type()
)
...
aclQosTCPUDPPort = _AclQosTCPUDPPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 12, 6, 1, 1, 5),
...
aclQosIP6TC = _AclQosIP6TC_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 12, 6, 1, 1, 10),
    _AclQosIP6TC_Type()
)
...
aclQosAssignPriority = _AclQosAssignPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 12, 6, 1, 1, 98),
...
aclQosStatus = _AclQosStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 12, 6, 1, 1, 99),
    _AclQosStatus_Type()
)
...
bandwidthCtrlEntry.setIndexNames(
    (0, "DES-1210-52_BX", "bandwidthCtrlIndex"),
)
if mibBuilder.loadTexts:
...
ipv4trustedHostEntry.setIndexNames(
    (0, "DES-1210-52_BX", "ipv4trustedHostIpAddr"),
    (0, "DES-1210-52_BX", "ipv4trustedHostIpMask"),
)
if mibBuilder.loadTexts:
...
trustedHostEntry.setIndexNames(
    (0, "DES-1210-52_BX", "trustedHostIPType"),
    (0, "DES-1210-52_BX", "trustedHostIpAddr"),
    (0, "DES-1210-52_BX", "trustedHostIpMask"),
)
if mibBuilder.loadTexts:
...
aRPSpoofPreventEntry.setIndexNames(
    (0, "DES-1210-52_BX", "aRPSpoofPreventIpAddr"),
)
if mibBuilder.loadTexts:
...
ipv4dhcpServerScreenServerEntry.setIndexNames(
    (0, "DES-1210-52_BX", "ipv4dhcpServerScreenServerIndex"),
)
if mibBuilder.loadTexts:
...
dhcpServerScreenTrustedServerEntry.setIndexNames(
    (0, "DES-1210-52_BX", "dhcpServerScreenTrustedServerIndex"),
)
if mibBuilder.loadTexts:
...
trafficSegEntry.setIndexNames(
    (0, "DES-1210-52_BX", "trafficSegIfIndex"),
)
if mibBuilder.loadTexts:
...
impbSettingEntry.setIndexNames(
    (0, "DES-1210-52_BX", "impbPortIndex"),
)
if mibBuilder.loadTexts:
...
impbSmartEntry.setIndexNames(
    (0, "DES-1210-52_BX", "impbSmartMacAddress"),
    (0, "DES-1210-52_BX", "impbSmartPort"),
    (0, "DES-1210-52_BX", "impbSmartIpAddress"),
)
if mibBuilder.loadTexts:
...
impbWhiteListEntry.setIndexNames(
    (0, "DES-1210-52_BX", "impbWhiteListIpAddress"),
    (0, "DES-1210-52_BX", "impbWhiteListMacAddress"),
)
if mibBuilder.loadTexts:
...
impbBlackListEntry.setIndexNames(
    (0, "DES-1210-52_BX", "impbBlackListMacAddress"),
    (0, "DES-1210-52_BX", "impbBlackListVlanId"),
    (0, "DES-1210-52_BX", "impbBlackListPort"),
)
if mibBuilder.loadTexts:
...
ipv4aclProfileEntry.setIndexNames(
    (0, "DES-1210-52_BX", "ipv4aclProfileNo"),
)
if mibBuilder.loadTexts:
...
aclL2RuleEntry.setIndexNames(
    (0, "DES-1210-52_BX", "aclL2AccessID"),
    (0, "DES-1210-52_BX", "aclL2ProfileID"),
)
if mibBuilder.loadTexts:
...
aclL3RuleEntry.setIndexNames(
    (0, "DES-1210-52_BX", "aclL3RuleAccessID"),
    (0, "DES-1210-52_BX", "aclL3RuleProfileNo"),
)
if mibBuilder.loadTexts:
...
aclv6L3RuleEntry.setIndexNames(
    (0, "DES-1210-52_BX", "aclv6L3RuleAccessID"),
    (0, "DES-1210-52_BX", "aclv6L3RuleProfileNo"),
)
if mibBuilder.loadTexts:
...
syslogSrvEntry.setIndexNames(
    (0, "DES-1210-52_BX", "syslogSrvIPType"),
    (0, "DES-1210-52_BX", "syslogSrvIP"),
)
if mibBuilder.loadTexts:
...
sysLBDCtrlEntry.setIndexNames(
    (0, "DES-1210-52_BX", "sysLBDCtrlIndex"),
)
if mibBuilder.loadTexts:
...
sysLBDVlanLoopEntry.setIndexNames(
    (0, "DES-1210-52_BX", "sysLBDVlanLoopIndex"),
)
if mibBuilder.loadTexts:
...
voicevlanPortControlEntry.setIndexNames(
    (0, "DES-1210-52_BX", "voicevlanPortControlIndex"),
)
if mibBuilder.loadTexts:
...
voicevlanOUIEntry.setIndexNames(
    (0, "DES-1210-52_BX", "voicevlanOUITelephonyOUI"),
)
if mibBuilder.loadTexts:
...
voicevlanDeviceEntry.setIndexNames(
    (0, "DES-1210-52_BX", "voicevlanDeviceIndexMac"),
)
if mibBuilder.loadTexts:
...
dlinklldpConfigManAddrEntry.setIndexNames(
    (0, "DES-1210-52_BX", "dlinklldpLocManAddrSubtype"),
    (0, "DES-1210-52_BX", "dlinklldpLocManAddr"),
)
if mibBuilder.loadTexts:
...
snmpV3UserEntry.setIndexNames(
    (0, "DES-1210-52_BX", "snmpV3UserName"),
    (0, "DES-1210-52_BX", "snmpV3UserVersion"),
)
if mibBuilder.loadTexts:
...
snmpV3GroupEntry.setIndexNames(
    (0, "DES-1210-52_BX", "snmpV3GroupName"),
    (0, "DES-1210-52_BX", "snmpV3GroupSecurityModel"),
    (0, "DES-1210-52_BX", "snmpV3GroupSecurityLevel"),
)
if mibBuilder.loadTexts:
...
snmpV3ViewTreeEntry.setIndexNames(
    (0, "DES-1210-52_BX", "snmpV3viewTreeName"),
    (0, "DES-1210-52_BX", "snmpV3viewTreeSubtree"),
)
if mibBuilder.loadTexts:
...
snmpV3CommunityEntry.setIndexNames(
    (0, "DES-1210-52_BX", "snmpV3CommunityName"),
)
if mibBuilder.loadTexts:
...
ipv4snmpV3HostEntry.setIndexNames(
    (0, "DES-1210-52_BX", "ipv4snmpV3HostAddress"),
)
if mibBuilder.loadTexts:
...
snmpV3HostEntry.setIndexNames(
    (0, "DES-1210-52_BX", "snmpV3HostAddress"),
    (0, "DES-1210-52_BX", "snmpV3IPType"),
)
if mibBuilder.loadTexts:
...
autoSurveillanceVlanOUIEntry.setIndexNames(
    (0, "DES-1210-52_BX", "autoSurveillanceVlanOUISurveillanceOUI"),
)
if mibBuilder.loadTexts:
...
swTimeRangeSettingEntry.setIndexNames(
    (0, "DES-1210-52_BX", "swTimeRangeIndex"),
)
if mibBuilder.loadTexts:
...
staticMcastEntry.setIndexNames(
    (0, "DES-1210-52_BX", "staticMcastVlanID"),
    (0, "DES-1210-52_BX", "staticMcastMac"),
    (0, "DES-1210-52_BX", "staticMcastEgressPorts"),
)
if mibBuilder.loadTexts:
...
rmonStatsEntry.setIndexNames(
    (0, "DES-1210-52_BX", "rmonStatsIndex"),
)
if mibBuilder.loadTexts:
...
rmonHistoryEntry.setIndexNames(
    (0, "DES-1210-52_BX", "rmonHistoryIndex"),
)
if mibBuilder.loadTexts:
...
rmonAlarmEntry.setIndexNames(
    (0, "DES-1210-52_BX", "rmonAlarmIndex"),
)
if mibBuilder.loadTexts:
...
rmonEventEntry.setIndexNames(
    (0, "DES-1210-52_BX", "rmonEventIndex"),
)
if mibBuilder.loadTexts:
...
neighborEntry.setIndexNames(
    (0, "DES-1210-52_BX", "neighborIfindex"),
    (0, "DES-1210-52_BX", "neighborIPv6Addr"),
    (0, "DES-1210-52_BX", "neighborMACAddr"),
)
if mibBuilder.loadTexts:
