# SNMP MIB module (DLINK-3100-SSL) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DLINK-3100-SSL
# Produced by pysmi-1.5.4 at Mon Oct 14 21:30:21 2024
...
rlSslCertificateGenerationEntry.setIndexNames(
    (0, "DLINK-3100-SSL", "rlSslCertificateGenerationIndex"),
)
if mibBuilder.loadTexts:
...
rlSslCertificateExportEntry.setIndexNames(
    (0, "DLINK-3100-SSL", "rlSslCertificateExportId"),
    (0, "DLINK-3100-SSL", "rlSslCertificateExportType"),
    (0, "DLINK-3100-SSL", "rlSslCertificateExportFragmentId"),
)
if mibBuilder.loadTexts:
...
rlSslCertificateImportEntry.setIndexNames(
    (0, "DLINK-3100-SSL", "rlSslCertificateImportId"),
    (0, "DLINK-3100-SSL", "rlSslCertificateImportFormat"),
    (0, "DLINK-3100-SSL", "rlSslCertificateImportFragmentId"),
)
if mibBuilder.loadTexts:
