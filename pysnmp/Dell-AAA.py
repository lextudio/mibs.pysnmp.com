# SNMP MIB module (Dell-AAA) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Dell-AAA
# Produced by pysmi-1.5.4 at Mon Oct 14 21:34:08 2024
...
rlAAAMethodListEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAAMethodListName"),
)
if mibBuilder.loadTexts:
...
rlAAALineEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAALinePortType"),
    (0, "Dell-AAA", "rlAAAIfIndex"),
    (0, "Dell-AAA", "rlAAAServiceType"),
)
if mibBuilder.loadTexts:
...
rlTacacsServerEntry.setIndexNames(
    (0, "Dell-AAA", "rlTacacsServerAddress"),
)
if mibBuilder.loadTexts:
...
class _RlTacacsGlobalDefaultSourceIPv6Interface_Type(InetAddressIPv6):
    """Custom type rlTacacsGlobalDefaultSourceIPv6Interface based on InetAddressIPv6"""
...
rlTacacsServerInetEntry.setIndexNames(
    (0, "Dell-AAA", "rlTacacsServerInetAddressType"),
    (0, "Dell-AAA", "rlTacacsServerInetAddress"),
)
if mibBuilder.loadTexts:
...
rlAAALocalLoginHistEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAALocalLoginHistName"),
    (0, "Dell-AAA", "rlAAALocalLoginHistIndex"),
)
if mibBuilder.loadTexts:
...
rlAAALinePassLoginHistEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAALinePassLoginHistPortType"),
    (0, "Dell-AAA", "rlAAALinePassLoginHistIfIndex"),
    (0, "Dell-AAA", "rlAAALinePassLoginHistServiceType"),
    (0, "Dell-AAA", "rlAAALinePassLoginHistIndex"),
)
if mibBuilder.loadTexts:
...
rlAAASystemLoginHistEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAASystemLoginHistLevel"),
    (0, "Dell-AAA", "rlAAASystemLoginHistIndex"),
)
if mibBuilder.loadTexts:
...
rlAAASysPassStatEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAASysPassStatLevel"),
)
if mibBuilder.loadTexts:
...
rlAAALockedLineEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAALockedLinePortType"),
    (0, "Dell-AAA", "rlAAALockedLineIfIndex"),
    (0, "Dell-AAA", "rlAAALockedLineServiceType"),
)
if mibBuilder.loadTexts:
...
rlAAASystemPasswordVerificationAndSettingEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAASystemPasswordSettingPrivilegeLevel"),
)
if mibBuilder.loadTexts:
...
rlAAALocalLoginHistInetEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAALocalLoginHistInetName"),
    (0, "Dell-AAA", "rlAAALocalLoginHistInetIndex"),
)
if mibBuilder.loadTexts:
...
rlAAALinePassLoginHistInetEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAALinePassLoginHistInetPortType"),
    (0, "Dell-AAA", "rlAAALinePassLoginHistInetIfIndex"),
    (0, "Dell-AAA", "rlAAALinePassLoginHistInetServiceType"),
    (0, "Dell-AAA", "rlAAALinePassLoginHistInetIndex"),
)
if mibBuilder.loadTexts:
...
rlAAASystemLoginHistInetEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAASystemLoginHistInetLevel"),
    (0, "Dell-AAA", "rlAAASystemLoginHistInetIndex"),
)
if mibBuilder.loadTexts:
...
rlAAALocalUserPasswordVerificationAndSettingEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAALocalUserNameString"),
)
if mibBuilder.loadTexts:
...
rlRadiusServerEntry.setIndexNames(
    (0, "Dell-AAA", "rlRadiusServerAddress"),
    (0, "Dell-AAA", "rlRadiusServerAuthPortNumber"),
    (0, "Dell-AAA", "rlRadiusServerAcctPortNumber"),
)
if mibBuilder.loadTexts:
...
rlRadiusServerInetEntry.setIndexNames(
    (0, "Dell-AAA", "rlRadiusServerInetAddressType"),
    (0, "Dell-AAA", "rlRadiusServerInetAddress"),
    (0, "Dell-AAA", "rlRadiusServerInetAuthPortNumber"),
    (0, "Dell-AAA", "rlRadiusServerInetAcctPortNumber"),
)
if mibBuilder.loadTexts:
...
rlAAAEapMethodListEntry.setIndexNames(
    (0, "Dell-AAA", "rlAAAEapMethodListName"),
)
if mibBuilder.loadTexts:
