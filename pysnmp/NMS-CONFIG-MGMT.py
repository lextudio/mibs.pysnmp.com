# SNMP MIB module (NMS-CONFIG-MGMT) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/NMS-CONFIG-MGMT
...
_Linmsm_ObjectIdentity = ObjectIdentity
linmsm = _Linmsm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11606, 10, 20, 15)
)
_Configuration_ObjectIdentity = ObjectIdentity
configuration = _Configuration_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11606, 10, 20, 15, 1)
)
...
operation = _Operation_Object(
    (1, 3, 6, 1, 4, 1, 11606, 10, 20, 15, 1, 1),
    _Operation_Type()
)
...
class _Result_Type(Integer32):
    """Custom type result based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 127),
    )
...
_Result_Type.__name__ = "Integer32"
_Result_Object = MibScalar
result = _Result_Object(
    (1, 3, 6, 1, 4, 1, 11606, 10, 20, 15, 1, 2),
    _Result_Type()
)
