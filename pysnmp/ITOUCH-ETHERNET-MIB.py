# SNMP MIB module (ITOUCH-ETHERNET-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ITOUCH-ETHERNET-MIB
...
etherEntry.setIndexNames(
    (0, "ITOUCH-ETHERNET-MIB", "etherIndex"),
)
if mibBuilder.loadTexts:
...
etherTxEntry.setIndexNames(
    (0, "ITOUCH-ETHERNET-MIB", "etherTxIndex"),
)
if mibBuilder.loadTexts:
...
etherMulticastEntry.setIndexNames(
    (0, "ITOUCH-ETHERNET-MIB", "etherMulticastIndex"),
)
if mibBuilder.loadTexts:
...
etherXTxEntry.setIndexNames(
    (0, "ITOUCH-ETHERNET-MIB", "etherXTxIndex"),
)
if mibBuilder.loadTexts:
