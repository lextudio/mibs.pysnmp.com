...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/FASTPATH-QOS-AUTOVOIP-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:44:03 2024
...
agentAutoVoIPEntry = _AgentAutoVoIPEntry_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 3, 4, 1, 1, 1)
)
...
agentAutoVoIPIntfIndex = _AgentAutoVoIPIntfIndex_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 3, 4, 1, 1, 1, 1),
...
agentAutoVoIPMode = _AgentAutoVoIPMode_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 3, 4, 1, 1, 1, 2),
...
agentAutoVoIPCosQueue = _AgentAutoVoIPCosQueue_Object(
    (1, 3, 6, 1, 4, 1, 674, 10895, 5000, 2, 6132, 1, 1, 3, 4, 1, 1, 1, 3),
