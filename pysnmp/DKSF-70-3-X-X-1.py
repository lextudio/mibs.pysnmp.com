# SNMP MIB module (DKSF-70-3-X-X-1) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DKSF-70-3-X-X-1
# Produced by pysmi-1.5.4 at Mon Oct 14 21:29:25 2024
...
npThermoEntry.setIndexNames(
    (0, "DKSF-70-3-X-X-1", "npThermoSensorN"),
)
if mibBuilder.loadTexts:
...
npGsmTrap.setObjects(
      *(("DKSF-70-3-X-X-1", "npGsmFailed"),
        ("DKSF-70-3-X-X-1", "npGsmRegistration"),
        ("DKSF-70-3-X-X-1", "npGsmStrength"))
)
if mibBuilder.loadTexts:
    npGsmTrap.setStatus(
        "current"
...
npCurLoopTrap.setObjects(
      *(("DKSF-70-3-X-X-1", "npCurLoopTrapN"),
        ("DKSF-70-3-X-X-1", "npCurLoopTrapStatus"),
        ("DKSF-70-3-X-X-1", "npCurLoopTrapI"),
        ("DKSF-70-3-X-X-1", "npCurLoopTrapV"),
        ("DKSF-70-3-X-X-1", "npCurLoopTrapR"),
        ("DKSF-70-3-X-X-1", "npCurLoopTrapPower"),
        ("DKSF-70-3-X-X-1", "npTrapEmailTo"))
)
if mibBuilder.loadTexts:
...
npRelHumTrap.setObjects(
      *(("DKSF-70-3-X-X-1", "npRelHumSensorStatusH"),
        ("DKSF-70-3-X-X-1", "npRelHumSensorValueH"),
        ("DKSF-70-3-X-X-1", "npRelHumSafeRangeHigh"),
        ("DKSF-70-3-X-X-1", "npRelHumSafeRangeLow"),
        ("DKSF-70-3-X-X-1", "npTrapEmailTo"))
)
if mibBuilder.loadTexts:
...
npThermoTrap.setObjects(
      *(("DKSF-70-3-X-X-1", "npThermoTrapSensorN"),
        ("DKSF-70-3-X-X-1", "npThermoTrapValue"),
        ("DKSF-70-3-X-X-1", "npThermoTrapStatus"),
        ("DKSF-70-3-X-X-1", "npThermoTrapLow"),
        ("DKSF-70-3-X-X-1", "npThermoTrapHigh"),
        ("DKSF-70-3-X-X-1", "npThermoTrapMemo"))
)
if mibBuilder.loadTexts:
...
npIoTrap.setObjects(
      *(("DKSF-70-3-X-X-1", "npIoTrapLineN"),
        ("DKSF-70-3-X-X-1", "npIoTrapLevelIn"),
        ("DKSF-70-3-X-X-1", "npIoTrapMemo"))
)
if mibBuilder.loadTexts:
    npIoTrap.setStatus(
        "current"
