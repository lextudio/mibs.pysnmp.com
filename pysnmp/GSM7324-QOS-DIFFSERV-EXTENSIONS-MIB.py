# SNMP MIB module (GSM7324-QOS-DIFFSERV-EXTENSIONS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/GSM7324-QOS-DIFFSERV-EXTENSIONS-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:49:09 2024
...
gsm7324QOSDiffServExtensions = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 1, 7, 3, 3)
)
gsm7324QOSDiffServExtensions.setRevisions(
        ("2003-05-06 12:00",)
)
...
agentDiffServAuxMfClfrEntry.setIndexNames(
    (0, "GSM7324-QOS-DIFFSERV-EXTENSIONS-MIB", "agentDiffServAuxMfClfrId"),
)
if mibBuilder.loadTexts:
...
agentDiffServCosMarkActEntry.setIndexNames(
    (0, "GSM7324-QOS-DIFFSERV-EXTENSIONS-MIB", "agentDiffServCosMarkActCos"),
)
if mibBuilder.loadTexts:
...
agentDiffServIpPrecMarkActEntry.setIndexNames(
    (0, "GSM7324-QOS-DIFFSERV-EXTENSIONS-MIB", "agentDiffServIpPrecMarkActPrecedence"),
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"IpPrecedence": IpPrecedence,
       ...
       "gsm7324QOSDiffServExtensions": gsm7324QOSDiffServExtensions,
