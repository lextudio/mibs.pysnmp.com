# SNMP MIB module (Unisphere-Data-HDLC-CONF) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Unisphere-Data-HDLC-CONF
...
(usdHdlcGroup,
 usdHdlcGroup2,
 usdHdlcGroup3) = mibBuilder.importSymbols(
...
usdHdlcAgent = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 18)
)
usdHdlcAgent.setRevisions(
        ("2001-03-28 14:17",)
)
...
usdHdlcAgentV1 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 18, 1)
)
if mibBuilder.loadTexts:
    usdHdlcAgentV1.setProductRelease("""\
...
if mibBuilder.loadTexts:
    usdHdlcAgentV1.setStatus(
        "obsolete"
    )

usdHdlcAgentV2 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 18, 2)
)
if mibBuilder.loadTexts:
    usdHdlcAgentV2.setProductRelease("""\
Version 2 of the HDLC component of the Unisphere Routing Switch SNMP
        agent.  This version of the HDLC component was supported in the
        Unisphere RX 1.1 thru 3.0 system releases.""")
if mibBuilder.loadTexts:
    usdHdlcAgentV2.setStatus(
        "current"
    )

usdHdlcAgentV3 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 18, 3)
)
if mibBuilder.loadTexts:
    usdHdlcAgentV3.setProductRelease("""\
...
mibBuilder.exportSymbols(
    ...
    **{"usdHdlcAgent": usdHdlcAgent,
       "usdHdlcAgentV1": usdHdlcAgentV1,
       "usdHdlcAgentV2": usdHdlcAgentV2,
       "usdHdlcAgentV3": usdHdlcAgentV3}
)
