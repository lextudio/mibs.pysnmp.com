# SNMP MIB module (Unisphere-Data-Profile-CONF) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Unisphere-Data-Profile-CONF
...
(usdProfileGroup,
 usdProfileIfGroup) = mibBuilder.importSymbols(
...
usdProfileManagerAgent = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 34, 1)
)
usdProfileManagerAgent.setRevisions(
        ("2001-03-29 18:00",)
)
...
usdProfileManagerAgentV1 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 34, 1, 1)
)
if mibBuilder.loadTexts:
    usdProfileManagerAgentV1.setProductRelease("""\
...
if mibBuilder.loadTexts:
    usdProfileManagerAgentV1.setStatus(
        "obsolete"
    )

usdProfileManagerAgentV2 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 34, 1, 2)
)
if mibBuilder.loadTexts:
    usdProfileManagerAgentV2.setProductRelease("""\
...
if mibBuilder.loadTexts:
    usdProfileManagerAgentV2.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"usdProfileManagerAgent": usdProfileManagerAgent,
       "usdProfileManagerAgentV1": usdProfileManagerAgentV1,
       "usdProfileManagerAgentV2": usdProfileManagerAgentV2}
)
