# SNMP MIB module (DLINK-3100-File) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DLINK-3100-File
# Produced by pysmi-1.5.4 at Mon Oct 14 21:29:58 2024
...
rlFileMibVersion = _RlFileMibVersion_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 96, 1),
...
rlFilePermission = _RlFilePermission_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 96, 2, 1, 2),
...
rlFileSize = _RlFileSize_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 96, 2, 1, 3),
    _RlFileSize_Type()
)
...
rlFileModificationDate = _RlFileModificationDate_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 96, 2, 1, 4),
...
rlFileModificationTime = _RlFileModificationTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 96, 2, 1, 5),
...
rlFileRowStatus = _RlFileRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 96, 2, 1, 6),
...
rlFileFlashSize = _RlFileFlashSize_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 96, 2, 1, 7),
...
rlFileActionRowStatus = _RlFileActionRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 96, 3, 1, 3),
...
rlFileActionCommand = _RlFileActionCommand_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 96, 3, 1, 4),
...
rlFileTotalSizeOfFlash = _RlFileTotalSizeOfFlash_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 96, 4),
...
rlFileFreeSizeOfFlash = _RlFileFreeSizeOfFlash_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 96, 5),
...
rlFileAuditingEnable = _RlFileAuditingEnable_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 96, 6),
