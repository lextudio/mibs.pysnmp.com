# SNMP MIB module (ChrComPmSonetSNT-L-Interval-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmSonetSNT-L-Interval-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:30 2024
...
_ChrComPmSonetSNT_L_IntervalTable_Object = MibTable
chrComPmSonetSNT_L_IntervalTable = _ChrComPmSonetSNT_L_IntervalTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 5)
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_L_IntervalTable.setStatus("current")
_ChrComPmSonetSNT_L_IntervalEntry_Object = MibTableRow
chrComPmSonetSNT_L_IntervalEntry = _ChrComPmSonetSNT_L_IntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 5, 1)
)
chrComPmSonetSNT_L_IntervalEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmSonetSNT-L-Interval-MIB", "chrComPmSonetIntervalNumber"),
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_L_IntervalEntry.setStatus("current")
...
mibBuilder.exportSymbols(
    "ChrComPmSonetSNT-L-Interval-MIB",
    **{"chrComPmSonetSNT-L-IntervalTable": chrComPmSonetSNT_L_IntervalTable,
       "chrComPmSonetSNT-L-IntervalEntry": chrComPmSonetSNT_L_IntervalEntry,
