# SNMP MIB module (T2000-TRAP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/T2000-TRAP-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 23:00:45 2024
...
_ThirdNMSFaultFilter_Type = OctetString
...
_HwNmClearAlarms_Type = OctetString
_HwNmClearAlarms_Object = MibScalar
hwNmClearAlarms = _HwNmClearAlarms_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 15, 1, 3, 6),
    _HwNmClearAlarms_Type()
)
hwNmClearAlarms.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hwNmClearAlarms.setStatus("mandatory")
_HwNmAcknowledgeAlarms_Type = OctetString
_HwNmAcknowledgeAlarms_Object = MibScalar
hwNmAcknowledgeAlarms = _HwNmAcknowledgeAlarms_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 15, 1, 3, 7),
    _HwNmAcknowledgeAlarms_Type()
)
hwNmAcknowledgeAlarms.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hwNmAcknowledgeAlarms.setStatus("mandatory")
_HwNmUnAcknowledgeAlarms_Type = OctetString
_HwNmUnAcknowledgeAlarms_Object = MibScalar
hwNmUnAcknowledgeAlarms = _HwNmUnAcknowledgeAlarms_Object(
    (1, 3, 6, 1, 4, 1, 2011, 2, 15, 1, 3, 8),
    _HwNmUnAcknowledgeAlarms_Type()
)
hwNmUnAcknowledgeAlarms.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hwNmUnAcknowledgeAlarms.setStatus("mandatory")
...
hwNmNorthboundEventNotify.setObjects(
      *(("T2000-TRAP-MIB", "hwNmNorthboundNEName"),
        ("T2000-TRAP-MIB", "hwNmNorthboundNEType"),
        ("T2000-TRAP-MIB", "hwNmNorthboundObjectInstance"),
        ("T2000-TRAP-MIB", "hwNmNorthboundEventType"),
        ("T2000-TRAP-MIB", "hwNmNorthboundEventTime"),
        ("T2000-TRAP-MIB", "hwNmNorthboundProbableCause"),
        ("T2000-TRAP-MIB", "hwNmNorthboundSeverity"),
        ("T2000-TRAP-MIB", "hwNmNorthboundEventDetail"),
        ("T2000-TRAP-MIB", "hwNmNorthboundAdditionalInfo"),
        ("T2000-TRAP-MIB", "hwNmNorthboundFaultFlag"),
        ("T2000-TRAP-MIB", "hwNmNorthboundFaultFunction"),
        ("T2000-TRAP-MIB", "hwNmNorthboundDeviceIP"),
        ("T2000-TRAP-MIB", "hwNmNorthboundSerialNo"),
        ("T2000-TRAP-MIB", "hwNmNorthboundProbableRepair"),
        ("T2000-TRAP-MIB", "hwNmNorthboundResourceIDs"),
        ("T2000-TRAP-MIB", "hwNmNorthboundsAdditionalVB1"),
        ("T2000-TRAP-MIB", "hwNmNorthboundsAdditionalVB2"),
        ("T2000-TRAP-MIB", "hwNmNorthboundsAdditionalVB3"),
        ("T2000-TRAP-MIB", "hwNmNorthboundsAdditionalVB4"),
        ("T2000-TRAP-MIB", "hwNmNorthboundsAdditionalVB5"),
        ("T2000-TRAP-MIB", "hwNmNorthboundsAdditionalVB6"),
        ("T2000-TRAP-MIB", "hwNmNorthboundsAdditionalVB7"),
        ("T2000-TRAP-MIB", "hwNmNorthboundsAdditionalVB8"),
        ("T2000-TRAP-MIB", "hwNmNorthboundEventName"))
)
if mibBuilder.loadTexts:
...
hwNmNorthboundEventSynchronizationEndNotify.setObjects(
      *(("T2000-TRAP-MIB", "hwNmNorthboundEventSynchronizationEndStatus"),
        ("T2000-TRAP-MIB", "hwNmNorthboundEventSynchronizationEndStatusDetail"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"huawei": huawei,
       ...
       "hwNmClearAlarms": hwNmClearAlarms,
       "hwNmAcknowledgeAlarms": hwNmAcknowledgeAlarms,
       "hwNmUnAcknowledgeAlarms": hwNmUnAcknowledgeAlarms,
