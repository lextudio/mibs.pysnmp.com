# SNMP MIB module (Dell-BRIDGE-SECURITY) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Dell-BRIDGE-SECURITY
# Produced by pysmi-1.5.4 at Mon Oct 14 21:34:11 2024
...
rlIpDhcpSnoopStaticEntry.setIndexNames(
    (0, "Dell-BRIDGE-SECURITY", "rlIpDhcpSnoopStaticVLANTag"),
    (0, "Dell-BRIDGE-SECURITY", "rlIpDhcpSnoopStaticMACAddress"),
)
if mibBuilder.loadTexts:
...
rlIpDhcpSnoopEntry.setIndexNames(
    (0, "Dell-BRIDGE-SECURITY", "rlIpDhcpSnoopVLANTag"),
    (0, "Dell-BRIDGE-SECURITY", "rlIpDhcpSnoopMACAddress"),
)
if mibBuilder.loadTexts:
...
rlIpDhcpSnoopEnableVlanEntry.setIndexNames(
    (0, "Dell-BRIDGE-SECURITY", "rlIpDhcpSnoopEnableVlanTag"),
)
if mibBuilder.loadTexts:
...
rlIpSourceGuardEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "Dell-BRIDGE-SECURITY", "rlIpSourceGuardIPAddress"),
    (0, "Dell-BRIDGE-SECURITY", "rlIpSourceGuardVLANTag"),
)
if mibBuilder.loadTexts:
...
rlIpSourceGuardPermittedRuleCounterEntry.setIndexNames(
    (0, "Dell-BRIDGE-SECURITY", "rlIpSourceGuardPermittedRuleCounterVLANTag"),
)
if mibBuilder.loadTexts:
...
rlIpArpInspectListEntry.setIndexNames(
    (0, "Dell-BRIDGE-SECURITY", "rlIpArpInspectListName"),
    (0, "Dell-BRIDGE-SECURITY", "rlIpArpInspectListIPAddress"),
)
if mibBuilder.loadTexts:
...
rlIpArpInspectEnableVlanEntry.setIndexNames(
    (0, "Dell-BRIDGE-SECURITY", "rlIpArpInspectEnableVlanTag"),
)
if mibBuilder.loadTexts:
