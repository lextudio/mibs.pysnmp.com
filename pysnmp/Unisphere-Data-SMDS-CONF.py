# SNMP MIB module (Unisphere-Data-SMDS-CONF) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Unisphere-Data-SMDS-CONF
...
(usdSmdsGroup,
 usdSmdsGroup2) = mibBuilder.importSymbols(
...
usdSmdsAgent = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 46)
)
usdSmdsAgent.setRevisions(
        ("2001-09-20 14:57",
         "2001-03-30 14:30")
)
...
usdSmdsAgentV1 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 46, 1)
)
if mibBuilder.loadTexts:
    usdSmdsAgentV1.setProductRelease("""\
Version 1 of the Switched Multimegabit Data Service (SMDS) management
        ...
        releases.""")
if mibBuilder.loadTexts:
    usdSmdsAgentV1.setStatus(
        "obsolete"
    )

usdSmdsAgentV2 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 46, 2)
)
if mibBuilder.loadTexts:
    usdSmdsAgentV2.setProductRelease("""\
...
mibBuilder.exportSymbols(
    ...
    **{"usdSmdsAgent": usdSmdsAgent,
       "usdSmdsAgentV1": usdSmdsAgentV1,
       "usdSmdsAgentV2": usdSmdsAgentV2}
)
