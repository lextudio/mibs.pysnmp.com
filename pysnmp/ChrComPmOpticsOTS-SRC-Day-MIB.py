# SNMP MIB module (ChrComPmOpticsOTS-SRC-Day-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmOpticsOTS-SRC-Day-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:27 2024
...
_ChrComPmOpticsOTS_SRC_DayTable_Object = MibTable
chrComPmOpticsOTS_SRC_DayTable = _ChrComPmOpticsOTS_SRC_DayTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 6)
)
if mibBuilder.loadTexts:
    chrComPmOpticsOTS_SRC_DayTable.setStatus("current")
_ChrComPmOpticsOTS_SRC_DayEntry_Object = MibTableRow
chrComPmOpticsOTS_SRC_DayEntry = _ChrComPmOpticsOTS_SRC_DayEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 6, 1)
)
chrComPmOpticsOTS_SRC_DayEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmOpticsOTS-SRC-Day-MIB", "chrComPmOpticsDayNumber"),
)
if mibBuilder.loadTexts:
    chrComPmOpticsOTS_SRC_DayEntry.setStatus("current")
...
chrComPmOpticsMin = _ChrComPmOpticsMin_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 6, 1, 10),
...
chrComPmOpticsSD = _ChrComPmOpticsSD_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 6, 1, 11),
...
chrComPmOpticsThresholdProfIndex = _ChrComPmOpticsThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 6, 1, 12),
...
chrComPmOpticsResetCountersAction = _ChrComPmOpticsResetCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 6, 1, 13),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmOpticsOTS-SRC-DayTable": chrComPmOpticsOTS_SRC_DayTable,
       "chrComPmOpticsOTS-SRC-DayEntry": chrComPmOpticsOTS_SRC_DayEntry,
