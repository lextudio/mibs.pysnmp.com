# SNMP MIB module (SYMBIOSDMI20MIFDEFINITIONID20-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/SYMBIOSDMI20MIFDEFINITIONID20-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:59:33 2024
...
a1Manufacturer = _A1Manufacturer_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 1, 1, 1),
...
a1Product = _A1Product_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 1, 1, 2),
    _A1Product_Type()
)
...
a1Version = _A1Version_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 1, 1, 3),
    _A1Version_Type()
)
...
a1SerialNumber = _A1SerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 1, 1, 4),
...
a1Installation = _A1Installation_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 1, 1, 5),
...
a1Verify = _A1Verify_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 1, 1, 6),
    _A1Verify_Type()
)
...
eSubcomponentSoftware = _ESubcomponentSoftware_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 2, 1)
)
eSubcomponentSoftware.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a2SoftwareIndex"),
)
if mibBuilder.loadTexts:
...
a2SoftwareIndex = _A2SoftwareIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 2, 1, 1),
...
a2Type = _A2Type_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 2, 1, 2),
    _A2Type_Type()
)
...
a2Vendor = _A2Vendor_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 2, 1, 3),
    _A2Vendor_Type()
)
...
a2Version = _A2Version_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 2, 1, 4),
    _A2Version_Type()
)
...
a2Description = _A2Description_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 2, 1, 5),
    _A2Description_Type()
)
...
a2IdentificationCode = _A2IdentificationCode_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 2, 1, 6),
...
a2LanguageEdition = _A2LanguageEdition_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 2, 1, 7),
...
a2InterfaceDescription = _A2InterfaceDescription_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 2, 1, 8),
...
a2InterfaceVersion = _A2InterfaceVersion_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 2, 1, 9),
...
eWorldwideIdentifer = _EWorldwideIdentifer_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 3, 1)
)
eWorldwideIdentifer.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a3WorldwideIdentifierIndex"),
)
if mibBuilder.loadTexts:
...
a3WorldwideIdentifierIndex = _A3WorldwideIdentifierIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 3, 1, 1),
...
a3WorldwideIdentifierType = _A3WorldwideIdentifierType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 3, 1, 2),
...
a3WorldwideIdentifier = _A3WorldwideIdentifier_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 3, 1, 3),
...
eFieldReplaceableUnit = _EFieldReplaceableUnit_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1)
)
eFieldReplaceableUnit.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a4FruIndex"),
)
if mibBuilder.loadTexts:
...
a4FruIndex = _A4FruIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1, 1),
    _A4FruIndex_Type()
)
...
a4DeviceGroupIndex = _A4DeviceGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1, 2),
...
a4Description = _A4Description_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1, 3),
    _A4Description_Type()
)
...
a4Manufacturer = _A4Manufacturer_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1, 4),
...
a4Model = _A4Model_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1, 5),
    _A4Model_Type()
)
...
a4PartNumber = _A4PartNumber_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1, 6),
    _A4PartNumber_Type()
)
...
a4FruSerialNumber = _A4FruSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1, 7),
...
a4RevisionLevel = _A4RevisionLevel_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1, 8),
...
a4WarrantyStartDate = _A4WarrantyStartDate_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1, 9),
...
a4WarrantyDuration = _A4WarrantyDuration_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1, 10),
...
a4SupportPhoneNumber = _A4SupportPhoneNumber_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1, 11),
...
a4FruInternetUniformResourceLocator = _A4FruInternetUniformResourceLocator_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 4, 1, 12),
...
a5StorageDeviceIndex = _A5StorageDeviceIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 5, 1, 1),
...
a5Type = _A5Type_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 5, 1, 2),
    _A5Type_Type()
)
...
a5TypeDescription = _A5TypeDescription_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 5, 1, 3),
...
a5Sub_identifier = _A5Sub_identifier_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 5, 1, 4),
...
a5RemovableDevice = _A5RemovableDevice_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 5, 1, 7),
...
a5DeviceLoaded = _A5DeviceLoaded_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 5, 1, 8),
...
a5RemovableMedia = _A5RemovableMedia_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 5, 1, 9),
...
a5MediaLoaded = _A5MediaLoaded_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 5, 1, 10),
    _A5MediaLoaded_Type()
)
...
a5Compression = _A5Compression_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 5, 1, 11),
    _A5Compression_Type()
)
...
a5Encryption = _A5Encryption_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 5, 1, 12),
    _A5Encryption_Type()
)
...
eStorageDevicesEvents = _EStorageDevicesEvents_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1)
)
eStorageDevicesEvents.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a6StorageDevicesEventType = _A6StorageDevicesEventType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1, 1),
...
a6EventSeverity = _A6EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1, 2),
...
a6EventIsStateBased = _A6EventIsStateBased_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1, 3),
...
a6EventStateKey = _A6EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1, 4),
...
a6AssociatedGroup = _A6AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1, 5),
...
a6EventSystem = _A6EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1, 6),
    _A6EventSystem_Type()
)
...
a6EventSubsystem = _A6EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1, 7),
...
a6EventSolution = _A6EventSolution_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1, 8),
...
a6InstanceDataPresent = _A6InstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1, 9),
...
a6EventMessage = _A6EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1, 10),
...
eStorageController = _EStorageController_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 7, 1)
)
eStorageController.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a7ControllerIndex"),
)
if mibBuilder.loadTexts:
...
a7ControllerIndex = _A7ControllerIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 7, 1, 1),
...
a7Identification = _A7Identification_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 7, 1, 2),
...
a7ProtectionManagement = _A7ProtectionManagement_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 7, 1, 3),
...
a7BusMaster = _A7BusMaster_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 7, 1, 4),
    _A7BusMaster_Type()
)
...
a7SecondsSinceLastPower_up = _A7SecondsSinceLastPower_up_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 7, 1, 5),
...
eStorageControllerEvents = _EStorageControllerEvents_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 8, 1)
)
eStorageControllerEvents.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a8AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a8StorageControllerEventType = _A8StorageControllerEventType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 8, 1, 1),
...
a8EventSeverity = _A8EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 8, 1, 2),
...
a8EventIsStateBased = _A8EventIsStateBased_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 8, 1, 3),
...
a8EventStateKey = _A8EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 8, 1, 4),
...
a8AssociatedGroup = _A8AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 8, 1, 5),
...
a8EventSystem = _A8EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 8, 1, 6),
    _A8EventSystem_Type()
)
...
a8EventSubsystem = _A8EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 8, 1, 7),
...
a8EventSolution = _A8EventSolution_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 8, 1, 8),
...
a8InstanceDataPresent = _A8InstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 8, 1, 9),
...
a8EventMessage = _A8EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 8, 1, 10),
...
tBusPort = _TBusPort_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9)
)
if mibBuilder.loadTexts:
    tBusPort.setStatus("mandatory")
_EBusPort_Object = MibTableRow
eBusPort = _EBusPort_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1)
)
eBusPort.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a9BusPortIndex"),
)
if mibBuilder.loadTexts:
...
a9BusPortIndex = _A9BusPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1, 1),
...
a9Protocol = _A9Protocol_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1, 2),
    _A9Protocol_Type()
)
...
a9ProtocolDescription = _A9ProtocolDescription_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1, 3),
...
a9SignalCharacteristics = _A9SignalCharacteristics_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1, 4),
...
a9AddressDescriptor = _A9AddressDescriptor_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1, 5),
...
a9Isochronous = _A9Isochronous_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1, 6),
    _A9Isochronous_Type()
)
...
a9MaximumWidth = _A9MaximumWidth_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1, 7),
...
a9MaximumTransferRate = _A9MaximumTransferRate_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1, 8),
...
a9MaximumNumberOfAttachments = _A9MaximumNumberOfAttachments_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1, 9),
...
a9ConnectorType = _A9ConnectorType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1, 10),
...
a9ConnectorTypeDescription = _A9ConnectorTypeDescription_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1, 11),
...
a9ConnectorGender = _A9ConnectorGender_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 9, 1, 12),
...
tFibreChannelBusPortExtensions = _TFibreChannelBusPortExtensions_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 10)
)
if mibBuilder.loadTexts:
...
eFibreChannelBusPortExtensions = _EFibreChannelBusPortExtensions_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 10, 1)
)
eFibreChannelBusPortExtensions.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a10BusPortIndex"),
)
if mibBuilder.loadTexts:
...
a10BusPortIndex = _A10BusPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 10, 1, 1),
...
a10EndToEndCredit = _A10EndToEndCredit_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 10, 1, 2),
...
a10BufferToBufferCredit = _A10BufferToBufferCredit_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 10, 1, 3),
...
a10LinkType = _A10LinkType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 10, 1, 4),
    _A10LinkType_Type()
)
...
a10FlowControlClassType = _A10FlowControlClassType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 10, 1, 5),
...
a10FlowControlAcknowledgmentType = _A10FlowControlAcknowledgmentType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 10, 1, 6),
...
a10FabricTopology = _A10FabricTopology_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 10, 1, 7),
...
tMassStorageAssociation = _TMassStorageAssociation_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 11)
)
if mibBuilder.loadTexts:
...
eMassStorageAssociation = _EMassStorageAssociation_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 11, 1)
)
eMassStorageAssociation.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a11AssociationIndex"),
)
if mibBuilder.loadTexts:
...
a11AssociationIndex = _A11AssociationIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 11, 1, 1),
...
a11Type = _A11Type_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 11, 1, 2),
    _A11Type_Type()
)
...
a11Reference1 = _A11Reference1_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 11, 1, 3),
    _A11Reference1_Type()
)
...
a11Reference2 = _A11Reference2_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 11, 1, 4),
    _A11Reference2_Type()
)
...
tMassStorageAssociationEvents = _TMassStorageAssociationEvents_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12)
)
if mibBuilder.loadTexts:
...
eMassStorageAssociationEvents = _EMassStorageAssociationEvents_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1)
)
eMassStorageAssociationEvents.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a12MassStorageAssociationEventType = _A12MassStorageAssociationEventType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 1),
...
a12EventSeverity = _A12EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 2),
...
a12EventIsStateBased = _A12EventIsStateBased_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 3),
...
a12EventStateKey = _A12EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 4),
...
a12AssociatedGroup = _A12AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 5),
...
a12EventSystem = _A12EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 6),
...
a12EventSubsystem = _A12EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 7),
...
a12EventSolution = _A12EventSolution_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 8),
...
a12InstanceDataPresent = _A12InstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 9),
...
a12EventMessage = _A12EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 10),
...
tBusPortAssociation = _TBusPortAssociation_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 13)
)
if mibBuilder.loadTexts:
...
eBusPortAssociation = _EBusPortAssociation_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 13, 1)
)
eBusPortAssociation.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a13BusPortAssociationIndex"),
)
if mibBuilder.loadTexts:
...
a13BusPortAssociationIndex = _A13BusPortAssociationIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 13, 1, 1),
...
a13NegotiatedSpeed = _A13NegotiatedSpeed_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 13, 1, 2),
...
a13NegotiatedWidth = _A13NegotiatedWidth_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 13, 1, 3),
...
a14OperationalStateInstanceIndex = _A14OperationalStateInstanceIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 14, 1, 1),
...
a14DeviceGroupIndex = _A14DeviceGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 14, 1, 2),
...
a14OperationalStatus = _A14OperationalStatus_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 14, 1, 3),
...
a14UsageState = _A14UsageState_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 14, 1, 4),
    _A14UsageState_Type()
)
...
a14AvailabilityStatus = _A14AvailabilityStatus_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 14, 1, 5),
...
a14AdministrativeState = _A14AdministrativeState_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 14, 1, 6),
...
a14FatalErrorCount = _A14FatalErrorCount_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 14, 1, 7),
...
a14MajorErrorCount = _A14MajorErrorCount_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 14, 1, 8),
...
a14WarningErrorCount = _A14WarningErrorCount_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 14, 1, 9),
...
a14CurrentErrorStatus = _A14CurrentErrorStatus_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 14, 1, 10),
...
a14DevicePredictedFailureStatus = _A14DevicePredictedFailureStatus_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 14, 1, 11),
...
tSymbiosEventPolling = _TSymbiosEventPolling_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 15)
)
if mibBuilder.loadTexts:
...
eSymbiosEventPolling = _ESymbiosEventPolling_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 15, 1)
)
...
a15SymbiosFlag = _A15SymbiosFlag_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 15, 1, 1),
...
a15SmartEventPolling = _A15SmartEventPolling_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 15, 1, 2),
...
a15ScanEventPolling = _A15ScanEventPolling_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 15, 1, 3),
...
a15Saf_teEventPolling = _A15Saf_teEventPolling_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 15, 1, 4),
...
a15EventPollingPeriod = _A15EventPollingPeriod_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 15, 1, 5),
...
tSymbiosSmartDevice = _TSymbiosSmartDevice_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 16)
)
if mibBuilder.loadTexts:
...
eSymbiosSmartDevice = _ESymbiosSmartDevice_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 16, 1)
)
eSymbiosSmartDevice.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a16SymSmartDeviceIndex"),
)
if mibBuilder.loadTexts:
...
a16SymSmartDeviceIndex = _A16SymSmartDeviceIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 16, 1, 1),
...
a16SmartReportingCapability = _A16SmartReportingCapability_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 16, 1, 2),
...
a17Saf_teProcessorIndex = _A17Saf_teProcessorIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 1),
...
a17StorageControllerIndex = _A17StorageControllerIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 2),
...
a17VendorId = _A17VendorId_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 5),
    _A17VendorId_Type()
)
...
a17ProductId = _A17ProductId_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 6),
    _A17ProductId_Type()
)
...
a17FirmwareRevisionLevel = _A17FirmwareRevisionLevel_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 7),
...
a17EnclosureUniqueIdentifier = _A17EnclosureUniqueIdentifier_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 8),
...
a17Saf_teSpecificationRevisionLevel = _A17Saf_teSpecificationRevisionLevel_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 9),
...
a17HasLocks = _A17HasLocks_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 10),
    _A17HasLocks_Type()
)
...
a17HasSpeakers = _A17HasSpeakers_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 11),
...
a17DoorLocked = _A17DoorLocked_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 12),
    _A17DoorLocked_Type()
)
...
a17SpeakerStatus = _A17SpeakerStatus_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 13),
...
a17PowerOnMinutes = _A17PowerOnMinutes_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 14),
...
a17PowerOnCycles = _A17PowerOnCycles_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 15),
...
a17TemperatureOutOfRange = _A17TemperatureOutOfRange_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 17, 1, 16),
...
tSaf_teControlledFan = _TSaf_teControlledFan_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 18)
)
if mibBuilder.loadTexts:
...
eSaf_teControlledFan = _ESaf_teControlledFan_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 18, 1)
)
eSaf_teControlledFan.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a18Saf-teControlledFanIndex"),
)
if mibBuilder.loadTexts:
...
a18Saf_teControlledFanIndex = _A18Saf_teControlledFanIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 18, 1, 1),
...
a18Saf_teProcessorIndex = _A18Saf_teProcessorIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 18, 1, 2),
...
a18Status = _A18Status_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 18, 1, 3),
    _A18Status_Type()
)
...
tSaf_teControlledPowerSupply = _TSaf_teControlledPowerSupply_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 19)
)
if mibBuilder.loadTexts:
...
eSaf_teControlledPowerSupply = _ESaf_teControlledPowerSupply_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 19, 1)
)
eSaf_teControlledPowerSupply.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a19Saf-teControlledPowerSupplyIndex"),
)
if mibBuilder.loadTexts:
...
a19Saf_teControlledPowerSupplyIndex = _A19Saf_teControlledPowerSupplyIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 19, 1, 1),
...
a19Saf_teProcessorIndex = _A19Saf_teProcessorIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 19, 1, 2),
...
a19Status = _A19Status_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 19, 1, 3),
    _A19Status_Type()
)
...
tSaf_teControlledSlot = _TSaf_teControlledSlot_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 20)
)
if mibBuilder.loadTexts:
...
eSaf_teControlledSlot = _ESaf_teControlledSlot_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 20, 1)
)
eSaf_teControlledSlot.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a20Saf-teControlledSlotIndex"),
)
if mibBuilder.loadTexts:
...
a20Saf_teControlledSlotIndex = _A20Saf_teControlledSlotIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 20, 1, 1),
...
a20NumberOfInsertions = _A20NumberOfInsertions_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 20, 1, 4),
...
a20State = _A20State_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 20, 1, 5),
    _A20State_Type()
)
...
a20Rebuild = _A20Rebuild_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 20, 1, 6),
    _A20Rebuild_Type()
)
...
a20DeviceFault = _A20DeviceFault_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 20, 1, 7),
...
a20InFailedArray = _A20InFailedArray_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 20, 1, 8),
...
a20InCriticalArray = _A20InCriticalArray_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 20, 1, 9),
...
a20ParityCheck = _A20ParityCheck_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 20, 1, 10),
...
a20PredictedFault = _A20PredictedFault_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 20, 1, 11),
...
tSaf_teControlledTemperatureSensor = _TSaf_teControlledTemperatureSensor_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 21)
)
if mibBuilder.loadTexts:
...
eSaf_teControlledTemperatureSensor = _ESaf_teControlledTemperatureSensor_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 21, 1)
)
eSaf_teControlledTemperatureSensor.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a21Saf-teControlledTemperatureSensorInde"),
)
if mibBuilder.loadTexts:
...
a21Saf_teControlledTemperatureSensorInde = _A21Saf_teControlledTemperatureSensorInde_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 21, 1, 1),
...
a21Saf_teProcessorIndex = _A21Saf_teProcessorIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 21, 1, 2),
...
a21Temperature = _A21Temperature_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 21, 1, 3),
...
tNetworkAdapter802PortGroup = _TNetworkAdapter802PortGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 22)
)
if mibBuilder.loadTexts:
...
eNetworkAdapter802PortGroup = _ENetworkAdapter802PortGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 22, 1)
)
eNetworkAdapter802PortGroup.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a22PortIndex"),
)
if mibBuilder.loadTexts:
...
a22PortIndex = _A22PortIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 22, 1, 1),
    _A22PortIndex_Type()
)
...
a22PermanentNetworkAddress = _A22PermanentNetworkAddress_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 22, 1, 2),
...
a22CurrentNetworkAddress = _A22CurrentNetworkAddress_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 22, 1, 3),
...
a22ConnectorType = _A22ConnectorType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 22, 1, 4),
...
a22DataRate = _A22DataRate_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 22, 1, 5),
    _A22DataRate_Type()
)
...
tNetworkAdapterHardwareGroup = _TNetworkAdapterHardwareGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 23)
)
if mibBuilder.loadTexts:
...
eNetworkAdapterHardwareGroup = _ENetworkAdapterHardwareGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 23, 1)
)
...
a23NetworkTopology = _A23NetworkTopology_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 23, 1, 1),
...
a23TransmissionCapability = _A23TransmissionCapability_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 23, 1, 2),
...
a23NetworkAdapterRamSize = _A23NetworkAdapterRamSize_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 23, 1, 3),
...
a23BusType = _A23BusType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 23, 1, 4),
    _A23BusType_Type()
)
...
a23BusWidth = _A23BusWidth_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 23, 1, 5),
    _A23BusWidth_Type()
)
...
tEventGenerationForPowerSupply = _TEventGenerationForPowerSupply_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 24)
)
if mibBuilder.loadTexts:
...
eEventGenerationForPowerSupply = _EEventGenerationForPowerSupply_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 24, 1)
)
eEventGenerationForPowerSupply.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a24AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a24EventType = _A24EventType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 24, 1, 1),
    _A24EventType_Type()
)
...
a24EventSeverity = _A24EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 24, 1, 2),
...
a24IsEventState_based = _A24IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 24, 1, 3),
...
a24EventStateKey = _A24EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 24, 1, 4),
...
a24AssociatedGroup = _A24AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 24, 1, 5),
...
a24EventSystem = _A24EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 24, 1, 6),
...
a24EventSubsystem = _A24EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 24, 1, 7),
...
a24IsInstanceDataPresent = _A24IsInstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 24, 1, 8),
...
a24EventMessage = _A24EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 24, 1, 9),
...
tEventGenerationForTemperatureProbe = _TEventGenerationForTemperatureProbe_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 25)
)
if mibBuilder.loadTexts:
...
eEventGenerationForTemperatureProbe = _EEventGenerationForTemperatureProbe_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 25, 1)
)
eEventGenerationForTemperatureProbe.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a25AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a25EventType = _A25EventType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 25, 1, 1),
    _A25EventType_Type()
)
...
a25EventSeverity = _A25EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 25, 1, 2),
...
a25IsEventState_based = _A25IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 25, 1, 3),
...
a25EventStateKey = _A25EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 25, 1, 4),
...
a25AssociatedGroup = _A25AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 25, 1, 5),
...
a25EventSystem = _A25EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 25, 1, 6),
...
a25EventSubsystem = _A25EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 25, 1, 7),
...
a25IsInstanceDataPresent = _A25IsInstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 25, 1, 8),
...
a25EventMessage = _A25EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 25, 1, 9),
...
tEventGenerationForFans = _TEventGenerationForFans_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 26)
)
if mibBuilder.loadTexts:
...
eEventGenerationForFans = _EEventGenerationForFans_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 26, 1)
)
eEventGenerationForFans.setIndexNames(
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a26AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a26EventType = _A26EventType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 26, 1, 1),
    _A26EventType_Type()
)
...
a26EventSeverity = _A26EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 26, 1, 2),
...
a26IsEventState_based = _A26IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 26, 1, 3),
...
a26EventStateKey = _A26EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 26, 1, 4),
...
a26AssociatedGroup = _A26AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 26, 1, 5),
...
a26EventSystem = _A26EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 26, 1, 6),
...
a26EventSubsystem = _A26EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 26, 1, 7),
...
a26IsInstanceDataPresent = _A26IsInstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 26, 1, 8),
...
a26EventMessage = _A26EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 26, 1, 9),
...
a27OverallHealthStatus = _A27OverallHealthStatus_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 27, 1, 1),
...
a27OverallControllerHealthStatus = _A27OverallControllerHealthStatus_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 27, 1, 2),
...
a27Non_recoverableControllers = _A27Non_recoverableControllers_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 27, 1, 3),
...
a27DegradedControllers = _A27DegradedControllers_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 27, 1, 4),
...
a27OverallDeviceHealthStatus = _A27OverallDeviceHealthStatus_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 27, 1, 5),
...
a27Non_recoverableDevices = _A27Non_recoverableDevices_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 27, 1, 6),
...
a27DegradedDevices = _A27DegradedDevices_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 27, 1, 7),
...
a99MibName = _A99MibName_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 99, 1, 1),
    _A99MibName_Type()
)
...
a99MibOid = _A99MibOid_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 99, 1, 2),
    _A99MibOid_Type()
)
...
a99DisableTrap = _A99DisableTrap_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 99, 1, 3),
...
trap1ID20forStorageDevices = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1, 0, 1)
)
trap1ID20forStorageDevices.setObjects(
      *(("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6StorageDevicesEventType"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6EventSeverity"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6EventIsStateBased"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6EventStateKey"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6AssociatedGroup"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6EventSystem"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6EventSubsystem"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6EventSolution"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6InstanceDataPresent"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6EventMessage"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a5StorageDeviceIndex"))
)
if mibBuilder.loadTexts:
    trap1ID20forStorageDevices.setStatus(
        ""
    )

trap2ID20forStorageDevices = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 6, 1, 0, 2)
)
trap2ID20forStorageDevices.setObjects(
      *(("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6StorageDevicesEventType"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6EventSeverity"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6EventIsStateBased"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a6EventStateKey"),
...
if mibBuilder.loadTexts:
    trap2ID20forStorageDevices.setStatus(
        ""
    )

trap3ID20forStorageController = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 8, 1, 0, 3)
)
trap3ID20forStorageController.setObjects(
      *(("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a8StorageControllerEventType"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a8EventSeverity"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a8EventIsStateBased"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a8EventStateKey"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a8AssociatedGroup"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a8EventSystem"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a8EventSubsystem"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a8EventSolution"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a8InstanceDataPresent"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a8EventMessage"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a7ControllerIndex"))
)
if mibBuilder.loadTexts:
    trap3ID20forStorageController.setStatus(
        ""
    )

trap4ID20forMassStorageAssociation = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 0, 4)
)
trap4ID20forMassStorageAssociation.setObjects(
      *(("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12MassStorageAssociationEventType"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventSeverity"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventIsStateBased"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventStateKey"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12AssociatedGroup"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventSystem"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventSubsystem"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventSolution"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12InstanceDataPresent"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventMessage"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a11AssociationIndex"))
)
if mibBuilder.loadTexts:
    trap4ID20forMassStorageAssociation.setStatus(
        ""
    )

trap5ID20forMassStorageAssociation = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 0, 5)
)
trap5ID20forMassStorageAssociation.setObjects(
      *(("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12MassStorageAssociationEventType"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventSeverity"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventIsStateBased"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventStateKey"),
...
if mibBuilder.loadTexts:
    trap5ID20forMassStorageAssociation.setStatus(
        ""
    )

trap6ID20forMassStorageAssociation = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 0, 6)
)
trap6ID20forMassStorageAssociation.setObjects(
      *(("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12MassStorageAssociationEventType"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventSeverity"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventIsStateBased"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventStateKey"),
...
if mibBuilder.loadTexts:
    trap6ID20forMassStorageAssociation.setStatus(
        ""
    )

trap7ID20forMassStorageAssociation = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 20, 1, 12, 1, 0, 7)
)
trap7ID20forMassStorageAssociation.setObjects(
      *(("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12MassStorageAssociationEventType"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventSeverity"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventIsStateBased"),
        ("SYMBIOSDMI20MIFDEFINITIONID20-MIB", "a12EventStateKey"),
...
if mibBuilder.loadTexts:
    trap7ID20forMassStorageAssociation.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    "SYMBIOSDMI20MIFDEFINITIONID20-MIB",
    **{"DmiCounter": DmiCounter,
       ...
       "trap1ID20forStorageDevices": trap1ID20forStorageDevices,
       "trap2ID20forStorageDevices": trap2ID20forStorageDevices,
       ...
       "trap3ID20forStorageController": trap3ID20forStorageController,
       ...
       "trap4ID20forMassStorageAssociation": trap4ID20forMassStorageAssociation,
       "trap5ID20forMassStorageAssociation": trap5ID20forMassStorageAssociation,
       "trap6ID20forMassStorageAssociation": trap6ID20forMassStorageAssociation,
       "trap7ID20forMassStorageAssociation": trap7ID20forMassStorageAssociation,
