# SNMP MIB module (DKSF-52-9-X-X-1) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DKSF-52-9-X-X-1
...
netPing2PWR220 = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 25728, 52)
)
netPing2PWR220.setRevisions(
        ("2015-08-17 00:00",
         "2014-11-14 00:00",
         "2014-08-21 00:00",
         "2014-04-14 00:00",
...
npPwrEntry.setIndexNames(
    (0, "DKSF-52-9-X-X-1", "npPwrChannelN"),
)
if mibBuilder.loadTexts:
...
npThermoEntry.setIndexNames(
    (0, "DKSF-52-9-X-X-1", "npThermoSensorN"),
)
if mibBuilder.loadTexts:
...
npRelHumTrap.setObjects(
      *(("DKSF-52-9-X-X-1", "npRelHumSensorStatusH"),
        ("DKSF-52-9-X-X-1", "npRelHumSensorValueH"),
        ("DKSF-52-9-X-X-1", "npRelHumSafeRangeHigh"),
        ("DKSF-52-9-X-X-1", "npRelHumSafeRangeLow"),
        ("DKSF-52-9-X-X-1", "npTrapEmailTo"))
)
if mibBuilder.loadTexts:
...
npThermoTrap.setObjects(
      *(("DKSF-52-9-X-X-1", "npThermoTrapSensorN"),
        ("DKSF-52-9-X-X-1", "npThermoTrapValue"),
        ("DKSF-52-9-X-X-1", "npThermoTrapStatus"),
        ("DKSF-52-9-X-X-1", "npThermoTrapLow"),
        ("DKSF-52-9-X-X-1", "npThermoTrapHigh"),
        ("DKSF-52-9-X-X-1", "npThermoTrapMemo"))
)
if mibBuilder.loadTexts:
...
npIoTrap.setObjects(
      *(("DKSF-52-9-X-X-1", "npIoTrapLineN"),
        ("DKSF-52-9-X-X-1", "npIoTrapLevelIn"),
        ("DKSF-52-9-X-X-1", "npIoTrapMemo"))
)
if mibBuilder.loadTexts:
    npIoTrap.setStatus(
        "current"
