# SNMP MIB module (HUAWEI-USERLOG-MIB) expressed in pysnmp data model.
#
...
# Produced by pysmi-1.5.4 at Mon Oct 14 22:06:22 2024
...
hwUserlogNatSlotCfgInfoEntry.setIndexNames(
    (0, "HUAWEI-USERLOG-MIB", "hwUserlogNatCfgSlotNumber"),
)
if mibBuilder.loadTexts:
...
hwUserlogNatSlotRunInfoEntry.setIndexNames(
    (0, "HUAWEI-USERLOG-MIB", "hwUserlogNatRunSlotNumber"),
)
if mibBuilder.loadTexts:
...
hwUserlogFlowSlotCfgInfoEntry.setIndexNames(
    (0, "HUAWEI-USERLOG-MIB", "hwUserlogFlowCfgSlotNumber"),
)
if mibBuilder.loadTexts:
...
hwUserlogFlowSlotRunInfoEntry.setIndexNames(
    (0, "HUAWEI-USERLOG-MIB", "hwUserlogFlowRunSlotNumber"),
)
if mibBuilder.loadTexts:
...
hwUserlogAccessSlotCfgInfoEntry.setIndexNames(
    (0, "HUAWEI-USERLOG-MIB", "hwUserlogAccessCfgSlotNumber"),
)
if mibBuilder.loadTexts:
...
hwUserlogAccessSlotRunInfoEntry.setIndexNames(
    (0, "HUAWEI-USERLOG-MIB", "hwUserlogAccessRunSlotNumber"),
)
if mibBuilder.loadTexts:
...
hwUserlogMandatoryGroup.setObjects(
      *(("HUAWEI-USERLOG-MIB", "hwUserlogNatEnable"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatHostAddress"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatUdpPort"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowEnable"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowHostAddress"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowUdpPort"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessEnable"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessHostAddress"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessUdpPort"))
)
if mibBuilder.loadTexts:
...
hwUserlogConfigGroup.setObjects(
      *(("HUAWEI-USERLOG-MIB", "hwUserlogNatVersion"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatSyslog"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatSourceIP"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatFlowBegin"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatActiveTime"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatCfgSlotNumber"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatEnable"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatAclNumber"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatHostAddress"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatUdpPort"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowVersion"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowSyslog"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowSourceIP"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowFlowBegin"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowActiveTime"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowCfgSlotNumber"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowEnable"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowAclNumber"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowHostAddress"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowUdpPort"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessVersion"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessSyslog"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessSourceIP"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessCfgSlotNumber"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessEnable"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessHostAddress"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessUdpPort"))
)
...
hwUserlogInfoGroup.setObjects(
      *(("HUAWEI-USERLOG-MIB", "hwUserlogNatTotalEntries"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatTotalPackets"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatFailedEntries"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogNatFailedPackets"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowTotalEntries"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowTotalPackets"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowFailedEntries"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogFlowFailedPackets"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessTotalEntries"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessTotalPackets"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessFailedEntries"),
        ("HUAWEI-USERLOG-MIB", "hwUserlogAccessFailedPackets"))
)
if mibBuilder.loadTexts:
