# SNMP MIB module (ChrComPmOpticsOMS-SRC-Interval-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmOpticsOMS-SRC-Interval-MIB
...
_ChrComPmOpticsOMS_SRC_IntervalTable_Object = MibTable
chrComPmOpticsOMS_SRC_IntervalTable = _ChrComPmOpticsOMS_SRC_IntervalTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11)
)
if mibBuilder.loadTexts:
    chrComPmOpticsOMS_SRC_IntervalTable.setStatus("current")
_ChrComPmOpticsOMS_SRC_IntervalEntry_Object = MibTableRow
chrComPmOpticsOMS_SRC_IntervalEntry = _ChrComPmOpticsOMS_SRC_IntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11, 1)
)
chrComPmOpticsOMS_SRC_IntervalEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmOpticsOMS-SRC-Interval-MIB", "chrComPmOpticsIntervalNumber"),
)
if mibBuilder.loadTexts:
    chrComPmOpticsOMS_SRC_IntervalEntry.setStatus("current")
...
chrComPmOpticsIntervalNumber = _ChrComPmOpticsIntervalNumber_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11, 1, 1),
...
chrComPmOpticsSuspectedIntrvl = _ChrComPmOpticsSuspectedIntrvl_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11, 1, 2),
...
chrComPmOpticsElapsedTime = _ChrComPmOpticsElapsedTime_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11, 1, 3),
...
chrComPmOpticsSuppressedIntrvls = _ChrComPmOpticsSuppressedIntrvls_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11, 1, 4),
...
chrComPmOpticsORS = _ChrComPmOpticsORS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11, 1, 5),
...
chrComPmOpticsSES = _ChrComPmOpticsSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11, 1, 6),
...
chrComPmOpticsUAS = _ChrComPmOpticsUAS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11, 1, 7),
...
chrComPmOpticsMean = _ChrComPmOpticsMean_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11, 1, 8),
...
chrComPmOpticsMax = _ChrComPmOpticsMax_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11, 1, 9),
...
chrComPmOpticsMin = _ChrComPmOpticsMin_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11, 1, 10),
...
chrComPmOpticsSD = _ChrComPmOpticsSD_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 11, 1, 11),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmOpticsOMS-SRC-IntervalTable": chrComPmOpticsOMS_SRC_IntervalTable,
       "chrComPmOpticsOMS-SRC-IntervalEntry": chrComPmOpticsOMS_SRC_IntervalEntry,
