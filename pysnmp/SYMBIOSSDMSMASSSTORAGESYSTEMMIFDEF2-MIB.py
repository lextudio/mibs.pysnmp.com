# SNMP MIB module (SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB
...
a1Manufacturer = _A1Manufacturer_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 1, 1, 1),
...
a1Product = _A1Product_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 1, 1, 2),
    _A1Product_Type()
)
...
a1Version = _A1Version_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 1, 1, 3),
    _A1Version_Type()
)
...
a1SerialNumber = _A1SerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 1, 1, 4),
...
a1Installation = _A1Installation_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 1, 1, 5),
...
a1Verify = _A1Verify_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 1, 1, 6),
    _A1Verify_Type()
)
...
eSoftwareComponentInformation = _ESoftwareComponentInformation_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 2, 1)
)
...
a2MajorVersion = _A2MajorVersion_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 2, 1, 1),
...
a2MinorVersion = _A2MinorVersion_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 2, 1, 2),
...
a2Revision = _A2Revision_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 2, 1, 3),
    _A2Revision_Type()
)
...
a2Build = _A2Build_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 2, 1, 4),
    _A2Build_Type()
)
...
a2TargetOperatingSystem = _A2TargetOperatingSystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 2, 1, 5),
...
a2LanguageEdition = _A2LanguageEdition_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 2, 1, 6),
...
a2IdentificationCode = _A2IdentificationCode_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 2, 1, 7),
...
a2InstallableState = _A2InstallableState_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 2, 1, 8),
...
a2ExecutableState = _A2ExecutableState_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 2, 1, 9),
    _A2ExecutableState_Type()
)
a2ExecutableState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    a2ExecutableState.setStatus("mandatory")
_TSoftwareSignature_Object = MibTable
tSoftwareSignature = _TSoftwareSignature_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 3)
)
if mibBuilder.loadTexts:
    tSoftwareSignature.setStatus("mandatory")
_ESoftwareSignature_Object = MibTableRow
eSoftwareSignature = _ESoftwareSignature_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 3, 1)
)
eSoftwareSignature.setIndexNames(
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a3FileIndex"),
)
if mibBuilder.loadTexts:
    eSoftwareSignature.setStatus("mandatory")
_A3FileName_Type = DmiDisplaystring
_A3FileName_Object = MibTableColumn
a3FileName = _A3FileName_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 3, 1, 1),
    _A3FileName_Type()
)
...
a3FileSize = _A3FileSize_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 3, 1, 2),
    _A3FileSize_Type()
)
...
a3FileDateAndTime = _A3FileDateAndTime_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 3, 1, 3),
...
a3FileChecksum = _A3FileChecksum_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 3, 1, 4),
...
a3FileCrc1 = _A3FileCrc1_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 3, 1, 5),
    _A3FileCrc1_Type()
)
...
a3FileCrc2 = _A3FileCrc2_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 3, 1, 6),
    _A3FileCrc2_Type()
)
a3FileCrc2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    a3FileCrc2.setStatus("mandatory")
_A3FileIndex_Type = DmiInteger
_A3FileIndex_Object = MibTableColumn
a3FileIndex = _A3FileIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 3, 1, 7),
    _A3FileIndex_Type()
)
a3FileIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    a3FileIndex.setStatus("mandatory")
_TFieldReplaceableUnit_Object = MibTable
tFieldReplaceableUnit = _TFieldReplaceableUnit_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4)
)
if mibBuilder.loadTexts:
...
eFieldReplaceableUnit = _EFieldReplaceableUnit_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4, 1)
)
eFieldReplaceableUnit.setIndexNames(
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a4FruIndex"),
)
if mibBuilder.loadTexts:
...
a4FruIndex = _A4FruIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4, 1, 1),
    _A4FruIndex_Type()
)
...
a4DeviceGroupIndex = _A4DeviceGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4, 1, 2),
...
a4Description = _A4Description_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4, 1, 3),
    _A4Description_Type()
)
...
a4Manufacturer = _A4Manufacturer_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4, 1, 4),
...
a4Model = _A4Model_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4, 1, 5),
    _A4Model_Type()
)
...
a4PartNumber = _A4PartNumber_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4, 1, 6),
    _A4PartNumber_Type()
)
...
a4FruSerialNumber = _A4FruSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4, 1, 7),
...
a4RevisionLevel = _A4RevisionLevel_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4, 1, 8),
...
a4WarrantyStartDate = _A4WarrantyStartDate_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4, 1, 9),
...
a4WarrantyDuration = _A4WarrantyDuration_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4, 1, 10),
...
a4SupportPhoneNumber = _A4SupportPhoneNumber_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 4, 1, 11),
...
a5StorageDeviceIndex = _A5StorageDeviceIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 1),
...
a5Type = _A5Type_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 2),
    _A5Type_Type()
)
...
a5TypeDescription = _A5TypeDescription_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 3),
...
a5WorldwideIdentifierType = _A5WorldwideIdentifierType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 4),
...
a5WorldwideIdentifier = _A5WorldwideIdentifier_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 5),
...
a5Sub_identifier = _A5Sub_identifier_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 6),
...
a5MediaDataBlockSize = _A5MediaDataBlockSize_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 7),
...
a5FormattedMediaCapacity = _A5FormattedMediaCapacity_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 8),
...
a5RemovableDevice = _A5RemovableDevice_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 9),
...
a5DeviceLoaded = _A5DeviceLoaded_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 10),
...
a5RemovableMedia = _A5RemovableMedia_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 11),
...
a5MediaLoaded = _A5MediaLoaded_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 12),
    _A5MediaLoaded_Type()
)
...
a5Compression = _A5Compression_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 13),
    _A5Compression_Type()
)
...
a5Encryption = _A5Encryption_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 14),
    _A5Encryption_Type()
)
...
a5FruGroupIndex = _A5FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 15),
...
a5OperationalGroupIndex = _A5OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 5, 1, 16),
...
eStorageDevicesEvents = _EStorageDevicesEvents_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 6, 1)
)
eStorageDevicesEvents.setIndexNames(
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a6StorageDevicesEventType = _A6StorageDevicesEventType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 6, 1, 1),
...
a6EventSeverity = _A6EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 6, 1, 2),
...
a6EventIsStateBased = _A6EventIsStateBased_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 6, 1, 3),
...
a6EventStateKey = _A6EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 6, 1, 4),
...
a6AssociatedGroup = _A6AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 6, 1, 5),
...
a6EventSystem = _A6EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 6, 1, 6),
    _A6EventSystem_Type()
)
...
a6EventSubsystem = _A6EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 6, 1, 7),
...
eStorageController = _EStorageController_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 7, 1)
)
eStorageController.setIndexNames(
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a7ControllerIndex"),
)
if mibBuilder.loadTexts:
...
a7ControllerIndex = _A7ControllerIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 7, 1, 1),
...
a7Identification = _A7Identification_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 7, 1, 2),
...
a7WorldwideIdentifierType = _A7WorldwideIdentifierType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 7, 1, 3),
...
a7WorldwideIdentifier = _A7WorldwideIdentifier_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 7, 1, 4),
...
a7ProtectionManagement = _A7ProtectionManagement_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 7, 1, 5),
...
a7BusMaster = _A7BusMaster_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 7, 1, 6),
    _A7BusMaster_Type()
)
...
a7SecondsSinceLastPower_up = _A7SecondsSinceLastPower_up_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 7, 1, 7),
...
a7FruGroupIndex = _A7FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 7, 1, 8),
...
a7OperationalGroupIndex = _A7OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 7, 1, 9),
...
eStorageControllerEvents = _EStorageControllerEvents_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 8, 1)
)
eStorageControllerEvents.setIndexNames(
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a8AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a8StorageControllerEventType = _A8StorageControllerEventType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 8, 1, 1),
...
a8EventSeverity = _A8EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 8, 1, 2),
...
a8EventIsStateBased = _A8EventIsStateBased_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 8, 1, 3),
...
a8EventStateKey = _A8EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 8, 1, 4),
...
a8AssociatedGroup = _A8AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 8, 1, 5),
...
a8EventSystem = _A8EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 8, 1, 6),
    _A8EventSystem_Type()
)
...
a8EventSubsystem = _A8EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 8, 1, 7),
...
tBusPort = _TBusPort_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9)
)
if mibBuilder.loadTexts:
    tBusPort.setStatus("mandatory")
_EBusPort_Object = MibTableRow
eBusPort = _EBusPort_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1)
)
eBusPort.setIndexNames(
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a9BusPortIndex"),
)
if mibBuilder.loadTexts:
...
a9BusPortIndex = _A9BusPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 1),
...
a9Protocol = _A9Protocol_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 2),
    _A9Protocol_Type()
)
...
a9ProtocolDescription = _A9ProtocolDescription_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 3),
...
a9SignalCharacteristics = _A9SignalCharacteristics_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 4),
...
a9WorldwideIdentifierType = _A9WorldwideIdentifierType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 5),
...
a9WorldwideIdentifier = _A9WorldwideIdentifier_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 6),
...
a9AddressDescriptor = _A9AddressDescriptor_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 7),
...
a9Isochronous = _A9Isochronous_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 8),
    _A9Isochronous_Type()
)
...
a9MaximumWidth = _A9MaximumWidth_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 9),
...
a9MaximumTransferRate = _A9MaximumTransferRate_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 10),
...
a9MaximumNumberOfAttachments = _A9MaximumNumberOfAttachments_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 11),
...
a9ConnectorType = _A9ConnectorType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 12),
...
a9ConnectorTypeDescription = _A9ConnectorTypeDescription_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 13),
...
a9ConnectorGender = _A9ConnectorGender_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 14),
...
a9OperationalGroupIndex = _A9OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 15),
...
a9MassStorageStatisticsGroupIndex = _A9MassStorageStatisticsGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 9, 1, 16),
...
a10BusPortEventType = _A10BusPortEventType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 10, 1, 1),
...
a10EventSeverity = _A10EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 10, 1, 2),
...
a10EventIsStateBased = _A10EventIsStateBased_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 10, 1, 3),
...
a10EventStateKey = _A10EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 10, 1, 4),
...
a10AssociatedGroup = _A10AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 10, 1, 5),
...
a10EventSystem = _A10EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 10, 1, 6),
...
a10EventSubsystem = _A10EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 10, 1, 7),
...
eMassStorageAssociation = _EMassStorageAssociation_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 11, 1)
)
eMassStorageAssociation.setIndexNames(
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a11AssociationIndex"),
)
if mibBuilder.loadTexts:
...
a11AssociationIndex = _A11AssociationIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 11, 1, 1),
...
a11Type = _A11Type_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 11, 1, 2),
    _A11Type_Type()
)
...
a11Object1Type = _A11Object1Type_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 11, 1, 3),
...
a11Object1Index = _A11Object1Index_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 11, 1, 4),
...
a11Object2Type = _A11Object2Type_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 11, 1, 5),
...
a11Object2Index = _A11Object2Index_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 11, 1, 6),
...
eMassStorageAssociationEvents = _EMassStorageAssociationEvents_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 12, 1)
)
eMassStorageAssociationEvents.setIndexNames(
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a12AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a12MassStorageAssociationEventType = _A12MassStorageAssociationEventType_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 12, 1, 1),
...
a12EventSeverity = _A12EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 12, 1, 2),
...
a12EventIsStateBased = _A12EventIsStateBased_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 12, 1, 3),
...
a12EventStateKey = _A12EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 12, 1, 4),
...
a12AssociatedGroup = _A12AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 12, 1, 5),
...
a12EventSystem = _A12EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 12, 1, 6),
...
a12EventSubsystem = _A12EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 12, 1, 7),
...
eBusPortAssociation = _EBusPortAssociation_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 13, 1)
)
eBusPortAssociation.setIndexNames(
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a13BusPortAssociationIndex"),
)
if mibBuilder.loadTexts:
...
a13BusPortAssociationIndex = _A13BusPortAssociationIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 13, 1, 1),
...
a13NegotiatedSpeed = _A13NegotiatedSpeed_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 13, 1, 2),
...
a13NegotiatedWidth = _A13NegotiatedWidth_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 13, 1, 3),
...
a14OperationalStateInstanceIndex = _A14OperationalStateInstanceIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 14, 1, 1),
...
a14DeviceGroupIndex = _A14DeviceGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 14, 1, 2),
...
a14OperationalStatus = _A14OperationalStatus_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 14, 1, 3),
...
a14UsageState = _A14UsageState_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 14, 1, 4),
    _A14UsageState_Type()
)
...
a14AvailabilityStatus = _A14AvailabilityStatus_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 14, 1, 5),
...
a14AdministrativeState = _A14AdministrativeState_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 14, 1, 6),
...
a14FatalErrorCount = _A14FatalErrorCount_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 14, 1, 7),
...
a14MajorErrorCount = _A14MajorErrorCount_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 14, 1, 8),
...
a14WarningErrorCount = _A14WarningErrorCount_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 14, 1, 9),
...
a14CurrentErrorStatus = _A14CurrentErrorStatus_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 14, 1, 10),
...
a14DevicePredictedFailureStatus = _A14DevicePredictedFailureStatus_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 14, 1, 11),
...
_TSymsdmsmassstoragesystem_Object = MibTable
tSymsdmsmassstoragesystem = _TSymsdmsmassstoragesystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 15)
)
if mibBuilder.loadTexts:
    tSymsdmsmassstoragesystem.setStatus("mandatory")
_ESymsdmsmassstoragesystem_Object = MibTableRow
eSymsdmsmassstoragesystem = _ESymsdmsmassstoragesystem_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 15, 1)
)
eSymsdmsmassstoragesystem.setIndexNames(
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "DmiComponentIndex"),
    (0, "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a15SymDeviceIndex"),
)
if mibBuilder.loadTexts:
    eSymsdmsmassstoragesystem.setStatus("mandatory")
_A15SymDeviceIndex_Type = DmiInteger
_A15SymDeviceIndex_Object = MibTableColumn
a15SymDeviceIndex = _A15SymDeviceIndex_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 15, 1, 1),
    _A15SymDeviceIndex_Type()
)
a15SymDeviceIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    a15SymDeviceIndex.setStatus("mandatory")
_A15SymDeviceFlag_Type = DmiInteger
_A15SymDeviceFlag_Object = MibTableColumn
a15SymDeviceFlag = _A15SymDeviceFlag_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 15, 1, 2),
    _A15SymDeviceFlag_Type()
)
a15SymDeviceFlag.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    a15SymDeviceFlag.setStatus("mandatory")
...
a15SmartReportingCapability = _A15SmartReportingCapability_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 15, 1, 3),
...
a15SmartPollingPeriod = _A15SmartPollingPeriod_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 15, 1, 4),
...
a99MibName = _A99MibName_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 99, 1, 1),
    _A99MibName_Type()
)
...
a99MibOid = _A99MibOid_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 99, 1, 2),
    _A99MibOid_Type()
)
...
a99DisableTrap = _A99DisableTrap_Object(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 99, 1, 3),
...
trap1 = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 6, 1, 0, 1)
)
trap1.setObjects(
      *(("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6StorageDevicesEventType"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6EventSeverity"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6EventIsStateBased"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6EventStateKey"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6AssociatedGroup"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6EventSystem"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6EventSubsystem"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a5StorageDeviceIndex"))
)
if mibBuilder.loadTexts:
    trap1.setStatus(
        ""
...
trap2 = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 6, 1, 0, 2)
)
trap2.setObjects(
      *(("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6StorageDevicesEventType"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6EventSeverity"),
...
trap3 = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 6, 1, 0, 3)
)
trap3.setObjects(
      *(("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6StorageDevicesEventType"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6EventSeverity"),
...
trap4 = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 6, 1, 0, 4)
)
trap4.setObjects(
      *(("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6StorageDevicesEventType"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a6EventSeverity"),
...
trap5 = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 8, 1, 0, 1)
)
trap5.setObjects(
      *(("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a8StorageControllerEventType"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a8EventSeverity"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a8EventIsStateBased"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a8EventStateKey"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a8AssociatedGroup"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a8EventSystem"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a8EventSubsystem"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a7ControllerIndex"))
)
if mibBuilder.loadTexts:
    trap5.setStatus(
        ""
...
trap6 = NotificationType(
    (1, 3, 6, 1, 4, 1, 1123, 3, 1, 2, 4, 1, 8, 1, 0, 2)
)
trap6.setObjects(
      *(("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a8StorageControllerEventType"),
        ("SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB", "a8EventSeverity"),
...
mibBuilder.exportSymbols(
    "SYMBIOSSDMSMASSSTORAGESYSTEMMIFDEF2-MIB",
    **{"DmiCounter": DmiCounter,
       ...
       "tSoftwareSignature": tSoftwareSignature,
       "eSoftwareSignature": eSoftwareSignature,
       ...
       "tSymsdmsmassstoragesystem": tSymsdmsmassstoragesystem,
       "eSymsdmsmassstoragesystem": eSymsdmsmassstoragesystem,
       "a15SymDeviceIndex": a15SymDeviceIndex,
       "a15SymDeviceFlag": a15SymDeviceFlag,
