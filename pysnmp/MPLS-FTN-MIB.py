# SNMP MIB module (MPLS-FTN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/MPLS-FTN-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:23:00 2024
...
mplsFTNMIB = ModuleIdentity(
    (1, 3, 6, 1, 2, 1, 10, 9999, 5)
)
mplsFTNMIB.setRevisions(
        ("2003-04-30 12:00",)
)
...
class _MplsFTNAddrType_Type(InetAddressType):
    """Custom type mplsFTNAddrType based on InetAddressType"""


_MplsFTNAddrType_Object = MibTableColumn
mplsFTNAddrType = _MplsFTNAddrType_Object(
    (1, 3, 6, 1, 2, 1, 10, 9999, 5, 1, 3, 1, 5),
...
mplsFTNProtocol = _MplsFTNProtocol_Object(
    (1, 3, 6, 1, 2, 1, 10, 9999, 5, 1, 3, 1, 14),
...
mplsFTNDscp = _MplsFTNDscp_Object(
    (1, 3, 6, 1, 2, 1, 10, 9999, 5, 1, 3, 1, 15),
    _MplsFTNDscp_Type()
)
...
mplsFTNActionType = _MplsFTNActionType_Object(
    (1, 3, 6, 1, 2, 1, 10, 9999, 5, 1, 3, 1, 16),
...
mplsFTNMapEntry.setIndexNames(
    (0, "MPLS-FTN-MIB", "mplsFTNMapIndex"),
    (0, "MPLS-FTN-MIB", "mplsFTNMapPrevIndex"),
    (0, "MPLS-FTN-MIB", "mplsFTNMapCurrIndex"),
)
if mibBuilder.loadTexts:
...
mplsFTNPerfEntry.setIndexNames(
    (0, "MPLS-FTN-MIB", "mplsFTNPerfIndex"),
    (0, "MPLS-FTN-MIB", "mplsFTNPerfCurrIndex"),
)
if mibBuilder.loadTexts:
...
mplsFTNConformance = _MplsFTNConformance_ObjectIdentity(
    (1, 3, 6, 1, 2, 1, 10, 9999, 5, 2)
)
_MplsFTNGroups_ObjectIdentity = ObjectIdentity
mplsFTNGroups = _MplsFTNGroups_ObjectIdentity(
    (1, 3, 6, 1, 2, 1, 10, 9999, 5, 2, 1)
)
_MplsFTNCompliances_ObjectIdentity = ObjectIdentity
mplsFTNCompliances = _MplsFTNCompliances_ObjectIdentity(
    (1, 3, 6, 1, 2, 1, 10, 9999, 5, 2, 2)
)

# Managed Objects groups

mplsFTNRuleGroup = ObjectGroup(
    (1, 3, 6, 1, 2, 1, 10, 9999, 5, 2, 1, 1)
)
mplsFTNRuleGroup.setObjects(
      *(("MPLS-FTN-MIB", "mplsFTNIndexNext"),
        ("MPLS-FTN-MIB", "mplsFTNTableLastChanged"),
        ("MPLS-FTN-MIB", "mplsFTNRowStatus"),
        ("MPLS-FTN-MIB", "mplsFTNDescr"),
        ("MPLS-FTN-MIB", "mplsFTNMask"),
        ("MPLS-FTN-MIB", "mplsFTNAddrType"),
        ("MPLS-FTN-MIB", "mplsFTNSourceAddrMin"),
        ("MPLS-FTN-MIB", "mplsFTNSourceAddrMax"),
        ("MPLS-FTN-MIB", "mplsFTNDestAddrMin"),
        ("MPLS-FTN-MIB", "mplsFTNDestAddrMax"),
        ("MPLS-FTN-MIB", "mplsFTNSourcePortMin"),
        ("MPLS-FTN-MIB", "mplsFTNSourcePortMax"),
        ("MPLS-FTN-MIB", "mplsFTNDestPortMin"),
        ("MPLS-FTN-MIB", "mplsFTNDestPortMax"),
        ("MPLS-FTN-MIB", "mplsFTNProtocol"),
        ("MPLS-FTN-MIB", "mplsFTNActionType"),
        ("MPLS-FTN-MIB", "mplsFTNActionPointer"),
        ("MPLS-FTN-MIB", "mplsFTNDscp"),
        ("MPLS-FTN-MIB", "mplsFTNStorageType"))
)
if mibBuilder.loadTexts:
    mplsFTNRuleGroup.setStatus("current")

mplsFTNMapGroup = ObjectGroup(
    (1, 3, 6, 1, 2, 1, 10, 9999, 5, 2, 1, 2)
)
mplsFTNMapGroup.setObjects(
      *(("MPLS-FTN-MIB", "mplsFTNMapTableLastChanged"),
        ("MPLS-FTN-MIB", "mplsFTNMapRowStatus"),
        ("MPLS-FTN-MIB", "mplsFTNMapStorageType"))
)
if mibBuilder.loadTexts:
    mplsFTNMapGroup.setStatus("current")

mplsFTNPerfGroup = ObjectGroup(
    (1, 3, 6, 1, 2, 1, 10, 9999, 5, 2, 1, 3)
)
mplsFTNPerfGroup.setObjects(
      *(("MPLS-FTN-MIB", "mplsFTNPerfMatchedPackets"),
        ("MPLS-FTN-MIB", "mplsFTNPerfMatchedOctets"),
        ("MPLS-FTN-MIB", "mplsFTNPerfDiscontinuityTime"))
)
if mibBuilder.loadTexts:
