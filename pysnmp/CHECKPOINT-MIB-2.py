# SNMP MIB module (CHECKPOINT-MIB-2) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/CHECKPOINT-MIB-2
# Produced by pysmi-1.5.4 at Mon Oct 14 20:54:40 2024
...
atEntry.setIndexNames(
    (0, "CHECKPOINT-MIB-2", "atIfIndex"),
    (0, "CHECKPOINT-MIB-2", "atNetAddress"),
)
if mibBuilder.loadTexts:
...
ipAddrEntry.setIndexNames(
    (0, "CHECKPOINT-MIB-2", "ipAdEntAddr"),
)
if mibBuilder.loadTexts:
...
ipRouteEntry.setIndexNames(
    (0, "CHECKPOINT-MIB-2", "ipRouteDest"),
)
if mibBuilder.loadTexts:
...
ipNetToMediaEntry.setIndexNames(
    (0, "CHECKPOINT-MIB-2", "ipNetToMediaIfIndex"),
    (0, "CHECKPOINT-MIB-2", "ipNetToMediaNetAddress"),
)
if mibBuilder.loadTexts:
...
tcpConnEntry.setIndexNames(
    (0, "CHECKPOINT-MIB-2", "tcpConnLocalAddress"),
    (0, "CHECKPOINT-MIB-2", "tcpConnLocalPort"),
    (0, "CHECKPOINT-MIB-2", "tcpConnRemAddress"),
    (0, "CHECKPOINT-MIB-2", "tcpConnRemPort"),
)
if mibBuilder.loadTexts:
...
udpEntry.setIndexNames(
    (0, "CHECKPOINT-MIB-2", "udpLocalAddress"),
    (0, "CHECKPOINT-MIB-2", "udpLocalPort"),
)
if mibBuilder.loadTexts:
...
egpNeighEntry.setIndexNames(
    (0, "CHECKPOINT-MIB-2", "egpNeighAddr"),
)
if mibBuilder.loadTexts:
