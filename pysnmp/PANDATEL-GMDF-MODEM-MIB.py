# SNMP MIB module (PANDATEL-GMDF-MODEM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/PANDATEL-GMDF-MODEM-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:36:50 2024
...
_Gmdf_ObjectIdentity = ObjectIdentity
gmdf = _Gmdf_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206)
)
_GmdfModemTable_Object = MibTable
gmdfModemTable = _GmdfModemTable_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1)
)
if mibBuilder.loadTexts:
    gmdfModemTable.setStatus("mandatory")
_GmdfTableEntry_Object = MibTableRow
gmdfTableEntry = _GmdfTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1)
)
gmdfTableEntry.setIndexNames(
    (0, "PANDATEL-GMDF-MODEM-MIB", "mdmRack"),
    (0, "PANDATEL-GMDF-MODEM-MIB", "mdmModem"),
    (0, "PANDATEL-GMDF-MODEM-MIB", "mdmPosition"),
)
if mibBuilder.loadTexts:
    gmdfTableEntry.setStatus("mandatory")
_MdmRack_Type = Integer32
_MdmRack_Object = MibTableColumn
mdmRack = _MdmRack_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 1),
    _MdmRack_Type()
)
...
mdmModem = _MdmModem_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 2),
    _MdmModem_Type()
)
...
mdmPosition = _MdmPosition_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 3),
    _MdmPosition_Type()
)
...
mdmModemName = _MdmModemName_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 5),
    _MdmModemName_Type()
)
...
mdmInterfaceEmulationMode = _MdmInterfaceEmulationMode_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 6),
...
mdmModemProperty = _MdmModemProperty_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 7),
...
mdmHDSLUnit = _MdmHDSLUnit_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 10),
    _MdmHDSLUnit_Type()
)
...
mdmClockSystem = _MdmClockSystem_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 23),
...
mdmClockSource = _MdmClockSource_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 24),
...
mdmDataRate = _MdmDataRate_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 25),
    _MdmDataRate_Type()
)
...
mdmStartTimeslot = _MdmStartTimeslot_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 26),
...
mdmTimeslotSize = _MdmTimeslotSize_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 27),
...
mdmTimeslot16 = _MdmTimeslot16_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 40),
    _MdmTimeslot16_Type()
)
...
mdmCRC4Generation = _MdmCRC4Generation_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 41),
...
mdmFramingMode = _MdmFramingMode_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 50),
...
mdmScrambler = _MdmScrambler_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 63),
    _MdmScrambler_Type()
)
...
mdmRemoteAccessMode = _MdmRemoteAccessMode_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 64),
...
mdmCRC6Test = _MdmCRC6Test_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 100),
    _MdmCRC6Test_Type()
)
...
mdmCRC6Status = _MdmCRC6Status_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 101),
    _MdmCRC6Status_Type()
)
...
mdmCRC6Error = _MdmCRC6Error_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 206, 1, 1, 102),
    _MdmCRC6Error_Type()
)
mdmCRC6Error.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    mdmCRC6Error.setStatus("mandatory")
_Gmdf_modem_ObjectIdentity = ObjectIdentity
gmdf_modem = _Gmdf_modem_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 10000, 2, 206)
)
...
mibBuilder.exportSymbols(
    "PANDATEL-GMDF-MODEM-MIB",
    **{"gmdf": gmdf,
       "gmdfModemTable": gmdfModemTable,
       "gmdfTableEntry": gmdfTableEntry,
       "mdmRack": mdmRack,
       "mdmModem": mdmModem,
