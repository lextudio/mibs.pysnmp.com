# SNMP MIB module (PANDATEL-FHFLF-MODEM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/PANDATEL-FHFLF-MODEM-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:36:44 2024
...
_Fhflf_ObjectIdentity = ObjectIdentity
fhflf = _Fhflf_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102)
)
_FhflfModemTable_Object = MibTable
fhflfModemTable = _FhflfModemTable_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1)
)
if mibBuilder.loadTexts:
    fhflfModemTable.setStatus("mandatory")
_FhflfTableEntry_Object = MibTableRow
fhflfTableEntry = _FhflfTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1)
)
fhflfTableEntry.setIndexNames(
    (0, "PANDATEL-FHFLF-MODEM-MIB", "mdmRack"),
    (0, "PANDATEL-FHFLF-MODEM-MIB", "mdmModem"),
    (0, "PANDATEL-FHFLF-MODEM-MIB", "mdmPosition"),
)
if mibBuilder.loadTexts:
    fhflfTableEntry.setStatus("mandatory")
_MdmRack_Type = Integer32
_MdmRack_Object = MibTableColumn
mdmRack = _MdmRack_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 1),
    _MdmRack_Type()
)
...
mdmModem = _MdmModem_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 2),
    _MdmModem_Type()
)
...
mdmPosition = _MdmPosition_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 3),
    _MdmPosition_Type()
)
...
mdmModemName = _MdmModemName_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 5),
    _MdmModemName_Type()
)
...
mdmInterfaceEmulationMode = _MdmInterfaceEmulationMode_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 6),
...
mdmModemProperty = _MdmModemProperty_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 7),
...
mdmClockSystem = _MdmClockSystem_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 23),
...
mdmClockSource = _MdmClockSource_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 24),
...
mdmDataRate = _MdmDataRate_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 25),
    _MdmDataRate_Type()
)
...
mdmStartTimeslot = _MdmStartTimeslot_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 26),
...
mdmTimeslotSize = _MdmTimeslotSize_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 27),
...
mdmTimeslot16 = _MdmTimeslot16_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 40),
    _MdmTimeslot16_Type()
)
...
mdmCRC4Generation = _MdmCRC4Generation_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 41),
...
mdmFramingMode = _MdmFramingMode_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 50),
...
class _MdmLocalCarrierDetect_Type(Integer32):
    """Custom type mdmLocalCarrierDetect based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_MdmLocalCarrierDetect_Type.__name__ = "Integer32"
_MdmLocalCarrierDetect_Object = MibTableColumn
mdmLocalCarrierDetect = _MdmLocalCarrierDetect_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 60),
    _MdmLocalCarrierDetect_Type()
)
mdmLocalCarrierDetect.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
mdmFOPower = _MdmFOPower_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 71),
    _MdmFOPower_Type()
)
...
mdmCRC6Test = _MdmCRC6Test_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 100),
    _MdmCRC6Test_Type()
)
...
mdmCRC6Status = _MdmCRC6Status_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 101),
    _MdmCRC6Status_Type()
)
...
mdmCRC6Error = _MdmCRC6Error_Object(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 102, 1, 1, 102),
    _MdmCRC6Error_Type()
)
mdmCRC6Error.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    mdmCRC6Error.setStatus("mandatory")
_Fhflf_modem_ObjectIdentity = ObjectIdentity
fhflf_modem = _Fhflf_modem_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 760, 1, 1, 2, 1, 10, 10000, 2, 102)
)
...
mibBuilder.exportSymbols(
    ...
    **{"fhflf": fhflf,
       "fhflfModemTable": fhflfModemTable,
       "fhflfTableEntry": fhflfTableEntry,
       "mdmRack": mdmRack,
       "mdmModem": mdmModem,
