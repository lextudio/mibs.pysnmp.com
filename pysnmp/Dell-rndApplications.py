# SNMP MIB module (Dell-rndApplications) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Dell-rndApplications
# Produced by pysmi-1.5.4 at Mon Oct 14 21:35:40 2024
...
rndMonitoredElementEntry.setIndexNames(
    (0, "Dell-rndApplications", "rndMonitoredElementAddress"),
)
if mibBuilder.loadTexts:
...
rndMonitoringEntry.setIndexNames(
    (0, "Dell-rndApplications", "rndMonitoredElement"),
    (1, "Dell-rndApplications", "rndMonitoredObjectInstanceLabel"),
)
if mibBuilder.loadTexts:
...
rndMibFileEntry.setIndexNames(
    (0, "Dell-rndApplications", "rndMibFileIndex"),
)
if mibBuilder.loadTexts:
...
rndDeleteValuesEntry.setIndexNames(
    (1, "Dell-rndApplications", "rndRowStatusVariableName"),
)
if mibBuilder.loadTexts:
...
rndSimulatedVariablesEntry.setIndexNames(
    (0, "Dell-rndApplications", "rndSimulatedVariableEntryIndex"),
)
if mibBuilder.loadTexts:
...
rlMibTreeEntry.setIndexNames(
    (0, "Dell-rndApplications", "rlMibTreeFather"),
    (0, "Dell-rndApplications", "rlMibTreeSonIndex"),
)
if mibBuilder.loadTexts:
...
rlMibTableInstancesInfoEntry.setIndexNames(
    (1, "Dell-rndApplications", "rlMibTableInstancesInfoTableName"),
)
if mibBuilder.loadTexts:
...
rsPingEntry.setIndexNames(
    (0, "Dell-rndApplications", "rsPingAddress"),
)
if mibBuilder.loadTexts:
...
rsPingInetEntry.setIndexNames(
    (0, "Dell-rndApplications", "rsPingInetAddressType"),
    (0, "Dell-rndApplications", "rsPingInetAddress"),
)
if mibBuilder.loadTexts:
...
rsPowerSupplyRedundacyEntry.setIndexNames(
    (0, "Dell-rndApplications", "rsPowerSupplyRedundacyReNumber"),
)
if mibBuilder.loadTexts:
...
rsNvramApplEntry.setIndexNames(
    (0, "Dell-rndApplications", "rsNvramApplIndex"),
)
if mibBuilder.loadTexts:
