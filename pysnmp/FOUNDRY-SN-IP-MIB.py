...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/FOUNDRY-SN-IP-MIB
...
snVrrpIfEntry.setIndexNames(
    (0, "FOUNDRY-SN-IP-MIB", "snVrrpIfPort"),
)
if mibBuilder.loadTexts:
...
snVrrpVirRtrEntry.setIndexNames(
    (0, "FOUNDRY-SN-IP-MIB", "snVrrpVirRtrPort"),
    (0, "FOUNDRY-SN-IP-MIB", "snVrrpVirRtrId"),
)
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    snVrrpVirRtrTrackPortList.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    snVrrpVirRtrTrackVifPortList.setStatus("mandatory")
