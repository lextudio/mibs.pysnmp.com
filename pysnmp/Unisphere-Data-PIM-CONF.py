# SNMP MIB module (Unisphere-Data-PIM-CONF) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Unisphere-Data-PIM-CONF
...
(pimAssertGroup,
 ...
 pimV2MIBGroup) = mibBuilder.importSymbols(
    "PIM-MIB",
    "pimAssertGroup",
    "pimDenseV2MIBGroup",
    "pimNextHopGroup",
...
(usdPimAutoRPCandGroup,
 ...
 usdPimUnicastRouteGroup) = mibBuilder.importSymbols(
...
usdPimAgent = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 29)
)
usdPimAgent.setRevisions(
        ("2001-11-15 22:38",)
)
...
usdPimAgentV1 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 29, 1)
)
if mibBuilder.loadTexts:
    usdPimAgentV1.setProductRelease("""\
