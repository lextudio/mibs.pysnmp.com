# SNMP MIB module (ChrComPmOpticsOCH-Interval-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmOpticsOCH-Interval-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:17 2024
...
_ChrComPmOpticsOCH_IntervalTable_Object = MibTable
chrComPmOpticsOCH_IntervalTable = _ChrComPmOpticsOCH_IntervalTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14)
)
if mibBuilder.loadTexts:
    chrComPmOpticsOCH_IntervalTable.setStatus("current")
_ChrComPmOpticsOCH_IntervalEntry_Object = MibTableRow
chrComPmOpticsOCH_IntervalEntry = _ChrComPmOpticsOCH_IntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1)
)
chrComPmOpticsOCH_IntervalEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmOpticsOCH-Interval-MIB", "chrComPmOpticsIntervalNumber"),
)
if mibBuilder.loadTexts:
    chrComPmOpticsOCH_IntervalEntry.setStatus("current")
...
chrComPmOpticsIntervalNumber = _ChrComPmOpticsIntervalNumber_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 1),
...
chrComPmOpticsSuspectedIntrvl = _ChrComPmOpticsSuspectedIntrvl_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 2),
...
chrComPmOpticsElapsedTime = _ChrComPmOpticsElapsedTime_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 3),
...
chrComPmOpticsSuppressedIntrvls = _ChrComPmOpticsSuppressedIntrvls_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 4),
...
chrComPmOpticsORS_R = _ChrComPmOpticsORS_R_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 5),
...
chrComPmOpticsSES_R = _ChrComPmOpticsSES_R_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 6),
...
chrComPmOpticsUAS_R = _ChrComPmOpticsUAS_R_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 7),
...
chrComPmOpticsORS_S = _ChrComPmOpticsORS_S_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 8),
...
chrComPmOpticsSES_S = _ChrComPmOpticsSES_S_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 9),
...
chrComPmOpticsUAS_S = _ChrComPmOpticsUAS_S_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 10),
...
chrComPmOpticsMean_R = _ChrComPmOpticsMean_R_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 11),
...
chrComPmOpticsMax_R = _ChrComPmOpticsMax_R_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 12),
...
chrComPmOpticsMin_R = _ChrComPmOpticsMin_R_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 13),
...
chrComPmOpticsSD_R = _ChrComPmOpticsSD_R_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 14),
...
chrComPmOpticsMean_S = _ChrComPmOpticsMean_S_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 15),
...
chrComPmOpticsMax_S = _ChrComPmOpticsMax_S_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 16),
...
chrComPmOpticsMin_S = _ChrComPmOpticsMin_S_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 17),
...
chrComPmOpticsSD_S = _ChrComPmOpticsSD_S_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 14, 1, 18),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmOpticsOCH-IntervalTable": chrComPmOpticsOCH_IntervalTable,
       "chrComPmOpticsOCH-IntervalEntry": chrComPmOpticsOCH_IntervalEntry,
