# SNMP MIB module (S410-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/S410-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:48:59 2024
...
_S410_ObjectIdentity = ObjectIdentity
s410 = _S410_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 40)
)
...
esPointEntry.setIndexNames(
    (0, "S410-MIB", "esIndexES"),
    (0, "S410-MIB", "esIndexPC"),
    (0, "S410-MIB", "esIndexPoint"),
)
if mibBuilder.loadTexts:
...
contact1ActiveTrap.setObjects(
      *(("S410-MIB", "thisTrapText"),
        ("S410-MIB", "siteID"),
        ("S410-MIB", "contact1Name"),
        ("S410-MIB", "contact1State"))
)
if mibBuilder.loadTexts:
...
contact2ActiveTrap.setObjects(
      *(("S410-MIB", "thisTrapText"),
        ("S410-MIB", "siteID"),
        ("S410-MIB", "contact2Name"),
        ("S410-MIB", "contact2State"))
)
if mibBuilder.loadTexts:
...
contact3ActiveTrap.setObjects(
      *(("S410-MIB", "thisTrapText"),
        ("S410-MIB", "siteID"),
        ("S410-MIB", "contact3Name"),
        ("S410-MIB", "contact3State"))
)
if mibBuilder.loadTexts:
...
contact4ActiveTrap.setObjects(
      *(("S410-MIB", "thisTrapText"),
        ("S410-MIB", "siteID"),
        ("S410-MIB", "contact4Name"),
        ("S410-MIB", "contact4State"))
)
if mibBuilder.loadTexts:
...
contact5ActiveTrap.setObjects(
      *(("S410-MIB", "thisTrapText"),
        ("S410-MIB", "siteID"),
        ("S410-MIB", "contact5Name"),
        ("S410-MIB", "contact5State"))
)
if mibBuilder.loadTexts:
...
contact6ActiveTrap.setObjects(
      *(("S410-MIB", "thisTrapText"),
        ("S410-MIB", "siteID"),
        ("S410-MIB", "contact6Name"),
        ("S410-MIB", "contact6State"))
)
if mibBuilder.loadTexts:
...
contact7ActiveTrap.setObjects(
      *(("S410-MIB", "thisTrapText"),
        ("S410-MIB", "siteID"),
        ("S410-MIB", "contact7Name"),
        ("S410-MIB", "contact7State"))
)
if mibBuilder.loadTexts:
...
contact8ActiveTrap.setObjects(
      *(("S410-MIB", "thisTrapText"),
        ("S410-MIB", "siteID"),
        ("S410-MIB", "contact8Name"),
        ("S410-MIB", "contact8State"))
)
if mibBuilder.loadTexts:
...
contact9ActiveTrap.setObjects(
      *(("S410-MIB", "thisTrapText"),
        ("S410-MIB", "siteID"),
        ("S410-MIB", "contact9Name"),
        ("S410-MIB", "contact9State"))
)
if mibBuilder.loadTexts:
...
analog1HighTrap.setObjects(
      *(("S410-MIB", "thisTrapText"),
        ("S410-MIB", "siteID"),
        ("S410-MIB", "analog1Name"),
        ("S410-MIB", "analog1Value"))
)
if mibBuilder.loadTexts:
...
analog2HighTrap.setObjects(
      *(("S410-MIB", "thisTrapText"),
        ("S410-MIB", "siteID"),
        ("S410-MIB", "analog2Name"),
        ("S410-MIB", "analog2Value"))
)
if mibBuilder.loadTexts:
...
contactESActiveTrap.setObjects(
      *(("S410-MIB", "thisTrapText"),
        ("S410-MIB", "siteID"),
        ("S410-MIB", "esPointName"),
        ("S410-MIB", "esPointValueInt"),
        ("S410-MIB", "esIndexES"),
        ("S410-MIB", "esIndexPoint"))
)
if mibBuilder.loadTexts:
