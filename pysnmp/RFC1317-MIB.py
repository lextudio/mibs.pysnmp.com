# SNMP MIB module (RFC1317-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/RFC1317-MIB
...
rs232AsyncPortEntry.setIndexNames(
    (0, "RFC1317-MIB", "rs232AsyncPortIndex"),
)
if mibBuilder.loadTexts:
...
rs232SyncPortEntry.setIndexNames(
    (0, "RFC1317-MIB", "rs232SyncPortIndex"),
)
if mibBuilder.loadTexts:
...
rs232InSigEntry.setIndexNames(
    (0, "RFC1317-MIB", "rs232InSigPortIndex"),
    (0, "RFC1317-MIB", "rs232InSigName"),
)
if mibBuilder.loadTexts:
...
rs232OutSigEntry.setIndexNames(
    (0, "RFC1317-MIB", "rs232OutSigPortIndex"),
    (0, "RFC1317-MIB", "rs232OutSigName"),
)
if mibBuilder.loadTexts:
