# SNMP MIB module (NOKIA-ENHANCED-SNMP-SOLUTION-SUITE-COMMON-DEFINITION) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/NOKIA-ENHANCED-SNMP-SOLUTION-SUITE-COMMON-DEFINITION
...
noiSnmpAlarmIrpCommon = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 94, 7, 1, 1, 1)
)
noiSnmpAlarmIrpCommon.setRevisions(
        ("2002-11-01 00:00",)
)
...
class NoiAcknowledgementState(Integer32, TextualConvention):
    status = "current"
...
class NoiAcknowledgementTime(DateAndTime, TextualConvention):
    status = "current"


class NoiAcknowledgementUserId(DisplayString, TextualConvention):
    status = "current"
...
class NoiAdditionalText(DisplayString, TextualConvention):
    status = "current"
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
class NoiAlarmId(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
class NoiAlarmLogControl(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class NoiAlarmLogCount(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
class NoiAlarmTableCount(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 2147483647),
...
class NoiAlarmText(DisplayString, TextualConvention):
    status = "current"
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
...
class NoiEventTime(DateAndTime, TextualConvention):
    status = "current"


class NoiEventType(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class NoiLogFullAction(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class NoiNotificationId(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
...
class NoiNotificationType(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class NoiPerceivedSeverity(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class NoiProbableCause(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class NoiSpecificProblem(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
class NoiSystemDistinguishedName(DisplayString, TextualConvention):
    status = "current"
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
mibBuilder.exportSymbols(
    ...
    **{"NoiAcknowledgementState": NoiAcknowledgementState,
       "NoiAcknowledgementTime": NoiAcknowledgementTime,
       "NoiAcknowledgementUserId": NoiAcknowledgementUserId,
       "NoiAdditionalText": NoiAdditionalText,
       ...
       "NoiEventTime": NoiEventTime,
       "NoiEventType": NoiEventType,
       "NoiLogFullAction": NoiLogFullAction,
       "NoiNotificationId": NoiNotificationId,
       "NoiNotificationType": NoiNotificationType,
       "NoiPerceivedSeverity": NoiPerceivedSeverity,
       "NoiProbableCause": NoiProbableCause,
       "NoiSpecificProblem": NoiSpecificProblem,
       "NoiSystemDistinguishedName": NoiSystemDistinguishedName,
       "noiSnmpAlarmIrpCommon": noiSnmpAlarmIrpCommon}
)
