# SNMP MIB module (Dell-DHCPv6-CLIENT) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Dell-DHCPv6-CLIENT
# Produced by pysmi-1.5.4 at Mon Oct 14 21:34:21 2024
...
rlDhcpv6ClientEntry.setIndexNames(
    (0, "Dell-DHCPv6-CLIENT", "rlDhcpv6ClientIfIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpv6ClientAuxDnsServerListEntry.setIndexNames(
    (0, "Dell-DHCPv6-CLIENT", "rlDhcpv6ClientAuxDnsServerListIfIndex"),
    (0, "Dell-DHCPv6-CLIENT", "rlDhcpv6ClientAuxDnsServerListPriority"),
)
if mibBuilder.loadTexts:
...
rlDhcpv6ClientAuxSntpServerListEntry.setIndexNames(
    (0, "Dell-DHCPv6-CLIENT", "rlDhcpv6ClientAuxSntpServerListIfIndex"),
    (0, "Dell-DHCPv6-CLIENT", "rlDhcpv6ClientAuxSntpServerListPriority"),
)
if mibBuilder.loadTexts:
...
rlDhcpv6ClientAuxDomainNameSearchListEntry.setIndexNames(
    (0, "Dell-DHCPv6-CLIENT", "rlDhcpv6ClientAuxDomainNameSearchListIfIndex"),
    (0, "Dell-DHCPv6-CLIENT", "rlDhcpv6ClientAuxDomainNameSearchListPriority"),
)
if mibBuilder.loadTexts:
...
rlDhcpv6ClientCommandEntry.setIndexNames(
    (0, "Dell-DHCPv6-CLIENT", "rlDhcpv6ClientCommandIfIndex"),
)
if mibBuilder.loadTexts:
