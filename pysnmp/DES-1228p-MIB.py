...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DES-1228P-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:24:38 2024
...
igsQuerierStateOnOff = _IgsQuerierStateOnOff_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 3, 22, 1, 18),
...
dot1pPortIndex = _Dot1pPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 3, 26, 3, 1, 1),
...
dot1pPortPriority = _Dot1pPortPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 3, 26, 3, 1, 2),
...
dscpIndex = _DscpIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 3, 26, 4, 1, 1),
    _DscpIndex_Type()
)
...
dscpPriority = _DscpPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 3, 26, 4, 1, 2),
    _DscpPriority_Type()
)
...
broadcastStormCtrlGlobalOnOff = _BroadcastStormCtrlGlobalOnOff_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 3, 27, 3, 1),
...
broadcastStormGlobalThreshold = _BroadcastStormGlobalThreshold_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 3, 27, 3, 2),
...
trustedHostOnOff = _TrustedHostOnOff_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 3, 28, 1, 1),
...
trustedHostID = _TrustedHostID_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 3, 28, 1, 2, 1, 1),
    _TrustedHostID_Type()
)
...
trustedHostIpAddress = _TrustedHostIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 3, 28, 1, 2, 1, 2),
...
trustedHostIpMask = _TrustedHostIpMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 3, 28, 1, 2, 1, 3),
...
trustedHostStatus = _TrustedHostStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 3, 28, 1, 2, 1, 4),
