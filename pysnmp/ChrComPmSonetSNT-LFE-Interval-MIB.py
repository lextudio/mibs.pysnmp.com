# SNMP MIB module (ChrComPmSonetSNT-LFE-Interval-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmSonetSNT-LFE-Interval-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:33 2024
...
_ChrComPmSonetSNT_LFE_IntervalTable_Object = MibTable
chrComPmSonetSNT_LFE_IntervalTable = _ChrComPmSonetSNT_LFE_IntervalTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 8)
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_LFE_IntervalTable.setStatus("current")
_ChrComPmSonetSNT_LFE_IntervalEntry_Object = MibTableRow
chrComPmSonetSNT_LFE_IntervalEntry = _ChrComPmSonetSNT_LFE_IntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 8, 1)
)
chrComPmSonetSNT_LFE_IntervalEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmSonetSNT-LFE-Interval-MIB", "chrComPmSonetIntervalNumber"),
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_LFE_IntervalEntry.setStatus("current")
...
mibBuilder.exportSymbols(
    "ChrComPmSonetSNT-LFE-Interval-MIB",
    **{"chrComPmSonetSNT-LFE-IntervalTable": chrComPmSonetSNT_LFE_IntervalTable,
       "chrComPmSonetSNT-LFE-IntervalEntry": chrComPmSonetSNT_LFE_IntervalEntry,
