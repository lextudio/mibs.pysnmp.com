# SNMP MIB module (DKSF-253-6-X-A-X) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DKSF-253-6-X-A-X
# Produced by pysmi-1.5.4 at Mon Oct 14 21:29:21 2024
...
npElecEntry.setIndexNames(
    (0, "DKSF-253-6-X-A-X", "npElecIndex"),
)
if mibBuilder.loadTexts:
...
npIoTrap.setObjects(
      *(("DKSF-253-6-X-A-X", "npIoTrapLineN"),
        ("DKSF-253-6-X-A-X", "npIoTrapLevelIn"),
        ("DKSF-253-6-X-A-X", "npIoTrapMemo"),
        ("DKSF-253-6-X-A-X", "npIoTrapLevelIn1"),
        ("DKSF-253-6-X-A-X", "npIoTrapLevelIn2"),
        ("DKSF-253-6-X-A-X", "npIoTrapLevelIn3"),
        ("DKSF-253-6-X-A-X", "npIoTrapLevelIn4"))
)
if mibBuilder.loadTexts:
    npIoTrap.setStatus(
        "current"
