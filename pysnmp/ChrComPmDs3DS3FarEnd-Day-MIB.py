# SNMP MIB module (ChrComPmDs3DS3FarEnd-Day-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmDs3DS3FarEnd-Day-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:11 2024
...
_ChrComPmDs3DS3FarEnd_DayTable_Object = MibTable
chrComPmDs3DS3FarEnd_DayTable = _ChrComPmDs3DS3FarEnd_DayTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14)
)
if mibBuilder.loadTexts:
    chrComPmDs3DS3FarEnd_DayTable.setStatus("current")
_ChrComPmDs3DS3FarEnd_DayEntry_Object = MibTableRow
chrComPmDs3DS3FarEnd_DayEntry = _ChrComPmDs3DS3FarEnd_DayEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1)
)
chrComPmDs3DS3FarEnd_DayEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmDs3DS3FarEnd-Day-MIB", "chrComPmDs3DayNumber"),
)
if mibBuilder.loadTexts:
    chrComPmDs3DS3FarEnd_DayEntry.setStatus("current")
...
chrComPmDs3DayNumber = _ChrComPmDs3DayNumber_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1, 1),
...
chrComPmDs3SuspectedInterval = _ChrComPmDs3SuspectedInterval_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1, 2),
...
chrComPmDs3ElapsedTime = _ChrComPmDs3ElapsedTime_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1, 3),
...
chrComPmDs3SuppressedIntrvls = _ChrComPmDs3SuppressedIntrvls_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1, 4),
...
chrComPmDs3CCV = _ChrComPmDs3CCV_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1, 5),
...
chrComPmDs3CES = _ChrComPmDs3CES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1, 6),
...
chrComPmDs3CSES = _ChrComPmDs3CSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1, 7),
...
chrComPmDs3SAS = _ChrComPmDs3SAS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1, 8),
...
chrComPmDs3UASCP = _ChrComPmDs3UASCP_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1, 9),
...
chrComPmDs3ESPLCP = _ChrComPmDs3ESPLCP_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1, 10),
...
chrComPmDs3ThresholdProfIndex = _ChrComPmDs3ThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1, 11),
...
chrComPmDs3ResetPmCountersAction = _ChrComPmDs3ResetPmCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 3, 14, 1, 12),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmDs3DS3FarEnd-DayTable": chrComPmDs3DS3FarEnd_DayTable,
       "chrComPmDs3DS3FarEnd-DayEntry": chrComPmDs3DS3FarEnd_DayEntry,
