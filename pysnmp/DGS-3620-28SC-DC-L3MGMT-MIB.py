...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DGS-3620-28SC-DC-L3MGMT-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:27:33 2024
...
swL3IpCtrlIpDhcpOption12State = _SwL3IpCtrlIpDhcpOption12State_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 2, 1, 3, 1, 22),
...
swL3IpCtrlIpDhcpOption12HostName = _SwL3IpCtrlIpDhcpOption12HostName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 2, 1, 3, 1, 23),
...
swL3IpCtrlIpv6AutoConfigState = _SwL3IpCtrlIpv6AutoConfigState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 2, 1, 3, 1, 28),
...
swL3IpCtrlIpv6AutoConfigDefault = _SwL3IpCtrlIpv6AutoConfigDefault_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 2, 1, 3, 1, 29),
...
swL3IpCtrlDhcpv6ClientRapidCommit = _SwL3IpCtrlDhcpv6ClientRapidCommit_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 2, 1, 3, 1, 30),
...
swL3IpCtrlDhcpv6ClientPDRapidCommit = _SwL3IpCtrlDhcpv6ClientPDRapidCommit_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 2, 1, 3, 1, 31),
...
class _SwL3ospfIfBfdStatus_Type(Integer32):
    """Custom type swL3ospfIfBfdStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwL3ospfIfBfdStatus_Type.__name__ = "Integer32"
_SwL3ospfIfBfdStatus_Object = MibTableColumn
swL3ospfIfBfdStatus = _SwL3ospfIfBfdStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 8, 1, 26),
    _SwL3ospfIfBfdStatus_Type()
)
swL3ospfIfBfdStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swL3ospfIfBfdStatus.setStatus("current")
...
class _SwL3VrrpOperBfdPeerAddr_Type(IpAddress):
    """Custom type swL3VrrpOperBfdPeerAddr based on IpAddress"""
    defaultHexValue = "00000000"


_SwL3VrrpOperBfdPeerAddr_Object = MibTableColumn
swL3VrrpOperBfdPeerAddr = _SwL3VrrpOperBfdPeerAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 14, 1, 1, 17),
    _SwL3VrrpOperBfdPeerAddr_Type()
)
swL3VrrpOperBfdPeerAddr.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    swL3VrrpOperBfdPeerAddr.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"NodeAddress": NodeAddress,
       ...
       "swL3ospfIfBfdStatus": swL3ospfIfBfdStatus,
       ...
       "swL3VrrpOperBfdPeerAddr": swL3VrrpOperBfdPeerAddr,
