...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DGS-3420-28TC-L3MGMT-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:27:23 2024
...
swL3DevCtrlOSPFState = _SwL3DevCtrlOSPFState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 1, 1, 2),
...
swL3DevCtrlDVMRPState = _SwL3DevCtrlDVMRPState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 1, 1, 3),
...
swL3IpCtrlIpv6AutoConfigState = _SwL3IpCtrlIpv6AutoConfigState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 1, 3, 1, 28),
...
swL3IpCtrlIpv6AutoConfigDefault = _SwL3IpCtrlIpv6AutoConfigDefault_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 1, 3, 1, 29),
...
swL3IpCtrlDhcpv6ClientRapidCommit = _SwL3IpCtrlDhcpv6ClientRapidCommit_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 1, 3, 1, 30),
...
swL3IpCtrlDhcpv6ClientPdRapidCommit = _SwL3IpCtrlDhcpv6ClientPdRapidCommit_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 1, 3, 1, 31),
...
swL3Ipv6CtrlDadRetransNum = _SwL3Ipv6CtrlDadRetransNum_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 1, 4, 1, 14),
...
swL3Ipv6CtrlOptimisticDadState = _SwL3Ipv6CtrlOptimisticDadState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 1, 4, 2),
...
swL3LoopBackIpv6CtrlTable = _SwL3LoopBackIpv6CtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 1, 9)
)
if mibBuilder.loadTexts:
...
swL3LoopBackIpv6CtrlEntry = _SwL3LoopBackIpv6CtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 1, 9, 1)
)
swL3LoopBackIpv6CtrlEntry.setIndexNames(
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3LoopBackIpv6CtrlInterfaceName"),
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3LoopBackIpv6CtrlIpv6Address"),
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3LoopBackIpv6CtrlIpv6PrefixLen"),
)
if mibBuilder.loadTexts:
...
swL3LoopBackIpv6CtrlInterfaceName = _SwL3LoopBackIpv6CtrlInterfaceName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 1, 9, 1, 1),
...
swL3LoopBackIpv6CtrlIpv6Address = _SwL3LoopBackIpv6CtrlIpv6Address_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 1, 9, 1, 2),
...
swL3LoopBackIpv6CtrlIpv6PrefixLen = _SwL3LoopBackIpv6CtrlIpv6PrefixLen_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 1, 9, 1, 3),
...
swL3LoopBackIpv6CtrlRowStatus = _SwL3LoopBackIpv6CtrlRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 1, 9, 1, 99),
...
swL3IpMcastStaticRouteTable = _SwL3IpMcastStaticRouteTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 6, 1)
)
if mibBuilder.loadTexts:
...
swL3IpMcastStaticRouteEntry = _SwL3IpMcastStaticRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 6, 1, 1)
)
swL3IpMcastStaticRouteEntry.setIndexNames(
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3IpMcastStaticRouteIpmrouteAddr"),
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3IpMcastStaticRouteIpmrouteMask"),
)
if mibBuilder.loadTexts:
...
swL3IpMcastStaticRouteIpmrouteAddr = _SwL3IpMcastStaticRouteIpmrouteAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 6, 1, 1, 1),
...
swL3IpMcastStaticRouteIpmrouteMask = _SwL3IpMcastStaticRouteIpmrouteMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 6, 1, 1, 2),
...
swL3IpMcastStaticRouteRpfAddr = _SwL3IpMcastStaticRouteRpfAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 6, 1, 1, 3),
...
swL3IpMcastStaticRouteRowStatus = _SwL3IpMcastStaticRouteRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 2, 6, 1, 1, 4),
...
swL3Md5KeyId = _SwL3Md5KeyId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 4, 1, 1),
    _SwL3Md5KeyId_Type()
)
...
swL3Md5Key = _SwL3Md5Key_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 4, 1, 2),
    _SwL3Md5Key_Type()
)
...
swL3Md5RowStatus = _SwL3Md5RowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 4, 1, 3),
...
swL3RouteRedistriRouteMapName = _SwL3RouteRedistriRouteMapName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 5, 1, 6),
...
swL3OspfHostTable = _SwL3OspfHostTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 6)
)
if mibBuilder.loadTexts:
    swL3OspfHostTable.setStatus("current")
_SwL3OspfHostEntry_Object = MibTableRow
swL3OspfHostEntry = _SwL3OspfHostEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 6, 1)
)
swL3OspfHostEntry.setIndexNames(
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3OspfHostIpAddress"),
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3OspfHostTOS"),
)
if mibBuilder.loadTexts:
...
swL3OspfHostIpAddress = _SwL3OspfHostIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 6, 1, 1),
...
swL3OspfHostTOS = _SwL3OspfHostTOS_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 6, 1, 2),
...
swL3OspfHostMetric = _SwL3OspfHostMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 6, 1, 3),
...
swL3OspfHostAreaID = _SwL3OspfHostAreaID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 6, 1, 4),
...
swL3OspfHostStatus = _SwL3OspfHostStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 6, 1, 5),
...
swL3ospfVirtIfEntry = _SwL3ospfVirtIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1)
)
swL3ospfVirtIfEntry.setIndexNames(
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3ospfVirtIfAreaId"),
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3ospfVirtIfNeighbor"),
)
if mibBuilder.loadTexts:
...
swL3ospfVirtIfAreaId = _SwL3ospfVirtIfAreaId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1, 1),
...
swL3ospfVirtIfNeighbor = _SwL3ospfVirtIfNeighbor_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1, 2),
...
swL3ospfVirtIfTransitDelay = _SwL3ospfVirtIfTransitDelay_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1, 3),
...
swL3ospfVirtIfRetransInterval = _SwL3ospfVirtIfRetransInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1, 4),
...
swL3ospfVirtIfHelloInterval = _SwL3ospfVirtIfHelloInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1, 5),
...
swL3ospfVirtIfRtrDeadInterval = _SwL3ospfVirtIfRtrDeadInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1, 6),
...
swL3ospfVirtIfState = _SwL3ospfVirtIfState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1, 7),
...
swL3ospfVirtIfEvents = _SwL3ospfVirtIfEvents_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1, 8),
...
swL3ospfVirtIfAuthType = _SwL3ospfVirtIfAuthType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1, 9),
...
swL3ospfVirtIfAuthKey = _SwL3ospfVirtIfAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1, 10),
...
swL3ospfVirtIfAuthKeyID = _SwL3ospfVirtIfAuthKeyID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1, 11),
...
swL3ospfVirtIfStatus = _SwL3ospfVirtIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 7, 1, 12),
...
swL3ospfIfTable = _SwL3ospfIfTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8)
)
if mibBuilder.loadTexts:
    swL3ospfIfTable.setStatus("current")
_SwL3ospfIfEntry_Object = MibTableRow
swL3ospfIfEntry = _SwL3ospfIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1)
)
swL3ospfIfEntry.setIndexNames(
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3ospfIfIpAddress"),
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3ospfAddressLessIf"),
)
if mibBuilder.loadTexts:
...
swL3ospfIfIpAddress = _SwL3ospfIfIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 1),
...
swL3ospfAddressLessIf = _SwL3ospfAddressLessIf_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 2),
...
swL3ospfIfAreaId = _SwL3ospfIfAreaId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 3),
...
swL3ospfIfType = _SwL3ospfIfType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 4),
...
swL3ospfIfAdminStat = _SwL3ospfIfAdminStat_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 5),
...
swL3ospfIfRtrPriority = _SwL3ospfIfRtrPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 6),
...
swL3ospfIfTransitDelay = _SwL3ospfIfTransitDelay_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 7),
...
swL3ospfIfRetransInterval = _SwL3ospfIfRetransInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 8),
...
swL3ospfIfHelloInterval = _SwL3ospfIfHelloInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 9),
...
swL3ospfIfRtrDeadInterval = _SwL3ospfIfRtrDeadInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 10),
...
swL3ospfIfPollInterval = _SwL3ospfIfPollInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 11),
...
swL3ospfIfState = _SwL3ospfIfState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 12),
...
swL3ospfIfDesignatedRouter = _SwL3ospfIfDesignatedRouter_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 13),
...
swL3ospfIfBackupDesignatedRouter = _SwL3ospfIfBackupDesignatedRouter_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 14),
...
swL3ospfIfEvents = _SwL3ospfIfEvents_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 15),
...
swL3ospfIfMulticastForwarding = _SwL3ospfIfMulticastForwarding_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 16),
...
swL3ospfIfDemand = _SwL3ospfIfDemand_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 17),
...
swL3ospfIfAuthType = _SwL3ospfIfAuthType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 18),
...
swL3ospfIfAuthKey = _SwL3ospfIfAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 19),
...
swL3ospfIfAuthKeyID = _SwL3ospfIfAuthKeyID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 20),
...
swL3ospfIfPassiveMode = _SwL3ospfIfPassiveMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 21),
...
swL3ospfIfMetric = _SwL3ospfIfMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 23),
...
swL3ospfIfDistributeListInType = _SwL3ospfIfDistributeListInType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 24),
...
swL3ospfIfDistributeListInName = _SwL3ospfIfDistributeListInName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 8, 1, 25),
...
swL3RoutePreferenceOSPFIntra = _SwL3RoutePreferenceOSPFIntra_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 9, 2),
...
swL3RoutePreferenceOSPFInter = _SwL3RoutePreferenceOSPFInter_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 9, 5),
...
swL3RoutePreferenceOSPFExtT1 = _SwL3RoutePreferenceOSPFExtT1_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 9, 6),
...
swL3RoutePreferenceOSPFExtT2 = _SwL3RoutePreferenceOSPFExtT2_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 9, 7),
...
swL3ospfAreaId = _SwL3ospfAreaId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 10, 1, 1),
...
swL3ospfAreaType = _SwL3ospfAreaType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 10, 1, 2),
...
swL3ospfAreaSummaryState = _SwL3ospfAreaSummaryState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 10, 1, 3),
...
swL3ospfAreaMetric = _SwL3ospfAreaMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 10, 1, 4),
...
swL3ospfAreaTranslateState = _SwL3ospfAreaTranslateState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 10, 1, 5),
...
swL3ospfAreaStatus = _SwL3ospfAreaStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 10, 1, 6),
...
swL3dvmrpInterfaceEntry = _SwL3dvmrpInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 12, 1)
)
swL3dvmrpInterfaceEntry.setIndexNames(
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3dvmrpInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
swL3dvmrpInterfaceIfIndex = _SwL3dvmrpInterfaceIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 12, 1, 1),
...
swL3dvmrpInterfaceLocalAddress = _SwL3dvmrpInterfaceLocalAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 12, 1, 2),
...
swL3dvmrpInterfaceMetric = _SwL3dvmrpInterfaceMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 12, 1, 3),
...
swL3dvmrpInterfaceProbe = _SwL3dvmrpInterfaceProbe_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 12, 1, 4),
...
swL3dvmrpInterfaceNbrTimeout = _SwL3dvmrpInterfaceNbrTimeout_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 12, 1, 5),
...
swL3dvmrpInterfaceStatus = _SwL3dvmrpInterfaceStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 12, 1, 6),
...
swL3dvmrpInterfaceRcvBadPkts = _SwL3dvmrpInterfaceRcvBadPkts_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 12, 1, 7),
...
swL3dvmrpInterfaceRcvBadRoutes = _SwL3dvmrpInterfaceRcvBadRoutes_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 12, 1, 8),
...
swL3OspfInternalLsdbTable = _SwL3OspfInternalLsdbTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 1)
)
if mibBuilder.loadTexts:
...
swL3OspfInternalLsdbEntry = _SwL3OspfInternalLsdbEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 1, 1)
)
swL3OspfInternalLsdbEntry.setIndexNames(
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3OspfInternalLsdbAreaId"),
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3OspfInternalLsdbType"),
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3OspfInternalLsdbLsid"),
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3OspfInternalLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
swL3OspfInternalLsdbAreaId = _SwL3OspfInternalLsdbAreaId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 1, 1, 1),
...
swL3OspfInternalLsdbType = _SwL3OspfInternalLsdbType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 1, 1, 2),
...
swL3OspfInternalLsdbLsid = _SwL3OspfInternalLsdbLsid_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 1, 1, 3),
...
swL3OspfInternalLsdbRouterId = _SwL3OspfInternalLsdbRouterId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 1, 1, 4),
...
swL3OspfInternalLsdbMetric = _SwL3OspfInternalLsdbMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 1, 1, 5),
...
swL3OspfInternalLsdbSequenceNo = _SwL3OspfInternalLsdbSequenceNo_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 1, 1, 6),
...
swL3OspfInternalLsdbAge = _SwL3OspfInternalLsdbAge_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 1, 1, 7),
...
swL3OspfInternalLsdbChecksum = _SwL3OspfInternalLsdbChecksum_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 1, 1, 8),
...
swL3OspfExternalLsdbTable = _SwL3OspfExternalLsdbTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 2)
)
if mibBuilder.loadTexts:
...
swL3OspfExternalLsdbEntry = _SwL3OspfExternalLsdbEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 2, 1)
)
swL3OspfExternalLsdbEntry.setIndexNames(
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3OspfExternalLsdbType"),
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3OspfExternalLsdbLsid"),
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3OspfExternalLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
swL3OspfExternalLsdbType = _SwL3OspfExternalLsdbType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 2, 1, 1),
...
swL3OspfExternalLsdbLsid = _SwL3OspfExternalLsdbLsid_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 2, 1, 2),
...
swL3OspfExternalLsdbRouterId = _SwL3OspfExternalLsdbRouterId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 2, 1, 3),
...
swL3OspfExternalLsdbMetric = _SwL3OspfExternalLsdbMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 2, 1, 4),
...
swL3OspfExternalLsdbMetricType = _SwL3OspfExternalLsdbMetricType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 2, 1, 5),
...
swL3OspfExternalLsdbSequenceNo = _SwL3OspfExternalLsdbSequenceNo_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 2, 1, 6),
...
swL3OspfExternalLsdbAge = _SwL3OspfExternalLsdbAge_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 2, 1, 7),
...
swL3OspfExternalLsdbChecksum = _SwL3OspfExternalLsdbChecksum_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 2, 1, 8),
...
swL3OspfExternalLsdbForwardingAddress = _SwL3OspfExternalLsdbForwardingAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 2, 1, 9),
...
swL3OspfExternalLsdbRouteTag = _SwL3OspfExternalLsdbRouteTag_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 13, 2, 1, 10),
...
swL3OspfECMPIpDestination = _SwL3OspfECMPIpDestination_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 15, 1),
...
swL3OspfECMPIpSource = _SwL3OspfECMPIpSource_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 15, 2),
...
swL3OspfECMPCrcLow = _SwL3OspfECMPCrcLow_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 15, 3),
...
swL3OspfECMPCrcHigh = _SwL3OspfECMPCrcHigh_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 15, 4),
...
swL3OspfECMPTCPorUDPport = _SwL3OspfECMPTCPorUDPport_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 15, 5),
...
swL3OspfECMPState = _SwL3OspfECMPState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 15, 6),
...
swL3OspfDefInfoOriginate = _SwL3OspfDefInfoOriginate_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 18, 1),
...
swL3OspfDefInfoOrigMetricType = _SwL3OspfDefInfoOrigMetricType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 18, 2),
...
swL3OspfDefInfoOrigMetric = _SwL3OspfDefInfoOrigMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 18, 3),
...
swL3RIPInboundRouteFilterEntry = _SwL3RIPInboundRouteFilterEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 19, 1)
)
swL3RIPInboundRouteFilterEntry.setIndexNames(
    (0, "DGS-3420-28TC-L3MGMT-MIB", "swL3RIPInboundRouteFilterIfIpAddress"),
)
if mibBuilder.loadTexts:
...
swL3RIPInboundRouteFilterIfIpAddress = _SwL3RIPInboundRouteFilterIfIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 19, 1, 1),
...
swL3RIPInboundRouteFilterType = _SwL3RIPInboundRouteFilterType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 19, 1, 2),
...
swL3RIPInboundRouteFilterName = _SwL3RIPInboundRouteFilterName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 3, 19, 1, 3),
