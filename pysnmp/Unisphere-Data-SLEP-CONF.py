# SNMP MIB module (Unisphere-Data-SLEP-CONF) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Unisphere-Data-SLEP-CONF
...
(usdSlepGroup,) = mibBuilder.importSymbols(
...
usdSlepAgent = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 38)
)
usdSlepAgent.setRevisions(
        ("2001-03-30 14:15",)
)
...
usdSlepAgentV1 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 38, 1)
)
if mibBuilder.loadTexts:
    usdSlepAgentV1.setProductRelease("""\
