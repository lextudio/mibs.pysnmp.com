# SNMP MIB module (ChrComPmSonetSNT-S-Interval-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmSonetSNT-S-Interval-MIB
...
_ChrComPmSonetSNT_S_IntervalTable_Object = MibTable
chrComPmSonetSNT_S_IntervalTable = _ChrComPmSonetSNT_S_IntervalTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 2)
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_S_IntervalTable.setStatus("current")
_ChrComPmSonetSNT_S_IntervalEntry_Object = MibTableRow
chrComPmSonetSNT_S_IntervalEntry = _ChrComPmSonetSNT_S_IntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 2, 1)
)
chrComPmSonetSNT_S_IntervalEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmSonetSNT-S-Interval-MIB", "chrComPmSonetIntervalNumber"),
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_S_IntervalEntry.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmSonetSNT-S-IntervalTable": chrComPmSonetSNT_S_IntervalTable,
       "chrComPmSonetSNT-S-IntervalEntry": chrComPmSonetSNT_S_IntervalEntry,
