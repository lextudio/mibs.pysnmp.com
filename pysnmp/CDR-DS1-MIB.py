# SNMP MIB module (CDR-DS1-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/CDR-DS1-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 20:53:54 2024
...
cdrClient = _CdrClient_Object(
    (1, 3, 6, 1, 4, 1, 1751, 1, 1198, 7, 1, 1, 1),
    _CdrClient_Type()
)
...
callState = _CallState_Object(
    (1, 3, 6, 1, 4, 1, 1751, 1, 1198, 7, 1, 1, 2),
    _CallState_Type()
)
...
fCAppID = _FCAppID_Object(
    (1, 3, 6, 1, 4, 1, 1751, 1, 1198, 7, 1, 1, 3),
    _FCAppID_Type()
)
...
fCAppInstance = _FCAppInstance_Object(
    (1, 3, 6, 1, 4, 1, 1751, 1, 1198, 7, 1, 1, 4),
    _FCAppInstance_Type()
)
...
severity = _Severity_Object(
    (1, 3, 6, 1, 4, 1, 1751, 1, 1198, 7, 1, 1, 5),
    _Severity_Type()
)
...
originationNumber = _OriginationNumber_Object(
    (1, 3, 6, 1, 4, 1, 1751, 1, 1198, 7, 1, 1, 6),
...
destinationNumber = _DestinationNumber_Object(
    (1, 3, 6, 1, 4, 1, 1751, 1, 1198, 7, 1, 1, 7),
...
callAnswerTime = _CallAnswerTime_Object(
    (1, 3, 6, 1, 4, 1, 1751, 1, 1198, 7, 1, 1, 8),
...
switchId = _SwitchId_Object(
    (1, 3, 6, 1, 4, 1, 1751, 1, 1198, 7, 1, 1, 9),
    _SwitchId_Type()
)
...
callId = _CallId_Object(
    (1, 3, 6, 1, 4, 1, 1751, 1, 1198, 7, 1, 1, 10),
    _CallId_Type()
)
...
fullPercent = _FullPercent_Object(
    (1, 3, 6, 1, 4, 1, 1751, 1, 1198, 7, 1, 1, 11),
    _FullPercent_Type()
)
...
fileSystem = _FileSystem_Object(
    (1, 3, 6, 1, 4, 1, 1751, 1, 1198, 7, 1, 1, 12),
    _FileSystem_Type()
)
