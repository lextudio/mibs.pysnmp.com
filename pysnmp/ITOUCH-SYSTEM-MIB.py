# SNMP MIB module (ITOUCH-SYSTEM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ITOUCH-SYSTEM-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:12:23 2024
...
bootRecordEntry.setIndexNames(
    (0, "ITOUCH-SYSTEM-MIB", "bootRecordIndex"),
)
if mibBuilder.loadTexts:
...
sysLoginAuthenticationFailure.setObjects(
      *(("ITOUCH-SYSTEM-MIB", "sysLoginAuthFailureTrapType"),
        ("ITOUCH-SYSTEM-MIB", "sysLoginAuthTrapIdentity"))
)
if mibBuilder.loadTexts:
