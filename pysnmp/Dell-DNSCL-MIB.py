# SNMP MIB module (Dell-DNSCL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Dell-DNSCL-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:34:22 2024
...
rlDnsClDomainNameEntry.setIndexNames(
    (0, "Dell-DNSCL-MIB", "rlDnsClDomainNameName"),
)
if mibBuilder.loadTexts:
...
rlDnsClNamesEntry.setIndexNames(
    (0, "Dell-DNSCL-MIB", "rlDnsClNamesName"),
    (0, "Dell-DNSCL-MIB", "rlDnsClNamesOwner"),
    (0, "Dell-DNSCL-MIB", "rlDnsClNamesIndex"),
)
if mibBuilder.loadTexts:
...
rlDnsClNamesInetEntry = _RlDnsClNamesInetEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 93, 8, 1)
)
rlDnsClNamesInetEntry.setIndexNames(
    (0, "Dell-DNSCL-MIB", "rlDnsClNamesInetName"),
    (0, "Dell-DNSCL-MIB", "rlDnsClNamesInetOwner"),
    (0, "Dell-DNSCL-MIB", "rlDnsClNamesInetIndex"),
    (0, "Dell-DNSCL-MIB", "rlDnsClNamesInetRRType"),
)
if mibBuilder.loadTexts:
...
rlDnsResConfigSbeltInetEntry = _RlDnsResConfigSbeltInetEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 93, 9, 1)
)
rlDnsResConfigSbeltInetEntry.setIndexNames(
    (0, "Dell-DNSCL-MIB", "rlDnsResConfigSbeltInetAddrType"),
    (0, "Dell-DNSCL-MIB", "rlDnsResConfigSbeltInetAddr"),
    (0, "Dell-DNSCL-MIB", "rlDnsResConfigSbeltInetSubTree"),
    (0, "Dell-DNSCL-MIB", "rlDnsResConfigSbeltInetClass"),
)
if mibBuilder.loadTexts:
...
rlDnsResCacheRRInetEntry = _RlDnsResCacheRRInetEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 93, 10, 1)
)
rlDnsResCacheRRInetEntry.setIndexNames(
    (0, "Dell-DNSCL-MIB", "rlDnsResCacheRRInetName"),
    (0, "Dell-DNSCL-MIB", "rlDnsResCacheRRInetClass"),
    (0, "Dell-DNSCL-MIB", "rlDnsResCacheRRInetType"),
    (0, "Dell-DNSCL-MIB", "rlDnsResCacheRRInetIndex"),
)
if mibBuilder.loadTexts:
...
rlDnsResNCacheErrInetEntry = _RlDnsResNCacheErrInetEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 93, 11, 1)
)
rlDnsResNCacheErrInetEntry.setIndexNames(
    (0, "Dell-DNSCL-MIB", "rlDnsResNCacheErrInetQName"),
    (0, "Dell-DNSCL-MIB", "rlDnsResNCacheErrInetQClass"),
    (0, "Dell-DNSCL-MIB", "rlDnsResNCacheErrInetQType"),
    (0, "Dell-DNSCL-MIB", "rlDnsResNCacheErrInetIndex"),
)
if mibBuilder.loadTexts:
...
rlDnsClv2DomainNameEntry = _RlDnsClv2DomainNameEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 93, 14, 1)
)
rlDnsClv2DomainNameEntry.setIndexNames(
    (0, "Dell-DNSCL-MIB", "rlDnsClv2DomainNameSource"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2DomainNameIfIndex"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2DomainNamePreference"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2DomainNameName"),
)
if mibBuilder.loadTexts:
...
rlDnsClv2ServersEntry = _RlDnsClv2ServersEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 93, 15, 1)
)
rlDnsClv2ServersEntry.setIndexNames(
    (0, "Dell-DNSCL-MIB", "rlDnsClv2ServersSource"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2ServersIfIndex"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2ServersPreference"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2ServersAddrType"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2ServersInetAddr"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2ServersSubTree"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2ServersClass"),
)
if mibBuilder.loadTexts:
...
rlDnsClv2FixedEntry = _RlDnsClv2FixedEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 93, 16, 1)
)
rlDnsClv2FixedEntry.setIndexNames(
    (0, "Dell-DNSCL-MIB", "rlDnsClv2FixedName"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2FixedType"),
)
if mibBuilder.loadTexts:
...
rlDnsClv2UnifiedCacheEntry = _RlDnsClv2UnifiedCacheEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 93, 18, 1)
)
rlDnsClv2UnifiedCacheEntry.setIndexNames(
    (0, "Dell-DNSCL-MIB", "rlDnsClv2UnifiedCacheName"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2UnifiedCacheSource"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2UnifiedCacheState"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2UnifiedCacheType"),
    (0, "Dell-DNSCL-MIB", "rlDnsClv2UnifiedCacheIndex"),
)
if mibBuilder.loadTexts:
