# SNMP MIB module (ASANTE-HUB1012-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ASANTE-HUB1012-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 20:40:49 2024
...
ipagentTrapRcvrEntry.setIndexNames(
    (0, "ASANTE-HUB1012-MIB", "ipagentTrapRcvrIpAddr"),
)
if mibBuilder.loadTexts:
...
concChassisPsEntry.setIndexNames(
    (0, "ASANTE-HUB1012-MIB", "concChassisPsIndex"),
)
if mibBuilder.loadTexts:
...
concChassisGrpEntry.setIndexNames(
    (0, "ASANTE-HUB1012-MIB", "concChassisGrpIndex"),
)
if mibBuilder.loadTexts:
...
_EGlobalHubDataRateMismatch_Type = Counter32
_EGlobalHubDataRateMismatch_Object = MibScalar
eGlobalHubDataRateMismatch = _EGlobalHubDataRateMismatch_Object(
    (1, 3, 6, 1, 4, 1, 298, 1, 3, 3, 1, 1, 10),
    _EGlobalHubDataRateMismatch_Type()
)
eGlobalHubDataRateMismatch.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    eGlobalHubDataRateMismatch.setStatus("mandatory")
...
_EGlobalHubSFDMissing_Type = Counter32
_EGlobalHubSFDMissing_Object = MibScalar
eGlobalHubSFDMissing = _EGlobalHubSFDMissing_Object(
    (1, 3, 6, 1, 4, 1, 298, 1, 3, 3, 1, 1, 16),
    _EGlobalHubSFDMissing_Type()
)
eGlobalHubSFDMissing.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    eGlobalHubSFDMissing.setStatus("mandatory")
...
eGrpStatisticsEntry.setIndexNames(
    (0, "ASANTE-HUB1012-MIB", "eGrpStatIndex"),
)
if mibBuilder.loadTexts:
...
_EGrpStatDataRateMismatch_Type = Counter32
_EGrpStatDataRateMismatch_Object = MibTableColumn
eGrpStatDataRateMismatch = _EGrpStatDataRateMismatch_Object(
    (1, 3, 6, 1, 4, 1, 298, 1, 3, 3, 1, 3, 1, 11),
    _EGrpStatDataRateMismatch_Type()
)
eGrpStatDataRateMismatch.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    eGrpStatDataRateMismatch.setStatus("mandatory")
...
_EGrpStatSFDMissing_Type = Counter32
_EGrpStatSFDMissing_Object = MibTableColumn
eGrpStatSFDMissing = _EGrpStatSFDMissing_Object(
    (1, 3, 6, 1, 4, 1, 298, 1, 3, 3, 1, 3, 1, 17),
    _EGrpStatSFDMissing_Type()
)
eGrpStatSFDMissing.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    eGrpStatSFDMissing.setStatus("mandatory")
...
ePortStatisticsEntry.setIndexNames(
    (0, "ASANTE-HUB1012-MIB", "ePortGrpIndex"),
    (0, "ASANTE-HUB1012-MIB", "ePortIndex"),
)
if mibBuilder.loadTexts:
...
_EPortStatDataRateMismatch_Type = Counter32
_EPortStatDataRateMismatch_Object = MibTableColumn
ePortStatDataRateMismatch = _EPortStatDataRateMismatch_Object(
    (1, 3, 6, 1, 4, 1, 298, 1, 3, 3, 1, 4, 1, 12),
    _EPortStatDataRateMismatch_Type()
)
ePortStatDataRateMismatch.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ePortStatDataRateMismatch.setStatus("mandatory")
...
_EPortStatSFDMissing_Type = Counter32
_EPortStatSFDMissing_Object = MibTableColumn
ePortStatSFDMissing = _EPortStatSFDMissing_Object(
    (1, 3, 6, 1, 4, 1, 298, 1, 3, 3, 1, 4, 1, 18),
    _EPortStatSFDMissing_Type()
)
ePortStatSFDMissing.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ePortStatSFDMissing.setStatus("mandatory")
...
eTrafficMatrixEntry.setIndexNames(
    (0, "ASANTE-HUB1012-MIB", "eTrafficMatrixLength"),
)
if mibBuilder.loadTexts:
...
_ETrafficMatrixFramesCount_Type = Counter32
_ETrafficMatrixFramesCount_Object = MibTableColumn
eTrafficMatrixFramesCount = _ETrafficMatrixFramesCount_Object(
    (1, 3, 6, 1, 4, 1, 298, 1, 3, 3, 1, 5, 1, 3),
    _ETrafficMatrixFramesCount_Type()
)
eTrafficMatrixFramesCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    eTrafficMatrixFramesCount.setStatus("mandatory")
...
ePortRateEntry.setIndexNames(
    (0, "ASANTE-HUB1012-MIB", "ePortRateGrpIndex"),
    (0, "ASANTE-HUB1012-MIB", "ePortRatePortIndex"),
)
if mibBuilder.loadTexts:
...
_EPortRateSFDMissing_Type = Integer32
_EPortRateSFDMissing_Object = MibTableColumn
ePortRateSFDMissing = _EPortRateSFDMissing_Object(
    (1, 3, 6, 1, 4, 1, 298, 1, 3, 3, 1, 6, 1, 6, 1, 18),
    _EPortRateSFDMissing_Type()
)
ePortRateSFDMissing.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ePortRateSFDMissing.setStatus("optional")
...
ePortStateCtrlEntry.setIndexNames(
    (0, "ASANTE-HUB1012-MIB", "ePortStateGrpIndex"),
    (0, "ASANTE-HUB1012-MIB", "ePortStatePortIndex"),
)
if mibBuilder.loadTexts:
...
nodeSummaryEntry.setIndexNames(
    (0, "ASANTE-HUB1012-MIB", "nodeSummaryGrpIndex"),
    (0, "ASANTE-HUB1012-MIB", "nodeSummaryPortIndex"),
    (0, "ASANTE-HUB1012-MIB", "nodeSummarySrcMacAddr"),
    (0, "ASANTE-HUB1012-MIB", "nodeSummaryDestMacAddr"),
)
if mibBuilder.loadTexts:
...
nodeSecuLev1Entry.setIndexNames(
    (0, "ASANTE-HUB1012-MIB", "nodeSecuLev1GrpIndex"),
    (0, "ASANTE-HUB1012-MIB", "nodeSecuLev1PortIndex"),
)
if mibBuilder.loadTexts:
...
thresholdLev1Entry.setIndexNames(
    (0, "ASANTE-HUB1012-MIB", "thresholdLev1Index"),
)
if mibBuilder.loadTexts:
...
thresholdLev1.setObjects(
      *(("ASANTE-HUB1012-MIB", "thresholdLev1Target"),
        ("ASANTE-HUB1012-MIB", "thresholdLev1GroupIndex"),
        ("ASANTE-HUB1012-MIB", "thresholdLev1PortIndex"),
        ("ASANTE-HUB1012-MIB", "thresholdLev1Subject"),
        ("ASANTE-HUB1012-MIB", "thresholdLev1SampleType"),
        ("ASANTE-HUB1012-MIB", "thresholdLev1WaterMark"),
        ("ASANTE-HUB1012-MIB", "thresholdLev1DetectedValue"),
        ("ASANTE-HUB1012-MIB", "thresholdLev1OwnerString"),
        ("ASANTE-HUB1012-MIB", "thresholdLev1RisingEvent"),
        ("ASANTE-HUB1012-MIB", "thresholdLev1FallingEvent"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"DisplayString": DisplayString,
       ...
       "eGlobalHubDataRateMismatch": eGlobalHubDataRateMismatch,
       ...
       "eGlobalHubSFDMissing": eGlobalHubSFDMissing,
       ...
       "eGrpStatDataRateMismatch": eGrpStatDataRateMismatch,
       ...
       "eGrpStatSFDMissing": eGrpStatSFDMissing,
       ...
       "ePortStatDataRateMismatch": ePortStatDataRateMismatch,
       ...
       "ePortStatSFDMissing": ePortStatSFDMissing,
       ...
       "eTrafficMatrixFramesCount": eTrafficMatrixFramesCount,
       "eSpecific": eSpecific,
       ...
       "ePortRateSFDMissing": ePortRateSFDMissing,
