# SNMP MIB module (ChrComPmOpticsOMS-SNK-Day-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmOpticsOMS-SNK-Day-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:19 2024
...
_ChrComPmOpticsOMS_SNK_DayTable_Object = MibTable
chrComPmOpticsOMS_SNK_DayTable = _ChrComPmOpticsOMS_SNK_DayTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 9)
)
if mibBuilder.loadTexts:
    chrComPmOpticsOMS_SNK_DayTable.setStatus("current")
_ChrComPmOpticsOMS_SNK_DayEntry_Object = MibTableRow
chrComPmOpticsOMS_SNK_DayEntry = _ChrComPmOpticsOMS_SNK_DayEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 9, 1)
)
chrComPmOpticsOMS_SNK_DayEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmOpticsOMS-SNK-Day-MIB", "chrComPmOpticsDayNumber"),
)
if mibBuilder.loadTexts:
    chrComPmOpticsOMS_SNK_DayEntry.setStatus("current")
...
chrComPmOpticsMin = _ChrComPmOpticsMin_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 9, 1, 10),
...
chrComPmOpticsSD = _ChrComPmOpticsSD_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 9, 1, 11),
...
chrComPmOpticsThresholdProfIndex = _ChrComPmOpticsThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 9, 1, 12),
...
chrComPmOpticsResetCountersAction = _ChrComPmOpticsResetCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 9, 1, 13),
...
mibBuilder.exportSymbols(
    "ChrComPmOpticsOMS-SNK-Day-MIB",
    **{"chrComPmOpticsOMS-SNK-DayTable": chrComPmOpticsOMS_SNK_DayTable,
       "chrComPmOpticsOMS-SNK-DayEntry": chrComPmOpticsOMS_SNK_DayEntry,
