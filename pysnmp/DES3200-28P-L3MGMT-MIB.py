# SNMP MIB module (DES3200-28P-L3MGMT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DES3200-28P-L3MGMT-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:25:19 2024
...
swL3DevCtrlRIPState = _SwL3DevCtrlRIPState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 1, 1, 1),
...
swL3DevCtrlOSPFState = _SwL3DevCtrlOSPFState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 1, 1, 2),
...
swL3DevCtrlDVMRPState = _SwL3DevCtrlDVMRPState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 1, 1, 3),
...
swL3DevCtrlVRRPState = _SwL3DevCtrlVRRPState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 1, 1, 5),
...
swL3DevCtrlVrrpPingState = _SwL3DevCtrlVrrpPingState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 1, 1, 6),
...
swL3DevCtrlDHCPAutoConfigState = _SwL3DevCtrlDHCPAutoConfigState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 1, 1, 7),
...
swL3IpCtrlInterfaceName = _SwL3IpCtrlInterfaceName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 1),
...
swL3IpCtrlIfIndex = _SwL3IpCtrlIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 2),
...
swL3IpCtrlIpAddr = _SwL3IpCtrlIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 3),
...
swL3IpCtrlIpSubnetMask = _SwL3IpCtrlIpSubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 4),
...
swL3IpCtrlVlanName = _SwL3IpCtrlVlanName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 5),
...
swL3IpCtrlProxyArp = _SwL3IpCtrlProxyArp_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 6),
...
swL3IpCtrlSecondary = _SwL3IpCtrlSecondary_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 7),
...
swL3IpCtrlMode = _SwL3IpCtrlMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 8),
...
swL3IpCtrlAdminState = _SwL3IpCtrlAdminState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 9),
...
swL3IpCtrlIpv4AdminState = _SwL3IpCtrlIpv4AdminState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 10),
...
swL3IpCtrlIpv6AdminState = _SwL3IpCtrlIpv6AdminState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 12),
...
swL3IpCtrlIpv6LinkLocalAddress = _SwL3IpCtrlIpv6LinkLocalAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 14),
...
swL3IpCtrlIpv6LinkLocalPrefixLen = _SwL3IpCtrlIpv6LinkLocalPrefixLen_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 15),
...
swL3IpCtrlState = _SwL3IpCtrlState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 16),
...
swL3IpCtrlIpv6LinkLocalAutoState = _SwL3IpCtrlIpv6LinkLocalAutoState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 17),
...
swL3IpCtrlLocalProxyArp = _SwL3IpCtrlLocalProxyArp_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 18),
...
swL3IpCtrlDhcpv6ClientState = _SwL3IpCtrlDhcpv6ClientState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 20),
...
swL3IpCtrlIpDirectedBroadcastState = _SwL3IpCtrlIpDirectedBroadcastState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 21),
...
swL3IpCtrlIpDhcpOption12State = _SwL3IpCtrlIpDhcpOption12State_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 22),
...
swL3IpCtrlIpDhcpOption12HostName = _SwL3IpCtrlIpDhcpOption12HostName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 3, 1, 23),
...
swL3Ipv6CtrlInterfaceName = _SwL3Ipv6CtrlInterfaceName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 4, 1, 1),
...
swL3Ipv6CtrlMaxReassmblySize = _SwL3Ipv6CtrlMaxReassmblySize_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 4, 1, 2),
...
swL3Ipv6CtrlNsRetransTimer = _SwL3Ipv6CtrlNsRetransTimer_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 4, 1, 3),
...
swL3Ipv6CtrlRaState = _SwL3Ipv6CtrlRaState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 4, 1, 5),
...
swL3Ipv6CtrlRaMinRtrAdvInterval = _SwL3Ipv6CtrlRaMinRtrAdvInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 4, 1, 6),
...
swL3Ipv6CtrlRaMaxRtrAdvInterval = _SwL3Ipv6CtrlRaMaxRtrAdvInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 4, 1, 7),
...
swL3Ipv6CtrlRaLifeTime = _SwL3Ipv6CtrlRaLifeTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 4, 1, 8),
...
swL3Ipv6CtrlRaReachableTime = _SwL3Ipv6CtrlRaReachableTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 4, 1, 9),
...
swL3Ipv6CtrlRaRetransTime = _SwL3Ipv6CtrlRaRetransTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 4, 1, 10),
...
swL3Ipv6CtrlRaHopLimit = _SwL3Ipv6CtrlRaHopLimit_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 4, 1, 11),
...
swL3Ipv6CtrlRaManagedFlag = _SwL3Ipv6CtrlRaManagedFlag_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 4, 1, 12),
...
swL3Ipv6CtrlRaOtherConfigFlag = _SwL3Ipv6CtrlRaOtherConfigFlag_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 4, 1, 13),
...
swL3Ipv6AddressCtrlTable = _SwL3Ipv6AddressCtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 5)
)
if mibBuilder.loadTexts:
...
swL3Ipv6AddressCtrlEntry = _SwL3Ipv6AddressCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 5, 1)
)
swL3Ipv6AddressCtrlEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3Ipv6AddressCtrlInterfaceName"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3Ipv6Address"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3Ipv6AddressCtrlPrefixLen"),
)
if mibBuilder.loadTexts:
...
swL3Ipv6AddressCtrlInterfaceName = _SwL3Ipv6AddressCtrlInterfaceName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 5, 1, 1),
...
swL3Ipv6Address = _SwL3Ipv6Address_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 5, 1, 2),
...
swL3Ipv6AddressCtrlPrefixLen = _SwL3Ipv6AddressCtrlPrefixLen_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 5, 1, 3),
...
swL3Ipv6AddressCtrlPreferredLifeTime = _SwL3Ipv6AddressCtrlPreferredLifeTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 5, 1, 4),
...
swL3Ipv6AddressCtrlValidLifeTime = _SwL3Ipv6AddressCtrlValidLifeTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 5, 1, 5),
...
swL3Ipv6AddressCtrlOnLinkFlag = _SwL3Ipv6AddressCtrlOnLinkFlag_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 5, 1, 6),
...
swL3Ipv6AddressCtrlAutonomousFlag = _SwL3Ipv6AddressCtrlAutonomousFlag_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 5, 1, 7),
...
swL3Ipv6AddressCtrlState = _SwL3Ipv6AddressCtrlState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 5, 1, 8),
...
swL3Ipv6AddressCtrlAddressType = _SwL3Ipv6AddressCtrlAddressType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 5, 1, 9),
...
swL3IpCtrlAllIpIfState = _SwL3IpCtrlAllIpIfState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 7),
...
swL3LoopBackIpCtrlTable = _SwL3LoopBackIpCtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 8)
)
if mibBuilder.loadTexts:
...
swL3LoopBackIpCtrlEntry = _SwL3LoopBackIpCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 8, 1)
)
swL3LoopBackIpCtrlEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3LoopBackIpCtrlInterfaceName"),
)
if mibBuilder.loadTexts:
...
swL3LoopBackIpCtrlInterfaceName = _SwL3LoopBackIpCtrlInterfaceName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 8, 1, 1),
...
swL3LoopBackIpCtrlIfIndex = _SwL3LoopBackIpCtrlIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 8, 1, 2),
...
swL3LoopBackIpCtrlIpAddr = _SwL3LoopBackIpCtrlIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 8, 1, 3),
...
swL3LoopBackIpCtrlIpSubnetMask = _SwL3LoopBackIpCtrlIpSubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 8, 1, 4),
...
swL3LoopBackIpCtrlAdminState = _SwL3LoopBackIpCtrlAdminState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 8, 1, 5),
...
swL3LoopBackIpCtrlRowStatus = _SwL3LoopBackIpCtrlRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 1, 8, 1, 6),
...
swL3IpFdbInfoIpAddr = _SwL3IpFdbInfoIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 2, 1, 1, 1),
...
swL3IpFdbInfoIpSubnetMask = _SwL3IpFdbInfoIpSubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 2, 1, 1, 2),
...
swL3IpFdbInfoPort = _SwL3IpFdbInfoPort_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 2, 1, 1, 3),
...
swL3IpFdbInfoType = _SwL3IpFdbInfoType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 2, 1, 1, 4),
...
swL3IpArpAgingTime = _SwL3IpArpAgingTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 4),
...
swL3IpStaticRouteTable = _SwL3IpStaticRouteTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 5)
)
if mibBuilder.loadTexts:
...
swL3IpStaticRouteEntry = _SwL3IpStaticRouteEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 5, 1)
)
swL3IpStaticRouteEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3IpStaticRouteDest"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3IpStaticRouteMask"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3IpStaticRouteNextHop"),
)
if mibBuilder.loadTexts:
...
swL3IpStaticRouteDest = _SwL3IpStaticRouteDest_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 5, 1, 1),
...
swL3IpStaticRouteMask = _SwL3IpStaticRouteMask_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 5, 1, 2),
...
swL3IpStaticRouteBkupState = _SwL3IpStaticRouteBkupState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 5, 1, 3),
...
swL3IpStaticRouteNextHop = _SwL3IpStaticRouteNextHop_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 5, 1, 4),
...
swL3IpStaticRouteMetric = _SwL3IpStaticRouteMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 5, 1, 5),
...
swL3IpStaticRouteStatus = _SwL3IpStaticRouteStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 5, 1, 6),
...
swL3IpStaticRouteWeight = _SwL3IpStaticRouteWeight_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 5, 1, 7),
...
swL3IpStaticRouteInterfaceName = _SwL3IpStaticRouteInterfaceName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 5, 1, 8),
...
swL3IpStaticRouteCost = _SwL3IpStaticRouteCost_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 2, 5, 1, 9),
...
swL3RelayDhcpState = _SwL3RelayDhcpState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 1),
...
swL3RelayDhcpHopCount = _SwL3RelayDhcpHopCount_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 2),
...
swL3RelayDhcpTimeThreshold = _SwL3RelayDhcpTimeThreshold_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 3),
...
swL3RelayDhcpCtrlTable = _SwL3RelayDhcpCtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 4)
)
if mibBuilder.loadTexts:
...
swL3RelayDhcpCtrlEntry = _SwL3RelayDhcpCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 4, 1)
)
swL3RelayDhcpCtrlEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3RelayDhcpCtrlInterfaceName"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3RelayDhcpCtrlServer"),
)
if mibBuilder.loadTexts:
...
swL3RelayDhcpCtrlInterfaceName = _SwL3RelayDhcpCtrlInterfaceName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 4, 1, 1),
...
swL3RelayDhcpCtrlServer = _SwL3RelayDhcpCtrlServer_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 4, 1, 2),
...
swL3RelayDhcpCtrlState = _SwL3RelayDhcpCtrlState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 4, 1, 3),
...
swL3RelayDhcpOption82State = _SwL3RelayDhcpOption82State_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 5),
...
swL3RelayDhcpOption82CheckState = _SwL3RelayDhcpOption82CheckState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 6),
...
swL3RelayDhcpOption82Policy = _SwL3RelayDhcpOption82Policy_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 7),
...
swL3DHCPRelayOption60 = _SwL3DHCPRelayOption60_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8)
)
...
swL3DHCPRelayOption60State = _SwL3DHCPRelayOption60State_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8, 1),
...
swL3DHCPRelayOption60DefMode = _SwL3DHCPRelayOption60DefMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8, 2),
...
swL3DHCPRelayOption60DefTable = _SwL3DHCPRelayOption60DefTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8, 3)
)
if mibBuilder.loadTexts:
...
swL3DHCPRelayOption60DefEntry = _SwL3DHCPRelayOption60DefEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8, 3, 1)
)
swL3DHCPRelayOption60DefEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3DHCPRelayOption60DefRelayIp"),
)
if mibBuilder.loadTexts:
...
swL3DHCPRelayOption60DefRelayIp = _SwL3DHCPRelayOption60DefRelayIp_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8, 3, 1, 1),
...
swL3DHCPRelayOption60DefRowStatus = _SwL3DHCPRelayOption60DefRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8, 3, 1, 2),
...
swL3DHCPRelayOption60Table = _SwL3DHCPRelayOption60Table_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8, 4)
)
if mibBuilder.loadTexts:
...
swL3DHCPRelayOption60Entry = _SwL3DHCPRelayOption60Entry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8, 4, 1)
)
swL3DHCPRelayOption60Entry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3DHCPRelayOption60String"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3DHCPRelayOption60RelayIp"),
)
if mibBuilder.loadTexts:
...
swL3DHCPRelayOption60String = _SwL3DHCPRelayOption60String_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8, 4, 1, 1),
...
swL3DHCPRelayOption60RelayIp = _SwL3DHCPRelayOption60RelayIp_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8, 4, 1, 2),
...
swL3DHCPRelayOption60MatchType = _SwL3DHCPRelayOption60MatchType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8, 4, 1, 3),
...
swL3DHCPRelayOption60RowStatus = _SwL3DHCPRelayOption60RowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 8, 4, 1, 4),
...
swL3DHCPRelayOption61 = _SwL3DHCPRelayOption61_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 9)
)
...
swL3DHCPRelayOption61State = _SwL3DHCPRelayOption61State_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 9, 1),
...
swL3DHCPRelayOption61DefMode = _SwL3DHCPRelayOption61DefMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 9, 2),
...
swL3DHCPRelayOption61DefRelayIp = _SwL3DHCPRelayOption61DefRelayIp_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 9, 3),
...
swL3DHCPRelayOption61Table = _SwL3DHCPRelayOption61Table_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 9, 4)
)
if mibBuilder.loadTexts:
...
swL3DHCPRelayOption61Entry = _SwL3DHCPRelayOption61Entry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 9, 4, 1)
)
swL3DHCPRelayOption61Entry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3DHCPRelayOption61ClientType"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3DHCPRelayOption61ClientID"),
)
if mibBuilder.loadTexts:
...
swL3DHCPRelayOption61ClientType = _SwL3DHCPRelayOption61ClientType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 9, 4, 1, 1),
...
swL3DHCPRelayOption61ClientID = _SwL3DHCPRelayOption61ClientID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 9, 4, 1, 2),
...
swL3DHCPRelayOption61Mode = _SwL3DHCPRelayOption61Mode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 9, 4, 1, 3),
...
swL3DHCPRelayOption61RelayIp = _SwL3DHCPRelayOption61RelayIp_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 9, 4, 1, 4),
...
swL3DHCPRelayOption61RowStatus = _SwL3DHCPRelayOption61RowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 1, 9, 4, 1, 5),
...
swL3RelayDnsMgmt = _SwL3RelayDnsMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 2)
)
...
swL3RelayDnsState = _SwL3RelayDnsState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 2, 1),
...
swL3RelayDnsPrimaryServer = _SwL3RelayDnsPrimaryServer_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 2, 2),
...
swL3RelayDnsSecondaryServer = _SwL3RelayDnsSecondaryServer_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 2, 3),
...
swL3RelayDnsCacheState = _SwL3RelayDnsCacheState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 2, 4),
...
swL3RelayDnsStaticTableState = _SwL3RelayDnsStaticTableState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 2, 5),
...
swL3RelayDnsCtrlTable = _SwL3RelayDnsCtrlTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 2, 6)
)
if mibBuilder.loadTexts:
...
swL3RelayDnsCtrlEntry = _SwL3RelayDnsCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 2, 6, 1)
)
swL3RelayDnsCtrlEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3RelayDnsCtrlDomainName"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3RelayDnsCtrlIpAddr"),
)
if mibBuilder.loadTexts:
...
swL3RelayDnsCtrlDomainName = _SwL3RelayDnsCtrlDomainName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 2, 6, 1, 1),
...
swL3RelayDnsCtrlIpAddr = _SwL3RelayDnsCtrlIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 2, 6, 1, 2),
...
swL3RelayDnsCtrlState = _SwL3RelayDnsCtrlState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 3, 2, 6, 1, 3),
...
swL3Md5KeyId = _SwL3Md5KeyId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 4, 1, 1),
    _SwL3Md5KeyId_Type()
)
...
swL3Md5Key = _SwL3Md5Key_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 4, 1, 2),
    _SwL3Md5Key_Type()
)
...
swL3Md5RowStatus = _SwL3Md5RowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 4, 1, 3),
...
swL3RouteRedistriTable = _SwL3RouteRedistriTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 5)
)
if mibBuilder.loadTexts:
...
swL3RouteRedistriEntry = _SwL3RouteRedistriEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 5, 1)
)
swL3RouteRedistriEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3RouteRedistriSrcProtocol"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3RouteRedistriDstProtocol"),
)
if mibBuilder.loadTexts:
...
swL3RouteRedistriSrcProtocol = _SwL3RouteRedistriSrcProtocol_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 5, 1, 1),
...
swL3RouteRedistriDstProtocol = _SwL3RouteRedistriDstProtocol_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 5, 1, 2),
...
swL3RouteRedistriType = _SwL3RouteRedistriType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 5, 1, 3),
...
swL3RouteRedistriMetric = _SwL3RouteRedistriMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 5, 1, 4),
...
swL3RouteRedistriRowStatus = _SwL3RouteRedistriRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 5, 1, 5),
...
swL3RouteRedistriRouteMapName = _SwL3RouteRedistriRouteMapName_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 5, 1, 6),
...
swL3OspfHostTable = _SwL3OspfHostTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 6)
)
if mibBuilder.loadTexts:
    swL3OspfHostTable.setStatus("current")
_SwL3OspfHostEntry_Object = MibTableRow
swL3OspfHostEntry = _SwL3OspfHostEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 6, 1)
)
swL3OspfHostEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3OspfHostIpAddress"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3OspfHostTOS"),
)
if mibBuilder.loadTexts:
...
swL3OspfHostIpAddress = _SwL3OspfHostIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 6, 1, 1),
...
swL3OspfHostTOS = _SwL3OspfHostTOS_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 6, 1, 2),
...
swL3OspfHostMetric = _SwL3OspfHostMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 6, 1, 3),
...
swL3OspfHostAreaID = _SwL3OspfHostAreaID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 6, 1, 4),
...
swL3OspfHostStatus = _SwL3OspfHostStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 6, 1, 5),
...
swL3ospfVirtIfTable = _SwL3ospfVirtIfTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7)
)
if mibBuilder.loadTexts:
...
swL3ospfVirtIfEntry = _SwL3ospfVirtIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1)
)
swL3ospfVirtIfEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3ospfVirtIfAreaId"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3ospfVirtIfNeighbor"),
)
if mibBuilder.loadTexts:
...
swL3ospfVirtIfAreaId = _SwL3ospfVirtIfAreaId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1, 1),
...
swL3ospfVirtIfNeighbor = _SwL3ospfVirtIfNeighbor_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1, 2),
...
swL3ospfVirtIfTransitDelay = _SwL3ospfVirtIfTransitDelay_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1, 3),
...
swL3ospfVirtIfRetransInterval = _SwL3ospfVirtIfRetransInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1, 4),
...
swL3ospfVirtIfHelloInterval = _SwL3ospfVirtIfHelloInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1, 5),
...
swL3ospfVirtIfRtrDeadInterval = _SwL3ospfVirtIfRtrDeadInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1, 6),
...
swL3ospfVirtIfState = _SwL3ospfVirtIfState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1, 7),
...
swL3ospfVirtIfEvents = _SwL3ospfVirtIfEvents_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1, 8),
...
swL3ospfVirtIfAuthType = _SwL3ospfVirtIfAuthType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1, 9),
...
swL3ospfVirtIfAuthKey = _SwL3ospfVirtIfAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1, 10),
...
swL3ospfVirtIfAuthKeyID = _SwL3ospfVirtIfAuthKeyID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1, 11),
...
swL3ospfVirtIfStatus = _SwL3ospfVirtIfStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 7, 1, 12),
...
swL3ospfIfTable = _SwL3ospfIfTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8)
)
if mibBuilder.loadTexts:
    swL3ospfIfTable.setStatus("current")
_SwL3ospfIfEntry_Object = MibTableRow
swL3ospfIfEntry = _SwL3ospfIfEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1)
)
swL3ospfIfEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3ospfIfIpAddress"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3ospfAddressLessIf"),
)
if mibBuilder.loadTexts:
...
swL3ospfIfIpAddress = _SwL3ospfIfIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 1),
...
swL3ospfAddressLessIf = _SwL3ospfAddressLessIf_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 2),
...
swL3ospfIfAreaId = _SwL3ospfIfAreaId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 3),
...
swL3ospfIfType = _SwL3ospfIfType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 4),
...
swL3ospfIfAdminStat = _SwL3ospfIfAdminStat_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 5),
...
swL3ospfIfRtrPriority = _SwL3ospfIfRtrPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 6),
...
swL3ospfIfTransitDelay = _SwL3ospfIfTransitDelay_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 7),
...
swL3ospfIfRetransInterval = _SwL3ospfIfRetransInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 8),
...
swL3ospfIfHelloInterval = _SwL3ospfIfHelloInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 9),
...
swL3ospfIfRtrDeadInterval = _SwL3ospfIfRtrDeadInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 10),
...
swL3ospfIfPollInterval = _SwL3ospfIfPollInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 11),
...
swL3ospfIfState = _SwL3ospfIfState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 12),
...
swL3ospfIfDesignatedRouter = _SwL3ospfIfDesignatedRouter_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 13),
...
swL3ospfIfBackupDesignatedRouter = _SwL3ospfIfBackupDesignatedRouter_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 14),
...
swL3ospfIfEvents = _SwL3ospfIfEvents_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 15),
...
swL3ospfIfMulticastForwarding = _SwL3ospfIfMulticastForwarding_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 16),
...
swL3ospfIfDemand = _SwL3ospfIfDemand_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 17),
...
swL3ospfIfAuthType = _SwL3ospfIfAuthType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 18),
...
swL3ospfIfAuthKey = _SwL3ospfIfAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 19),
...
swL3ospfIfAuthKeyID = _SwL3ospfIfAuthKeyID_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 20),
...
swL3ospfIfPassiveMode = _SwL3ospfIfPassiveMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 21),
...
swL3ospfIfMetric = _SwL3ospfIfMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 8, 1, 23),
...
swL3RoutePreference = _SwL3RoutePreference_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 9)
)
...
swL3RoutePreferenceRIP = _SwL3RoutePreferenceRIP_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 9, 1),
...
swL3RoutePreferenceOSPFIntra = _SwL3RoutePreferenceOSPFIntra_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 9, 2),
...
swL3RoutePreferenceStatic = _SwL3RoutePreferenceStatic_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 9, 3),
...
swL3RoutePreferenceLocal = _SwL3RoutePreferenceLocal_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 9, 4),
...
swL3RoutePreferenceOSPFInter = _SwL3RoutePreferenceOSPFInter_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 9, 5),
...
swL3RoutePreferenceOSPFExtT1 = _SwL3RoutePreferenceOSPFExtT1_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 9, 6),
...
swL3RoutePreferenceOSPFExtT2 = _SwL3RoutePreferenceOSPFExtT2_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 9, 7),
...
swL3RoutePreferenceDefault = _SwL3RoutePreferenceDefault_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 9, 8),
...
swL3RoutePreferenceEBGP = _SwL3RoutePreferenceEBGP_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 9, 9),
...
swL3RoutePreferenceIBGP = _SwL3RoutePreferenceIBGP_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 9, 10),
...
swL3ospfAreaId = _SwL3ospfAreaId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 10, 1, 1),
...
swL3ospfAreaType = _SwL3ospfAreaType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 10, 1, 2),
...
swL3ospfAreaSummaryState = _SwL3ospfAreaSummaryState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 10, 1, 3),
...
swL3ospfAreaMetric = _SwL3ospfAreaMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 10, 1, 4),
...
swL3ospfAreaTranslateState = _SwL3ospfAreaTranslateState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 10, 1, 5),
...
swL3ospfAreaStatus = _SwL3ospfAreaStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 10, 1, 6),
...
swL3dvmrpInterfaceTable = _SwL3dvmrpInterfaceTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 12)
)
if mibBuilder.loadTexts:
...
swL3dvmrpInterfaceEntry = _SwL3dvmrpInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 12, 1)
)
swL3dvmrpInterfaceEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3dvmrpInterfaceIfIndex"),
)
if mibBuilder.loadTexts:
...
swL3dvmrpInterfaceIfIndex = _SwL3dvmrpInterfaceIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 12, 1, 1),
...
swL3dvmrpInterfaceLocalAddress = _SwL3dvmrpInterfaceLocalAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 12, 1, 2),
...
swL3dvmrpInterfaceMetric = _SwL3dvmrpInterfaceMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 12, 1, 3),
...
swL3dvmrpInterfaceProbe = _SwL3dvmrpInterfaceProbe_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 12, 1, 4),
...
swL3dvmrpInterfaceNbrTimeout = _SwL3dvmrpInterfaceNbrTimeout_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 12, 1, 5),
...
swL3dvmrpInterfaceStatus = _SwL3dvmrpInterfaceStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 12, 1, 6),
...
swL3dvmrpInterfaceRcvBadPkts = _SwL3dvmrpInterfaceRcvBadPkts_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 12, 1, 7),
...
swL3dvmrpInterfaceRcvBadRoutes = _SwL3dvmrpInterfaceRcvBadRoutes_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 12, 1, 8),
...
swL3OspfInternalLsdbEntry = _SwL3OspfInternalLsdbEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 1, 1)
)
swL3OspfInternalLsdbEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3OspfInternalLsdbAreaId"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3OspfInternalLsdbType"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3OspfInternalLsdbLsid"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3OspfInternalLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
swL3OspfInternalLsdbAreaId = _SwL3OspfInternalLsdbAreaId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 1, 1, 1),
...
swL3OspfInternalLsdbType = _SwL3OspfInternalLsdbType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 1, 1, 2),
...
swL3OspfInternalLsdbLsid = _SwL3OspfInternalLsdbLsid_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 1, 1, 3),
...
swL3OspfInternalLsdbRouterId = _SwL3OspfInternalLsdbRouterId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 1, 1, 4),
...
swL3OspfInternalLsdbMetric = _SwL3OspfInternalLsdbMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 1, 1, 5),
...
swL3OspfInternalLsdbSequenceNo = _SwL3OspfInternalLsdbSequenceNo_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 1, 1, 6),
...
swL3OspfInternalLsdbAge = _SwL3OspfInternalLsdbAge_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 1, 1, 7),
...
swL3OspfInternalLsdbChecksum = _SwL3OspfInternalLsdbChecksum_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 1, 1, 8),
...
swL3OspfExternalLsdbTable = _SwL3OspfExternalLsdbTable_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 2)
)
if mibBuilder.loadTexts:
...
swL3OspfExternalLsdbEntry = _SwL3OspfExternalLsdbEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 2, 1)
)
swL3OspfExternalLsdbEntry.setIndexNames(
    (0, "DES3200-28P-L3MGMT-MIB", "swL3OspfExternalLsdbType"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3OspfExternalLsdbLsid"),
    (0, "DES3200-28P-L3MGMT-MIB", "swL3OspfExternalLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
swL3OspfExternalLsdbType = _SwL3OspfExternalLsdbType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 2, 1, 1),
...
swL3OspfExternalLsdbLsid = _SwL3OspfExternalLsdbLsid_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 2, 1, 2),
...
swL3OspfExternalLsdbRouterId = _SwL3OspfExternalLsdbRouterId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 2, 1, 3),
...
swL3OspfExternalLsdbMetric = _SwL3OspfExternalLsdbMetric_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 2, 1, 4),
...
swL3OspfExternalLsdbMetricType = _SwL3OspfExternalLsdbMetricType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 2, 1, 5),
...
swL3OspfExternalLsdbSequenceNo = _SwL3OspfExternalLsdbSequenceNo_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 2, 1, 6),
...
swL3OspfExternalLsdbAge = _SwL3OspfExternalLsdbAge_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 2, 1, 7),
...
swL3OspfExternalLsdbChecksum = _SwL3OspfExternalLsdbChecksum_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 2, 1, 8),
...
swL3OspfExternalLsdbForwardingAddress = _SwL3OspfExternalLsdbForwardingAddress_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 2, 1, 9),
...
swL3OspfExternalLsdbRouteTag = _SwL3OspfExternalLsdbRouteTag_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 13, 2, 1, 10),
...
swL3VrrpOperIfIndex = _SwL3VrrpOperIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 1),
...
swL3VrrpOperVrId = _SwL3VrrpOperVrId_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 2),
...
swL3VrrpOperVirtualMacAddr = _SwL3VrrpOperVirtualMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 3),
...
swL3VrrpOperState = _SwL3VrrpOperState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 4),
...
swL3VrrpOperAdminState = _SwL3VrrpOperAdminState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 5),
...
swL3VrrpOperPriority = _SwL3VrrpOperPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 6),
...
swL3VrrpOperMasterIpAddr = _SwL3VrrpOperMasterIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 7),
...
swL3VrrpOperCriticalIpAddr = _SwL3VrrpOperCriticalIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 8),
...
swL3VrrpOperCheckCriticalIpState = _SwL3VrrpOperCheckCriticalIpState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 9),
...
swL3VrrpOperAuthType = _SwL3VrrpOperAuthType_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 10),
...
swL3VrrpOperAuthKey = _SwL3VrrpOperAuthKey_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 11),
...
swL3VrrpOperAdvertisementInterval = _SwL3VrrpOperAdvertisementInterval_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 12),
...
swL3VrrpOperPreemptMode = _SwL3VrrpOperPreemptMode_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 13),
...
swL3VrrpOperVirtualRouterUpTime = _SwL3VrrpOperVirtualRouterUpTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 14),
...
swL3VrrpOperVirtualIpAddr = _SwL3VrrpOperVirtualIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 15),
...
swL3VrrpOperRowStatus = _SwL3VrrpOperRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 14, 1, 1, 16),
...
swL3OspfECMPMgmt = _SwL3OspfECMPMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 15)
)
...
swL3OspfECMPIpDestination = _SwL3OspfECMPIpDestination_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 15, 1),
...
swL3OspfECMPIpSource = _SwL3OspfECMPIpSource_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 15, 2),
...
swL3OspfECMPCrcLow = _SwL3OspfECMPCrcLow_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 15, 3),
...
swL3OspfECMPCrcHigh = _SwL3OspfECMPCrcHigh_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 15, 4),
...
swL3OspfECMPTCPorUDPport = _SwL3OspfECMPTCPorUDPport_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 15, 5),
...
swL3OspfECMPState = _SwL3OspfECMPState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 15, 6),
...
swL3LocalRouteMgmt = _SwL3LocalRouteMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 16)
)
...
swL3LocalRouteIPv4GlobalState = _SwL3LocalRouteIPv4GlobalState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 16, 1),
...
swL3LocalRouteIPv6GlobalState = _SwL3LocalRouteIPv6GlobalState_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 16, 2),
...
swL3RIPTimerMgmt = _SwL3RIPTimerMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 17)
)
...
swL3RIPUpdateTime = _SwL3RIPUpdateTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 17, 1),
...
swL3RIPTimeOutTime = _SwL3RIPTimeOutTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 17, 2),
...
swL3RIPGarbageCollectionTime = _SwL3RIPGarbageCollectionTime_Object(
    (1, 3, 6, 1, 4, 1, 171, 11, 113, 8, 1, 3, 17, 3),
