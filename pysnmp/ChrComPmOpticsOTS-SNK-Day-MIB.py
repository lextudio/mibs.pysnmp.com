# SNMP MIB module (ChrComPmOpticsOTS-SNK-Day-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmOpticsOTS-SNK-Day-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:24 2024
...
_ChrComPmOpticsOTS_SNK_DayTable_Object = MibTable
chrComPmOpticsOTS_SNK_DayTable = _ChrComPmOpticsOTS_SNK_DayTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 3)
)
if mibBuilder.loadTexts:
    chrComPmOpticsOTS_SNK_DayTable.setStatus("current")
_ChrComPmOpticsOTS_SNK_DayEntry_Object = MibTableRow
chrComPmOpticsOTS_SNK_DayEntry = _ChrComPmOpticsOTS_SNK_DayEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 3, 1)
)
chrComPmOpticsOTS_SNK_DayEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmOpticsOTS-SNK-Day-MIB", "chrComPmOpticsDayNumber"),
)
if mibBuilder.loadTexts:
    chrComPmOpticsOTS_SNK_DayEntry.setStatus("current")
...
chrComPmOpticsMin = _ChrComPmOpticsMin_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 3, 1, 10),
...
chrComPmOpticsSD = _ChrComPmOpticsSD_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 3, 1, 11),
...
chrComPmOpticsThresholdProfIndex = _ChrComPmOpticsThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 3, 1, 12),
...
chrComPmOpticsResetCountersAction = _ChrComPmOpticsResetCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 3, 1, 13),
...
mibBuilder.exportSymbols(
    "ChrComPmOpticsOTS-SNK-Day-MIB",
    **{"chrComPmOpticsOTS-SNK-DayTable": chrComPmOpticsOTS_SNK_DayTable,
       "chrComPmOpticsOTS-SNK-DayEntry": chrComPmOpticsOTS_SNK_DayEntry,
