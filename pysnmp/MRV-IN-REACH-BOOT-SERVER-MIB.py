# SNMP MIB module (MRV-IN-REACH-BOOT-SERVER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/MRV-IN-REACH-BOOT-SERVER-MIB
...
activeEntry.setIndexNames(
    (0, "MRV-IN-REACH-BOOT-SERVER-MIB", "activeIdentificationType"),
    (0, "MRV-IN-REACH-BOOT-SERVER-MIB", "activeIdentification"),
)
if mibBuilder.loadTexts:
...
clientEntry.setIndexNames(
    (0, "MRV-IN-REACH-BOOT-SERVER-MIB", "clientIdentificationType"),
    (0, "MRV-IN-REACH-BOOT-SERVER-MIB", "clientIdentification"),
)
if mibBuilder.loadTexts:
...
namedEntry.setIndexNames(
    (0, "MRV-IN-REACH-BOOT-SERVER-MIB", "namedName"),
)
if mibBuilder.loadTexts:
...
xEventEntry.setIndexNames(
    (0, "MRV-IN-REACH-BOOT-SERVER-MIB", "xEventIndex"),
)
if mibBuilder.loadTexts:
...
deviceEntry.setIndexNames(
    (0, "MRV-IN-REACH-BOOT-SERVER-MIB", "deviceIndex"),
)
if mibBuilder.loadTexts:
...
dumpFileEntry.setIndexNames(
    (0, "MRV-IN-REACH-BOOT-SERVER-MIB", "dumpFileIdentificationType"),
    (0, "MRV-IN-REACH-BOOT-SERVER-MIB", "dumpFileIdentification"),
)
if mibBuilder.loadTexts:
...
loadFileEntry.setIndexNames(
    (0, "MRV-IN-REACH-BOOT-SERVER-MIB", "loadFileName"),
)
if mibBuilder.loadTexts:
...
paramFileEntry.setIndexNames(
    (0, "MRV-IN-REACH-BOOT-SERVER-MIB", "paramFileIdentificationType"),
    (0, "MRV-IN-REACH-BOOT-SERVER-MIB", "paramFileIdentification"),
)
if mibBuilder.loadTexts:
