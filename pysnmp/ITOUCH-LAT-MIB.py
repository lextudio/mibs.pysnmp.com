# SNMP MIB module (ITOUCH-LAT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ITOUCH-LAT-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:12:16 2024
...
latOfferedServiceEntry.setIndexNames(
    (0, "ITOUCH-LAT-MIB", "latOfferedServiceName"),
)
if mibBuilder.loadTexts:
...
latVisibleServiceEntry.setIndexNames(
    (0, "ITOUCH-LAT-MIB", "latVisibleServiceName"),
)
if mibBuilder.loadTexts:
