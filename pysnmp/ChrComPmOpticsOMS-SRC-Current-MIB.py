# SNMP MIB module (ChrComPmOpticsOMS-SRC-Current-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmOpticsOMS-SRC-Current-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:21 2024
...
_ChrComPmOpticsOMS_SRC_CurrentTable_Object = MibTable
chrComPmOpticsOMS_SRC_CurrentTable = _ChrComPmOpticsOMS_SRC_CurrentTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10)
)
if mibBuilder.loadTexts:
    chrComPmOpticsOMS_SRC_CurrentTable.setStatus("current")
_ChrComPmOpticsOMS_SRC_CurrentEntry_Object = MibTableRow
chrComPmOpticsOMS_SRC_CurrentEntry = _ChrComPmOpticsOMS_SRC_CurrentEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1)
)
chrComPmOpticsOMS_SRC_CurrentEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
)
if mibBuilder.loadTexts:
    chrComPmOpticsOMS_SRC_CurrentEntry.setStatus("current")
...
chrComPmOpticsSuspectedIntrvl = _ChrComPmOpticsSuspectedIntrvl_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1, 1),
...
chrComPmOpticsElapsedTime = _ChrComPmOpticsElapsedTime_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1, 2),
...
chrComPmOpticsSuppressedIntrvls = _ChrComPmOpticsSuppressedIntrvls_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1, 3),
...
chrComPmOpticsORS = _ChrComPmOpticsORS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1, 4),
...
chrComPmOpticsSES = _ChrComPmOpticsSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1, 5),
...
chrComPmOpticsUAS = _ChrComPmOpticsUAS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1, 6),
...
chrComPmOpticsMean = _ChrComPmOpticsMean_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1, 7),
...
chrComPmOpticsMax = _ChrComPmOpticsMax_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1, 8),
...
chrComPmOpticsMin = _ChrComPmOpticsMin_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1, 9),
...
chrComPmOpticsSD = _ChrComPmOpticsSD_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1, 10),
...
chrComPmOpticsThresholdProfIndex = _ChrComPmOpticsThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1, 11),
...
chrComPmOpticsResetCountersAction = _ChrComPmOpticsResetCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 10, 1, 12),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmOpticsOMS-SRC-CurrentTable": chrComPmOpticsOMS_SRC_CurrentTable,
       "chrComPmOpticsOMS-SRC-CurrentEntry": chrComPmOpticsOMS_SRC_CurrentEntry,
