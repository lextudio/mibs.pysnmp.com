# SNMP MIB module (ChrComPmSonetSNT-LFE-Day-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmSonetSNT-LFE-Day-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:32 2024
...
_ChrComPmSonetSNT_LFE_DayTable_Object = MibTable
chrComPmSonetSNT_LFE_DayTable = _ChrComPmSonetSNT_LFE_DayTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 9)
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_LFE_DayTable.setStatus("current")
_ChrComPmSonetSNT_LFE_DayEntry_Object = MibTableRow
chrComPmSonetSNT_LFE_DayEntry = _ChrComPmSonetSNT_LFE_DayEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 9, 1)
)
chrComPmSonetSNT_LFE_DayEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmSonetSNT-LFE-Day-MIB", "chrComPmSonetDayNumber"),
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_LFE_DayEntry.setStatus("current")
...
chrComPmSonetResetPmCountersAction = _ChrComPmSonetResetPmCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 9, 1, 10),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmSonetSNT-LFE-DayTable": chrComPmSonetSNT_LFE_DayTable,
       "chrComPmSonetSNT-LFE-DayEntry": chrComPmSonetSNT_LFE_DayEntry,
