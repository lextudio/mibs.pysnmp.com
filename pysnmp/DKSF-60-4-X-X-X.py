# SNMP MIB module (DKSF-60-4-X-X-X) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DKSF-60-4-X-X-X
...
npPwrEntry.setIndexNames(
    (0, "DKSF-60-4-X-X-X", "npPwrChannelN"),
)
if mibBuilder.loadTexts:
...
npThermoEntry.setIndexNames(
    (0, "DKSF-60-4-X-X-X", "npThermoSensorN"),
)
if mibBuilder.loadTexts:
...
npCurLoopTrap.setObjects(
      *(("DKSF-60-4-X-X-X", "npCurLoopTrapN"),
        ("DKSF-60-4-X-X-X", "npCurLoopTrapStatus"),
        ("DKSF-60-4-X-X-X", "npCurLoopTrapI"),
        ("DKSF-60-4-X-X-X", "npCurLoopTrapV"),
        ("DKSF-60-4-X-X-X", "npCurLoopTrapR"),
        ("DKSF-60-4-X-X-X", "npCurLoopTrapPower"))
)
if mibBuilder.loadTexts:
...
npThermoTrap.setObjects(
      *(("DKSF-60-4-X-X-X", "npThermoTrapSensorN"),
        ("DKSF-60-4-X-X-X", "npThermoTrapValue"),
        ("DKSF-60-4-X-X-X", "npThermoTrapStatus"),
        ("DKSF-60-4-X-X-X", "npThermoTrapLow"),
        ("DKSF-60-4-X-X-X", "npThermoTrapHigh"),
        ("DKSF-60-4-X-X-X", "npThermoTrapMemo"))
)
if mibBuilder.loadTexts:
...
npIoTrap.setObjects(
      *(("DKSF-60-4-X-X-X", "npIoTrapLineN"),
        ("DKSF-60-4-X-X-X", "npIoTrapLevelIn"),
        ("DKSF-60-4-X-X-X", "npIoTrapMemo"))
)
if mibBuilder.loadTexts:
    npIoTrap.setStatus(
        "current"
