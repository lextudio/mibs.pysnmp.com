# SNMP MIB module (DES-1210-08P_AX) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DES-1210-08P_AX
# Produced by pysmi-1.5.4 at Mon Oct 14 21:24:12 2024
...
_Des_1210_08pax_ObjectIdentity = ObjectIdentity
des_1210_08pax = _Des_1210_08pax_ObjectIdentity(
...
sysPortCtrlEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "sysPortCtrlIndex"),
)
if mibBuilder.loadTexts:
...
dot1qVlanEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "dot1qVlanName"),
)
if mibBuilder.loadTexts:
...
dot1qVlanForbiddenPorts = _Dot1qVlanForbiddenPorts_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 7, 6, 1, 3),
...
laPortChannelEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "laPortChannelIfIndex"),
)
if mibBuilder.loadTexts:
...
laPortControlEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "laPortControlIndex"),
)
if mibBuilder.loadTexts:
...
laPortActorPortPriority = _LaPortActorPortPriority_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 8, 2, 1, 1, 2),
...
staticEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "staticVlanID"),
    (0, "DES-1210-08P_AX", "staticMac"),
    (0, "DES-1210-08P_AX", "staticPort"),
)
if mibBuilder.loadTexts:
...
igsVlanRouterEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "igsVlanRouterVlanId"),
)
if mibBuilder.loadTexts:
...
igsVlanFilterEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "igsVlanFilterVlanId"),
)
if mibBuilder.loadTexts:
...
igsVlanMulticastGroupEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "igsVlanMulticastGroupVlanId"),
    (0, "DES-1210-08P_AX", "igsVlanMulticastGroupIpAddress"),
)
if mibBuilder.loadTexts:
...
dot1xAuthConfigPortEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "dot1xAuthConfigPortNumber"),
)
if mibBuilder.loadTexts:
...
dot1pPortEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "dot1pPortIndex"),
)
if mibBuilder.loadTexts:
...
bandwidthCtrlEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "bandwidthCtrlIndex"),
)
if mibBuilder.loadTexts:
...
trustedHostEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "trustedHostIpAddr"),
    (0, "DES-1210-08P_AX", "trustedHostIpMask"),
)
if mibBuilder.loadTexts:
...
portSecEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "portSecIndex"),
)
if mibBuilder.loadTexts:
...
aRPSpoofPreventEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "aRPSpoofPreventIpAddr"),
)
if mibBuilder.loadTexts:
...
aclProfileEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "aclProfileNo"),
)
if mibBuilder.loadTexts:
...
aclL2RuleEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "aclL2AccessID"),
    (0, "DES-1210-08P_AX", "aclL2ProfileID"),
)
if mibBuilder.loadTexts:
...
aclL3RuleEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "aclL3RuleAccessID"),
    (0, "DES-1210-08P_AX", "aclL3RuleProfileNo"),
)
if mibBuilder.loadTexts:
...
sysLBDCtrlEntry = _SysLBDCtrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 17, 4, 1)
)
sysLBDCtrlEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "sysLBDCtrlIndex"),
)
if mibBuilder.loadTexts:
...
sysLBDCtrlIndex = _SysLBDCtrlIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 17, 4, 1, 1),
...
sysLBDPortStatus = _SysLBDPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 17, 4, 1, 2),
...
sysLBDPortLoopStatus = _SysLBDPortLoopStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 17, 4, 1, 3),
...
sysTrapStatus = _SysTrapStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 19, 10),
    _SysTrapStatus_Type()
)
...
voicevlanPortControlEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "voicevlanPortControlIndex"),
)
if mibBuilder.loadTexts:
...
voicevlanOUIEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "voicevlanOUITelephonyOUI"),
)
if mibBuilder.loadTexts:
...
sysPoEPortSettingEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "poeportgroup"),
    (0, "DES-1210-08P_AX", "poeportid"),
)
if mibBuilder.loadTexts:
...
poeTimeRangeSettingEntry = _PoeTimeRangeSettingEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1)
)
poeTimeRangeSettingEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "poeTimeRangeSettingID"),
)
if mibBuilder.loadTexts:
...
poeTimeRangeSettingID = _PoeTimeRangeSettingID_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 1),
...
poeTimeBasedPoERangeName = _PoeTimeBasedPoERangeName_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 2),
...
poeTimeRangeDate = _PoeTimeRangeDate_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 3),
...
poeScheduleStartYear = _PoeScheduleStartYear_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 4),
...
poeScheduleStartMonth = _PoeScheduleStartMonth_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 5),
...
poeScheduleStartDay = _PoeScheduleStartDay_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 6),
...
poeScheduleStartHour = _PoeScheduleStartHour_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 7),
...
poeScheduleStartMinute = _PoeScheduleStartMinute_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 8),
...
poeScheduleEndYear = _PoeScheduleEndYear_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 9),
...
poeScheduleEndMonth = _PoeScheduleEndMonth_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 10),
...
poeScheduleEndDay = _PoeScheduleEndDay_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 11),
...
poeScheduleEndHour = _PoeScheduleEndHour_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 12),
...
poeScheduleEndMinute = _PoeScheduleEndMinute_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 13),
...
poeScheduleMonday = _PoeScheduleMonday_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 14),
...
poeScheduleTuesday = _PoeScheduleTuesday_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 15),
...
poeScheduleWednesday = _PoeScheduleWednesday_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 16),
...
poeScheduleThursday = _PoeScheduleThursday_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 17),
...
poeScheduleFriday = _PoeScheduleFriday_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 18),
...
poeScheduleSaturday = _PoeScheduleSaturday_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 19),
...
poeScheduleSunday = _PoeScheduleSunday_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 20),
...
poeTimeRangeRowStatus = _PoeTimeRangeRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 23, 1, 1, 21),
...
lldpRemOrgDefInfoEntry = _LldpRemOrgDefInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 24, 9, 1)
)
lldpRemOrgDefInfoEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "dlinklldpAntiRoguePortIndex"),
)
if mibBuilder.loadTexts:
...
dlinklldpAntiRoguePortIndex = _DlinklldpAntiRoguePortIndex_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 24, 9, 1, 1),
...
dlinklldpAntiRoguePortStatus = _DlinklldpAntiRoguePortStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 24, 9, 1, 2),
...
dlinklldpRemOrgDefInfoOUI = _DlinklldpRemOrgDefInfoOUI_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 24, 9, 1, 3),
...
snmpV3UserEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "snmpV3UserName"),
    (0, "DES-1210-08P_AX", "snmpV3UserVersion"),
)
if mibBuilder.loadTexts:
...
snmpV3GroupEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "snmpV3GroupName"),
    (0, "DES-1210-08P_AX", "snmpV3GroupSecurityModel"),
    (0, "DES-1210-08P_AX", "snmpV3GroupSecurityLevel"),
)
if mibBuilder.loadTexts:
...
snmpV3ViewTreeEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "snmpV3viewTreeName"),
    (0, "DES-1210-08P_AX", "snmpV3viewTreeSubtree"),
)
if mibBuilder.loadTexts:
...
snmpV3CommunityEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "snmpV3CommunityName"),
)
if mibBuilder.loadTexts:
...
snmpV3HostEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "snmpV3HostAddress"),
)
if mibBuilder.loadTexts:
...
snmpV3TrapOverMaxPowerBudget = _SnmpV3TrapOverMaxPowerBudget_Object(
    (1, 3, 6, 1, 4, 1, 171, 10, 75, 13, 25, 8, 9),
...
autoSurveillanceVlanOUIEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "autoSurveillanceVlanOUISurveillanceOUI"),
)
if mibBuilder.loadTexts:
...
mcastFilterPortEntry.setIndexNames(
    (0, "DES-1210-08P_AX", "mcastFilterPortIndex"),
)
if mibBuilder.loadTexts:
