# SNMP MIB module (ChrComPmOpticsOTS-SRC-Interval-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmOpticsOTS-SRC-Interval-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:28 2024
...
_ChrComPmOpticsOTS_SRC_IntervalTable_Object = MibTable
chrComPmOpticsOTS_SRC_IntervalTable = _ChrComPmOpticsOTS_SRC_IntervalTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 5)
)
if mibBuilder.loadTexts:
    chrComPmOpticsOTS_SRC_IntervalTable.setStatus("current")
_ChrComPmOpticsOTS_SRC_IntervalEntry_Object = MibTableRow
chrComPmOpticsOTS_SRC_IntervalEntry = _ChrComPmOpticsOTS_SRC_IntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 5, 1)
)
chrComPmOpticsOTS_SRC_IntervalEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmOpticsOTS-SRC-Interval-MIB", "chrComPmOpticsIntervalNumber"),
)
if mibBuilder.loadTexts:
    chrComPmOpticsOTS_SRC_IntervalEntry.setStatus("current")
...
chrComPmOpticsMin = _ChrComPmOpticsMin_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 5, 1, 10),
...
chrComPmOpticsSD = _ChrComPmOpticsSD_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 5, 1, 11),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmOpticsOTS-SRC-IntervalTable": chrComPmOpticsOTS_SRC_IntervalTable,
       "chrComPmOpticsOTS-SRC-IntervalEntry": chrComPmOpticsOTS_SRC_IntervalEntry,
