# SNMP MIB module (OMNI-gx2LM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/OMNI-gx2LM-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:34:23 2024
...
(gx2Lm,) = mibBuilder.importSymbols(
    "GX2HFC-MIB",
    "gx2Lm")
...
_Gx2lmDescriptor_ObjectIdentity = ObjectIdentity
gx2lmDescriptor = _Gx2lmDescriptor_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 1)
)
_Gx2lmAnalogTable_Object = MibTable
gx2lmAnalogTable = _Gx2lmAnalogTable_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2)
)
if mibBuilder.loadTexts:
    gx2lmAnalogTable.setStatus("mandatory")
_Gx2lmAnalogEntry_Object = MibTableRow
gx2lmAnalogEntry = _Gx2lmAnalogEntry_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1)
)
gx2lmAnalogEntry.setIndexNames(
    (0, "OMNI-gx2LM-MIB", "gx2lmAnalogTableIndex"),
)
if mibBuilder.loadTexts:
    gx2lmAnalogEntry.setStatus("mandatory")


class _Gx2lmAnalogTableIndex_Type(Integer32):
    """Custom type gx2lmAnalogTableIndex based on Integer32"""
...
_Gx2lmAnalogTableIndex_Type.__name__ = "Integer32"
_Gx2lmAnalogTableIndex_Object = MibTableColumn
gx2lmAnalogTableIndex = _Gx2lmAnalogTableIndex_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 1),
    _Gx2lmAnalogTableIndex_Type()
)
gx2lmAnalogTableIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    gx2lmAnalogTableIndex.setStatus("mandatory")
...
labelOffsetNomMonitor = _LabelOffsetNomMonitor_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 2),
...
uomOffsetNomMonitor = _UomOffsetNomMonitor_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 3),
...
majorHighOffsetNomMonitor = _MajorHighOffsetNomMonitor_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 4),
...
majorLowOffsetNomMonitor = _MajorLowOffsetNomMonitor_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 5),
...
minorHighOffsetNomMonitor = _MinorHighOffsetNomMonitor_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 6),
...
minorLowOffsetNomMonitor = _MinorLowOffsetNomMonitor_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 7),
...
currentValueOffsetNomMonitor = _CurrentValueOffsetNomMonitor_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 8),
...
stateFlagOffsetNomMonitor = _StateFlagOffsetNomMonitor_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 9),
...
minValueOffsetNomMonitor = _MinValueOffsetNomMonitor_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 10),
...
maxValueOffsetNomMonitor = _MaxValueOffsetNomMonitor_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 11),
...
alarmStateOffsetNomMonitor = _AlarmStateOffsetNomMonitor_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 12),
...
labelOffsetNomCnt = _LabelOffsetNomCnt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 13),
...
uomOffsetNomCnt = _UomOffsetNomCnt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 14),
...
majorHighOffsetNomCnt = _MajorHighOffsetNomCnt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 15),
...
majorLowOffsetNomCnt = _MajorLowOffsetNomCnt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 16),
...
minorHighOffsetNomCnt = _MinorHighOffsetNomCnt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 17),
...
minorLowOffsetNomCnt = _MinorLowOffsetNomCnt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 18),
...
currentValueOffsetNomCnt = _CurrentValueOffsetNomCnt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 19),
...
stateFlagOffsetNomCnt = _StateFlagOffsetNomCnt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 20),
...
minValueOffsetNomCnt = _MinValueOffsetNomCnt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 21),
...
maxValueOffsetNomCnt = _MaxValueOffsetNomCnt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 22),
...
alarmStateOffsetNomCnt = _AlarmStateOffsetNomCnt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 23),
...
labelRelAttenSetting = _LabelRelAttenSetting_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 24),
...
uomRelAttenSetting = _UomRelAttenSetting_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 25),
...
majorHighRelAttenSetting = _MajorHighRelAttenSetting_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 26),
...
majorLowRelAttenSetting = _MajorLowRelAttenSetting_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 27),
...
minorHighRelAttenSetting = _MinorHighRelAttenSetting_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 28),
...
minorLowRelAttenSetting = _MinorLowRelAttenSetting_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 29),
...
currentValueRelAttenSetting = _CurrentValueRelAttenSetting_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 30),
...
stateFlagRelAttenSetting = _StateFlagRelAttenSetting_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 31),
...
minValueRelAttenSetting = _MinValueRelAttenSetting_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 32),
...
maxValueRelAttenSetting = _MaxValueRelAttenSetting_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 33),
...
alarmStateRelAttenSetting = _AlarmStateRelAttenSetting_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 34),
...
labelOptPower = _LabelOptPower_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 35),
    _LabelOptPower_Type()
)
...
uomOptPower = _UomOptPower_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 36),
    _UomOptPower_Type()
)
...
majorHighOptPower = _MajorHighOptPower_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 37),
...
majorLowOptPower = _MajorLowOptPower_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 38),
...
minorHighOptPower = _MinorHighOptPower_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 39),
...
minorLowOptPower = _MinorLowOptPower_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 40),
...
currentValueOptPower = _CurrentValueOptPower_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 41),
...
stateFlagOptPower = _StateFlagOptPower_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 42),
...
minValueOptPower = _MinValueOptPower_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 43),
...
maxValueOptPower = _MaxValueOptPower_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 44),
...
alarmStateOptPower = _AlarmStateOptPower_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 45),
...
labelLaserBias = _LabelLaserBias_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 46),
...
uomLaserBias = _UomLaserBias_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 47),
    _UomLaserBias_Type()
)
...
majorHighLaserBias = _MajorHighLaserBias_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 48),
...
majorLowLaserBias = _MajorLowLaserBias_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 49),
...
minorHighLaserBias = _MinorHighLaserBias_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 50),
...
minorLowLaserBias = _MinorLowLaserBias_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 51),
...
currentValueLaserBias = _CurrentValueLaserBias_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 52),
...
stateFlagLaserBias = _StateFlagLaserBias_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 53),
...
minValueLaserBias = _MinValueLaserBias_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 54),
...
maxValueLaserBias = _MaxValueLaserBias_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 55),
...
alarmStateLaserBias = _AlarmStateLaserBias_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 56),
...
labelTecCurrent = _LabelTecCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 57),
...
uomTecCurrent = _UomTecCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 58),
    _UomTecCurrent_Type()
)
...
majorHighTecCurrent = _MajorHighTecCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 59),
...
majorLowTecCurrent = _MajorLowTecCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 60),
...
minorHighTecCurrent = _MinorHighTecCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 61),
...
minorLowTecCurrent = _MinorLowTecCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 62),
...
currentValueTecCurrent = _CurrentValueTecCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 63),
...
stateFlagTecCurrent = _StateFlagTecCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 64),
...
minValueTecCurrent = _MinValueTecCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 65),
...
maxValueTecCurrent = _MaxValueTecCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 66),
...
alarmStateTecCurrent = _AlarmStateTecCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 67),
...
labelLaserTemp = _LabelLaserTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 68),
...
uomLaserTemp = _UomLaserTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 69),
    _UomLaserTemp_Type()
)
...
majorHighLaserTemp = _MajorHighLaserTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 70),
...
majorLowLaserTemp = _MajorLowLaserTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 71),
...
minorHighLaserTemp = _MinorHighLaserTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 72),
...
minorLowLaserTemp = _MinorLowLaserTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 73),
...
currentValueLaserTemp = _CurrentValueLaserTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 74),
...
stateFlagLaserTemp = _StateFlagLaserTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 75),
...
minValueLaserTemp = _MinValueLaserTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 76),
...
maxValueLaserTemp = _MaxValueLaserTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 77),
...
alarmStateLaserTemp = _AlarmStateLaserTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 78),
...
labelModuleTemp = _LabelModuleTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 79),
...
uomModuleTemp = _UomModuleTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 80),
    _UomModuleTemp_Type()
)
...
majorHighModuleTemp = _MajorHighModuleTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 81),
...
majorLowModuleTemp = _MajorLowModuleTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 82),
...
minorHighModuleTemp = _MinorHighModuleTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 83),
...
minorLowModuleTemp = _MinorLowModuleTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 84),
...
currentValueModuleTemp = _CurrentValueModuleTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 85),
...
stateFlagModuleTemp = _StateFlagModuleTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 86),
...
minValueModuleTemp = _MinValueModuleTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 87),
...
maxValueModuleTemp = _MaxValueModuleTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 88),
...
alarmStateModuleTemp = _AlarmStateModuleTemp_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 89),
...
labelFanCurrent = _LabelFanCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 90),
...
uomFanCurrent = _UomFanCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 91),
    _UomFanCurrent_Type()
)
...
majorHighFanCurrent = _MajorHighFanCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 92),
...
majorLowFanCurrent = _MajorLowFanCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 93),
...
minorHighFanCurrent = _MinorHighFanCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 94),
...
minorLowFanCurrent = _MinorLowFanCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 95),
...
currentValueFanCurrent = _CurrentValueFanCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 96),
...
stateFlagFanCurrent = _StateFlagFanCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 97),
...
minValueFanCurrent = _MinValueFanCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 98),
...
maxValueFanCurrent = _MaxValueFanCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 99),
...
alarmStateFanCurrent = _AlarmStateFanCurrent_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 100),
...
label12Volt = _Label12Volt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 101),
    _Label12Volt_Type()
)
...
uom12Volt = _Uom12Volt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 102),
    _Uom12Volt_Type()
)
...
majorHigh12Volt = _MajorHigh12Volt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 103),
...
majorLow12Volt = _MajorLow12Volt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 104),
...
minorHigh12Volt = _MinorHigh12Volt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 105),
...
minorLow12Volt = _MinorLow12Volt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 106),
...
currentValue12Volt = _CurrentValue12Volt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 107),
...
stateFlag12Volt = _StateFlag12Volt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 108),
...
minValue12Volt = _MinValue12Volt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 109),
...
maxValue12Volt = _MaxValue12Volt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 110),
...
alarmState12Volt = _AlarmState12Volt_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 2, 1, 111),
    _AlarmState12Volt_Type()
)
alarmState12Volt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    alarmState12Volt.setStatus("mandatory")
_Gx2lmDigitalTable_Object = MibTable
gx2lmDigitalTable = _Gx2lmDigitalTable_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3)
)
if mibBuilder.loadTexts:
    gx2lmDigitalTable.setStatus("mandatory")
_Gx2lmDigitalEntry_Object = MibTableRow
gx2lmDigitalEntry = _Gx2lmDigitalEntry_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2)
)
gx2lmDigitalEntry.setIndexNames(
    (0, "OMNI-gx2LM-MIB", "gx2lmDigitalTableIndex"),
)
if mibBuilder.loadTexts:
    gx2lmDigitalEntry.setStatus("mandatory")


class _Gx2lmDigitalTableIndex_Type(Integer32):
    """Custom type gx2lmDigitalTableIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4294967295),
    )
...
_Gx2lmDigitalTableIndex_Type.__name__ = "Integer32"
_Gx2lmDigitalTableIndex_Object = MibTableColumn
gx2lmDigitalTableIndex = _Gx2lmDigitalTableIndex_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 1),
    _Gx2lmDigitalTableIndex_Type()
)
gx2lmDigitalTableIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    gx2lmDigitalTableIndex.setStatus("mandatory")
...
labelRfInput = _LabelRfInput_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 2),
    _LabelRfInput_Type()
)
...
enumRfInput = _EnumRfInput_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 3),
    _EnumRfInput_Type()
)
...
valueRfInput = _ValueRfInput_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 4),
    _ValueRfInput_Type()
)
...
stateflagRfInput = _StateflagRfInput_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 5),
...
labelOptOutput = _LabelOptOutput_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 6),
...
enumOptOutput = _EnumOptOutput_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 7),
    _EnumOptOutput_Type()
)
...
valueOptOutput = _ValueOptOutput_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 8),
...
stateflagOptOutput = _StateflagOptOutput_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 9),
...
labelLaserMode = _LabelLaserMode_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 10),
...
enumLaserMode = _EnumLaserMode_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 11),
    _EnumLaserMode_Type()
)
...
valueLaserMode = _ValueLaserMode_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 12),
...
stateflagLaserMode = _StateflagLaserMode_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 13),
...
labelLaserSecMode = _LabelLaserSecMode_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 14),
...
enumLaserSecMode = _EnumLaserSecMode_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 15),
...
valueLaserSecMode = _ValueLaserSecMode_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 16),
...
stateflagLaserSecMode = _StateflagLaserSecMode_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 17),
...
labelVideoOffset = _LabelVideoOffset_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 18),
...
enumVideoOffset = _EnumVideoOffset_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 19),
...
valueVideoOffset = _ValueVideoOffset_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 20),
...
stateflagVideoOffset = _StateflagVideoOffset_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 21),
...
labelFactoryDefault = _LabelFactoryDefault_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 22),
...
enumFactoryDefault = _EnumFactoryDefault_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 23),
...
valueFactoryDefault = _ValueFactoryDefault_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 24),
...
stateflagFactoryDefault = _StateflagFactoryDefault_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 3, 2, 25),
    _StateflagFactoryDefault_Type()
)
stateflagFactoryDefault.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    stateflagFactoryDefault.setStatus("mandatory")
_Gx2lmStatusTable_Object = MibTable
gx2lmStatusTable = _Gx2lmStatusTable_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4)
)
if mibBuilder.loadTexts:
    gx2lmStatusTable.setStatus("mandatory")
_Gx2lmStatusEntry_Object = MibTableRow
gx2lmStatusEntry = _Gx2lmStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3)
)
gx2lmStatusEntry.setIndexNames(
    (0, "OMNI-gx2LM-MIB", "gx2lmStatusTableIndex"),
)
if mibBuilder.loadTexts:
    gx2lmStatusEntry.setStatus("mandatory")


class _Gx2lmStatusTableIndex_Type(Integer32):
    """Custom type gx2lmStatusTableIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4294967295),
    )
...
_Gx2lmStatusTableIndex_Type.__name__ = "Integer32"
_Gx2lmStatusTableIndex_Object = MibTableColumn
gx2lmStatusTableIndex = _Gx2lmStatusTableIndex_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 1),
    _Gx2lmStatusTableIndex_Type()
)
gx2lmStatusTableIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    gx2lmStatusTableIndex.setStatus("mandatory")
...
labelBoot = _LabelBoot_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 2),
    _LabelBoot_Type()
)
...
valueBoot = _ValueBoot_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 3),
    _ValueBoot_Type()
)
...
stateflagBoot = _StateflagBoot_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 4),
    _StateflagBoot_Type()
)
...
labelFlash = _LabelFlash_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 5),
    _LabelFlash_Type()
)
...
valueFlash = _ValueFlash_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 6),
    _ValueFlash_Type()
)
...
stateflagFlash = _StateflagFlash_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 7),
...
labelFactoryDataCRC = _LabelFactoryDataCRC_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 8),
...
valueFactoryDataCRC = _ValueFactoryDataCRC_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 9),
...
stateflagFactoryDataCRC = _StateflagFactoryDataCRC_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 10),
...
labelLaserDataCRC = _LabelLaserDataCRC_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 11),
...
valueLaserDataCRC = _ValueLaserDataCRC_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 12),
...
stateflagLaserDataCRC = _StateflagLaserDataCRC_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 13),
...
labelAlarmDataCrc = _LabelAlarmDataCrc_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 14),
...
valueAlarmDataCrc = _ValueAlarmDataCrc_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 15),
...
stateflagAlarmDataCrc = _StateflagAlarmDataCrc_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 16),
...
labelHWStatus = _LabelHWStatus_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 17),
    _LabelHWStatus_Type()
)
...
valueHWStatus = _ValueHWStatus_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 18),
    _ValueHWStatus_Type()
)
...
stateflagHWStatus = _StateflagHWStatus_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 19),
...
labelRFInputStatus = _LabelRFInputStatus_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 20),
...
valueRFInputStatus = _ValueRFInputStatus_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 21),
...
stateflagRFInputStatus = _StateflagRFInputStatus_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 4, 3, 22),
    _StateflagRFInputStatus_Type()
)
stateflagRFInputStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    stateflagRFInputStatus.setStatus("mandatory")
_Gx2lmFactoryTable_Object = MibTable
gx2lmFactoryTable = _Gx2lmFactoryTable_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5)
)
if mibBuilder.loadTexts:
    gx2lmFactoryTable.setStatus("mandatory")
_Gx2lmFactoryEntry_Object = MibTableRow
gx2lmFactoryEntry = _Gx2lmFactoryEntry_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4)
)
gx2lmFactoryEntry.setIndexNames(
    (0, "OMNI-gx2LM-MIB", "gx2lmFactoryTableIndex"),
)
if mibBuilder.loadTexts:
    gx2lmFactoryEntry.setStatus("mandatory")


class _Gx2lmFactoryTableIndex_Type(Integer32):
    """Custom type gx2lmFactoryTableIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4294967295),
    )
...
_Gx2lmFactoryTableIndex_Type.__name__ = "Integer32"
_Gx2lmFactoryTableIndex_Object = MibTableColumn
gx2lmFactoryTableIndex = _Gx2lmFactoryTableIndex_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 1),
    _Gx2lmFactoryTableIndex_Type()
)
gx2lmFactoryTableIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    gx2lmFactoryTableIndex.setStatus("mandatory")
...
bootControlByteValue = _BootControlByteValue_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 2),
...
bootStatusByteValue = _BootStatusByteValue_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 3),
...
bank1CRCValue = _Bank1CRCValue_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 4),
    _Bank1CRCValue_Type()
)
...
bank2CRCValue = _Bank2CRCValue_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 5),
    _Bank2CRCValue_Type()
)
...
prgEEPROMByteValue = _PrgEEPROMByteValue_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 6),
...
factoryCRCValue = _FactoryCRCValue_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 7),
...
calculateCRCValue = _CalculateCRCValue_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 8),
...
hourMeterValue = _HourMeterValue_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 9),
...
flashPrgCntAValue = _FlashPrgCntAValue_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 10),
...
flashPrgCntBValue = _FlashPrgCntBValue_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 11),
...
flashBankARevValue = _FlashBankARevValue_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 12),
...
flashBankBRevValue = _FlashBankBRevValue_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 5, 4, 13),
    _FlashBankBRevValue_Type()
)
flashBankBRevValue.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    flashBankBRevValue.setStatus("mandatory")
_Gx2Lm1000HoldTimeTable_Object = MibTable
gx2Lm1000HoldTimeTable = _Gx2Lm1000HoldTimeTable_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 6)
)
if mibBuilder.loadTexts:
    gx2Lm1000HoldTimeTable.setStatus("mandatory")
_Gx2Lm1000HoldTimeEntry_Object = MibTableRow
gx2Lm1000HoldTimeEntry = _Gx2Lm1000HoldTimeEntry_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 6, 5)
)
gx2Lm1000HoldTimeEntry.setIndexNames(
    (0, "OMNI-gx2LM-MIB", "gx2Lm1000HoldTimeTableIndex"),
    (0, "OMNI-gx2LM-MIB", "gx2Lm1000HoldTimeSpecIndex"),
)
if mibBuilder.loadTexts:
    gx2Lm1000HoldTimeEntry.setStatus("mandatory")


class _Gx2Lm1000HoldTimeTableIndex_Type(Integer32):
    """Custom type gx2Lm1000HoldTimeTableIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4294967295),
    )
...
_Gx2Lm1000HoldTimeTableIndex_Type.__name__ = "Integer32"
_Gx2Lm1000HoldTimeTableIndex_Object = MibTableColumn
gx2Lm1000HoldTimeTableIndex = _Gx2Lm1000HoldTimeTableIndex_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 6, 5, 1),
    _Gx2Lm1000HoldTimeTableIndex_Type()
)
gx2Lm1000HoldTimeTableIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    gx2Lm1000HoldTimeTableIndex.setStatus("mandatory")


class _Gx2Lm1000HoldTimeSpecIndex_Type(Integer32):
    """Custom type gx2Lm1000HoldTimeSpecIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4294967295),
    )
...
_Gx2Lm1000HoldTimeSpecIndex_Type.__name__ = "Integer32"
_Gx2Lm1000HoldTimeSpecIndex_Object = MibTableColumn
gx2Lm1000HoldTimeSpecIndex = _Gx2Lm1000HoldTimeSpecIndex_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 6, 5, 2),
    _Gx2Lm1000HoldTimeSpecIndex_Type()
)
gx2Lm1000HoldTimeSpecIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    gx2Lm1000HoldTimeSpecIndex.setStatus("mandatory")
_Gx2Lm1000HoldTimeData_Type = Integer32
_Gx2Lm1000HoldTimeData_Object = MibTableColumn
gx2Lm1000HoldTimeData = _Gx2Lm1000HoldTimeData_Object(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 6, 5, 3),
    _Gx2Lm1000HoldTimeData_Type()
)
gx2Lm1000HoldTimeData.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gx2Lm1000HoldTimeData.setStatus("mandatory")
...
trapLMConfigChangeInteger = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 1)
)
trapLMConfigChangeInteger.setObjects(
...
if mibBuilder.loadTexts:
    trapLMConfigChangeInteger.setStatus(
        ""
    )

trapLMConfigChangeDisplayString = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 2)
)
trapLMConfigChangeDisplayString.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMConfigChangeDisplayString.setStatus(
        ""
    )

trapLMRFInputAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 3)
)
trapLMRFInputAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMRFInputAlarm.setStatus(
        ""
    )

trapLMRFOverloadAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 4)
)
trapLMRFOverloadAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMRFOverloadAlarm.setStatus(
        ""
    )

trapLMRFOffsetAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 5)
)
trapLMRFOffsetAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMRFOffsetAlarm.setStatus(
        ""
    )

trapLMOpticalPowerAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 6)
)
trapLMOpticalPowerAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMOpticalPowerAlarm.setStatus(
        ""
    )

trapLMLaserBiasAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 7)
)
trapLMLaserBiasAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMLaserBiasAlarm.setStatus(
        ""
    )

trapLMLaserTempAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 8)
)
trapLMLaserTempAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMLaserTempAlarm.setStatus(
        ""
    )

trapLMTECCurrentAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 9)
)
trapLMTECCurrentAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMTECCurrentAlarm.setStatus(
        ""
    )

trapLMFanCurrentAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 10)
)
trapLMFanCurrentAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMFanCurrentAlarm.setStatus(
        ""
    )

trapLM12vAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 11)
)
trapLM12vAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLM12vAlarm.setStatus(
        ""
    )

trapLMModuleTempAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 12)
)
trapLMModuleTempAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMModuleTempAlarm.setStatus(
        ""
    )

trapLMFlashAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 13)
)
trapLMFlashAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMFlashAlarm.setStatus(
        ""
    )

trapLMLaserBiasCntLoopAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 14)
)
trapLMLaserBiasCntLoopAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMLaserBiasCntLoopAlarm.setStatus(
        ""
    )

trapLMBankBootAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 15)
)
trapLMBankBootAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMBankBootAlarm.setStatus(
        ""
    )

trapLMLaserBiasCntLoopInitAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 16)
)
trapLMLaserBiasCntLoopInitAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMLaserBiasCntLoopInitAlarm.setStatus(
        ""
    )

trapLMRFParamInitAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 17)
)
trapLMRFParamInitAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMRFParamInitAlarm.setStatus(
        ""
    )

trapLMTECParamInitAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 18)
)
trapLMTECParamInitAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMTECParamInitAlarm.setStatus(
        ""
    )

trapLMAttnTableInitAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 19)
)
trapLMAttnTableInitAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMAttnTableInitAlarm.setStatus(
        ""
    )

trapLMPowerMeterTableInitAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 20)
)
trapLMPowerMeterTableInitAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMPowerMeterTableInitAlarm.setStatus(
        ""
    )

trapLMLaserDataCRCAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 21)
)
trapLMLaserDataCRCAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMLaserDataCRCAlarm.setStatus(
        ""
    )

trapLMAlarmDataCRCAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 22)
)
trapLMAlarmDataCRCAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMAlarmDataCRCAlarm.setStatus(
        ""
    )

trapLMFactoryDataCRCAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 23)
)
trapLMFactoryDataCRCAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMFactoryDataCRCAlarm.setStatus(
        ""
    )

trapLMUserRFOffAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 24)
)
trapLMUserRFOffAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMUserRFOffAlarm.setStatus(
        ""
    )

trapLMUserOpticalOffAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 25)
)
trapLMUserOpticalOffAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMUserOpticalOffAlarm.setStatus(
        ""
    )

trapLMResetFactoryDefaultAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 1166, 6, 1, 2, 4, 0, 26)
)
trapLMResetFactoryDefaultAlarm.setObjects(
      *(("NLSBBN-TRAPS-MIB", "trapIdentifier"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemModelNumber"),
        ("NLSBBN-TRAPS-MIB", "trapNetworkElemSerialNum"),
        ("NLSBBN-TRAPS-MIB", "trapPerceivedSeverity"),
...
if mibBuilder.loadTexts:
    trapLMResetFactoryDefaultAlarm.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    "OMNI-gx2LM-MIB",
    **{"Float": Float,
       "trapLMConfigChangeInteger": trapLMConfigChangeInteger,
       "trapLMConfigChangeDisplayString": trapLMConfigChangeDisplayString,
       "trapLMRFInputAlarm": trapLMRFInputAlarm,
       "trapLMRFOverloadAlarm": trapLMRFOverloadAlarm,
       "trapLMRFOffsetAlarm": trapLMRFOffsetAlarm,
       "trapLMOpticalPowerAlarm": trapLMOpticalPowerAlarm,
       "trapLMLaserBiasAlarm": trapLMLaserBiasAlarm,
       "trapLMLaserTempAlarm": trapLMLaserTempAlarm,
       "trapLMTECCurrentAlarm": trapLMTECCurrentAlarm,
       "trapLMFanCurrentAlarm": trapLMFanCurrentAlarm,
       "trapLM12vAlarm": trapLM12vAlarm,
       "trapLMModuleTempAlarm": trapLMModuleTempAlarm,
       "trapLMFlashAlarm": trapLMFlashAlarm,
       "trapLMLaserBiasCntLoopAlarm": trapLMLaserBiasCntLoopAlarm,
       "trapLMBankBootAlarm": trapLMBankBootAlarm,
       "trapLMLaserBiasCntLoopInitAlarm": trapLMLaserBiasCntLoopInitAlarm,
       "trapLMRFParamInitAlarm": trapLMRFParamInitAlarm,
       "trapLMTECParamInitAlarm": trapLMTECParamInitAlarm,
       "trapLMAttnTableInitAlarm": trapLMAttnTableInitAlarm,
       "trapLMPowerMeterTableInitAlarm": trapLMPowerMeterTableInitAlarm,
       "trapLMLaserDataCRCAlarm": trapLMLaserDataCRCAlarm,
       "trapLMAlarmDataCRCAlarm": trapLMAlarmDataCRCAlarm,
       "trapLMFactoryDataCRCAlarm": trapLMFactoryDataCRCAlarm,
       "trapLMUserRFOffAlarm": trapLMUserRFOffAlarm,
       "trapLMUserOpticalOffAlarm": trapLMUserOpticalOffAlarm,
       "trapLMResetFactoryDefaultAlarm": trapLMResetFactoryDefaultAlarm,
       "gx2lmDescriptor": gx2lmDescriptor,
       "gx2lmAnalogTable": gx2lmAnalogTable,
       "gx2lmAnalogEntry": gx2lmAnalogEntry,
       "gx2lmAnalogTableIndex": gx2lmAnalogTableIndex,
       ...
       "gx2lmDigitalTable": gx2lmDigitalTable,
       "gx2lmDigitalEntry": gx2lmDigitalEntry,
       "gx2lmDigitalTableIndex": gx2lmDigitalTableIndex,
       ...
       "gx2lmStatusTable": gx2lmStatusTable,
       "gx2lmStatusEntry": gx2lmStatusEntry,
       "gx2lmStatusTableIndex": gx2lmStatusTableIndex,
       "labelBoot": labelBoot,
       "valueBoot": valueBoot,
       ...
       "gx2lmFactoryTable": gx2lmFactoryTable,
       "gx2lmFactoryEntry": gx2lmFactoryEntry,
       ...
       "gx2Lm1000HoldTimeTable": gx2Lm1000HoldTimeTable,
       "gx2Lm1000HoldTimeEntry": gx2Lm1000HoldTimeEntry,
       "gx2Lm1000HoldTimeTableIndex": gx2Lm1000HoldTimeTableIndex,
       "gx2Lm1000HoldTimeSpecIndex": gx2Lm1000HoldTimeSpecIndex,
       "gx2Lm1000HoldTimeData": gx2Lm1000HoldTimeData}
)
