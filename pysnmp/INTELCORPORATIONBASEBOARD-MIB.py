# SNMP MIB module (INTELCORPORATIONBASEBOARD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/INTELCORPORATIONBASEBOARD-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:10:13 2024
...
a1Manufacturer = _A1Manufacturer_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1, 1, 1),
...
a1Product = _A1Product_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1, 1, 2),
    _A1Product_Type()
)
...
a1Version = _A1Version_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1, 1, 3),
    _A1Version_Type()
)
...
a1SerialNumber = _A1SerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1, 1, 4),
...
a1Installation = _A1Installation_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1, 1, 5),
...
a1Verify = _A1Verify_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1, 1, 6),
    _A1Verify_Type()
)
...
eGeneralInformation = _EGeneralInformation_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 2, 1)
)
...
a2SystemName = _A2SystemName_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 2, 1, 1),
    _A2SystemName_Type()
)
...
a2SystemLocation = _A2SystemLocation_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 2, 1, 2),
...
a2SystemPrimaryUserName = _A2SystemPrimaryUserName_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 2, 1, 3),
...
a2SystemPrimaryUserPhone = _A2SystemPrimaryUserPhone_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 2, 1, 4),
...
a2SystemBootupTime = _A2SystemBootupTime_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 2, 1, 5),
...
a2SystemDateTime = _A2SystemDateTime_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 2, 1, 6),
...
a4BiosIndex = _A4BiosIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 4, 1, 1),
    _A4BiosIndex_Type()
)
...
a4BiosManufacturer = _A4BiosManufacturer_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 4, 1, 2),
...
a4BiosVersion = _A4BiosVersion_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 4, 1, 3),
    _A4BiosVersion_Type()
)
...
a4BiosRomSize = _A4BiosRomSize_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 4, 1, 4),
    _A4BiosRomSize_Type()
)
...
a4BiosStartingAddress = _A4BiosStartingAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 4, 1, 5),
...
a4BiosEndingAddress = _A4BiosEndingAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 4, 1, 6),
...
a4BiosLoaderVersion = _A4BiosLoaderVersion_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 4, 1, 7),
...
a4BiosReleaseDate = _A4BiosReleaseDate_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 4, 1, 8),
...
a4PrimaryBios = _A4PrimaryBios_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 4, 1, 9),
    _A4PrimaryBios_Type()
)
...
eSystemBiosCharacteristics = _ESystemBiosCharacteristics_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 5, 1)
)
eSystemBiosCharacteristics.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a5BiosCharacteristicIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a5BiosNumber"),
)
if mibBuilder.loadTexts:
...
a5BiosCharacteristicIndex = _A5BiosCharacteristicIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 5, 1, 1),
...
a5BiosNumber = _A5BiosNumber_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 5, 1, 2),
    _A5BiosNumber_Type()
)
...
a5BiosCharacteristic = _A5BiosCharacteristic_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 5, 1, 3),
...
a5BiosCharacteristicDescription = _A5BiosCharacteristicDescription_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 5, 1, 4),
...
a6ProcessorIndex = _A6ProcessorIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 1),
...
a6ProcessorType = _A6ProcessorType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 2),
...
a6ProcessorFamily = _A6ProcessorFamily_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 3),
...
a6ProcessorVersionInformation = _A6ProcessorVersionInformation_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 4),
...
a6MaximumSpeed = _A6MaximumSpeed_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 5),
...
a6CurrentSpeed = _A6CurrentSpeed_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 6),
...
a6ProcessorUpgrade = _A6ProcessorUpgrade_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 7),
...
a6FruGroupIndex = _A6FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 8),
...
a6OperationalGroupIndex = _A6OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 9),
...
a6Level1CacheIndex = _A6Level1CacheIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 10),
...
a6Level2CacheIndex = _A6Level2CacheIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 11),
...
a6Level3CacheIndex = _A6Level3CacheIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 12),
...
a6Status = _A6Status_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 6, 1, 13),
    _A6Status_Type()
)
...
a7NumberOfExpansionSlots = _A7NumberOfExpansionSlots_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 7, 1, 1),
...
a7FruGroupIndex = _A7FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 7, 1, 2),
...
a7OperationalGroupIndex = _A7OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 7, 1, 3),
...
a10SystemCacheIndex = _A10SystemCacheIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 10, 1, 1),
...
a10SystemCacheLevel = _A10SystemCacheLevel_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 10, 1, 2),
...
a10SystemCacheSpeed = _A10SystemCacheSpeed_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 10, 1, 3),
...
a10SystemCacheSize = _A10SystemCacheSize_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 10, 1, 4),
...
a10SystemCacheWritePolicy = _A10SystemCacheWritePolicy_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 10, 1, 5),
...
a10SystemCacheErrorCorrection = _A10SystemCacheErrorCorrection_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 10, 1, 6),
...
a10FruGroupIndex = _A10FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 10, 1, 7),
...
a10OperationalGroupIndex = _A10OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 10, 1, 8),
...
a10SystemCacheType = _A10SystemCacheType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 10, 1, 9),
...
a17PowerSupplyIndex = _A17PowerSupplyIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 1),
...
a17FruGroupIndex = _A17FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 2),
...
a17OperationalGroupIndex = _A17OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 3),
...
a17PowerUnitIndex = _A17PowerUnitIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 4),
...
a17PowerSupplyType = _A17PowerSupplyType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 5),
...
a17InputVoltageCapabilityDescription = _A17InputVoltageCapabilityDescription_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 6),
...
a17Range1InputVoltageLow = _A17Range1InputVoltageLow_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 7),
...
a17Range1InputVoltageHigh = _A17Range1InputVoltageHigh_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 8),
...
a17Range1VoltageProbeIndex = _A17Range1VoltageProbeIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 9),
...
a17Range1ElectricalCurrentProbeIndex = _A17Range1ElectricalCurrentProbeIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 10),
...
a17Range2InputVoltageLow = _A17Range2InputVoltageLow_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 11),
...
a17Range2InputVoltageHigh = _A17Range2InputVoltageHigh_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 12),
...
a17Range2VoltageProbeIndex = _A17Range2VoltageProbeIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 13),
...
a17Range2CurrentProbeIndex = _A17Range2CurrentProbeIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 14),
...
a17ActiveInputVoltageRange = _A17ActiveInputVoltageRange_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 15),
...
a17InputVoltageRangeSwitching = _A17InputVoltageRangeSwitching_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 16),
...
a17Range1InputFrequencyLow = _A17Range1InputFrequencyLow_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 17),
...
a17Range1InputFrequencyHigh = _A17Range1InputFrequencyHigh_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 18),
...
a17Range2InputFrequencyLow = _A17Range2InputFrequencyLow_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 19),
...
a17Range2InputFrequencyHigh = _A17Range2InputFrequencyHigh_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 20),
...
a17TotalOutputPower = _A17TotalOutputPower_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 17, 1, 21),
...
a19SlotIndex = _A19SlotIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 1),
    _A19SlotIndex_Type()
)
...
a19SlotType = _A19SlotType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 2),
    _A19SlotType_Type()
)
...
a19SlotWidth = _A19SlotWidth_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 3),
    _A19SlotWidth_Type()
)
...
a19CurrentUsage = _A19CurrentUsage_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 4),
...
a19SlotDescription = _A19SlotDescription_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 5),
...
a19SlotCategory = _A19SlotCategory_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 6),
...
a19VirtualSlot = _A19VirtualSlot_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 7),
...
a19ResourceUserId = _A19ResourceUserId_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 8),
...
a19VccMixedVoltageSupport = _A19VccMixedVoltageSupport_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 9),
...
a19VppMixedVoltageSupport = _A19VppMixedVoltageSupport_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 10),
...
a19SlotThermalRating = _A19SlotThermalRating_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 11),
...
a19OperationalGroupIndex = _A19OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 12),
...
a19SlotPowerState = _A19SlotPowerState_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 13),
...
a19SlotFaultState = _A19SlotFaultState_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 14),
...
a19SlotSwitchStatus = _A19SlotSwitchStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 19, 1, 15),
...
eCoolingUnitGlobalTable = _ECoolingUnitGlobalTable_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 28, 1)
)
eCoolingUnitGlobalTable.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a28CoolingUnitIndex"),
)
if mibBuilder.loadTexts:
...
a28CoolingUnitIndex = _A28CoolingUnitIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 28, 1, 1),
...
a28CoolingUnitStatus = _A28CoolingUnitStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 28, 1, 2),
...
eFieldReplaceableUnit = _EFieldReplaceableUnit_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1)
)
eFieldReplaceableUnit.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a30FruIndex"),
)
if mibBuilder.loadTexts:
...
a30FruIndex = _A30FruIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1, 1),
    _A30FruIndex_Type()
)
...
a30DeviceGroupIndex = _A30DeviceGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1, 2),
...
a30Description = _A30Description_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1, 3),
...
a30Manufacturer = _A30Manufacturer_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1, 4),
...
a30Model = _A30Model_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1, 5),
    _A30Model_Type()
)
...
a30PartNumber = _A30PartNumber_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1, 6),
    _A30PartNumber_Type()
)
...
a30FruSerialNumber = _A30FruSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1, 7),
...
a30RevisionLevel = _A30RevisionLevel_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1, 8),
...
a30WarrantyStartDate = _A30WarrantyStartDate_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1, 9),
...
a30WarrantyDuration = _A30WarrantyDuration_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1, 10),
...
a30SupportPhoneNumber = _A30SupportPhoneNumber_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1, 11),
...
a30FruInternetUniformResourceLocator = _A30FruInternetUniformResourceLocator_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 30, 1, 12),
...
a31OperationalStateInstanceIndex = _A31OperationalStateInstanceIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 31, 1, 1),
...
a31DeviceGroupIndex = _A31DeviceGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 31, 1, 2),
...
a31OperationalStatus = _A31OperationalStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 31, 1, 3),
...
a31UsageState = _A31UsageState_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 31, 1, 4),
    _A31UsageState_Type()
)
...
a31AvailabilityStatus = _A31AvailabilityStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 31, 1, 5),
...
a31AdministrativeState = _A31AdministrativeState_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 31, 1, 6),
...
a31FatalErrorCount = _A31FatalErrorCount_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 31, 1, 7),
...
a31MajorErrorCount = _A31MajorErrorCount_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 31, 1, 8),
...
a31WarningErrorCount = _A31WarningErrorCount_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 31, 1, 9),
...
a31CurrentErrorStatus = _A31CurrentErrorStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 31, 1, 10),
...
a31DevicePredictedFailureStatus = _A31DevicePredictedFailureStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 31, 1, 11),
...
ePhysicalMemoryArray = _EPhysicalMemoryArray_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1)
)
ePhysicalMemoryArray.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a34MemoryArrayTableIndex"),
)
if mibBuilder.loadTexts:
...
a34MemoryArrayTableIndex = _A34MemoryArrayTableIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 1),
...
a34MemoryArrayLocation = _A34MemoryArrayLocation_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 2),
...
a34MemoryArrayUse = _A34MemoryArrayUse_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 3),
...
a34MaximumMemoryCapacity = _A34MaximumMemoryCapacity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 4),
...
a34NumberOfMemoryDeviceSockets = _A34NumberOfMemoryDeviceSockets_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 5),
...
a34NumberOfMemoryDeviceSocketsUsed = _A34NumberOfMemoryDeviceSocketsUsed_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 6),
...
a34MemoryErrorCorrection = _A34MemoryErrorCorrection_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 7),
...
a34ArrayErrorType = _A34ArrayErrorType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 8),
...
a34LastErrorUpdate = _A34LastErrorUpdate_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 9),
...
a34ErrorOperation = _A34ErrorOperation_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 10),
...
a34ErrorDataSize = _A34ErrorDataSize_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 11),
...
a34ErrorData = _A34ErrorData_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 12),
    _A34ErrorData_Type()
)
...
a34VendorSyndrome = _A34VendorSyndrome_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 13),
...
a34ErrorAddress = _A34ErrorAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 14),
...
a34ErrorResolution = _A34ErrorResolution_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 15),
...
a34FruGroupIndex = _A34FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 16),
...
a34OperationalGroupIndex = _A34OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 34, 1, 17),
...
eMemoryArrayMappedAddresses = _EMemoryArrayMappedAddresses_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 35, 1)
)
eMemoryArrayMappedAddresses.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a35MemoryArrayMappedAddressesTableIndex"),
)
if mibBuilder.loadTexts:
...
a35MemoryArrayMappedAddressesTableIndex = _A35MemoryArrayMappedAddressesTableIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 35, 1, 1),
...
a35MemoryArrayIndex = _A35MemoryArrayIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 35, 1, 2),
...
a35MappedRangeStartingAddress = _A35MappedRangeStartingAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 35, 1, 3),
...
a35MappedRangeEndingAddress = _A35MappedRangeEndingAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 35, 1, 4),
...
a35PartitionId = _A35PartitionId_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 35, 1, 5),
...
a35PartitionWidth = _A35PartitionWidth_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 35, 1, 6),
...
a35OperationalGroupIndex = _A35OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 35, 1, 7),
...
a36MemoryDeviceTableIndex = _A36MemoryDeviceTableIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 1),
...
a36MemoryArrayIndex = _A36MemoryArrayIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 2),
...
a36DeviceLocator = _A36DeviceLocator_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 3),
...
a36BankLocator = _A36BankLocator_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 4),
...
a36Size = _A36Size_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 5),
    _A36Size_Type()
)
...
a36FormFactor = _A36FormFactor_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 6),
    _A36FormFactor_Type()
)
...
a36TotalWidth = _A36TotalWidth_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 7),
    _A36TotalWidth_Type()
)
...
a36DataWidth = _A36DataWidth_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 8),
    _A36DataWidth_Type()
)
...
a36MemoryType = _A36MemoryType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 9),
    _A36MemoryType_Type()
)
...
a36TypeDetail = _A36TypeDetail_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 10),
    _A36TypeDetail_Type()
)
...
a36DeviceSet = _A36DeviceSet_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 11),
    _A36DeviceSet_Type()
)
...
a36DeviceErrorType = _A36DeviceErrorType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 12),
...
a36ErrorGranularity = _A36ErrorGranularity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 13),
...
a36LastErrorUpdate = _A36LastErrorUpdate_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 14),
...
a36ErrorOperation = _A36ErrorOperation_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 15),
...
a36ErrorDataSize = _A36ErrorDataSize_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 16),
...
a36ErrorData = _A36ErrorData_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 17),
    _A36ErrorData_Type()
)
...
a36VendorSyndrome = _A36VendorSyndrome_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 18),
...
a36DeviceErrorAddress = _A36DeviceErrorAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 19),
...
a36ArrayErrorAddress = _A36ArrayErrorAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 20),
...
a36ErrorResolution = _A36ErrorResolution_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 21),
...
a36FruGroupIndex = _A36FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 22),
...
a36OperationalGroupIndex = _A36OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 36, 1, 23),
...
eMemoryDeviceMappedAddresses = _EMemoryDeviceMappedAddresses_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 37, 1)
)
eMemoryDeviceMappedAddresses.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a37MemoryDeviceMappedAddressesTableIndex"),
)
if mibBuilder.loadTexts:
...
a37MemoryDeviceMappedAddressesTableIndex = _A37MemoryDeviceMappedAddressesTableIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 37, 1, 1),
...
a37MemoryDeviceSetId = _A37MemoryDeviceSetId_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 37, 1, 2),
...
a37Partition = _A37Partition_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 37, 1, 3),
    _A37Partition_Type()
)
...
a37MappedRangeStartingAddress = _A37MappedRangeStartingAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 37, 1, 4),
...
a37MappedRangeEndingAddress = _A37MappedRangeEndingAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 37, 1, 5),
...
a37PartitionRowPosition = _A37PartitionRowPosition_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 37, 1, 6),
...
a37InterleavePosition = _A37InterleavePosition_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 37, 1, 7),
...
a37DataDepth = _A37DataDepth_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 37, 1, 8),
    _A37DataDepth_Type()
)
...
eSystemHardwareSecurity = _ESystemHardwareSecurity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 50, 1)
)
...
a50Power_onPasswordStatus = _A50Power_onPasswordStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 50, 1, 1),
...
a50KeyboardPasswordStatus = _A50KeyboardPasswordStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 50, 1, 2),
...
a50AdministratorPasswordStatus = _A50AdministratorPasswordStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 50, 1, 3),
...
a50FrontPanelResetStatus = _A50FrontPanelResetStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 50, 1, 4),
...
eSystemPowerControls = _ESystemPowerControls_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 52, 1)
)
...
a52PowerControlRequest = _A52PowerControlRequest_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 52, 1, 1),
...
a52TimedPower_onAvailable = _A52TimedPower_onAvailable_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 52, 1, 2),
...
a52TimeToNextScheduledPower_on = _A52TimeToNextScheduledPower_on_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 52, 1, 3),
...
a54VoltageProbeIndex = _A54VoltageProbeIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 1),
...
a54VoltageProbeLocation = _A54VoltageProbeLocation_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 2),
...
a54VoltageProbeDescription = _A54VoltageProbeDescription_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 3),
...
a54VoltageStatus = _A54VoltageStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 4),
...
a54VoltageProbeVoltageLevel = _A54VoltageProbeVoltageLevel_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 5),
...
a54MonitoredVoltageNominalLevel = _A54MonitoredVoltageNominalLevel_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 6),
...
a54MonitoredVoltageNormalMaximum = _A54MonitoredVoltageNormalMaximum_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 7),
...
a54MonitoredVoltageNormalMinimum = _A54MonitoredVoltageNormalMinimum_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 8),
...
a54VoltageProbeMaximum = _A54VoltageProbeMaximum_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 9),
...
a54VoltageProbeMinimum = _A54VoltageProbeMinimum_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 10),
...
a54VoltageLevelLowerThreshold_Non_critic = _A54VoltageLevelLowerThreshold_Non_critic_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 11),
...
a54VoltageLevelUpperThreshold_Non_critic = _A54VoltageLevelUpperThreshold_Non_critic_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 12),
...
a54VoltageLevelLowerThreshold_Critical = _A54VoltageLevelLowerThreshold_Critical_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 13),
...
a54VoltageLevelUpperThreshold_Critical = _A54VoltageLevelUpperThreshold_Critical_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 14),
...
a54VoltageLevelLowerThreshold_Non_recove = _A54VoltageLevelLowerThreshold_Non_recove_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 15),
...
a54VoltageLevelUpperThreshold_Non_recove = _A54VoltageLevelUpperThreshold_Non_recove_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 16),
...
a54VoltageProbeResolution = _A54VoltageProbeResolution_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 17),
...
a54VoltageProbeTolerance = _A54VoltageProbeTolerance_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 18),
...
a54VoltageProbeAccuracy = _A54VoltageProbeAccuracy_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 19),
...
a54FruGroupIndex = _A54FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 20),
...
a54OperationalGroupIndex = _A54OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 54, 1, 21),
...
a55TemperatureProbeTableIndex = _A55TemperatureProbeTableIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 1),
...
a55TemperatureProbeLocation = _A55TemperatureProbeLocation_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 2),
...
a55TemperatureProbeDescription = _A55TemperatureProbeDescription_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 3),
...
a55TemperatureStatus = _A55TemperatureStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 4),
...
a55TemperatureProbeTemperatureReading = _A55TemperatureProbeTemperatureReading_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 5),
...
a55MonitoredTemperatureNominalReading = _A55MonitoredTemperatureNominalReading_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 6),
...
a55MonitoredTemperatureNormalMaximum = _A55MonitoredTemperatureNormalMaximum_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 7),
...
a55MonitoredTemperatureNormalMinimum = _A55MonitoredTemperatureNormalMinimum_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 8),
...
a55TemperatureProbeMaximum = _A55TemperatureProbeMaximum_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 9),
...
a55TemperatureProbeMinimum = _A55TemperatureProbeMinimum_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 10),
...
a55TemperatureLowerThreshold_Non_critica = _A55TemperatureLowerThreshold_Non_critica_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 11),
...
a55TemperatureUpperThreshold_Non_critica = _A55TemperatureUpperThreshold_Non_critica_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 12),
...
a55TemperatureLowerThreshold_Critical = _A55TemperatureLowerThreshold_Critical_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 13),
...
a55TemperatureUpperThreshold_Critical = _A55TemperatureUpperThreshold_Critical_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 14),
...
a55TemperatureLowerThreshold_Non_recover = _A55TemperatureLowerThreshold_Non_recover_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 15),
...
a55TemperatureUpperThreshold_Non_recover = _A55TemperatureUpperThreshold_Non_recover_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 16),
...
a55TemperatureProbeResolution = _A55TemperatureProbeResolution_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 17),
...
a55TemperatureProbeTolerance = _A55TemperatureProbeTolerance_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 18),
...
a55TemperatureProbeAccuracy = _A55TemperatureProbeAccuracy_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 19),
...
a55FruGroupIndex = _A55FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 20),
...
a55OperationalGroupIndex = _A55OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 55, 1, 21),
...
ePhysicalContainerGlobalTable = _EPhysicalContainerGlobalTable_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1)
)
ePhysicalContainerGlobalTable.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a64ContainerIndex"),
)
if mibBuilder.loadTexts:
...
a64ContainerOrChassisType = _A64ContainerOrChassisType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1, 1),
...
a64AssetTag = _A64AssetTag_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1, 2),
    _A64AssetTag_Type()
)
...
a64ChassisLockPresent = _A64ChassisLockPresent_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1, 3),
...
a64BootupState = _A64BootupState_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1, 4),
...
a64PowerState = _A64PowerState_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1, 5),
    _A64PowerState_Type()
)
...
a64ThermalState = _A64ThermalState_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1, 6),
...
a64FruGroupIndex = _A64FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1, 7),
...
a64OperationalGroupIndex = _A64OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1, 8),
...
a64ContainerIndex = _A64ContainerIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1, 9),
...
a64ContainerName = _A64ContainerName_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1, 10),
...
a64ContainerLocation = _A64ContainerLocation_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1, 11),
...
a64ContainerSecurityStatus = _A64ContainerSecurityStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 64, 1, 12),
...
a66OperatingSystemIndex = _A66OperatingSystemIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 66, 1, 1),
...
a66OperatingSystemName = _A66OperatingSystemName_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 66, 1, 2),
...
a66OperatingSystemVersion = _A66OperatingSystemVersion_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 66, 1, 3),
...
a66PrimaryOperatingSystem = _A66PrimaryOperatingSystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 66, 1, 4),
...
a66OperatingSystemBootDeviceStorageType = _A66OperatingSystemBootDeviceStorageType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 66, 1, 5),
...
a66OperatingSystemBootDeviceIndex = _A66OperatingSystemBootDeviceIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 66, 1, 6),
...
a66OperatingSystemBootPartitionIndex = _A66OperatingSystemBootPartitionIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 66, 1, 7),
...
a66OperatingSystemDescription = _A66OperatingSystemDescription_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 66, 1, 8),
...
ePowerUnitGlobalTable = _EPowerUnitGlobalTable_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 67, 1)
)
ePowerUnitGlobalTable.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a67PowerUnitIndex"),
)
if mibBuilder.loadTexts:
...
a67PowerUnitIndex = _A67PowerUnitIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 67, 1, 1),
...
a67PowerUnitRedundancyStatus = _A67PowerUnitRedundancyStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 67, 1, 2),
...
a74ParallelPortIndex = _A74ParallelPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 74, 1, 1),
...
a74ParallelBaseIoAddress = _A74ParallelBaseIoAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 74, 1, 2),
...
a74IrqUsed = _A74IrqUsed_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 74, 1, 3),
    _A74IrqUsed_Type()
)
...
a74LogicalName = _A74LogicalName_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 74, 1, 4),
...
a74ConnectorType = _A74ConnectorType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 74, 1, 5),
...
a74ConnectorPinout = _A74ConnectorPinout_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 74, 1, 6),
...
a74DmaSupport = _A74DmaSupport_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 74, 1, 7),
    _A74DmaSupport_Type()
)
...
a74ParallelPortCapabilities = _A74ParallelPortCapabilities_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 74, 1, 8),
...
a74OperationalGroupIndex = _A74OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 74, 1, 9),
...
a74ParallelPortSecuritySettings = _A74ParallelPortSecuritySettings_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 74, 1, 10),
...
a75SerialPortIndex = _A75SerialPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 75, 1, 1),
...
a75SerialBaseIoAddress = _A75SerialBaseIoAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 75, 1, 2),
...
a75IrqUsed = _A75IrqUsed_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 75, 1, 3),
    _A75IrqUsed_Type()
)
...
a75LogicalName = _A75LogicalName_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 75, 1, 4),
...
a75ConnectorType = _A75ConnectorType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 75, 1, 5),
...
a75MaximumSpeed = _A75MaximumSpeed_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 75, 1, 6),
...
a75SerialPortCapabilities = _A75SerialPortCapabilities_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 75, 1, 7),
...
a75OperationalGroupIndex = _A75OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 75, 1, 8),
...
a75SerialPortSecuritySettings = _A75SerialPortSecuritySettings_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 75, 1, 9),
...
a81CoolingDeviceTableIndex = _A81CoolingDeviceTableIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 81, 1, 1),
...
a81FruGroupIndex = _A81FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 81, 1, 2),
...
a81OperationalGroupIndex = _A81OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 81, 1, 3),
...
a81CoolingUnitIndex = _A81CoolingUnitIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 81, 1, 4),
...
a81CoolingDeviceType = _A81CoolingDeviceType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 81, 1, 5),
...
a81TemperatureProbeIndex = _A81TemperatureProbeIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 81, 1, 6),
...
tVideo = _TVideo_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83)
)
if mibBuilder.loadTexts:
    tVideo.setStatus("mandatory")
_EVideo_Object = MibTableRow
eVideo = _EVideo_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1)
)
eVideo.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a83VideoIndex"),
)
if mibBuilder.loadTexts:
...
a83VideoIndex = _A83VideoIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 1),
    _A83VideoIndex_Type()
)
...
a83VideoType = _A83VideoType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 2),
    _A83VideoType_Type()
)
...
a83CurrentVideoMode = _A83CurrentVideoMode_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 3),
...
a83MinimumRefreshRate = _A83MinimumRefreshRate_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 4),
...
a83MaximumRefreshRate = _A83MaximumRefreshRate_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 5),
...
a83VideoMemoryType = _A83VideoMemoryType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 6),
...
a83VideoRamMemorySize = _A83VideoRamMemorySize_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 7),
...
a83ScanMode = _A83ScanMode_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 8),
    _A83ScanMode_Type()
)
...
a83VideoPhysicalLocation = _A83VideoPhysicalLocation_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 9),
...
a83CurrentVerticalResolution = _A83CurrentVerticalResolution_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 10),
...
a83CurrentHorizontalResolution = _A83CurrentHorizontalResolution_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 11),
...
a83CurrentNumberOfBitsPerPixel = _A83CurrentNumberOfBitsPerPixel_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 12),
...
a83CurrentNumberOfRows = _A83CurrentNumberOfRows_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 13),
...
a83CurrentNumberOfColumns = _A83CurrentNumberOfColumns_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 14),
...
a83CurrentRefreshRate = _A83CurrentRefreshRate_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 15),
...
a83FruGroupIndex = _A83FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 16),
...
a83OperationalGroupIndex = _A83OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 83, 1, 17),
...
a84VideoBiosIndex = _A84VideoBiosIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 84, 1, 1),
...
a84VideoBiosManufacturer = _A84VideoBiosManufacturer_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 84, 1, 2),
...
a84VideoBiosVersion = _A84VideoBiosVersion_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 84, 1, 3),
...
a84VideoBiosReleaseDate = _A84VideoBiosReleaseDate_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 84, 1, 4),
...
a84VideoBiosShadowingState = _A84VideoBiosShadowingState_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 84, 1, 5),
...
a91MouseInterface = _A91MouseInterface_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 91, 1, 1),
...
a91MouseIrq = _A91MouseIrq_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 91, 1, 2),
    _A91MouseIrq_Type()
)
...
a91MouseButtons = _A91MouseButtons_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 91, 1, 3),
...
a91MousePortName = _A91MousePortName_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 91, 1, 4),
...
a91MouseDriverName = _A91MouseDriverName_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 91, 1, 5),
...
a91MouseDriverVersion = _A91MouseDriverVersion_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 91, 1, 6),
...
a91FruGroupIndex = _A91FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 91, 1, 7),
...
a91OperationalGroupIndex = _A91OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 91, 1, 8),
...
a91SecuritySettings = _A91SecuritySettings_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 91, 1, 9),
...
a92KeyboardLayout = _A92KeyboardLayout_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 92, 1, 1),
...
a92KeyboardType = _A92KeyboardType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 92, 1, 2),
...
a92KeyboardConnectorType = _A92KeyboardConnectorType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 92, 1, 3),
...
a92FruGroupIndex = _A92FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 92, 1, 4),
...
a92OperationalGroupIndex = _A92OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 92, 1, 5),
...
a92SecuritySettings = _A92SecuritySettings_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 92, 1, 6),
...
tEventGenerationForProcessor = _TEventGenerationForProcessor_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100)
)
if mibBuilder.loadTexts:
...
eEventGenerationForProcessor = _EEventGenerationForProcessor_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1)
)
eEventGenerationForProcessor.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a100AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a100EventType = _A100EventType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 1),
    _A100EventType_Type()
)
...
a100EventSeverity = _A100EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 2),
...
a100IsEventState_based = _A100IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 3),
...
a100EventStateKey = _A100EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 4),
...
a100AssociatedGroup = _A100AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 5),
...
a100EventSystem = _A100EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 6),
...
a100EventSubsystem = _A100EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 7),
...
a100IsInstanceDataPresent = _A100IsInstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 9),
...
a100EventMessage = _A100EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 10),
...
tEventGenerationForPowerSupply = _TEventGenerationForPowerSupply_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104)
)
if mibBuilder.loadTexts:
...
eEventGenerationForPowerSupply = _EEventGenerationForPowerSupply_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1)
)
eEventGenerationForPowerSupply.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a104AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
class _A104EventType_Type(Integer32):
    ...
    namedValues = NamedValues(
        *(("vPowerSupplyAcLost", 261),
          ("vPowerSupplyAcLostOrOut-of-range", 262),
          ("vPowerSupplyAcOut-of-rangeButPresent", 263),
...
a104EventType = _A104EventType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 1),
    _A104EventType_Type()
)
...
a104EventSeverity = _A104EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 2),
...
a104IsEventState_based = _A104IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 3),
...
a104EventStateKey = _A104EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 4),
...
a104AssociatedGroup = _A104AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 5),
...
a104EventSystem = _A104EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 6),
...
a104EventSubsystem = _A104EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 7),
...
a104IsInstanceDataPresent = _A104IsInstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 9),
...
a104EventMessage = _A104EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 10),
...
tEventGenerationForPhysicalMemory = _TEventGenerationForPhysicalMemory_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108)
)
if mibBuilder.loadTexts:
...
eEventGenerationForPhysicalMemory = _EEventGenerationForPhysicalMemory_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1)
)
eEventGenerationForPhysicalMemory.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a108AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
class _A108EventType_Type(Integer32):
    ...
    namedValues = NamedValues(
        *(("vMemoryDeviceDisabled", 259),
          ("vMemoryErrorLoggingLimitReached", 260),
          ("vMemoryScrubFailed", 258),
...
a108EventType = _A108EventType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 1),
    _A108EventType_Type()
)
...
a108EventSeverity = _A108EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 2),
...
a108IsEventState_based = _A108IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 3),
...
a108EventStateKey = _A108EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 4),
...
a108AssociatedGroup = _A108AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 5),
...
a108EventSystem = _A108EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 6),
...
a108EventSubsystem = _A108EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 7),
...
a108IsInstanceDataPresent = _A108IsInstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 9),
...
a108EventMessage = _A108EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 10),
...
tEventGenerationForVoltageProbe = _TEventGenerationForVoltageProbe_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113)
)
if mibBuilder.loadTexts:
...
eEventGenerationForVoltageProbe = _EEventGenerationForVoltageProbe_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1)
)
eEventGenerationForVoltageProbe.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a113AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a113EventType = _A113EventType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 1),
    _A113EventType_Type()
)
...
a113EventSeverity = _A113EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 2),
...
a113IsEventState_based = _A113IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 3),
...
a113EventStateKey = _A113EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 4),
...
a113AssociatedGroup = _A113AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 5),
...
a113EventSystem = _A113EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 6),
...
a113EventSubsystem = _A113EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 7),
...
a113IsInstanceDataPresent = _A113IsInstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 9),
...
a113EventMessage = _A113EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 10),
...
tEventGenerationForTemperatureProbe = _TEventGenerationForTemperatureProbe_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114)
)
if mibBuilder.loadTexts:
...
eEventGenerationForTemperatureProbe = _EEventGenerationForTemperatureProbe_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1)
)
eEventGenerationForTemperatureProbe.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a114AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a114EventType = _A114EventType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 1),
    _A114EventType_Type()
)
...
a114EventSeverity = _A114EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 2),
...
a114IsEventState_based = _A114IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 3),
...
a114EventStateKey = _A114EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 4),
...
a114AssociatedGroup = _A114AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 5),
...
a114EventSystem = _A114EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 6),
...
a114EventSubsystem = _A114EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 7),
...
a114IsInstanceDataPresent = _A114IsInstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 9),
...
a114EventMessage = _A114EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 10),
...
tEventGenerationForPhysicalContainer = _TEventGenerationForPhysicalContainer_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116)
)
if mibBuilder.loadTexts:
...
eEventGenerationForPhysicalContainer = _EEventGenerationForPhysicalContainer_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116, 1)
)
eEventGenerationForPhysicalContainer.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a116AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a116EventType = _A116EventType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116, 1, 1),
    _A116EventType_Type()
)
...
a116EventSeverity = _A116EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116, 1, 2),
...
a116IsEventState_based = _A116IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116, 1, 3),
...
a116EventStateKey = _A116EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116, 1, 4),
...
a116AssociatedGroup = _A116AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116, 1, 5),
...
a116EventSystem = _A116EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116, 1, 6),
...
a116EventSubsystem = _A116EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116, 1, 7),
...
a116IsInstanceDataPresent = _A116IsInstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116, 1, 9),
...
a116EventMessage = _A116EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116, 1, 10),
...
a122PointingDeviceType = _A122PointingDeviceType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 122, 1, 1),
...
a122PointingDeviceInterface = _A122PointingDeviceInterface_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 122, 1, 2),
...
a122PointingDeviceIrq = _A122PointingDeviceIrq_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 122, 1, 3),
...
a122PointingDeviceButtons = _A122PointingDeviceButtons_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 122, 1, 4),
...
a122PointingDevicePortName = _A122PointingDevicePortName_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 122, 1, 5),
...
a122PointingDeviceDriverName = _A122PointingDeviceDriverName_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 122, 1, 6),
...
a122PointingDeviceDriverVersion = _A122PointingDeviceDriverVersion_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 122, 1, 7),
...
a122FruGroupIndex = _A122FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 122, 1, 8),
...
a122OperationalGroupIndex = _A122OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 122, 1, 9),
...
a122SecuritySettings = _A122SecuritySettings_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 122, 1, 10),
...
a128BusId = _A128BusId_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 128, 1, 1),
    _A128BusId_Type()
)
...
a128BusType = _A128BusType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 128, 1, 2),
    _A128BusType_Type()
)
...
tPhysicalExpansionSitesTable = _TPhysicalExpansionSitesTable_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 129)
)
if mibBuilder.loadTexts:
...
ePhysicalExpansionSitesTable = _EPhysicalExpansionSitesTable_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 129, 1)
)
ePhysicalExpansionSitesTable.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a129ExpansionSiteIndex"),
)
if mibBuilder.loadTexts:
...
a129ExpansionSiteIndex = _A129ExpansionSiteIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 129, 1, 1),
...
a129ExpansionSiteType = _A129ExpansionSiteType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 129, 1, 2),
...
a129VirtualExpansionSite = _A129VirtualExpansionSite_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 129, 1, 3),
...
a129ExpansionSiteName = _A129ExpansionSiteName_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 129, 1, 4),
...
a129ExpansionSiteDescription = _A129ExpansionSiteDescription_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 129, 1, 5),
...
a129ExpansionSiteCurrentlyOccupied = _A129ExpansionSiteCurrentlyOccupied_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 129, 1, 6),
...
tEventGenerationForCoolingDevice = _TEventGenerationForCoolingDevice_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 140)
)
if mibBuilder.loadTexts:
...
eEventGenerationForCoolingDevice = _EEventGenerationForCoolingDevice_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 140, 1)
)
eEventGenerationForCoolingDevice.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a140AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a140EventType = _A140EventType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 140, 1, 1),
    _A140EventType_Type()
)
...
a140EventSeverity = _A140EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 140, 1, 2),
...
a140IsEventState_based = _A140IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 140, 1, 3),
...
a140EventStateKey = _A140EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 140, 1, 4),
...
a140AssociatedGroup = _A140AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 140, 1, 5),
...
a140EventSystem = _A140EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 140, 1, 6),
...
a140EventSubsystem = _A140EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 140, 1, 7),
...
tEventGenerationForPowerUnit = _TEventGenerationForPowerUnit_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201)
)
if mibBuilder.loadTexts:
...
eEventGenerationForPowerUnit = _EEventGenerationForPowerUnit_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1)
)
eEventGenerationForPowerUnit.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a201AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a201EventType = _A201EventType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 1),
    _A201EventType_Type()
)
...
a201EventSeverity = _A201EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 2),
...
a201IsEventState_based = _A201IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 3),
...
a201EventStateKey = _A201EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 4),
...
a201AssociatedGroup = _A201AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 5),
...
a201EventSystem = _A201EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 6),
...
a201EventSubsystem = _A201EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 7),
...
a201IsInstanceDataPresent = _A201IsInstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 9),
...
a201EventMessage = _A201EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 10),
...
tEventGenerationForCoolingSensors = _TEventGenerationForCoolingSensors_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202)
)
if mibBuilder.loadTexts:
...
eEventGenerationForCoolingSensors = _EEventGenerationForCoolingSensors_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202, 1)
)
eEventGenerationForCoolingSensors.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a202AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a202EventType = _A202EventType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202, 1, 1),
    _A202EventType_Type()
)
...
a202EventSeverity = _A202EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202, 1, 2),
...
a202IsEventState_based = _A202IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202, 1, 3),
...
a202EventStateKey = _A202EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202, 1, 4),
...
a202AssociatedGroup = _A202AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202, 1, 5),
...
a202EventSystem = _A202EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202, 1, 6),
...
a202EventSubsystem = _A202EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202, 1, 7),
...
a202IsInstanceDataPresent = _A202IsInstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202, 1, 9),
...
a202EventMessage = _A202EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202, 1, 10),
...
tEventGenerationForSystemSlots = _TEventGenerationForSystemSlots_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205)
)
if mibBuilder.loadTexts:
...
eEventGenerationForSystemSlots = _EEventGenerationForSystemSlots_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1)
)
eEventGenerationForSystemSlots.setIndexNames(
    (0, "INTELCORPORATIONBASEBOARD-MIB", "DmiComponentIndex"),
    (0, "INTELCORPORATIONBASEBOARD-MIB", "a205AssociatedGroup"),
)
if mibBuilder.loadTexts:
...
a205EventType = _A205EventType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 1),
    _A205EventType_Type()
)
...
a205EventSeverity = _A205EventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 2),
...
a205IsEventState_based = _A205IsEventState_based_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 3),
...
a205EventStateKey = _A205EventStateKey_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 4),
...
a205AssociatedGroup = _A205AssociatedGroup_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 5),
...
a205EventSystem = _A205EventSystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 6),
...
a205EventSubsystem = _A205EventSubsystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 7),
...
a205IsInstanceDataPresent = _A205IsInstanceDataPresent_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 9),
...
a205EventMessage = _A205EventMessage_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 10),
...
a1001MibName = _A1001MibName_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1001, 1, 1),
    _A1001MibName_Type()
)
...
a1001MibOid = _A1001MibOid_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1001, 1, 2),
    _A1001MibOid_Type()
)
...
a1001DisableTrap = _A1001DisableTrap_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1001, 1, 3),
...
a1004Selfid = _A1004Selfid_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 1),
    _A1004Selfid_Type()
)
...
a1004ResetSystem = _A1004ResetSystem_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 2),
...
a1004TimedResetIncrement = _A1004TimedResetIncrement_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 3),
...
a1004TimedResetResolution = _A1004TimedResetResolution_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 4),
...
a1004TimeUntilSystemReset = _A1004TimeUntilSystemReset_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 5),
...
a1004SystemPowerCapabilities = _A1004SystemPowerCapabilities_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 6),
...
a1004SystemPowerStatus = _A1004SystemPowerStatus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 7),
...
a1004EventLoggingCapability = _A1004EventLoggingCapability_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 8),
...
a1004WatchdogTimerIncrement = _A1004WatchdogTimerIncrement_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 9),
...
a1004WatchdogTimerResolution = _A1004WatchdogTimerResolution_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 10),
...
a1004WatchdogUpdateInterval = _A1004WatchdogUpdateInterval_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 11),
...
a1004UseSystemWatchdogFeature = _A1004UseSystemWatchdogFeature_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 12),
...
a1004ResetSystemAfterDelay = _A1004ResetSystemAfterDelay_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 13),
...
a1004SavePersistentData = _A1004SavePersistentData_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 15),
...
a1004RestoreFactoryDefaults = _A1004RestoreFactoryDefaults_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 16),
...
a1004ShutdownOs = _A1004ShutdownOs_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 17),
...
a1004ShutdownOsAndPowerOff = _A1004ShutdownOsAndPowerOff_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 18),
...
a1004ShutdownOsAndHardwareReset = _A1004ShutdownOsAndHardwareReset_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 19),
...
a1004IssueAHardwareNmi = _A1004IssueAHardwareNmi_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 20),
...
a1004ImmediatePowerDown = _A1004ImmediatePowerDown_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 21),
...
a1004Challenge = _A1004Challenge_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 22),
...
a1004VerifyPrivilege = _A1004VerifyPrivilege_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1004, 1, 23),
...
a1005Selfid = _A1005Selfid_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 1),
    _A1005Selfid_Type()
)
...
a1005FruGroupIndex = _A1005FruGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 2),
...
a1005OperationalGroupIndex = _A1005OperationalGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 3),
...
a1005CoolingDeviceType = _A1005CoolingDeviceType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 6),
...
a1005CfmRating = _A1005CfmRating_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 7),
...
a1005FanUnits = _A1005FanUnits_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 8),
    _A1005FanUnits_Type()
)
...
a1005MaximumReading = _A1005MaximumReading_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 9),
...
a1005MinimumReading = _A1005MinimumReading_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 10),
...
a1005CurrentReading = _A1005CurrentReading_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 11),
...
a1005SensorAccuracy = _A1005SensorAccuracy_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 13),
...
a1005SensorTolerancePlus = _A1005SensorTolerancePlus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 14),
...
a1005SensorToleranceMinus = _A1005SensorToleranceMinus_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 15),
...
a1005Non_criticalThreshold = _A1005Non_criticalThreshold_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 16),
...
a1005CriticalThreshold = _A1005CriticalThreshold_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 17),
...
a1005Non_recoverableThreshold = _A1005Non_recoverableThreshold_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 18),
...
a1005CoolingSensorDescription = _A1005CoolingSensorDescription_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 19),
...
a1005NominalReading = _A1005NominalReading_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 21),
...
a1005LowestNormalReading = _A1005LowestNormalReading_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 22),
...
a1005HighestNormalReading = _A1005HighestNormalReading_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1005, 1, 23),
...
a1006Selfid = _A1006Selfid_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1006, 1, 1),
    _A1006Selfid_Type()
)
...
a1006Timestamp = _A1006Timestamp_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1006, 1, 2),
...
a1006RecordType = _A1006RecordType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1006, 1, 3),
...
a1006RecordLength = _A1006RecordLength_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1006, 1, 4),
...
a1006RecordData = _A1006RecordData_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1006, 1, 5),
...
a1008PciHotplugDeviceIndex = _A1008PciHotplugDeviceIndex_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1008, 1, 1),
...
a1008PciHotplugSlotNumber = _A1008PciHotplugSlotNumber_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1008, 1, 2),
...
a1008DeviceManufacturer = _A1008DeviceManufacturer_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1008, 1, 3),
...
a1008DeviceType = _A1008DeviceType_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1008, 1, 4),
...
a1008DeviceRevision = _A1008DeviceRevision_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1008, 1, 5),
...
a1010PagingSupported = _A1010PagingSupported_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1010, 1, 1),
...
a1010DefaultPepString = _A1010DefaultPepString_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1010, 1, 2),
...
a1010GlobalPaging = _A1010GlobalPaging_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1010, 1, 3),
...
a1010PepStringSize = _A1010PepStringSize_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1010, 1, 4),
...
a1010TestPage = _A1010TestPage_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1010, 1, 5),
    _A1010TestPage_Type()
)
...
a1010IssuePaging = _A1010IssuePaging_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1010, 1, 6),
...
tLocalPagingConfig = _TLocalPagingConfig_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1011)
)
if mibBuilder.loadTexts:
...
eLocalPagingConfig = _ELocalPagingConfig_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1011, 1)
)
...
a1011PepString1 = _A1011PepString1_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1011, 1, 1),
...
a1011PepString2 = _A1011PepString2_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1011, 1, 2),
...
a1011RepeatCount = _A1011RepeatCount_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1011, 1, 3),
...
a1011RepeatInterval = _A1011RepeatInterval_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1011, 1, 4),
...
a1011TestString = _A1011TestString_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1011, 1, 5),
...
a1012SmtpServer = _A1012SmtpServer_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1012, 1, 1),
...
a1012EmailFromAddress = _A1012EmailFromAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1012, 1, 2),
...
a1012EmailToAddress = _A1012EmailToAddress_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1012, 1, 3),
...
a1012EmailSubject = _A1012EmailSubject_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1012, 1, 4),
...
a1012EmailMessage = _A1012EmailMessage_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1012, 1, 5),
...
a1012TestEmail = _A1012TestEmail_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 1012, 1, 6),
...
a9000DpcDialNumberString = _A9000DpcDialNumberString_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 9000, 1, 1),
...
a9000DpcServicePartitionPresenceFlag = _A9000DpcServicePartitionPresenceFlag_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 9000, 1, 2),
...
a9000ScanServicePartitionFlag = _A9000ScanServicePartitionFlag_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 9000, 1, 3),
...
a9000BootServicePartitionFlag = _A9000BootServicePartitionFlag_Object(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 9000, 1, 4),
...
trap1ForProcessor = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 0, 256)
)
trap1ForProcessor.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a100EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a100EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a100IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a100EventStateKey"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a100AssociatedGroup"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a100EventSystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a100EventSubsystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a100IsInstanceDataPresent"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a100EventMessage"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a6ProcessorIndex"))
)
if mibBuilder.loadTexts:
...
trap2ForProcessor = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 0, 257)
)
...
trap3ForProcessor = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 0, 258)
)
...
trap4ForProcessor = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 100, 1, 0, 259)
)
trap4ForProcessor.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a100EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a100EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a100IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a100EventStateKey"),
...
if mibBuilder.loadTexts:
    trap4ForProcessor.setStatus(
        ""
    )

trap1ForPowerSupply = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 0, 256)
)
trap1ForPowerSupply.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a104EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventStateKey"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104AssociatedGroup"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventSystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventSubsystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104IsInstanceDataPresent"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a17PowerSupplyIndex"))
)
if mibBuilder.loadTexts:
...
trap2ForPowerSupply = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 0, 257)
)
...
trap3ForPowerSupply = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 0, 258)
)
...
trap4ForPowerSupply = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 0, 259)
)
trap4ForPowerSupply.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a104EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventStateKey"),
...
if mibBuilder.loadTexts:
    trap4ForPowerSupply.setStatus(
        ""
    )

trap5ForPowerSupply = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 0, 260)
)
trap5ForPowerSupply.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a104EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventStateKey"),
...
if mibBuilder.loadTexts:
    trap5ForPowerSupply.setStatus(
        ""
    )

trap6ForPowerSupply = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 0, 261)
)
trap6ForPowerSupply.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a104EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventStateKey"),
...
if mibBuilder.loadTexts:
    trap6ForPowerSupply.setStatus(
        ""
    )

trap7ForPowerSupply = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 0, 262)
)
trap7ForPowerSupply.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a104EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventStateKey"),
...
if mibBuilder.loadTexts:
    trap7ForPowerSupply.setStatus(
        ""
    )

trap8ForPowerSupply = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 104, 1, 0, 263)
)
trap8ForPowerSupply.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a104EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a104EventStateKey"),
...
if mibBuilder.loadTexts:
    trap8ForPowerSupply.setStatus(
        ""
    )

trap1ForPhysicalMemory = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 0, 256)
)
trap1ForPhysicalMemory.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a108EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108EventStateKey"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108AssociatedGroup"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108EventSystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108EventSubsystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108IsInstanceDataPresent"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a34MemoryArrayTableIndex"))
)
if mibBuilder.loadTexts:
...
trap2ForPhysicalMemory = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 0, 257)
)
...
trap3ForPhysicalMemory = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 0, 258)
)
trap3ForPhysicalMemory.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a108EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108EventStateKey"),
...
if mibBuilder.loadTexts:
    trap3ForPhysicalMemory.setStatus(
        ""
    )

trap4ForPhysicalMemory = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 0, 259)
)
trap4ForPhysicalMemory.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a108EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108EventStateKey"),
...
if mibBuilder.loadTexts:
    trap4ForPhysicalMemory.setStatus(
        ""
    )

trap5ForPhysicalMemory = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 108, 1, 0, 260)
)
trap5ForPhysicalMemory.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a108EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a108EventStateKey"),
...
if mibBuilder.loadTexts:
    trap5ForPhysicalMemory.setStatus(
        ""
    )

trap1ForVoltageProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 0, 256)
)
trap1ForVoltageProbe.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a113EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a113EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a113IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a113EventStateKey"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a113AssociatedGroup"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a113EventSystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a113EventSubsystem"),
...
trap2ForVoltageProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 0, 257)
)
...
trap3ForVoltageProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 0, 258)
)
...
trap4ForVoltageProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 0, 259)
)
...
trap5ForVoltageProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 0, 260)
)
...
trap6ForVoltageProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 0, 261)
)
...
trap7ForVoltageProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 113, 1, 0, 262)
)
...
trap1ForTemperatureProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 0, 256)
)
trap1ForTemperatureProbe.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a114EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a114EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a114IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a114EventStateKey"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a114AssociatedGroup"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a114EventSystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a114EventSubsystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a114IsInstanceDataPresent"),
...
trap2ForTemperatureProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 0, 257)
)
...
trap3ForTemperatureProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 0, 258)
)
...
trap4ForTemperatureProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 0, 259)
)
...
trap5ForTemperatureProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 0, 260)
)
...
trap6ForTemperatureProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 0, 261)
)
...
trap7ForTemperatureProbe = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 114, 1, 0, 262)
)
...
trap1ForPhysicalContainer = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116, 1, 0, 6)
)
trap1ForPhysicalContainer.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a116EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a116EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a116IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a116EventStateKey"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a116AssociatedGroup"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a116EventSystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a116EventSubsystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a116IsInstanceDataPresent"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a64ContainerIndex"))
)
if mibBuilder.loadTexts:
...
trap2ForPhysicalContainer = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 116, 1, 0, 256)
)
...
trap1ForPowerUnit = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 0, 1)
)
trap1ForPowerUnit.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a201EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a201EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a201IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a201EventStateKey"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a201AssociatedGroup"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a201EventSystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a201EventSubsystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a201IsInstanceDataPresent"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a67PowerUnitIndex"))
)
if mibBuilder.loadTexts:
...
trap2ForPowerUnit = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 0, 2)
)
...
trap3ForPowerUnit = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 0, 3)
)
...
trap4ForPowerUnit = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 0, 4)
)
...
trap5ForPowerUnit = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 201, 1, 0, 5)
)
...
trap1ForCoolingSensors = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202, 1, 0, 256)
)
trap1ForCoolingSensors.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a202EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a202EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a202IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a202EventStateKey"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a202AssociatedGroup"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a202EventSystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a202EventSubsystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a202IsInstanceDataPresent"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a1005Selfid"))
)
if mibBuilder.loadTexts:
...
trap2ForCoolingSensors = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 202, 1, 0, 257)
)
...
trap1ForSystemSlots = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 0, 1)
)
trap1ForSystemSlots.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a205EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventStateKey"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205AssociatedGroup"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventSystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventSubsystem"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205IsInstanceDataPresent"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventMessage"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a19SlotIndex"))
)
if mibBuilder.loadTexts:
    trap1ForSystemSlots.setStatus(
        ""
    )

trap2ForSystemSlots = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 0, 2)
)
trap2ForSystemSlots.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a205EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventStateKey"),
...
if mibBuilder.loadTexts:
    trap2ForSystemSlots.setStatus(
        ""
    )

trap3ForSystemSlots = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 0, 3)
)
trap3ForSystemSlots.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a205EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventStateKey"),
...
if mibBuilder.loadTexts:
    trap3ForSystemSlots.setStatus(
        ""
    )

trap4ForSystemSlots = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 0, 4)
)
trap4ForSystemSlots.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a205EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventStateKey"),
...
if mibBuilder.loadTexts:
    trap4ForSystemSlots.setStatus(
        ""
    )

trap5ForSystemSlots = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 0, 5)
)
trap5ForSystemSlots.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a205EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventStateKey"),
...
if mibBuilder.loadTexts:
    trap5ForSystemSlots.setStatus(
        ""
    )

trap6ForSystemSlots = NotificationType(
    (1, 3, 6, 1, 4, 1, 343, 2, 10, 3, 4, 1, 205, 1, 0, 6)
)
trap6ForSystemSlots.setObjects(
      *(("INTELCORPORATIONBASEBOARD-MIB", "a205EventType"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventSeverity"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205IsEventState_based"),
        ("INTELCORPORATIONBASEBOARD-MIB", "a205EventStateKey"),
...
mibBuilder.exportSymbols(
    ...
    **{"DmiCounter": DmiCounter,
       ...
       "trap4ForProcessor": trap4ForProcessor,
       ...
       "trap4ForPowerSupply": trap4ForPowerSupply,
       "trap5ForPowerSupply": trap5ForPowerSupply,
       "trap6ForPowerSupply": trap6ForPowerSupply,
       "trap7ForPowerSupply": trap7ForPowerSupply,
       "trap8ForPowerSupply": trap8ForPowerSupply,
       ...
       "trap3ForPhysicalMemory": trap3ForPhysicalMemory,
       "trap4ForPhysicalMemory": trap4ForPhysicalMemory,
       "trap5ForPhysicalMemory": trap5ForPhysicalMemory,
       ...
       "trap1ForSystemSlots": trap1ForSystemSlots,
       "trap2ForSystemSlots": trap2ForSystemSlots,
       "trap3ForSystemSlots": trap3ForSystemSlots,
       "trap4ForSystemSlots": trap4ForSystemSlots,
       "trap5ForSystemSlots": trap5ForSystemSlots,
       "trap6ForSystemSlots": trap6ForSystemSlots,
