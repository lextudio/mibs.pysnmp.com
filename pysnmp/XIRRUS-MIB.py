...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/XIRRUS-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 23:18:42 2024
...
class _GlobalCountryCode_Type(Integer32):
    ...
    namedValues = NamedValues(
        *(("australia", 3),
          ...
          ("united-states-weather-radar", 40))
    )
...
class _NeighborArrayModel_Type(Integer32):
    """Custom type neighborArrayModel based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_NeighborArrayModel_Type.__name__ = "Integer32"
