# SNMP MIB module (GENERIC-3COM-VLAN-MIB-1-0-6) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/GENERIC-3COM-VLAN-MIB-1-0-6
# Produced by pysmi-1.5.4 at Mon Oct 14 21:48:30 2024
...
a3ComVlanGlobalMappingEntry.setIndexNames(
    (0, "GENERIC-3COM-VLAN-MIB-1-0-6", "a3ComVlanGlobalMappingIdentifier"),
)
if mibBuilder.loadTexts:
...
a3ComVlanIfEntry.setIndexNames(
    (0, "GENERIC-3COM-VLAN-MIB-1-0-6", "a3ComVlanIfIndex"),
)
if mibBuilder.loadTexts:
...
a3ComVlanProtocolEntry.setIndexNames(
    (0, "GENERIC-3COM-VLAN-MIB-1-0-6", "a3ComVlanProtocolIfIndex"),
    (0, "GENERIC-3COM-VLAN-MIB-1-0-6", "a3ComVlanProtocolIndex"),
)
if mibBuilder.loadTexts:
...
a3ComVlanEncapsIfEntry.setIndexNames(
    (0, "GENERIC-3COM-VLAN-MIB-1-0-6", "a3ComVlanEncapsIfIndex"),
)
if mibBuilder.loadTexts:
