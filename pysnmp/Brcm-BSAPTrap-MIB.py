# SNMP MIB module (Brcm-BSAPTrap-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Brcm-BSAPTrap-MIB
...
trapAdapterName.setMaxAccess("not-accessible")
...
trapTeamName.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
trapCauseDirection.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
trapAdapterActivityCause.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
...
failoverEvent.setObjects(
      *(("Brcm-BSAPTrap-MIB", "trapAdapterName"),
        ("Brcm-BSAPTrap-MIB", "trapTeamName"),
        ("Brcm-BSAPTrap-MIB", "trapCauseDirection"),
        ("Brcm-BSAPTrap-MIB", "trapAdapterActivityCause"))
)
if mibBuilder.loadTexts:
