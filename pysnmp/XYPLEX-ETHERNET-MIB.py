# SNMP MIB module (XYPLEX-ETHERNET-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/XYPLEX-ETHERNET-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 23:19:47 2024
...
etherEntry.setIndexNames(
    (0, "XYPLEX-ETHERNET-MIB", "etherIndex"),
)
if mibBuilder.loadTexts:
...
etherTxEntry.setIndexNames(
    (0, "XYPLEX-ETHERNET-MIB", "etherTxIndex"),
)
if mibBuilder.loadTexts:
...
etherMulticastEntry.setIndexNames(
    (0, "XYPLEX-ETHERNET-MIB", "etherMulticastIndex"),
)
if mibBuilder.loadTexts:
...
etherXTxEntry.setIndexNames(
    (0, "XYPLEX-ETHERNET-MIB", "etherXTxIndex"),
)
if mibBuilder.loadTexts:
