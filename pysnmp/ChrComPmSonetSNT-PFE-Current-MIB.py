# SNMP MIB module (ChrComPmSonetSNT-PFE-Current-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmSonetSNT-PFE-Current-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:36 2024
...
_ChrComPmSonetSNT_PFE_CurrentTable_Object = MibTable
chrComPmSonetSNT_PFE_CurrentTable = _ChrComPmSonetSNT_PFE_CurrentTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 13)
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_PFE_CurrentTable.setStatus("current")
_ChrComPmSonetSNT_PFE_CurrentEntry_Object = MibTableRow
chrComPmSonetSNT_PFE_CurrentEntry = _ChrComPmSonetSNT_PFE_CurrentEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 13, 1)
)
chrComPmSonetSNT_PFE_CurrentEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_PFE_CurrentEntry.setStatus("current")
...
chrComPmSonetSuspectedInterval = _ChrComPmSonetSuspectedInterval_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 13, 1, 1),
...
chrComPmSonetElapsedTime = _ChrComPmSonetElapsedTime_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 13, 1, 2),
...
chrComPmSonetSuppressedIntrvls = _ChrComPmSonetSuppressedIntrvls_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 13, 1, 3),
...
chrComPmSonetStatus = _ChrComPmSonetStatus_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 13, 1, 4),
...
chrComPmSonetES = _ChrComPmSonetES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 13, 1, 5),
...
chrComPmSonetSES = _ChrComPmSonetSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 13, 1, 6),
...
chrComPmSonetCV = _ChrComPmSonetCV_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 13, 1, 7),
...
chrComPmSonetUAS = _ChrComPmSonetUAS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 13, 1, 8),
...
chrComPmSonetThresholdProfIndex = _ChrComPmSonetThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 13, 1, 9),
...
chrComPmSonetResetPmCountersAction = _ChrComPmSonetResetPmCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 13, 1, 10),
...
mibBuilder.exportSymbols(
    "ChrComPmSonetSNT-PFE-Current-MIB",
    **{"chrComPmSonetSNT-PFE-CurrentTable": chrComPmSonetSNT_PFE_CurrentTable,
       "chrComPmSonetSNT-PFE-CurrentEntry": chrComPmSonetSNT_PFE_CurrentEntry,
