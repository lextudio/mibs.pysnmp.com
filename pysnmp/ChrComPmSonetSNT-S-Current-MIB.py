# SNMP MIB module (ChrComPmSonetSNT-S-Current-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmSonetSNT-S-Current-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:39 2024
...
_ChrComPmSonetSNT_S_CurrentTable_Object = MibTable
chrComPmSonetSNT_S_CurrentTable = _ChrComPmSonetSNT_S_CurrentTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 1)
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_S_CurrentTable.setStatus("current")
_ChrComPmSonetSNT_S_CurrentEntry_Object = MibTableRow
chrComPmSonetSNT_S_CurrentEntry = _ChrComPmSonetSNT_S_CurrentEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 1, 1)
)
chrComPmSonetSNT_S_CurrentEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_S_CurrentEntry.setStatus("current")
...
chrComPmSonetResetPmCountersAction = _ChrComPmSonetResetPmCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 1, 1, 10),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmSonetSNT-S-CurrentTable": chrComPmSonetSNT_S_CurrentTable,
       "chrComPmSonetSNT-S-CurrentEntry": chrComPmSonetSNT_S_CurrentEntry,
