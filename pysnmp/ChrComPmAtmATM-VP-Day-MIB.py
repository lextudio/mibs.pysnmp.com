# SNMP MIB module (ChrComPmAtmATM-VP-Day-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmAtmATM-VP-Day-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:06 2024
...
_ChrComPmAtmATM_VP_DayTable_Object = MibTable
chrComPmAtmATM_VP_DayTable = _ChrComPmAtmATM_VP_DayTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 6)
)
if mibBuilder.loadTexts:
    chrComPmAtmATM_VP_DayTable.setStatus("current")
_ChrComPmAtmATM_VP_DayEntry_Object = MibTableRow
chrComPmAtmATM_VP_DayEntry = _ChrComPmAtmATM_VP_DayEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 6, 1)
)
chrComPmAtmATM_VP_DayEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ATM-MIB", "atmVplVpi"),
    (0, "ChrComPmAtmATM-VP-Day-MIB", "chrComPmAtmDayNumber"),
)
if mibBuilder.loadTexts:
    chrComPmAtmATM_VP_DayEntry.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmAtmATM-VP-DayTable": chrComPmAtmATM_VP_DayTable,
       "chrComPmAtmATM-VP-DayEntry": chrComPmAtmATM_VP_DayEntry,
