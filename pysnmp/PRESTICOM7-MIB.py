# SNMP MIB module (PRESTICOM7-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/PRESTICOM7-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:39:38 2024
...
_Presticom_ObjectIdentity = ObjectIdentity
presticom = _Presticom_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727)
)
_Netperformer7_ObjectIdentity = ObjectIdentity
netperformer7 = _Netperformer7_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7)
)
...
_NoDevice_ObjectIdentity = ObjectIdentity
noDevice = _NoDevice_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7, 1, 1)
)
_Ver6X_Device_ObjectIdentity = ObjectIdentity
ver6X_Device = _Ver6X_Device_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7, 1, 2)
)
...
sysPosEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "sysPosRackId"),
    (0, "PRESTICOM7-MIB", "sysPosId"),
)
if mibBuilder.loadTexts:
...
scheduleEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "schedulePeriod"),
)
if mibBuilder.loadTexts:
...
ipstaticEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "ipstaticIndex"),
)
if mibBuilder.loadTexts:
...
ospfAreaEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "ospfAreaIndex"),
)
if mibBuilder.loadTexts:
...
ospfRangeEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "ospfRangeIndex"),
)
if mibBuilder.loadTexts:
...
ospfVLinkEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "ospfVLinkIndex"),
)
if mibBuilder.loadTexts:
...
ipxfilterEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "ipxfilterIndex"),
)
if mibBuilder.loadTexts:
...
statAlarmEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "statAlarmIndex"),
)
if mibBuilder.loadTexts:
...
statIfwanEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "statIfwanIndex"),
)
if mibBuilder.loadTexts:
...
statIflanEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "statIflanIndex"),
)
if mibBuilder.loadTexts:
...
_StatIflanTrReceiveCongestion_Type = Counter32
_StatIflanTrReceiveCongestion_Object = MibTableColumn
statIflanTrReceiveCongestion = _StatIflanTrReceiveCongestion_Object(
    (1, 3, 6, 1, 4, 1, 727, 7, 2, 20, 3, 1, 14),
    _StatIflanTrReceiveCongestion_Type()
)
statIflanTrReceiveCongestion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    statIflanTrReceiveCongestion.setStatus("mandatory")
_StatIflanEthOneCollision_Type = Counter32
_StatIflanEthOneCollision_Object = MibTableColumn
statIflanEthOneCollision = _StatIflanEthOneCollision_Object(
    (1, 3, 6, 1, 4, 1, 727, 7, 2, 20, 3, 1, 15),
    _StatIflanEthOneCollision_Type()
)
statIflanEthOneCollision.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    statIflanEthOneCollision.setStatus("mandatory")
_StatIflanEthTwoCollisions_Type = Counter32
_StatIflanEthTwoCollisions_Object = MibTableColumn
statIflanEthTwoCollisions = _StatIflanEthTwoCollisions_Object(
    (1, 3, 6, 1, 4, 1, 727, 7, 2, 20, 3, 1, 16),
    _StatIflanEthTwoCollisions_Type()
)
statIflanEthTwoCollisions.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    statIflanEthTwoCollisions.setStatus("mandatory")
_StatIflanEthThreeAndMoreCol_Type = Counter32
_StatIflanEthThreeAndMoreCol_Object = MibTableColumn
statIflanEthThreeAndMoreCol = _StatIflanEthThreeAndMoreCol_Object(
    (1, 3, 6, 1, 4, 1, 727, 7, 2, 20, 3, 1, 17),
    _StatIflanEthThreeAndMoreCol_Type()
)
statIflanEthThreeAndMoreCol.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    statIflanEthThreeAndMoreCol.setStatus("mandatory")
_StatIflanEthDeferredTrans_Type = Counter32
_StatIflanEthDeferredTrans_Object = MibTableColumn
statIflanEthDeferredTrans = _StatIflanEthDeferredTrans_Object(
    (1, 3, 6, 1, 4, 1, 727, 7, 2, 20, 3, 1, 18),
    _StatIflanEthDeferredTrans_Type()
)
statIflanEthDeferredTrans.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    statIflanEthDeferredTrans.setStatus("mandatory")
_StatIflanEthExcessiveCollision_Type = Counter32
_StatIflanEthExcessiveCollision_Object = MibTableColumn
statIflanEthExcessiveCollision = _StatIflanEthExcessiveCollision_Object(
    (1, 3, 6, 1, 4, 1, 727, 7, 2, 20, 3, 1, 19),
    _StatIflanEthExcessiveCollision_Type()
)
statIflanEthExcessiveCollision.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    statIflanEthExcessiveCollision.setStatus("mandatory")
_StatIflanEthLateCollision_Type = Counter32
_StatIflanEthLateCollision_Object = MibTableColumn
statIflanEthLateCollision = _StatIflanEthLateCollision_Object(
    (1, 3, 6, 1, 4, 1, 727, 7, 2, 20, 3, 1, 20),
    _StatIflanEthLateCollision_Type()
)
statIflanEthLateCollision.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    statIflanEthLateCollision.setStatus("mandatory")
_StatIflanEthFrameCheckSeq_Type = Counter32
_StatIflanEthFrameCheckSeq_Object = MibTableColumn
statIflanEthFrameCheckSeq = _StatIflanEthFrameCheckSeq_Object(
    (1, 3, 6, 1, 4, 1, 727, 7, 2, 20, 3, 1, 21),
    _StatIflanEthFrameCheckSeq_Type()
)
statIflanEthFrameCheckSeq.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    statIflanEthFrameCheckSeq.setStatus("mandatory")
_StatIflanEthAlign_Type = Counter32
_StatIflanEthAlign_Object = MibTableColumn
statIflanEthAlign = _StatIflanEthAlign_Object(
    (1, 3, 6, 1, 4, 1, 727, 7, 2, 20, 3, 1, 22),
    _StatIflanEthAlign_Type()
)
statIflanEthAlign.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    statIflanEthAlign.setStatus("mandatory")
_StatIflanEthCarrierSense_Type = Counter32
_StatIflanEthCarrierSense_Object = MibTableColumn
statIflanEthCarrierSense = _StatIflanEthCarrierSense_Object(
    (1, 3, 6, 1, 4, 1, 727, 7, 2, 20, 3, 1, 23),
    _StatIflanEthCarrierSense_Type()
)
statIflanEthCarrierSense.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    statIflanEthCarrierSense.setStatus("mandatory")
...
statBridgePortEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "statBridgePortIndex"),
)
if mibBuilder.loadTexts:
...
statPvcrRouteEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "statPvcrRouteName"),
    (0, "PRESTICOM7-MIB", "statPvcrRouteNextHop"),
)
if mibBuilder.loadTexts:
...
statIfvceEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "statIfvceIndex"),
)
if mibBuilder.loadTexts:
...
statIfcemEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "statIfcemIndex"),
)
if mibBuilder.loadTexts:
...
slotPortInSlotEntry.setIndexNames(
    (0, "PRESTICOM7-MIB", "slotSlot"),
    (0, "PRESTICOM7-MIB", "slotPortInSlot"),
)
if mibBuilder.loadTexts:
...
info = _Info_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7, 50)
)
_TMS380C26_ObjectIdentity = ObjectIdentity
tMS380C26 = _TMS380C26_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7, 50, 1)
)
_MC68EN360_ObjectIdentity = ObjectIdentity
mC68EN360 = _MC68EN360_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7, 50, 2)
)
_TMS380C30_ObjectIdentity = ObjectIdentity
tMS380C30 = _TMS380C30_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7, 50, 3)
)
_DP83936_ObjectIdentity = ObjectIdentity
dP83936 = _DP83936_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7, 50, 4)
)
_MibVersionInfo_ObjectIdentity = ObjectIdentity
mibVersionInfo = _MibVersionInfo_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7, 50, 10)
)
_MibVersion_ObjectIdentity = ObjectIdentity
mibVersion = _MibVersion_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7, 50, 10, 7)
)
_MibSubVersion_ObjectIdentity = ObjectIdentity
mibSubVersion = _MibSubVersion_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7, 50, 10, 7, 0)
)
_MibSpecialVersion_ObjectIdentity = ObjectIdentity
mibSpecialVersion = _MibSpecialVersion_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7, 50, 10, 7, 0, 4)
)
_MibEvolution_ObjectIdentity = ObjectIdentity
mibEvolution = _MibEvolution_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 727, 7, 50, 10, 7, 0, 4, 1)
)
...
cardDown.setObjects(
    ("PRESTICOM7-MIB", "sysTrapRackandPos")
)
if mibBuilder.loadTexts:
    cardDown.setStatus(
        ""
...
mibBuilder.exportSymbols(
    ...
    **{"presticom": presticom,
       ...
       "statIflanTrReceiveCongestion": statIflanTrReceiveCongestion,
       "statIflanEthOneCollision": statIflanEthOneCollision,
       "statIflanEthTwoCollisions": statIflanEthTwoCollisions,
       "statIflanEthThreeAndMoreCol": statIflanEthThreeAndMoreCol,
       "statIflanEthDeferredTrans": statIflanEthDeferredTrans,
       "statIflanEthExcessiveCollision": statIflanEthExcessiveCollision,
       "statIflanEthLateCollision": statIflanEthLateCollision,
       "statIflanEthFrameCheckSeq": statIflanEthFrameCheckSeq,
       "statIflanEthAlign": statIflanEthAlign,
       "statIflanEthCarrierSense": statIflanEthCarrierSense,
       ...
       "tMS380C30": tMS380C30,
       "dP83936": dP83936,
       "mibVersionInfo": mibVersionInfo,
       "mibVersion": mibVersion,
       "mibSubVersion": mibSubVersion,
       "mibSpecialVersion": mibSpecialVersion,
       "mibEvolution": mibEvolution}
)
