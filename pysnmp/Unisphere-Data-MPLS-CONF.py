# SNMP MIB module (Unisphere-Data-MPLS-CONF) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Unisphere-Data-MPLS-CONF
...
(usdMplsExplicitPathConfGroup,
 ...
 usdMplsTunnelProfileConfGroup) = mibBuilder.importSymbols(
...
usdMplsAgent = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 51)
)
usdMplsAgent.setRevisions(
        ("2001-12-05 21:41",)
)
...
usdMplsAgentV1 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 51, 1)
)
if mibBuilder.loadTexts:
    usdMplsAgentV1.setProductRelease("""\
