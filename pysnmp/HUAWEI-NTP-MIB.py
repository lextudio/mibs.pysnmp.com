# SNMP MIB module (HUAWEI-NTP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/HUAWEI-NTP-MIB
...
hwNTPSysLeap = _HwNTPSysLeap_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 1),
    _HwNTPSysLeap_Type()
)
...
hwNTPSysStratum = _HwNTPSysStratum_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 2),
...
hwNTPSysPrecision = _HwNTPSysPrecision_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 3),
...
hwNTPSysRootdelay = _HwNTPSysRootdelay_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 4),
...
hwNTPSysRootdispersion = _HwNTPSysRootdispersion_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 5),
...
hwNTPSysRefid = _HwNTPSysRefid_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 6),
    _HwNTPSysRefid_Type()
)
...
hwNTPSysReftime = _HwNTPSysReftime_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 7),
...
hwNTPSysPoll = _HwNTPSysPoll_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 8),
    _HwNTPSysPoll_Type()
)
...
hwNTPSysPeer = _HwNTPSysPeer_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 9),
    _HwNTPSysPeer_Type()
)
...
hwNTPSysState = _HwNTPSysState_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 10),
    _HwNTPSysState_Type()
)
...
hwNTPSysOffset = _HwNTPSysOffset_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 11),
...
hwNTPSysDrift = _HwNTPSysDrift_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 12),
    _HwNTPSysDrift_Type()
)
...
hwNTPSysCompliance = _HwNTPSysCompliance_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 13),
...
hwNTPSysClock = _HwNTPSysClock_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 14),
    _HwNTPSysClock_Type()
)
...
hwNTPSysStabil = _HwNTPSysStabil_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 15),
...
hwNTPSysAuthenticate = _HwNTPSysAuthenticate_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 16),
...
hwNTPSysPollSec = _HwNTPSysPollSec_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 17),
...
hwNTPSysClockSec = _HwNTPSysClockSec_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 18),
...
hwNTPServerIP = _HwNTPServerIP_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 1, 1, 19),
    _HwNTPServerIP_Type()
)
...
hwNTPPeerConfig = _HwNTPPeerConfig_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 1),
...
hwNTPPeerAuthenable = _HwNTPPeerAuthenable_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 2),
...
hwNTPPeerAuthentic = _HwNTPPeerAuthentic_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 3),
...
hwNTPPeerRemAdr = _HwNTPPeerRemAdr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 4),
...
hwNTPPeerRemPort = _HwNTPPeerRemPort_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 5),
...
hwNTPPeerLocAdr = _HwNTPPeerLocAdr_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 6),
...
hwNTPPeerLocPort = _HwNTPPeerLocPort_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 7),
...
hwNTPPeerLeap = _HwNTPPeerLeap_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 8),
    _HwNTPPeerLeap_Type()
)
...
hwNTPPeerHMode = _HwNTPPeerHMode_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 9),
...
hwNTPPeerStratum = _HwNTPPeerStratum_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 10),
...
hwNTPPeerPPoll = _HwNTPPeerPPoll_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 11),
...
hwNTPPeerHPoll = _HwNTPPeerHPoll_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 12),
...
hwNTPPeerRootDelay = _HwNTPPeerRootDelay_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 14),
...
hwNTPPeerRootDispersion = _HwNTPPeerRootDispersion_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 15),
...
hwNTPPeerRefId = _HwNTPPeerRefId_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 16),
...
hwNTPPeerRefTime = _HwNTPPeerRefTime_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 17),
...
hwNTPPeerOrg = _HwNTPPeerOrg_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 18),
    _HwNTPPeerOrg_Type()
)
...
hwNTPPeerRec = _HwNTPPeerRec_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 19),
    _HwNTPPeerRec_Type()
)
...
hwNTPPeerXmt = _HwNTPPeerXmt_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 20),
    _HwNTPPeerXmt_Type()
)
...
hwNTPPeerReach = _HwNTPPeerReach_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 21),
...
hwNTPPeerValid = _HwNTPPeerValid_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 22),
...
hwNTPPeerTimer = _HwNTPPeerTimer_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 23),
...
hwNTPPeerDelay = _HwNTPPeerDelay_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 24),
...
hwNTPPeerOffset = _HwNTPPeerOffset_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 25),
...
hwNTPPeerJitter = _HwNTPPeerJitter_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 26),
...
hwNTPPeerDispersion = _HwNTPPeerDispersion_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 27),
...
hwNTPPeerKeyId = _HwNTPPeerKeyId_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 28),
...
hwNTPPeerFiltDelay = _HwNTPPeerFiltDelay_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 29),
...
hwNTPPeerFiltOffset = _HwNTPPeerFiltOffset_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 30),
...
hwNTPPeerFiltError = _HwNTPPeerFiltError_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 31),
...
hwNTPPeerPMode = _HwNTPPeerPMode_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 32),
...
hwNTPPeerReceived = _HwNTPPeerReceived_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 33),
...
hwNTPPeerSent = _HwNTPPeerSent_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 34),
    _HwNTPPeerSent_Type()
)
...
hwNTPPeerFlash = _HwNTPPeerFlash_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 35),
...
hwNTPPeerRowStatus = _HwNTPPeerRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 2011, 5, 25, 22, 2, 1, 1, 1, 36),
