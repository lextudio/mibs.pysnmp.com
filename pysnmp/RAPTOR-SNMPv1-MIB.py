# SNMP MIB module (RAPTOR-SNMPv1-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/RAPTOR-SNMPv1-MIB
...
raptorNotifyTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 1294, 0, 1)
)
raptorNotifyTrap.setObjects(
    ("RAPTOR-SNMPv1-MIB", "raptorNotifyMessage")
)
if mibBuilder.loadTexts:
