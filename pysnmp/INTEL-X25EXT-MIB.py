# SNMP MIB module (INTEL-X25EXT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/INTEL-X25EXT-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:10:04 2024
...
x25extCircuitEntry = _X25extCircuitEntry_Object(
    (1, 3, 6, 1, 4, 1, 343, 6, 27, 1, 1, 1)
)
x25extCircuitEntry.setIndexNames(
    (0, "INTEL-X25EXT-MIB", "x25extCircuitIndex"),
    (0, "INTEL-X25EXT-MIB", "x25extCircuitChannel"),
)
if mibBuilder.loadTexts:
