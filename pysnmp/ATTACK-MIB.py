# SNMP MIB module (ATTACK-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ATTACK-MIB
...
deviceAttackEntry.setIndexNames(
    (0, "ATTACK-MIB", "deviceAttackIndex"),
)
if mibBuilder.loadTexts:
...
deviceAttackTrap.setObjects(
      *(("ATTACK-MIB", "deviceAttackName"),
        ("ATTACK-MIB", "deviceAttackStatus"))
)
if mibBuilder.loadTexts:
