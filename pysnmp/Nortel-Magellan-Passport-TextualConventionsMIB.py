# SNMP MIB module (Nortel-Magellan-Passport-TextualConventionsMIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Nortel-Magellan-Passport-TextualConventionsMIB
...
textualConventionsMIB = _TextualConventionsMIB_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 2)
)
_TextualConventionsGroup_ObjectIdentity = ObjectIdentity
textualConventionsGroup = _TextualConventionsGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 2, 1)
)
_TextualConventionsGroupBC_ObjectIdentity = ObjectIdentity
textualConventionsGroupBC = _TextualConventionsGroupBC_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 2, 1, 3)
)
_TextualConventionsGroupBC02_ObjectIdentity = ObjectIdentity
textualConventionsGroupBC02 = _TextualConventionsGroupBC02_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 2, 1, 3, 2)
)
_TextualConventionsGroupBC02A_ObjectIdentity = ObjectIdentity
textualConventionsGroupBC02A = _TextualConventionsGroupBC02A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 2, 1, 3, 2, 2)
)
...
textualConventionsCapabilities = _TextualConventionsCapabilities_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 2, 3)
)
_TextualConventionsCapabilitiesBC_ObjectIdentity = ObjectIdentity
textualConventionsCapabilitiesBC = _TextualConventionsCapabilitiesBC_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 2, 3, 3)
)
_TextualConventionsCapabilitiesBC02_ObjectIdentity = ObjectIdentity
textualConventionsCapabilitiesBC02 = _TextualConventionsCapabilitiesBC02_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 2, 3, 3, 2)
)
_TextualConventionsCapabilitiesBC02A_ObjectIdentity = ObjectIdentity
textualConventionsCapabilitiesBC02A = _TextualConventionsCapabilitiesBC02A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 2, 3, 3, 2, 2)
)
...
mibBuilder.exportSymbols(
    ...
    **{"Hex": Hex,
       ...
       "textualConventionsGroupBC": textualConventionsGroupBC,
       "textualConventionsGroupBC02": textualConventionsGroupBC02,
       "textualConventionsGroupBC02A": textualConventionsGroupBC02A,
       "textualConventionsCapabilities": textualConventionsCapabilities,
       "textualConventionsCapabilitiesBC": textualConventionsCapabilitiesBC,
       "textualConventionsCapabilitiesBC02": textualConventionsCapabilitiesBC02,
       "textualConventionsCapabilitiesBC02A": textualConventionsCapabilitiesBC02A}
)
