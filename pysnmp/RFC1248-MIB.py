# SNMP MIB module (RFC1248-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/RFC1248-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:47:14 2024
...
ospfStubAreaEntry.setIndexNames(
    (0, "RFC1248-MIB", "ospfStubAreaID"),
    (0, "RFC1248-MIB", "ospfStubTOS"),
)
if mibBuilder.loadTexts:
...
ospfLsdbEntry.setIndexNames(
    (0, "RFC1248-MIB", "ospfLsdbAreaId"),
    (0, "RFC1248-MIB", "ospfLsdbType"),
    (0, "RFC1248-MIB", "ospfLsdbLSID"),
    (0, "RFC1248-MIB", "ospfLsdbRouterId"),
)
if mibBuilder.loadTexts:
...
ospfAreaRangeEntry.setIndexNames(
    (0, "RFC1248-MIB", "ospfAreaRangeAreaID"),
    (0, "RFC1248-MIB", "ospfAreaRangeNet"),
)
if mibBuilder.loadTexts:
...
ospfHostEntry.setIndexNames(
    (0, "RFC1248-MIB", "ospfHostIpAddress"),
    (0, "RFC1248-MIB", "ospfHostTOS"),
)
if mibBuilder.loadTexts:
...
ospfIfEntry.setIndexNames(
    (0, "RFC1248-MIB", "ospfIfIpAddress"),
    (0, "RFC1248-MIB", "ospfAddressLessIf"),
)
if mibBuilder.loadTexts:
...
ospfIfMetricEntry.setIndexNames(
    (0, "RFC1248-MIB", "ospfIfMetricIpAddress"),
    (0, "RFC1248-MIB", "ospfIfMetricAddressLessIf"),
    (0, "RFC1248-MIB", "ospfIfMetricTOS"),
)
if mibBuilder.loadTexts:
...
ospfVirtIfEntry.setIndexNames(
    (0, "RFC1248-MIB", "ospfVirtIfAreaID"),
    (0, "RFC1248-MIB", "ospfVirtIfNeighbor"),
)
if mibBuilder.loadTexts:
...
ospfNbrEntry.setIndexNames(
    (0, "RFC1248-MIB", "ospfNbrIpAddr"),
    (0, "RFC1248-MIB", "ospfNbrAddressLessIndex"),
)
if mibBuilder.loadTexts:
...
ospfVirtNbrEntry.setIndexNames(
    (0, "RFC1248-MIB", "ospfVirtNbrArea"),
    (0, "RFC1248-MIB", "ospfVirtNbrRtrId"),
)
if mibBuilder.loadTexts:
...
class _OspfVirtNbrEvents_Type(Counter32):
    """Custom type ospfVirtNbrEvents based on Counter32"""
    defaultValue = 0
