...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DAMOCLES-MIB
...
_InpState_Type = OnOff
_InpState_Object = MibTableColumn
inpState = _InpState_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 1, 1, 2),
    _InpState_Type()
)
inpState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    inpState.setStatus("current")
...
inpChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 0, 1)
)
inpChange.setObjects(
      *(("DAMOCLES-MIB", "inpName"),
        ("DAMOCLES-MIB", "inpState"),
...
sensStateChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 0, 2)
)
sensStateChanged.setObjects(
...
if mibBuilder.loadTexts:
    sensStateChanged.setStatus(
        ""
    )

tsTrapNewAlarm = NotificationType(
    (1, 3, 6, 1, 4, 1, 21796, 3, 4, 0, 3)
)
tsTrapNewAlarm.setObjects(
      *(("DAMOCLES-MIB", "tsAlarmId"),
        ("DAMOCLES-MIB", "tsAlarmDescr"))
)
if mibBuilder.loadTexts:
    tsTrapNewAlarm.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"PositiveInteger": PositiveInteger,
       ...
       "damocles": damocles,
       "inpChange": inpChange,
       "sensStateChanged": sensStateChanged,
       "tsTrapNewAlarm": tsTrapNewAlarm,
