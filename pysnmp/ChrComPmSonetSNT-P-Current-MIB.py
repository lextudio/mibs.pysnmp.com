# SNMP MIB module (ChrComPmSonetSNT-P-Current-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmSonetSNT-P-Current-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:34 2024
...
_ChrComPmSonetSNT_P_CurrentTable_Object = MibTable
chrComPmSonetSNT_P_CurrentTable = _ChrComPmSonetSNT_P_CurrentTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10)
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_P_CurrentTable.setStatus("current")
_ChrComPmSonetSNT_P_CurrentEntry_Object = MibTableRow
chrComPmSonetSNT_P_CurrentEntry = _ChrComPmSonetSNT_P_CurrentEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1)
)
chrComPmSonetSNT_P_CurrentEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
)
if mibBuilder.loadTexts:
    chrComPmSonetSNT_P_CurrentEntry.setStatus("current")
...
chrComPmSonetSuspectedInterval = _ChrComPmSonetSuspectedInterval_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1, 1),
...
chrComPmSonetElapsedTime = _ChrComPmSonetElapsedTime_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1, 2),
...
chrComPmSonetSuppressedIntrvls = _ChrComPmSonetSuppressedIntrvls_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1, 3),
...
class _ChrComPmSonetStatus_Type(Gauge32):
    """Custom type chrComPmSonetStatus based on Gauge32"""
    subtypeSpec = Gauge32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 4294967295),
    )
...
_ChrComPmSonetStatus_Type.__name__ = "Gauge32"
_ChrComPmSonetStatus_Object = MibTableColumn
chrComPmSonetStatus = _ChrComPmSonetStatus_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1, 4),
    _ChrComPmSonetStatus_Type()
)
chrComPmSonetStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    chrComPmSonetStatus.setStatus("current")


class _ChrComPmSonetWidth_Type(Unsigned32):
    """Custom type chrComPmSonetWidth based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_ChrComPmSonetWidth_Type.__name__ = "Unsigned32"
_ChrComPmSonetWidth_Object = MibTableColumn
chrComPmSonetWidth = _ChrComPmSonetWidth_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1, 5),
    _ChrComPmSonetWidth_Type()
)
chrComPmSonetWidth.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    chrComPmSonetWidth.setStatus("current")
...
chrComPmSonetES = _ChrComPmSonetES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1, 6),
...
chrComPmSonetSES = _ChrComPmSonetSES_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1, 7),
...
chrComPmSonetCV = _ChrComPmSonetCV_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1, 8),
...
chrComPmSonetUAS = _ChrComPmSonetUAS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1, 9),
...
chrComPmSonetPS = _ChrComPmSonetPS_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1, 10),
...
chrComPmSonetThresholdProfIndex = _ChrComPmSonetThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1, 11),
...
chrComPmSonetResetPmCountersAction = _ChrComPmSonetResetPmCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 2, 10, 1, 12),
...
mibBuilder.exportSymbols(
    "ChrComPmSonetSNT-P-Current-MIB",
    **{"chrComPmSonetSNT-P-CurrentTable": chrComPmSonetSNT_P_CurrentTable,
       "chrComPmSonetSNT-P-CurrentEntry": chrComPmSonetSNT_P_CurrentEntry,
       ...
       "chrComPmSonetStatus": chrComPmSonetStatus,
       "chrComPmSonetWidth": chrComPmSonetWidth,
