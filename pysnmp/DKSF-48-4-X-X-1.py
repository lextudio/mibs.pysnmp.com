# SNMP MIB module (DKSF-48-4-X-X-1) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/DKSF-48-4-X-X-1
...
npPwrEntry.setIndexNames(
    (0, "DKSF-48-4-X-X-1", "npPwrChannelN"),
)
if mibBuilder.loadTexts:
...
npSmokeEntry.setIndexNames(
    (0, "DKSF-48-4-X-X-1", "npSmokeSensorN"),
)
if mibBuilder.loadTexts:
...
npThermoEntry.setIndexNames(
    (0, "DKSF-48-4-X-X-1", "npThermoSensorN"),
)
if mibBuilder.loadTexts:
...
npGsmTrap.setObjects(
      *(("DKSF-48-4-X-X-1", "npGsmFailed"),
        ("DKSF-48-4-X-X-1", "npGsmRegistration"),
        ("DKSF-48-4-X-X-1", "npGsmStrength"))
)
if mibBuilder.loadTexts:
    npGsmTrap.setStatus(
        "current"
...
npSmokeTrap.setObjects(
      *(("DKSF-48-4-X-X-1", "npSmokeTrapSensorN"),
        ("DKSF-48-4-X-X-1", "npSmokeTrapStatus"),
        ("DKSF-48-4-X-X-1", "npSmokeTrapMemo"))
)
if mibBuilder.loadTexts:
...
npRelHumTrap.setObjects(
      *(("DKSF-48-4-X-X-1", "npRelHumSensorStatusH"),
        ("DKSF-48-4-X-X-1", "npRelHumSensorValueH"),
        ("DKSF-48-4-X-X-1", "npRelHumSafeRangeHigh"),
        ("DKSF-48-4-X-X-1", "npRelHumSafeRangeLow"))
)
if mibBuilder.loadTexts:
...
npThermoTrap.setObjects(
      *(("DKSF-48-4-X-X-1", "npThermoTrapSensorN"),
        ("DKSF-48-4-X-X-1", "npThermoTrapValue"),
        ("DKSF-48-4-X-X-1", "npThermoTrapStatus"),
        ("DKSF-48-4-X-X-1", "npThermoTrapLow"),
        ("DKSF-48-4-X-X-1", "npThermoTrapHigh"),
        ("DKSF-48-4-X-X-1", "npThermoTrapMemo"))
)
if mibBuilder.loadTexts:
...
npIoTrap.setObjects(
      *(("DKSF-48-4-X-X-1", "npIoTrapLineN"),
        ("DKSF-48-4-X-X-1", "npIoTrapLevelIn"),
        ("DKSF-48-4-X-X-1", "npIoTrapMemo"))
)
if mibBuilder.loadTexts:
    npIoTrap.setStatus(
        "current"
