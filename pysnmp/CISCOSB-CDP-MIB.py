...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/CISCOSB-CDP-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:14:02 2024
...
class RlCdpVersionTypes(Integer32, TextualConvention):
    status = "current"
...
class RlCdpCounterTypes(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class RlCdpPduActionTypes(Integer32, TextualConvention):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
