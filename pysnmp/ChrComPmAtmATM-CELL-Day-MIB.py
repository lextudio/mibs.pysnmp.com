# SNMP MIB module (ChrComPmAtmATM-CELL-Day-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmAtmATM-CELL-Day-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:21:59 2024
...
_ChrComPmAtmATM_CELL_DayTable_Object = MibTable
chrComPmAtmATM_CELL_DayTable = _ChrComPmAtmATM_CELL_DayTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 3)
)
if mibBuilder.loadTexts:
    chrComPmAtmATM_CELL_DayTable.setStatus("current")
_ChrComPmAtmATM_CELL_DayEntry_Object = MibTableRow
chrComPmAtmATM_CELL_DayEntry = _ChrComPmAtmATM_CELL_DayEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 3, 1)
)
chrComPmAtmATM_CELL_DayEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmAtmATM-CELL-Day-MIB", "chrComPmAtmDayNumber"),
)
if mibBuilder.loadTexts:
    chrComPmAtmATM_CELL_DayEntry.setStatus("current")
...
chrComPmAtmTransmittedCells = _ChrComPmAtmTransmittedCells_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 3, 1, 10),
...
chrComPmAtmDiscardedIngCells = _ChrComPmAtmDiscardedIngCells_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 3, 1, 11),
...
chrComPmAtmDiscardedIngHighPrCells = _ChrComPmAtmDiscardedIngHighPrCells_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 3, 1, 12),
...
chrComPmAtmDiscardedEgCells = _ChrComPmAtmDiscardedEgCells_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 3, 1, 13),
...
chrComPmAtmDiscardedEgHighPrCells = _ChrComPmAtmDiscardedEgHighPrCells_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 3, 1, 14),
...
chrComPmAtmDiscardedUPC = _ChrComPmAtmDiscardedUPC_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 3, 1, 15),
...
chrComPmAtmTaggedUPC = _ChrComPmAtmTaggedUPC_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 3, 1, 16),
...
chrComPmAtmThresholdProfIndex = _ChrComPmAtmThresholdProfIndex_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 3, 1, 17),
...
chrComPmAtmResetPmCountersAction = _ChrComPmAtmResetPmCountersAction_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 4, 3, 1, 18),
...
mibBuilder.exportSymbols(
    ...
    **{"chrComPmAtmATM-CELL-DayTable": chrComPmAtmATM_CELL_DayTable,
       "chrComPmAtmATM-CELL-DayEntry": chrComPmAtmATM_CELL_DayEntry,
