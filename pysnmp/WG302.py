# SNMP MIB module (WG302) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/WG302
# Produced by pysmi-1.5.4 at Mon Oct 14 23:13:50 2024
...
remoteSettings = _RemoteSettings_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4526, 4, 6, 4)
)
_Sshd_Type = TruthValue
_Sshd_Object = MibScalar
sshd = _Sshd_Object(
    (1, 3, 6, 1, 4, 1, 4526, 4, 6, 4, 1),
    _Sshd_Type()
)
