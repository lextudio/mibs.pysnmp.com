# SNMP MIB module (MPLS-VPN-MIB-DRAFT-05) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/MPLS-VPN-MIB-DRAFT-05
# Produced by pysmi-1.5.4 at Mon Oct 14 22:23:30 2024
...
class MplsVpnName(OctetString, TextualConvention):
    status = "current"
...
mplsVpnIfConfEntry.setIndexNames(
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfName"),
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnIfConfIndex"),
)
if mibBuilder.loadTexts:
...
mplsVpnVrfRouteTargetEntry.setIndexNames(
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfName"),
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteTargetIndex"),
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteTargetType"),
)
if mibBuilder.loadTexts:
...
mplsVpnVrfBgpNbrAddrEntry.setIndexNames(
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfName"),
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnIfConfIndex"),
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpNbrIndex"),
)
if mibBuilder.loadTexts:
...
mplsVpnVrfRouteEntry.setIndexNames(
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfName"),
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteDest"),
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteMask"),
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteTos"),
    (0, "MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteNextHop"),
)
if mibBuilder.loadTexts:
...
mplsVpnScalarGroup.setObjects(
      *(("MPLS-VPN-MIB-DRAFT-05", "mplsVpnConfiguredVrfs"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnActiveVrfs"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnConnectedInterfaces"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnNotificationEnable"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfConfMaxPossibleRoutes"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfConfRouteMaxThreshTime"))
)
if mibBuilder.loadTexts:
...
mplsVpnVrfGroup.setObjects(
      *(("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfVpnId"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfDescription"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteDistinguisher"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfCreationTime"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfOperStatus"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfActiveInterfaces"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfAssociatedInterfaces"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfConfMidRouteThreshold"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfConfHighRouteThreshold"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfConfMaxRoutes"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfConfLastChanged"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfConfRowStatus"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfConfStorageType"))
)
if mibBuilder.loadTexts:
...
mplsVpnIfGroup.setObjects(
      *(("MPLS-VPN-MIB-DRAFT-05", "mplsVpnIfLabelEdgeType"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnIfVpnClassification"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnIfVpnRouteDistProtocol"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnIfConfStorageType"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnIfConfRowStatus"))
)
if mibBuilder.loadTexts:
...
mplsVpnPerfGroup.setObjects(
      *(("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfPerfRoutesAdded"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfPerfRoutesDeleted"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfPerfCurrNumRoutes"))
)
if mibBuilder.loadTexts:
...
mplsVpnVrfBgpNbrGroup.setObjects(
      *(("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpNbrRole"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpNbrType"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpNbrAddr"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpNbrRowStatus"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpNbrStorageType"))
)
if mibBuilder.loadTexts:
...
mplsVpnVrfBgpPrefixGroup.setObjects(
      *(("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrOrigin"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrASPathSegment"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrNextHop"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrMultiExitDisc"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrLocalPref"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrAtomicAggregate"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrAggregatorAS"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrAggregatorAddr"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrCalcLocalPref"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrBest"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrUnknown"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrPeerType"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfBgpPAtrIpAddrPfxType"),
...
mplsVpnSecGroup.setObjects(
      *(("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfSecIllegalLblVltns"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfSecIllegalLblRcvThrsh"))
)
if mibBuilder.loadTexts:
...
mplsVpnVrfRouteGroup.setObjects(
      *(("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteDestAddrType"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteMaskAddrType"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteNextHop"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteNextHopAddrType"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteIfIndex"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteType"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteProto"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteAge"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteInfo"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteNextHopAS"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteMetric1"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteMetric2"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteMetric3"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteMetric4"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteMetric5"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteRowStatus"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteStorageType"))
)
if mibBuilder.loadTexts:
...
mplsVpnVrfRouteTargetGroup.setObjects(
      *(("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteTargetDescr"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteTarget"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVpnVrfRouteTargetRowStatus"))
)
if mibBuilder.loadTexts:
...
mplsVpnNotificationGroup.setObjects(
      *(("MPLS-VPN-MIB-DRAFT-05", "mplsVrfIfUp"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsVrfIfDown"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsNumVrfRouteMidThreshExceeded"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsNumVrfRouteMaxThreshExceeded"),
        ("MPLS-VPN-MIB-DRAFT-05", "mplsNumVrfSecIllglLblThrshExcd"),
