# SNMP MIB module (MRV-IN-REACH-LAT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/MRV-IN-REACH-LAT-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:23:43 2024
...
latPortEntry.setIndexNames(
    (0, "MRV-IN-REACH-LAT-MIB", "latPortIndex"),
)
if mibBuilder.loadTexts:
...
latOfferedServiceEntry.setIndexNames(
    (0, "MRV-IN-REACH-LAT-MIB", "latOfferedServiceName"),
)
if mibBuilder.loadTexts:
...
latVisibleServiceEntry.setIndexNames(
    (0, "MRV-IN-REACH-LAT-MIB", "latVisibleServiceName"),
)
if mibBuilder.loadTexts:
...
latNodeEntry.setIndexNames(
    (0, "MRV-IN-REACH-LAT-MIB", "latNodeName"),
)
if mibBuilder.loadTexts:
