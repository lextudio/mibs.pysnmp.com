# SNMP MIB module (ADH-NETCOM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ADH-NETCOM-MIB
...
class _CycleTime_Type(DisplayString):
    """Custom type cycleTime based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(10, 10),
    )
...
_CycleTime_Type.__name__ = "DisplayString"
_CycleTime_Object = MibScalar
cycleTime = _CycleTime_Object(
    (1, 3, 6, 1, 4, 1, 32185, 2, 1, 9),
    _CycleTime_Type()
)
cycleTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
