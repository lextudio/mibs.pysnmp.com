# SNMP MIB module (Nortel-Magellan-Passport-StandardTextualConventionsMIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Nortel-Magellan-Passport-StandardTextualConventionsMIB
...
standardTextualConventionsGroup = _StandardTextualConventionsGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 6, 1)
)
_StandardTextualConventionsGroupBC_ObjectIdentity = ObjectIdentity
standardTextualConventionsGroupBC = _StandardTextualConventionsGroupBC_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 6, 1, 3)
)
_StandardTextualConventionsGroupBC02_ObjectIdentity = ObjectIdentity
standardTextualConventionsGroupBC02 = _StandardTextualConventionsGroupBC02_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 6, 1, 3, 2)
)
_StandardTextualConventionsGroupBC02A_ObjectIdentity = ObjectIdentity
standardTextualConventionsGroupBC02A = _StandardTextualConventionsGroupBC02A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 6, 1, 3, 2, 2)
)
...
standardTextualConventionsCapabilities = _StandardTextualConventionsCapabilities_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 6, 3)
)
_StandardTextualConventionsCapabilitiesBC_ObjectIdentity = ObjectIdentity
standardTextualConventionsCapabilitiesBC = _StandardTextualConventionsCapabilitiesBC_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 6, 3, 3)
)
_StandardTextualConventionsCapabilitiesBC02_ObjectIdentity = ObjectIdentity
standardTextualConventionsCapabilitiesBC02 = _StandardTextualConventionsCapabilitiesBC02_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 6, 3, 3, 2)
)
_StandardTextualConventionsCapabilitiesBC02A_ObjectIdentity = ObjectIdentity
standardTextualConventionsCapabilitiesBC02A = _StandardTextualConventionsCapabilitiesBC02A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 562, 2, 4, 2, 6, 3, 3, 2, 2)
)
...
mibBuilder.exportSymbols(
    ...
    **{"PassportCounter64": PassportCounter64,
       ...
       "standardTextualConventionsGroupBC": standardTextualConventionsGroupBC,
       "standardTextualConventionsGroupBC02": standardTextualConventionsGroupBC02,
       "standardTextualConventionsGroupBC02A": standardTextualConventionsGroupBC02A,
       "standardTextualConventionsCapabilities": standardTextualConventionsCapabilities,
       "standardTextualConventionsCapabilitiesBC": standardTextualConventionsCapabilitiesBC,
       "standardTextualConventionsCapabilitiesBC02": standardTextualConventionsCapabilitiesBC02,
       "standardTextualConventionsCapabilitiesBC02A": standardTextualConventionsCapabilitiesBC02A}
)
