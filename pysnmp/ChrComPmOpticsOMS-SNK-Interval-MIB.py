# SNMP MIB module (ChrComPmOpticsOMS-SNK-Interval-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/ChrComPmOpticsOMS-SNK-Interval-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 21:22:20 2024
...
_ChrComPmOpticsOMS_SNK_IntervalTable_Object = MibTable
chrComPmOpticsOMS_SNK_IntervalTable = _ChrComPmOpticsOMS_SNK_IntervalTable_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 8)
)
if mibBuilder.loadTexts:
    chrComPmOpticsOMS_SNK_IntervalTable.setStatus("current")
_ChrComPmOpticsOMS_SNK_IntervalEntry_Object = MibTableRow
chrComPmOpticsOMS_SNK_IntervalEntry = _ChrComPmOpticsOMS_SNK_IntervalEntry_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 8, 1)
)
chrComPmOpticsOMS_SNK_IntervalEntry.setIndexNames(
    (0, "ChrComIfifTable-MIB", "chrComIfifIndex"),
    (0, "ChrComPmOpticsOMS-SNK-Interval-MIB", "chrComPmOpticsIntervalNumber"),
)
if mibBuilder.loadTexts:
    chrComPmOpticsOMS_SNK_IntervalEntry.setStatus("current")
...
chrComPmOpticsMin = _ChrComPmOpticsMin_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 8, 1, 10),
...
chrComPmOpticsSD = _ChrComPmOpticsSD_Object(
    (1, 3, 6, 1, 4, 1, 3695, 1, 10, 1, 8, 1, 11),
...
mibBuilder.exportSymbols(
    "ChrComPmOpticsOMS-SNK-Interval-MIB",
    **{"chrComPmOpticsOMS-SNK-IntervalTable": chrComPmOpticsOMS_SNK_IntervalTable,
       "chrComPmOpticsOMS-SNK-IntervalEntry": chrComPmOpticsOMS_SNK_IntervalEntry,
