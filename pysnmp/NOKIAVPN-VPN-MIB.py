# SNMP MIB module (NOKIAVPN-VPN-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/NOKIAVPN-VPN-MIB
...
nokiaVPNMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 94, 1, 41, 5, 5)
)
nokiaVPNMIB.setRevisions(
        ("2001-01-18 00:00",)
)
...
vpnSessionRecvFlags = _VpnSessionRecvFlags_Object(
    (1, 3, 6, 1, 4, 1, 94, 1, 41, 2, 2, 8, 1, 10),
...
vpnSessionUsername = _VpnSessionUsername_Object(
    (1, 3, 6, 1, 4, 1, 94, 1, 41, 2, 2, 8, 1, 11),
...
vpnSessionLifetimeSeconds = _VpnSessionLifetimeSeconds_Object(
    (1, 3, 6, 1, 4, 1, 94, 1, 41, 2, 2, 8, 1, 12),
