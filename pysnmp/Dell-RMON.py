# SNMP MIB module (Dell-RMON) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/Dell-RMON
...
rlHistoryControlEntry.setIndexNames(
    (0, "Dell-RMON", "rlHistoryControlIndex"),
)
if mibBuilder.loadTexts:
...
rlHistoryEntry.setIndexNames(
    (0, "Dell-RMON", "rlHistoryIndex"),
    (0, "Dell-RMON", "rlHistorySampleIndex"),
)
if mibBuilder.loadTexts:
