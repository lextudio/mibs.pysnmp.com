# SNMP MIB module (RADLAN-TUNNEL-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file:///Users/lextm/pysnmp.com/mibs.pysnmp.com/asn1/RADLAN-TUNNEL-MIB
# Produced by pysmi-1.5.4 at Mon Oct 14 22:43:48 2024
...
rlTunnelIsatapPrlEntry = _RlTunnelIsatapPrlEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 122, 12, 1, 2, 1)
)
rlTunnelIsatapPrlEntry.setIndexNames(
    (0, "RADLAN-TUNNEL-MIB", "rlTunnelIsatapPrlIfIndex"),
    (0, "RADLAN-TUNNEL-MIB", "rlTunnelIsatapPrlPriority"),
)
if mibBuilder.loadTexts:
